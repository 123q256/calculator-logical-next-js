      ...
      >
        <div className="text-end">
          <button
            ...
            onClick={onClose}
            className="close-modal absolute top-1 right-1 text-gray-500 hover:text-black focus:outline-none"
          >
            <svg
          ...
          <div className="relative shrink-0 w-full mb-0">
            <input
              ...
              className="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full pl-4 pr-10 py-3 transition-all duration-300 ease-in-out hover:shadow-lg hover:bg-white search_cal input_border"
              ...
              >
                {suggestions.map((item, index) => (
                  <Link
                    ...
                    key={index}
                    onClick={onClose}
                    className={`block items-center p-2 mt-1 rounded border-bb group hover:shadow-sm hover:bg-gray-50 ${

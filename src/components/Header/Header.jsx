          ...
          <div className="flex gap-2 ">
            <div className="pr-btn">
              <button
                ...
                className="open-modal premium-btn bg-[#1A1A1A] lg:hidden  text-[#fff] hover:bg-[#2845F5] hover:text-white duration-200 font-[600] text-[14px] rounded-[25px] px-4 py-3"
              >
                Search
              </button>
            </div>
            <button
              ...
              className="text-white lg:hidden bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2.5 "
              type="button"

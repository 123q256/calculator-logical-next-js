          ...
          <div class="lg:w-[60%] md:w-[60%] w-full mx-auto ">
            <div class="grid grid-cols-1  lg:grid-cols-2 md:grid-cols-2  gap-4">
              <div class="space-y-2">
                ...
                <div className="col-span-12">
                  <p class="label">{data?.payload?.tech_lang_keys["3"]}:</p>
                  <label
                    htmlFor="tech_length"
                    className="label"
                    id="textChanged"
              ...
              <div className="w-full mx-auto p-4 lg:p-8 md:p-8 result_calculator rounded-lg space-y-6 result">
                <div>
                  ...
                  <div class="rounded-lg  flex items-center justify-center">
                    <div class="w-full bg-light-blue p-2 rounded-lg mt-2">
                      <div class="mt-4">
                        <p class="text-lg mt-2 mb-2 font-bold">
                          {data?.payload?.tech_lang_keys["9"]}{" "}
                          {data?.payload?.tech_lang_keys["10"]}
                        </p>
                        <table class="text-base mb-6 w-full lg:w-1/2 overflow-auto">
                          <tr>
                            <td class="border-b py-2 w-3/4">
                              {data?.payload?.tech_lang_keys["10"]}:
                            </td>
                        ...
                        <table class="text-base mb-2 w-full lg:w-1/2 overflow-auto">
                          <tr>
                            <td class="border-b py-2 w-3/4">
                              {data?.payload?.tech_lang_keys["11"]}:
                            </td>

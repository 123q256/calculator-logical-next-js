...
const DaysAgoCalculator = () => {
  ...
  useEffect(() => {
    ...
    const htmlContent = Array.from({ length: 60 }, (_, i) => {
      ...
      return `
                <tr class="font-bold hover:bg-gray-600" style="font-weight: 700;">
                  <td class="bg-gray">${index} days ago</td>
              ...
              <div className="w-full mx-auto p-4 lg:p-8 md:p-8 result_calculator rounded-lg  space-y-6 result">
                <div>
                  ...
                  <div class="rounded-lg  flex items-center justify-center">
                    <div class="col-12 bg-light-blue result radius-10 mt-4 overflow-auto">
                      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-2">
                        <div class="col-lg-6 p-1">
                          <div class="bordered radius-5 bg-sky lg:p-4 md:p-4 p-3">
                            <p>📅 Date</p>
                            <p class="font-s-18">

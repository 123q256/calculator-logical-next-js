    ...
    rows.push(
      <div key={i} className="grid grid-cols-12 gap-3 mb-3">
        ...
        <div className="col-span-4">
          <label htmlFor={`tech_n${i}`} className="label block mb-1 font-medium">Holiday</label>
          <input
            type="text"
            name={`tech_n${i}`}
            id={`tech_n${i}`}
        ...
        {/* Month */}
        <div className="col-span-4">
          <label htmlFor={`tech_m${i}`} className="label block mb-1 font-medium">Month</label>
          <select
            name={`tech_m${i}`}
            id={`tech_m${i}`}
        ...
        {/* Day */}
        <div className="col-span-4">
          <label htmlFor={`tech_d${i}`} className="label block mb-1 font-medium">Day</label>
                                  ...
                                  <div className="grid grid-cols-12  gap-2">
                                      ...
                                      <div className="col-span-6">
                                        <input
                                          ...
                                          />
                                        <label htmlFor="tech_end_inc" className="text-sm text-blue-500">
                                      ...
                                      <div className="col-span-6 ps-lg-4">  
                                          ...
                                          />
                                        <label htmlFor="tech_sat_inc" className="text-sm text-blue-500">
                                          {data?.payload?.tech_lang_keys['n30']}:
                                        </label>
                                      </div>
                                      <p className="mt-2 col-span-12 text-[14px]">{data?.payload?.tech_lang_keys['n31']}</p>
                                                ...
                                                <div className="col-span-6">
                                                    <label className="d-block">
                                                        <input
                                                          ...
                                                          />
                                                        <span className="black-text">New Year's Day</span>
                                                    </label>
                                                </div>
                                                 <div className="col-span-6">
                                                    <label className="d-block my-2">
                                                      <input
                                                          ...
                                                          />
                                                        <span className="black-text">M. L. King Day (US)</span>
                                                    </label>
                                                  </div>
                                                  <div className="col-span-6">
                                                    <label className="d-block my-2">
                                                        <input
                                                          ...
                                                          />
                                                        <span className="black-text">President's Day (US)</span>
                                                    </label>
                                                  </div>
                                                  <div className="col-span-6">
                                                      <label className="d-block my-2">
                                                        <input
                                                            ...
                                                            />
                                                          <span className="black-text">Memorial Day (US)</span>
                                                      </label>
                                                  </div>
                                                  <div className="col-span-6">
                                                    <label className="d-block my-2">
                                                      <input
                                                          ...
                                                          />
                                                        <span className="black-text">Independence Day (US)</span>
                                                    </label>
                                                  </div>
                                                  <div className="col-span-6">
                                                    <label className="d-block my-2">
                                                      <input
                                                          ...
                                                          />
                                                        <span className="black-text">Labor Day (US)</span>
                                                    </label>
                                                  </div>
                                                  <div className="col-span-6">
                                                    <label className="d-block my-2">
                                                      <input
                                                          ...
                                                          />
                                                        <span className="black-text">Columbus Day (US)</span>
                                                    </label>
                                                  </div>
                                                  <div className="col-span-6">
                                                  <label className="d-block">
                                                      <input
                                                        ...
                                                        />
                                                      <span className="black-text">Veteran's Day (US)</span>
                                                  </label>
                                                  </div>
                                                  <div className="col-span-6">
                                                  <label className="d-block my-2">
                                                    <input
                                                        ...
                                                        />
                                                      <span className="black-text">Thanksgiving (US)</span>
                                                  </label>
                                                  </div>
                                                  <div className="col-span-6">
                                                  <label className="d-block my-2">
                                                      <input
                                                        ...
                                                        />
                                                      <span className="black-text">Black Friday (US)</span>
                                                  </label>
                                                  </div>
                                                  <div className="col-span-6">
                                                  <label className="d-block my-2">
                                                      <input
                                                        ...
                                                        />
                                                      <span className="black-text">Christmas Eve</span>
                                                  </label>
                                                  </div>
                                                  <div className="col-span-6">
                                                  <label className="d-block my-2">
                                                      <input
                                                        ...
                                                        />
                                                      <span className="black-text">Christmas</span>
                                                  </label>
                                                  </div>
                                                  <div className="col-span-6">
                                                  <label className="d-block my-2">
                                                      <input
                                                        ...
                                                        />
                                                      <span className="black-text">New Year's Eve</span>
                                                  </label>
                                                </div>

                                            </div>
                                            <p className="fw-bold mb-3 mt-2">If not in the list, define the holidays below:</p>
                                               <input type="hidden" name="total_i" value={count} id="total_i" />
                                              {renderHolidayRows()}
                                            <div className="mt-4">
                                              <button
                                                type="button"
                                      ...
                                      <p className="mt-2 col-span-12 text-[14px]">{data?.payload?.tech_lang_keys['n35']}</p>
                                      <div className="col-span-12 md:col-span-6 mt-2 pe-lg-4">
                                          ...
                                          <div className="mt-2">
                                            <select
                                              ...
                                              onChange={handleChange}
                                            >
                                              <option value="1">{data?.payload?.tech_lang_keys["n37"]} </option>
                                              <option value="2">{data?.payload?.tech_lang_keys["n38"]} </option>
                                            </select>
                                          </div>
                                      </div>
                                      <div className="col-span-12 md:col-span-6 mt-2 ps-lg-4">
                                          ...
                                          <div className="mt-2">
                                            <select
                                              ...
                                              onChange={handleChange}
                                            >
                                              <option value="2">{data?.payload?.tech_lang_keys["n40"]} </option>
                                              <option value="4">{data?.payload?.tech_lang_keys["n41"]} </option>
                                              <option value="5">{data?.payload?.tech_lang_keys["n42"]} </option>
                                              <option value="6">{data?.payload?.tech_lang_keys["n43"]} </option>
                                            </select>
                                          </div>
                                      </div>
                                            ...
                                            <div className="grid grid-cols-12  gap-4 mt-3">
                                                <div className="col-span-6">
                                                    <label className="d-block">
                                                        ...
                                                        />
                                                        <span className="black-text">{data?.payload?.tech_lang_keys['n44']}</span>
                                                    </label>
                                                  </div>
                                                    <div className="col-span-6">
                                                      <label className="d-block my-2">
                                                        <input
                                                          ...
                                                          />
                                                          <span className="black-text">{data?.payload?.tech_lang_keys['n45']}</span>
                                                      </label>
                                                    </div>
                                                      <div className="col-span-6">
                                                      <label className="d-block my-2">
                                                          ...
                                                          />
                                                          <span className="black-text">{data?.payload?.tech_lang_keys['n36']}</span>
                                                      </label>
                                                      </div>
                                                      <div className="col-span-6">
                                                      <label className="d-block my-2">
                                                          ...
                                                          />
                                                          <span className="black-text">{data?.payload?.tech_lang_keys['n37']}</span>
                                                      </label>
                                                      </div>
                                                    <div className="col-span-6">
                                                      <label className="d-block">
                                                          ...
                                                          />
                                                          <span className="black-text">{data?.payload?.tech_lang_keys['n38']}</span>
                                                      </label>
                                                    </div>
                                                    <div className="col-span-6">
                                                    <label className="d-block my-2">
                                                        ...
                                                        />
                                                        <span className="black-text">{data?.payload?.tech_lang_keys['n39']}</span>
                                                    </label>
                                                    </div>
                                                    <div className="col-span-6">
                                                    <label className="d-block my-2">
                                                        ...
                                                        />
                                                        <span className="black-text">{data?.payload?.tech_lang_keys['n40']}</span>
                                                    </label>
                                                    </div>
                              ...
                              <>
                                <div className="grid grid-cols-12 gap-2">
                                    ...
                                    <div className="col-span-12 md:col-span-6 ">
                                          ...
                                          {data?.payload?.tech_lang_keys["n19"]}  / {data?.payload?.tech_lang_keys['n20']}:
                                        </label>
                                        <div className="mt-2">
                                          <select
                                            className="input"
                                            ...
                                            onChange={handleChange}
                                          >
                                          <option value="+">{ data?.payload?.tech_lang_keys['n19'] } (+)</option>
                                            <option value="-">{ data?.payload?.tech_lang_keys['n21'] } (-)</option>
                                          </select>
                                        </div>
                                    </div>
                                    <div className="col-span-12">
                                    ...
                                    <div className="col-span-6">    
                                        <label className="d-block my-2">
                                          <input
                                            ...
                                            />
                                          <span className="black-text">{data?.payload?.tech_lang_keys['n49'] }</span>
                                      </label>
                                    </div>
                                      {formData.tech_cal_bus   && (
                                      <>
                                      <div className=" checkrow col-span-12 ">
                                            <div className="grid grid-cols-12 gap-2">
                                            <p className="mt-2 col-span-12 text-[14px]">{data?.payload?.tech_lang_keys['n50']}</p>
                                            <div className="col-span-12 md:col-span-6 mt-2">
                                                <label className="pe-2" htmlFor="no">
                                                  ...
                                                  />
                                                  <span>{ data?.payload?.tech_lang_keys['n51'] }</span>
                                                </label>
                                            </div>
                                            <div className="col-span-12 md:col-span-6 mt-2 ps-lg-4">
                                                <label className="pe-2" htmlFor="yes">
                                                  ...
                                                  />
                                                  <span>{ data?.payload?.tech_lang_keys['n52'] }</span>
                                                </label>
                                            </div>
                                            </div>
                                      </div>
                                      ...
                                      {(formData.tech_weekend_c  == 'yes' && formData.tech_cal_bus) && (
                                      <>
                                      <div className="week my-3  col-span-12">
                                          <div className="grid grid-cols-12 gap-3">
                                           ...
                                           {/* Hidden input for total_j */}
                                            <input type="hidden" name="total_j" value={count} id="total_j" />
                                          <p className="fw-bold my-2">{((data?.payload?.tech_lang_keys=='en')?'If not in the list,':'')} {data?.payload?.tech_lang_keys['n53']}</p>
                                           {renderHolidayRows()}
                                            <div className="mt-4">
                                              <button
                                                type="button"
                                    ...
                                    <table className="w-full">
                                      <tbody>
                                        <tr className="">
                                          ...
                                          <td className="border-b py-2">{result?.tech_from}</td>
                                        </tr>
                                        <tr>
                                          <td className="py-2">
                                            <strong>{data?.payload?.tech_lang_keys['20']}</strong>
                                          </td>
                                          <td className="py-2">{result?.tech_to}</td>
                                        </tr>
                                        <tr>
                                          <td colSpan={2} className="border-b py-2">
                                            {result?.tech_getworkdays?.workdays} {data?.payload?.tech_lang_keys['34']}
                                          </td>
                                        </tr>
                                        <tr>
                                          <td colSpan={2} className="border-b py-2">
                                            {data?.payload?.tech_lang_keys['35']} {result?.tech_getworkdays?.workdays * 8} {data?.payload?.tech_lang_keys['36']}
                                          </td>
                                        </tr>
                                        <tr>
                                          <td colSpan={2} className="border-b py-2">
                                            {data?.payload?.tech_lang_keys['35']} {result?.tech_getworkdays?.workdays * 8 * 60} {data?.payload?.tech_lang_keys['37']}
                                          </td>
                                        </tr>
                                        <tr>
                                          <td colSpan={2} className="border-b py-2">
                                            {data?.payload?.tech_lang_keys['35']} {result?.tech_getworkdays?.workdays * 8 * 60 * 60} {data?.payload?.tech_lang_keys['38']}
                                          </td>
                                        </tr>
                                        <tr>
                                          <td className="pt-2">
                                        ...
                                        <tr>
                                          <td className="border-b py-2">Total Days</td>
                                          <td className="border-b py-2">{result?.tech_t_days}</td>
                                        </tr>
                                        <tr>
                                          <td className="border-b py-2">Business Days</td>
                                          <td className="border-b py-2">{result?.tech_getworkdays?.workdays}</td>
                                        </tr>
                                        <tr>
                                          <td className="border-b py-2">Weekend Days</td>
                                          <td className="border-b py-2">{result?.tech_getworkdays?.weekend}</td>
                                        </tr>
                                        <tr>
                                          <td className="border-b py-2">Work Hours</td>
                                          <td className="border-b py-2">{result?.tech_getworkdays?.workdays * 8}h</td>
                                        </tr>
                                        {formData?.tech_holiday_c == 'yes' && (
                                          <tr>
                                            <td className="border-b py-2">
                                              Holidays{' '}
                                              {result?.tech_getworkdays?.holidays != 0 && (
                                                <span className="view_holi">(View result)</span>
                                              )}
                                            </td>
                                            <td className="border-b py-2">{result?.tech_getworkdays?.holidays}</td>
                                          </tr>
                                        )}

                                        {result?.tech_t_days && result?.tech_ans2 && (
                                          <tr>
                                            <td className="border-b py-2">
                                              <strong>{result?.tech_t_days}</strong> Calendar Days – <strong>{result?.tech_ans2}</strong> Skipped Days
                                            </td>
                                          </tr>
                                        )}
                                        ...
                                        {result?.tech_weekends_days && (
                                          <tr>
                                            <td className="border-b py-2">{result?.tech_weekends_days} Weekend Days</td>
                                          </tr>
                                        )}
                                        {result?.tech_holi_days && (
                                          <tr>
                                            <td className="border-b py-2">{result?.tech_holi_days} Holidays</td>
                                          </tr>
                                        )}

                                        {Object.entries(result || {}).map(([key, value]) => {
                                          if (key.match(/^tech_(sun|mon|tue|wed|thu|fri|sat)_day$/) && value) {
                                            return (
                                              <tr key={key}>
                                                <td className="border-b py-2">
                                                  <strong>{value}</strong>
                                        ...
                                        {result?.tech_res_days && (
                                          <tr>
                                            <td className="border-b py-2" id="resu">Result: </td>
                                            <td className="border-b py-2">{result?.tech_res_days} Days</td>
                                          </tr>
                                        )}

                                        {formData?.tech_holiday_c == 'yes' && result?.tech_getworkdays?.holidays != 0 && (
                                          <>
                                            <tr>
                                              <td className="border-b py-2" colSpan={2}>
                                                <strong>
                                                  {data?.payload?.tech_lang_keys['25']} {result?.tech_from} and {result?.tech_to}
                                                </strong>
                                              </td>
                                            </tr>
                                            {holidays.map((holiday, i) => (
                                              <tr key={i}>
                                                <td className="border-b py-2">{holidayLabels[i]}</td>
                                                <td className="border-b py-2">
                                 ...
                                 <div className="col-span-12 md:col-span-12 text-[16px] overflow-auto">
                                    <table className="w-full">
                                      {formData?.tech_cal_bus ? (
                                        <>
                                          <tr>
                                            <td colSpan={2} width="60%" className="border-b py-2">
                                              {result?.tech_date}
                                            </td>
                                          </tr>
                                          <tr>
                                            <td colSpan={2} className="border-b py-2">
                                              {formData?.tech_method == "+" ? (
                                                <>
                                                  {data?.payload?.tech_lang_keys["28"]} {formData?.tech_days}{" "}
                                                  {data?.payload?.tech_lang_keys["22"]}{" "}
                                                  {data?.payload?.tech_lang_keys["29"]} {result?.tech_from}{" "}
                                                  {data?.payload?.tech_lang_keys["30"]} {result?.tech_from_s}{" "}
                                                  {data?.payload?.tech_lang_keys["26"]} {result?.tech_date_e}
                                                </>
                                              ) : (
                                                <>
                                                  {data?.payload?.tech_lang_keys["28"]} {formData?.tech_days}{" "}
                                                  {data?.payload?.tech_lang_keys["22"]} before {result?.tech_from}{" "}
                                                  {data?.payload?.tech_lang_keys["30"]} {result?.tech_date_e}{" "}
                                                  {data?.payload?.tech_lang_keys["31"]} {result?.tech_from_s} and
                                                </>
                                              )}
                                            </td>
                                          </tr>
                                          <tr>
                                            <td className="border-b py-2">{data?.payload?.tech_lang_keys["22"]}</td>
                                            <td className="border-b py-2">{formData?.tech_days}</td>
                                          </tr>
                                          <tr>
                                            <td className="border-b py-2">{data?.payload?.tech_lang_keys["23"]}</td>
                                            <td className="border-b py-2">{result?.tech_weekends}</td>
                                          </tr>
                                          <tr>
                                            <td className="border-b py-2">
                                            ...
                                            <td className="border-b py-2">{result?.tech_holidays}</td>
                                          </tr>

                                          {formData?.tech_weekend_c == "yes" && result?.tech_holidays != 0 && (
                                            <>
                                              <tr>
                                                <td className="border-b py-2 font-bold">
                                                  {data?.payload?.tech_lang_keys["25"]} {result?.tech_from}{" "}
                                                  {data?.payload?.tech_lang_keys["26"]} {result?.tech_date}
                                                </td>
                                              </tr>
                                              {(result?.tech_get_holi || []).map((holiday, i) => (
                                                <tr key={i}>
                                                  <td className="border-b py-2">{result?.tech_dis_holi?.[i]}</td>
                                                  <td className="border-b py-2">{holiday}</td>
                                                </tr>
                                              ))}
                                            </>
                                          )}
                                        ...
                                        <>
                                          ...
                                          <tr>
                                            <td className="border-b py-2">{data?.payload?.tech_lang_keys["27"]}</td>
                                            <td className="border-b py-2">{result?.tech_date}</td>
                                          </tr>
                                        </>
                                      )}
                                    </table>

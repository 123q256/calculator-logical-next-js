                  ...
                  <div class="rounded-lg  flex items-center justify-center">
                    <div class="w-full mt-3">
                      <div class="grid grid-cols-12 gap-2 my-2">
                        <div class="col-span-12 md:cols-span-6 text-[16px]">
                          <table class="w-full">
                            <tbody>
                              <tr>
                                <td width="70%" class="border-b py-2">
                                  <strong>
                          ...
                          <table class="w-full">
                            <tbody>
                              <tr>
                                <td width="70%" class="border-b pt-4 pb-2">
                                  <strong>
                                    {data?.payload?.tech_lang_keys["9"]} :
                                  </strong>
                                </td>
                                <td class="border-b pt-4 pb-2">
                        ...
                        <div class="col-span-12 md:cols-span-6">

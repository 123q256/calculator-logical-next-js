                        ...
                        <div className="w-full  font-s-18">
                          <table className="w-full">
                            ...
                            <tr>
                              ...
                              <td className="border-b py-2">
                                {Number(result?.tech_v_liter).toFixed(2)} liters
                              </td>
                            </tr>
                            <tr>
                              <td width="20%" className="border-b py-2">
                            ...
                            <>
                              <table className="w-full mt-2">
                                <tr>
                                  ...
                                  <td className="border-b py-2">
                                    {Number(result?.tech_v_fill).toFixed(2)} in³
                                    (
                                ...
                                <tr>
                                  ...
                                  <td className="border-b py-2">
                                    {Number(result?.tech_v_liter_fill).toFixed(
                                      2
                                    )}{" "}
                                    liters
                                  </td>
                                ...
                                <tr>
                                  ...
                                  <td className="border-b py-2">
                                    {Number(result?.tech_v_meter_fill).toFixed(
                                      2
                                    )}{" "}
                                    m³
                                  </td>
                                ...
                                <tr>
                                  ...
                                  <td className="border-b py-2">
                                    {Number(result?.tech_v_cm_fill).toFixed(2)}{" "}
                                    cm³
                                  </td>
                                </tr>
                              </table>

...
import { useSquareFootageCalculatorMutation } from "../../../redux/services/datecalculator/dateCalculatorApi";
                  ...
                  <div className="rounded-lg  flex items-center justify-center">
                    <div className="w-full  p-6 rounded-lg mt-6">
                      <div className="w-full text-center text-xl">
                        <p className="my-3 ">
                          <strong className="px-6 py-4 text-3xl rounded-lg bg-black text-white">

            ...
            <div className="grid grid-cols-12 mt-3  gap-2">
              ...
              <div className="col-span-12 text-end mt-3">
                <button
                  type="button"
                  onClick={addPerk}
                  className="px-3 py-2 mx-1 addmore bg-[#2845F5] rounded-[10px] text-white font-semibold"
                >
                                ...
                                <>
                                  ...
                                  <tr>
                                    ...
                                    <td className="py-2 border-b">
                                      {currency.symbol}{" "}
                                      <strong>
                                        {(result?.tech_emp_h_r_p / 12).toFixed(
                                          2
                                        )}
                                      </strong>
                                    </td>
                                  ...
                                  <tr>
                                    ...
                                    <td className="py-2 border-b">
                                      {currency.symbol}{" "}
                                      <strong>
                                        {(result?.tech_emp_h_r_p / 52).toFixed(
                                          2
                                        )}
                                      </strong>
                                    </td>
                                  ...
                                  <tr>
                                    ...
                                    <td className="py-2 border-b">
                                      {currency.symbol}{" "}
                                      <strong>
                                        {(result?.tech_emp_h_r_p / 365).toFixed(
                                          2
                                        )}
                                      </strong>
                                    </td>

          ...
          <div class="lg:w-[60%] md:w-[60%] w-full mx-auto ">
            <div class="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
              ...
              {formData.tech_method_unit ==
                data?.payload?.tech_lang_keys[12] && (
                <>
                  <div class="col-span-12 md:col-span-6 " id="hidden_three">
                    <label htmlFor="tech_area" className="label">
                      <span class="text-blue">
                        {data?.payload?.tech_lang_keys["9"]}
                      </span>
                      <span class="text-blue"> {currency.symbol} per</span>
                    </label>
                  ...
                  <div class="col-span-12 md:col-span-6 " id="hidden_four">
                      ...
                      <div class="w-full md:w-[80%] lg:w-[80%] mt-2">
                        <table class="w-full text-[18px]">
                          ...
                          <tr>
                            ...
                            <td class="py-2 border-b">
                              {" "}
                              {Number(result?.tech_maximum_bid_price).toFixed()}
                            </td>
                          </tr>
                          <tr>
                            <td class="py-2 border-b" width="70%">

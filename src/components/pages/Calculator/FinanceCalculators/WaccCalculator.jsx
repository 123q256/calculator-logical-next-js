          ...
          <div class="lg:w-[70%] md:w-[70%] w-full mx-auto ">
            ...
            <div class="grid grid-cols-12 mt-3  gap-4">
              ...
              {formData.tech_unit_type == "cd" && (
                <div class=" col-span-12  " id="test2">
                  <div class="grid grid-cols-12 mt-3  gap-4">
                    <p class="col-span-12 px-2">
              ...
              {formData.tech_unit_type == "debt" && (
                <div class=" col-span-12  " id="test3">
                  <div class="grid grid-cols-12 mt-3  gap-4">
                    <p class="col-span-12 px-2">
                      <strong>
                    ...
                    <div className="w-full mt-3">
                      {formData.tech_unit_type == "capm" ? (
                        ...
                        <div className="w-full text-center text-[25px]">
                          ...
                          <p className="my-3">
                            <strong className="bg-sky-100 px-3 py-2 font-s-32 radius-10 text-blue">

        ...
        <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg  space-y-6 mb-3">
          ...
          <div className="lg:w-[60%] md:w-[90%] w-full mx-auto ">
            ...
            {formData.tech_type === "second" && (
              <div className="grid grid-cols-1  gap-4 mt-3" id="calculator">
            ...
            {formData.tech_type === "first" && (
              <div className="grid grid-cols-1  gap-4 mt-3" id="converter">
                <div className="grid grid-cols-1 md:grid-cols-2  gap-4 mt-3">
                  <div className="space-y-2 ">
                    ...
                    <div className="w-full bg-light-blue p-3 rounded-lg mt-3">
                      <div className="w-full text-center text-xl">
                        ...
                        <p className="my-3" id="jawab">
                          <strong className="bg-[#2845F5] px-3 py-2 lg:text-4xl rounded-lg text-white">

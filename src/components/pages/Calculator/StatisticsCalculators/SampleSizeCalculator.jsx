          ...
          <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
            ...
            <div className="grid grid-cols-12 mt-5  gap-2">
              ...
              {formData.tech_given_unit == "standard" && (
                <>
                  <div className="lg:col-span-6 md:col-span-6 col-span-12" id="stander">
              ...
              {formData.tech_given_unit == "population" && (
                <>
                  <div className="lg:col-span-6 md:col-span-6 col-span-12" id="proportion">
              ...
              {formData.tech_population == "margin" && (
                <>
                  <div className="lg:col-span-6 md:col-span-6 col-span-12" id="finite">
                              ...
                              <div className="overflow-auto">
                                ...
                                <p className="w-full mt-3 text-[16px] md:text-[20px]">
                                  <InlineMath
                                    math={`${
                                      data?.payload?.tech_lang_keys["8"]
                                    } = (${Number(result?.tech_divide).toFixed(
                                      2
                                    )})^2`}
                                  />
                                </p>

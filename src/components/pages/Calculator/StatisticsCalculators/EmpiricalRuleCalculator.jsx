                        ...
                        <div className="w-full">
                          <table className="w-full">
                            <tr>
                              ...
                              <td className="py-2 border-b">
                                <b className="color_blue">{result?.tech_first}</b>
                              </td>
                            </tr>
                            <tr>
                              <td className="py-2 border-b">
                              ...
                              <td className="py-2 border-b">
                                <b className="color_blue">{result?.tech_second}</b>
                              </td>
                            </tr>
                            <tr>
                              <td className="py-2 border-b">
                              ...
                              <td className="py-2 border-b">
                                <b className="color_blue">{result?.tech_third}</b>
                              </td>
                            </tr>
                            {formData?.tech_form == "raw" && (
                              <>
                            ...
                            {result?.tech_count && (
                              <>
                                <tr>
                                  <td className="py-2 border-b">Total Numbers:</td>
                                  <td className="py-2 border-b">
                                    <b className="color_blue">
                                      {result?.tech_count}
                                    </b>

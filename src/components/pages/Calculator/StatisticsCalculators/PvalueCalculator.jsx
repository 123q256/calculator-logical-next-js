                ...
                <div className="grid grid-cols-12 mt-3  gap-2">
                    <div className="col-span-6">
                            ...
                            <div className="mt-2">
                              ...
                              >
                                <option value="z">{data?.payload?.tech_lang_keys["6"]}</option>
                                <option value="t">{data?.payload?.tech_lang_keys["7"]}</option>
                                <option value="chi">{data?.payload?.tech_lang_keys["8"]}</option>
                                <option value="f">{data?.payload?.tech_lang_keys["9"]}</option>
                    ...
                    {(formData.tech_with == "z" || formData.tech_with == "t" ) && (
                      ...
                      <div className="col-span-6">
                            ...
                            {(formData.tech_with == "t") ? (
                              <>
                             <label htmlFor="tech_score" className="label">  {data?.payload?.tech_lang_keys["7"]}: </label>
                              </>
                            ): (formData.tech_with == "chi") ? (
                              <>
                             <label htmlFor="tech_score" className="label">  {data?.payload?.tech_lang_keys["8"]}: </label>
                              </>
                             ): (formData.tech_with == "f") ? (
                              <>
                             <label htmlFor="tech_score" className="label">  {data?.payload?.tech_lang_keys["9"]}: </label>
                              </>
                             ): (formData.tech_with == "r") ? (
                              <>
                             <label htmlFor="tech_score" className="label">  R Score: </label>
                              </>
                              ): (formData.tech_with == "q") ? (
                              <>
                             <label htmlFor="tech_score" className="label"> The value of q: </label>
                              </>
                            ): (formData.tech_with == "z") ? (
                              <>
                             <label htmlFor="tech_score" className="label">  {data?.payload?.tech_lang_keys["6"]}: </label>
                              </>
                            ):null }
                    ...
                    {(formData.tech_with == "t" || formData.tech_with == "chi" || formData.tech_with == "f"  || formData.tech_with == "r"   || formData.tech_with == "q"  ) && (
                      <>
                      <div className="col-span-6  deg1">

                         {(formData.tech_with == "t") ? (
                              <>
                              <label htmlFor="tech_deg" className="label"> {data?.payload?.tech_lang_keys["10"]} (d): </label>
                              </>
                            ): (formData.tech_with == "chi") ? (
                              <>
                              <label htmlFor="tech_deg" className="label"> {data?.payload?.tech_lang_keys["10"]} (d): </label>
                              ...
                              <>
                              <label htmlFor="tech_deg" className="label"> {data?.payload?.tech_lang_keys["13"]} (d₁): </label>
                              </>
                             ): (formData.tech_with == "r") ? (
                              <>
                             <label htmlFor="tech_deg" className="label"> N: </label>
                              </>
                              ): (formData.tech_with == "q") ? (
                              <>
                              <label htmlFor="tech_deg" className="label"> Number of groups (or means): </label>
                              </>
                            ): (formData.tech_with == "z") ? (
                              <>
                             <label htmlFor="tech_deg" className="label"> {data?.payload?.tech_lang_keys["10"]} (d): </label>
                      ...
                      { formData.tech_conversionType == "fixed_value" && (
                        <>
                          <div className="col-span-12  my-2 fixed_value">
                              <p className="font-s-14 text-blue my-1">Significance Level:</p>
                          ...
                          <div className="w-full mt-3">
                            <div className="w-full text-center">
                              ...
                              <p className="text-[32px] bg-[#2845F5] px-3 py-2 rounded-[10px] inline-block my-3">
                                <strong className="text-white" id="testResult">{result?.tech_p}</strong>
                              </p>
                            </div>

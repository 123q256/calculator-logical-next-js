                              ...
                              <table className="min-w-full border border-gray-400 text-center">
                                <thead className="bg-gray-200">
                                  <tr>
                                    ...
                                    <th className="p-2 border">Yᵢ²</th>
                                    <th className="p-2 border">Xᵢ · Yᵢ</th>
                                  </tr>
                                </thead>
                                <tbody>
                                  {techX.map((xi, index) => {
                                  ...
                                  <tr className="bg-gray-200 font-bold">
                                    <td className="p-2 border">Sum =</td>
                                    <td className="p-2 border">{sum.x}</td>
                                    <td className="p-2 border">{sum.y}</td>
                                    <td className="p-2 border">{sum.xi2}</td>
                                    <td className="p-2 border">{sum.yi2}</td>
                                    <td className="p-2 border">{sum.xy}</td>
                                  </tr>
                                </tbody>
                              </table>
                            </div>

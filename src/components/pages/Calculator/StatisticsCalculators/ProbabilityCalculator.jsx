                            ...
                            <div className="w-full mt-2 overflow-auto">
                              <table className="min-w-[600px] w-full">
                                ...
                                <tr>
                                  ...
                                  <td className="text-blue py-2 border-b">
                                    {data?.payload?.tech_lang_keys["pro_both"]}
                                  </td>
                                  <td className="py-2 border-b">
                                ...
                                <tr>
                                  ...
                                  <td className="py-2 border-b">
                                    <b>{result?.tech_either_events * 100} %</b>
                                  </td>
                                </tr>
                                <tr>
                                  <td className="py-2 border-b">
                                ...
                                <tr>
                                  ...
                                  <td className="text-blue py-2 border-b">
                                    {data?.payload?.tech_lang_keys["pro_of"]} A{" "}
                                ...
                                <tr>
                                  ...
                                  <td className="text-blue py-2 border-b">
                                    {data?.payload?.tech_lang_keys["pro_of"]} B{" "}
                                    {data?.payload?.tech_lang_keys["occr"]}{" "}
                              ...
                              <table className="min-w-[600px] w-full">
                                ...
                                <tr>
                                  <td className="text-blue py-2 border-b">
                                    ...
                                    {data?.payload?.tech_lang_keys["occr"]}{" "}
                                    {formData?.tech_rep_a}{" "}
                                    {data?.payload?.tech_lang_keys["time"]} and
                            ...
                            <div className="w-full mt-2 overflow-auto">
                              <table className="min-w-[600px] w-full">
                                ...
                                <tr>
                                  ...
                                  <td className="py-2 border-b">
                                    <b>{result?.tech_event_a_occur * 100} %</b>
                                  </td>
                                </tr>
                                <tr>
                                  <td className="py-2 border-b">
                                ...
                                <tr>
                                  ...
                                  <td className="py-2 border-b">
                                    <b>{result?.tech_event_b_occur * 100} %</b>
                                  </td>
                                </tr>
                                <tr>
                                  <td className="py-2 border-b">

                  ...
                  <div className="col-span-12  one_way">
                    ...
                    <div className="col-lg-7 mx-auto d-flex px-2">
                      <button
                        ...
                        className="bg-[#000000] text-white border rounded-lg px-4 py-2 me-2"
                      >
                      ...
                      <button
                        ...
                        className="bg-[#000000] text-white border rounded-lg px-4 py-2"
                      >
                        <strong className="text-blue">
                ...
                <div className="grid grid-cols-12 mt-3 gap-2">
                  <div className="col-span-12 two_way">
                    <div className="overflow-auto">
                      <table width={685} className="border">
                        <tbody>
                          {data1.map((row, rIdx) => (
                            <tr key={rIdx}>
                              {row.map((val, cIdx) => (
                    ...
                    <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-2 gap-2 mt-4">
                      <button
                        type="button"
                        onClick={addRow}
                        className="bg-[#000000] text-white rounded-lg border px-4 py-2"
                      >
                        Add Row
                      </button>
                      <button

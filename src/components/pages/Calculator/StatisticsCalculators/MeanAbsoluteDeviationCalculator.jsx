...
const MeanAbsoluteDeviationCalculator = () => {
  ...
  // result
  // Selecting method name based on tech_method
  let methodText = "";
          ...
          <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
            <div className="grid grid-cols-1   gap-4">
              ...
              <div className="lg:col-span-6 md:col-span-6 col-span-12 px-2 flex items-center justify-center">
                <label for="method" className="label">
                  &nbsp;
                </label>
                <img
                      ...
                      <div className="w-full">
                        ...
                        {result?.tech_mean ? (
                          <>
                            ...
                            <p className="w-full mt-3 text-[16px]">
                              <span className="text-[#2845F5]">
                          ...
                          <>
                            {/* Section 1 */}
                            <p className="w-full mt-2 text-[16px]">
                              <span className="text-[#2845F5]">
                                {data?.payload?.tech_lang_keys["11"]} 1:{" "}
                              </span>
                            ...
                            {/* Section 1.1 */}
                            <p className="w-full mt-2 text-[16px] ms-3">
                              <span className="text-[#2845F5]">
                                {data?.payload?.tech_lang_keys["11"]} 1:{" "}
                              </span>
                          ...
                          <>
                            <p className="w-full mt-3 text-[16px]">
                              ...
                              <b>{data?.payload?.tech_lang_keys["26"]} (m):</b>
                            </p>
                            <p className="w-full mt-1">
                              {datax.map((val, i) => (
                                <div key={"diff-line-" + i}>

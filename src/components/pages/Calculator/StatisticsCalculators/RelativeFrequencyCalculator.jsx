...
const RelativeFrequencyCalculator = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.tech_data || !formData.tech_freq || !formData.tech_k || !formData.tech_st_val ) {
            ...
            <div className="grid grid-cols-12 mt-3  gap-2">
                ...
                <div className="col-span-12  mb-2 text-center flex items-center justify-between">
                    <div className="flex items-center">
                        <p className="font-s-14 me-2">{ data?.payload?.tech_lang_keys['2'] }:</p>
                     ...
                     <label htmlFor="tech_data" className="label">
                          {data?.payload?.tech_lang_keys["1"]}
                            ...
                            <textarea
                              ...
                              value={formData.tech_data || " 4, 14, 16, 22, 24, 25, 37, 38, 38, 40, 42, 42, 45, 44"}
                              onChange={handleChange}
                            />
                       </div>
                </div>
                          ...
                          <div className="w-full mt-3">
                              <div className="w-full">
                                 ...
                                 <div>
                                  ...
                                  <div id="container" style={{ height: 350 }} className="w-full mt-3">
                                  ...
                                  <p className="w-full mt-2">
                                    {data?.payload?.tech_lang_keys['10']} ({data?.payload?.tech_lang_keys['11']}): μ = {mean}
                                  </p>
                                  ...
                                  <p className="w-full mt-2">
                                    {data?.payload?.tech_lang_keys['13']} = {modeString} - multimodal
                                  </p>
                                </div>
                                 ...
                                 <div className="bg-sky-100 p-3">
                                  ...
                                  <p className="w-full mt-2">
                                    {data?.payload?.tech_lang_keys['21']} = {Number(variance).toFixed(2)}
                                  </p>
                                  <p className="w-full mt-2">
                                    {data?.payload?.tech_lang_keys['23']} (s) = {Number(s_d1).toFixed(2)}
                                  </p>
                                  ...
                                  <p className="w-full mt-2">
                                    {data?.payload?.tech_lang_keys['24']} (C<sub>v</sub>) = {c_v}
                                  </p>
                                  <p className="w-full mt-2">

        ...
        <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mb-3">
          ...
          <div class="lg:w-[60%] md:w-[80%] w-full mx-auto ">
            <div class="grid grid-cols-2   gap-2 md:gap-4 lg:gap-4">
              <div class="lg:col-span-7 md:col-span-7 col-span-6">
              ...
              <div class="lg:col-span-5 md:col-span-5 col-span-6">
                  ...
                  <div class="rounded-lg  flex items-center justify-center">
                    <div class="w-full mt-3">
                      <div class="w-full">
                        ...
                        <p class="col-12 mt-2">K = {result?.tech_answer}</p>
                      </div>
                    </div>
                  </div>
                </div>

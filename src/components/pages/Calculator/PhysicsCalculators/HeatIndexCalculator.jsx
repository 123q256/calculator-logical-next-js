                    ...
                    <div className="grid grid-cols-12  gap-4">
                        <div className="col-span-12">
                          ...
                          <div className="mt-2">
                            ...
                            >
                              <option value="1">{data?.payload?.tech_lang_keys["2"]}  & {data?.payload?.tech_lang_keys["3"]} </option>
                              <option value="2">{data?.payload?.tech_lang_keys["4"]}  & {data?.payload?.tech_lang_keys["5"]} </option>
                              <option value="3">{data?.payload?.tech_lang_keys["6"]}  & {data?.payload?.tech_lang_keys["5"]} </option>
                            </select>
                          </div>
                        </div>
                    ...
                    <div className="w-full p-3 radius-10 mt-3 ">
                        ...
                        <div className="w-full overfow-auto mt-2">
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td className="py-2 border-b">
                                    {Number((result?.tech_hi - 32) * (5 / 9)).toFixed(2)} (<sup>o</sup>C)
                                  </td>
                                </tr>
                                <tr>
                                  <td className="py-2 border-b" width="50%">
                                  ...
                                  <td className="py-2 border-b">
                                    {Number(result?.tech_hi).toFixed(2)} (<sup>o</sup>F)
                                  </td>
                                </tr>
                                <tr>
                                  <td className="py-2 border-b" width="50%">
                                  ...
                                  <td className="py-2 border-b">
                                    {Number((result?.tech_hi - 32) * (5 / 9) + 273).toFixed(2)} (<sup>o</sup>K)
                                  </td>
                                </tr>
                              </tbody>
                            </table>
                          ...
                          <div className="w-full  mt-2 my-3 overflow-auto">
                            <table className="w-full text-[16px]">
                              <tbody>
                               {(result?.tech_dp !== undefined && result?.tech_dp !== null && !isNaN(result?.tech_dp)) && (
                                <tr>
                                  <td className="py-2 border-b" width="50%">
                                    <strong>{data?.payload?.tech_lang_keys[5]}</strong>
                                  </td>
                                  <td className="py-2 border-b">
                                    {Number(result.tech_dp).toFixed(2)} <sup>o</sup> (C)
                                  </td>
                                </tr>
                              )}

                              {(result?.tech_hum !== undefined && result?.tech_hum !== null && !isNaN(result?.tech_hum)) && (
                                <tr>
                                  <td className="py-2 border-b" width="50%">
                              ...
                              {(result?.tech_temp !== undefined && result?.tech_temp !== null && !isNaN(result?.tech_temp)) && (
                                <tr>
                                  <td className="py-2 border-b" width="50%">
                                    <strong>{data?.payload?.tech_lang_keys[8]}</strong>
                                  </td>
                                  <td className="py-2 border-b">
                                    {Number(result.tech_temp * 9 / 5 + 32).toFixed(2)} (<sup>o</sup>F) /{" "}
                                    {Number(result.tech_temp).toFixed(2)} (<sup>o</sup>C)
                                  </td>
                                </tr>
                              )}

                              {(result?.tech_ans !== undefined && result?.tech_ans !== null && !isNaN(result?.tech_ans)) && (
                                <tr>
                                  <td className="py-2 border-b" width="50%">
                            ...
                            <div className="w-full overflow-auto">
                                  <p className="center  ">Heat Index Chart (Apparent Temperature)
                                  </p>
                                   <div className="dk o overflow-auto">
                                       <table className="table tablesx w-full text-[16px]">
                                          <tbody>
                                              <tr>
                                                  <td rowspan="2" className="p nela"><strong>{data?.payload?.tech_lang_keys['8'] } (°F)</strong></td>
                                                  <td colspan="13" className="p nela"><strong>{data?.payload?.tech_lang_keys['6'] } (%)</strong></td>
                                              </tr>
                                              <tr>
                                              ...
                                              <tr>
                                                  ...
                                                  <td className="rc white-text" style={ styles.d16 }>136</td>
                                                  <td className="rc white-text" style={ styles.d32 }>143</td>
                                                  <td className="rc white-text" style={ styles.d48 }>152</td>
                                                  <td className="rc white-text" style={ styles.d64 }>161</td>
                                                  <td className="rc white-text" style={ styles.d80 }>171</td>
                                                  <td className="rc white-text" style={ styles.d96 }>182</td>
                                                  <td className="rc white-text" style={ styles.d112 }>194</td>
                                                  <td className="rc white-text" style={ styles.d128 }>206</td>
                                                  <td className="rc white-text" style={ styles.d144 }>219</td>
                                                  <td className="rc white-text" style={ styles.d160 }>233</td>
                                                  <td className="rc white-text" style={ styles.d176 }>247</td>
                                                  <td className="rc white-text" style={ styles.d192 }>262</td>
                                                  <td className="rc white-text" style={ styles.d208 }>278</td>
                                              </tr>
                                              <tr>
                                                  <td className="p nela">108</td>
                                                  <td className="rc white-text" style={ styles.d15 }>130</td>
                                                  <td className="rc white-text" style={ styles.d31 }>137</td>
                                                  <td className="rc white-text" style={ styles.d47 }>144</td>
                                                  <td className="rc white-text" style={ styles.d63 }>153</td>
                                                  <td className="rc white-text" style={ styles.d79 }>162</td>
                                                  <td className="rc white-text" style={ styles.d95 }>172</td>
                                                  <td className="rc white-text" style={ styles.d111 }>182</td>
                                                  <td className="rc white-text" style={ styles.d127 }>193</td>
                                                  <td className="rc white-text" style={ styles.d143 }>205</td>
                                                  <td className="rc white-text" style={ styles.d159 }>218</td>
                                                  <td className="rc white-text" style={ styles.d175 }>231</td>
                                                  <td className="rc white-text" style={ styles.d191 }>245</td>
                                                  <td className="rc white-text" style={ styles.d207 }>260</td>
                                              </tr>
                                              <tr>
                                                  <td className="p nela">106</td>
                                                  <td className="oc text-white" style={ styles.d14 }>124</td>
                                                  <td className="rc white-text" style={ styles.d30 }>130</td>
                                                  <td className="rc white-text" style={ styles.d46 }>137</td>
                                                  <td className="rc white-text" style={ styles.d62 }>145</td>
                                                  <td className="rc white-text" style={ styles.d78 }>153</td>
                                                  <td className="rc white-text" style={ styles.d94 }>162</td>
                                                  <td className="rc white-text" style={ styles.d110 }>172</td>
                                                  <td className="rc white-text" style={ styles.d126 }>182</td>
                                                  <td className="rc white-text" style={ styles.d142 }>193</td>
                                                  <td className="rc white-text" style={ styles.d158 }>204</td>
                                                  <td className="rc white-text" style={ styles.d174 }>216</td>
                                                  <td className="rc white-text" style={ styles.d190 }>229</td>
                                                  <td className="rc white-text" style={ styles.d206 }>243</td>
                                              </tr>
                                              <tr>
                                                  <td className="p nela">104</td>
                                                  <td className="oc text-white" style={ styles.d13 }>119</td>
                                                  <td className="oc text-white" style={ styles.d29 }>124</td>
                                                  <td className="rc white-text" style={ styles.d45 }>131</td>
                                                  <td className="rc white-text" style={ styles.d61 }>137</td>
                                                  <td className="rc white-text" style={ styles.d77 }>145</td>
                                                  <td className="rc white-text" style={ styles.d93 }>153</td>
                                                  <td className="rc white-text" style={ styles.d109 }>161</td>
                                                  <td className="rc white-text" style={ styles.d125 }>171</td>
                                                  <td className="rc white-text" style={ styles.d141 }>181</td>
                                                  <td className="rc white-text" style={ styles.d157 }>191</td>
                                                  <td className="rc white-text" style={ styles.d173 }>202</td>
                                                  <td className="rc white-text" style={ styles.d189 }>214</td>
                                                  <td className="rc white-text" style={ styles.d205 }>226</td>
                                              </tr>
                                              <tr>
                                                  <td className="p nela">102</td>
                                                  <td className="oc text-white" style={ styles.d12 }>114</td>
                                                  <td className="oc text-white" style={ styles.d28 }>119</td>
                                                  <td className="oc text-white" style={ styles.d44 }>124</td>
                                                  <td className="rc white-text" style={ styles.d60 }>130</td>
                                                  <td className="rc white-text" style={ styles.d76 }>137</td>
                                                  <td className="rc white-text" style={ styles.d92 }>144</td>
                                                  <td className="rc white-text" style={ styles.d108 }>152</td>
                                                  <td className="rc white-text" style={ styles.d124 }>160</td>
                                                  <td className="rc white-text" style={ styles.d140 }>169</td>
                                                  <td className="rc white-text" style={ styles.d156 }>179</td>
                                                  <td className="rc white-text" style={ styles.d172 }>189</td>
                                                  <td className="rc white-text" style={ styles.d188 }>199</td>
                                                  <td className="rc white-text" style={ styles.d204 }>210</td>
                                              </tr>
                                              <tr>
                                                  <td className="p nela">100</td>
                                                  <td className="oc text-white" style={ styles.d11 }>109</td>
                                                  <td className="oc text-white" style={ styles.d27 }>114</td>
                                                  <td className="oc text-white" style={ styles.d43 }>118</td>
                                                  <td className="oc text-white" style={ styles.d59 }>124</td>
                                                  <td className="rc white-text" style={ styles.d75 }>129</td>
                                                  <td className="rc white-text" style={ styles.d91 }>136</td>
                                                  <td className="rc white-text" style={ styles.d107 }>143</td>
                                                  <td className="rc white-text" style={ styles.d123 }>150</td>
                                                  <td className="rc white-text" style={ styles.d139 }>158</td>
                                                  <td className="rc white-text" style={ styles.d155 }>167</td>
                                                  <td className="rc white-text" style={ styles.d171 }>176</td>
                                                  <td className="rc white-text" style={ styles.d187 }>185</td>
                                                  <td className="rc white-text" style={ styles.d203 }>195</td>
                                              </tr>
                                              <tr>
                                                  <td className="p nela">98</td>
                                                  <td className="oc text-white" style={ styles.d10 }>105</td>
                                                  <td className="oc text-white" style={ styles.d26 }>109</td>
                                                  <td className="oc text-white" style={ styles.d42 }>113</td>
                                                  <td className="oc text-white" style={ styles.d58 }>117</td>
                                                  <td className="oc text-white" style={ styles.d74 }>123</td>
                                                  <td className="rc white-text" style={ styles.d90 }>128</td>
                                                  <td className="rc white-text" style={ styles.d106 }>134</td>
                                                  <td className="rc white-text" style={ styles.d122 }>141</td>
                                                  <td className="rc white-text" style={ styles.d138 }>148</td>
                                                  <td className="rc white-text" style={ styles.d154 }>156</td>
                                                  <td className="rc white-text" style={ styles.d170 }>164</td>
                                                  <td className="rc white-text" style={ styles.d186 }>172</td>
                                                  <td className="rc white-text" style={ styles.d202 }>181</td>
                                              </tr>
                                              <tr>
            
                                                  <td className="p nela">96</td>
                                                  <td className="kc" style={ styles.d9 }>101</td>
                                                  <td className="oc text-white" style={ styles.d25 }>104</td>
                                                  <td className="oc text-white" style={ styles.d41 }>108</td>
                                                  <td className="oc text-white" style={ styles.d57 }>112</td>
                                                  <td className="oc text-white" style={ styles.d73 }>116</td>
                                                  <td className="oc text-white" style={ styles.d89 }>121</td>
                                                  <td className="oc text-white" style={ styles.d105 }>126</td>
                                                  <td className="rc white-text" style={ styles.d121 }>132</td>
                                                  <td className="rc white-text" style={ styles.d137 }>138</td>
                                                  <td className="rc white-text" style={ styles.d153 }>145</td>
                                                  <td className="rc white-text" style={ styles.d169 }>152</td>
                                                  <td className="rc white-text" style={ styles.d185 }>160</td>
                                                  <td className="rc white-text" style={ styles.d191 }>168</td>
                                              </tr>
                                              <tr>
            
                                                  <td className="p nela">94</td>
                                                  <td className="kc" style={ styles.d8 }>97</td>
                                                  <td className="kc" style={ styles.d24 }>100</td>
                                                  <td className="kc" style={ styles.d40 }>102</td>
                                                  <td className="oc text-white" style={ styles.d56 }>106</td>
                                                  <td className="oc text-white" style={ styles.d72 }>110</td>
                                                  <td className="oc text-white" style={ styles.d88 }>114</td>
                                                  <td className="oc text-white" style={ styles.d104 }>119</td>
                                                  <td className="oc text-white" style={ styles.d120 }>124</td>
                                                  <td className="rc white-text" style={ styles.d136 }>129</td>
                                                  <td className="rc white-text" style={ styles.d152 }>135</td>
                                                  <td className="rc white-text" style={ styles.d168 }>141</td>
                                                  <td className="rc white-text" style={ styles.d184 }>148</td>
                                                  <td className="rc white-text" style={ styles.d200 }>155</td>
                                              </tr>
                                              <tr>
            
                                                  <td className="p nela">92</td>
                                                  <td className="kc" style={ styles.d7 }>94</td>
                                                  <td className="kc" style={ styles.d23 }>96</td>
                                                  <td className="kc" style={ styles.d39 }>99</td>
                                                  <td className="kc" style={ styles.d55 }>101</td>
                                                  <td className="oc text-white" style={ styles.d71 }>105</td>
                                                  <td className="oc text-white" style={ styles.d87 }>108</td>
                                                  <td className="oc text-white" style={ styles.d103 }>112</td>
                                                  <td className="oc text-white" style={ styles.d119 }>116</td>
                                                  <td className="oc text-white" style={ styles.d135 }>121</td>
                                                  <td className="oc text-white" style={ styles.d151 }>126</td>
                                                  <td className="rc white-text" style={ styles.d167 }>131</td>
                                                  <td className="rc white-text" style={ styles.d183 }>137</td>
                                                  <td className="rc white-text" style={ styles.d199 }>143</td>
                                              </tr>
                                              <tr>
            
                                                  <td className="p nela">90</td>
                                                  <td className="kc" style={ styles.d6 }>91</td>
                                                  <td className="kc" style={ styles.d22 }>93</td>
                                                  <td className="kc" style={ styles.d38 }>95</td>
                                                  <td className="kc" style={ styles.d54 }>97</td>
                                                  <td className="kc" style={ styles.d70 }>100</td>
                                                  <td className="kc" style={ styles.d86 }>103</td>
                                                  <td className="oc text-white" style={ styles.d102 }>106</td>
                                                  <td className="oc text-white" style={ styles.d118 }>109</td>
                                                  <td className="oc text-white" style={ styles.d134 }>113</td>
                                                  <td className="oc text-white" style={ styles.d150 }>117</td>
                                                  <td className="oc text-white" style={ styles.d166 }>122</td>
                                                  <td className="oc text-white" style={ styles.d182 }>127</td>
                                                  <td className="rc white-text" style={ styles.d198 }>132</td>
                                              </tr>
                                              <tr>
            
                                                  <td className="p nela">88</td>
                                                  <td className="kkc" style={ styles.d5 }>88</td>
                                                  <td className="kkc" style={ styles.d21 }>89</td>
                                                  <td className="kc" style={ styles.d37 }>91</td>
                                                  <td className="kc" style={ styles.d53 }>93</td>
                                                  <td className="kc" style={ styles.d69 }>95</td>
                                                  <td className="kc" style={ styles.d85 }>98</td>
                                                  <td className="kc" style={ styles.d101 }>100</td>
                                                  <td className="kc" style={ styles.d117 }>103</td>
                                                  <td className="oc text-white" style={ styles.d133 }>106</td>
                                                  <td className="oc text-white" style={ styles.d149 }>110</td>
                                                  <td className="oc text-white" style={ styles.d165 }>113</td>
                                                  <td className="oc text-white" style={ styles.d181 }>117</td>
                                                  <td className="oc text-white" style={ styles.d197 }>121</td>
                                              </tr>
                                              <tr>
            
                                                  <td className="p nela">86</td>
                                                  <td className="kkc" style={ styles.d4 }>85</td>
                                                  <td className="kkc" style={ styles.d20 }>87</td>
                                                  <td className="kkc" style={ styles.d36 }>88</td>
                                                  <td className="kkc" style={ styles.d52 }>89</td>
                                                  <td className="kc" style={ styles.d68 }>91</td>
                                                  <td className="kc" style={ styles.d84 }>93</td>
                                                  <td className="kc" style={ styles.d100 }>95</td>
                                                  <td className="kc" style={ styles.d116 }>97</td>
                                                  <td className="kc" style={ styles.d132 }>100</td>
                                                  <td className="kc" style={ styles.d148 }>102</td>
                                                  <td className="oc text-white" style={ styles.d164 }>105</td>
                                                  <td className="oc text-white" style={ styles.d180 }>108</td>
                                                  <td className="oc text-white" style={ styles.d196 }>112</td>
                                              </tr>
                                              <tr>
                                                  <td className="p nela">84</td>
                                                  <td className="kkc" style={ styles.d3 }>83</td>
                                                  <td className="kkc" style={ styles.d19 }>84</td>
                                                  <td className="kkc" style={ styles.d35 }>85</td>
                                                  <td className="kkc" style={ styles.d51 }>86</td>
                                                  <td className="kkc" style={ styles.d67 }>88</td>
                                                 <td className="kkc" style={ styles.d83 }>89</td>
                                                <td className="kkc" style={ styles.d99 }>90</td>
                                                <td className="kkc" style={ styles.d115 }>92</td>
                                                <td className="kc" style={ styles.d131 }>94</td>
                                                <td className="kc" style={ styles.d147 }>96</td>
                                                <td className="kc" style={ styles.d163 }>98</td>
                                                <td className="kc" style={ styles.d179 }>100</td>
                                                <td className="kc" style={ styles.d195 }>103</td>
                                            </tr>
                                            <tr>
                                                <td className="p nela">82</td>
                                                <td className="kkc" style={ styles.d2}>81</td>
                                                <td className="kkc" style={ styles.d18 }>82</td>
                                                <td className="kkc" style={ styles.d34 }>83</td>
                                                <td className="kkc" style={ styles.d50 }>84</td>
                                                <td className="kkc" style={ styles.d66 }>84</td>
                                                <td className="kkc" style={ styles.d82 }>85</td>
                                                <td className="kkc" style={ styles.d98 }>86</td>
                                                <td className="kkc" style={ styles.d114 }>88</td>
                                                <td className="kkc" style={ styles.d130 }>89</td>
                                                <td className="kkc" style={ styles.d146 }>90</td>
                                                <td className="kkc" style={ styles.d162 }>91</td>
                                                <td className="kkc" style={ styles.d178 }>93</td>
                                                <td className="kkc" style={ styles.d194 }>95</td>
                                            </tr>
                                            <tr>
                                                <td className="p nela">80</td>
                                                <td className="kkc" style={ styles.d1}>80</td>
                                                <td className="kkc" style={ styles.d17 }>80</td>
                                                <td className="kkc" style={ styles.d33 }>81</td>
                                                <td className="kkc" style={ styles.d49 }>81</td>
                                                <td className="kkc" style={ styles.d65 }>82</td>
                                                <td className="kkc" style={ styles.d81 }>82</td>
                                                <td className="kkc" style={ styles.d97 }>83</td>
                                                <td className="kkc" style={ styles.d113 }>84</td>
                                                <td className="kkc" style={ styles.d129 }>84</td>
                                                <td className="kkc" style={ styles.d145 }>85</td>
                                                <td className="kkc" style={ styles.d161 }>86</td>
                                                <td className="kkc" style={ styles.d177 }>86</td>
                                                <td className="kkc" style={ styles.d193 }>87</td>
                                            </tr>
                                            <tr>
                                                <td className="p gr" colspan="2"><strong>{data?.payload?.tech_lang_keys['9'] }:</strong></td>
                                                <td className="p kkc font_size16" colspan="3">{data?.payload?.tech_lang_keys['10'] }</td>
                                                <td className="p kc  font_size16" colspan="3">{data?.payload?.tech_lang_keys['11'] }</td>
                                                <td className="p oc  font_size16" colspan="3">{data?.payload?.tech_lang_keys['12'] }</td>
                                                <td className="p rc  font_size16" colspan="3">{data?.payload?.tech_lang_keys['13'] }</td>
                                            </tr>
                                           </tbody>
                                       </table>
                                   </div>

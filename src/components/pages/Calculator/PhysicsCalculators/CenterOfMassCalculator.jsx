          ...
          <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mb-3">
            ...
            <div className="grid grid-cols-12 mt-3  gap-4">
                ...
                <div className="col-span-6">
                  ...
                  <div className="col-span-12 md:col-span-6  three">
                    ...
                    <div className="col-span-12  ">
                        <p className="my-2 p-2 tagsUnit radius-5"><strong className="text-sky">{data?.payload?.tech_lang_keys['3']} 1</strong></p>
                    </div>
               ...
               <div className="col-span-12 md:col-span-6  three">
                ...
                <div className="col-span-12">
                    <p className="my-2 p-2 tagsUnit radius-5"><strong className="text-sky">{data?.payload?.tech_lang_keys['3']} 2</strong></p>
                </div>
                ...
                {( formData.tech_how == "3" || formData.tech_how == "4" || formData.tech_how == "5" || formData.tech_how == "6" || formData.tech_how == "7"  || formData.tech_how == "8" || formData.tech_how == "9" || formData.tech_how == "10" ) && (
                  <>
                <div className="col-span-12 md:col-span-6  three">
                    <div className="grid grid-cols-12 mt-3  gap-4">
                      <div className="col-span-12  ">
                          <p className="my-2 p-2 tagsUnit radius-5"><strong className="">{data?.payload?.tech_lang_keys['3']} 3</strong></p>
                      </div>
                      <div className="col-span-6 mt-0 mt-lg-2 ">
               ...
               {( formData.tech_how == "4" || formData.tech_how == "5" || formData.tech_how == "6" || formData.tech_how == "7"  || formData.tech_how == "8" || formData.tech_how == "9" || formData.tech_how == "10" ) && (
                  <>
                <div className="col-span-12 md:col-span-6 four">
                <div className="grid grid-cols-12 mt-3  gap-4">
                    <div className="col-span-12  ">
                        <p className="my-2 p-2 tagsUnit radius-5"><strong className="" >{data?.payload?.tech_lang_keys['3']} 4</strong></p>
                    </div>
                    <div className="col-span-6 mt-0 mt-lg-2 ">
             ...
             {(  formData.tech_how == "5" || formData.tech_how == "6" || formData.tech_how == "7"  || formData.tech_how == "8" || formData.tech_how == "9" || formData.tech_how == "10" ) && (
                  <>
                <div className="col-span-12 md:col-span-6  five">
                    <div className="grid grid-cols-12 mt-3  gap-4">
                    <div className="col-span-12 ">
                        <p className="my-2 p-2 tagsUnit radius-5"><strong className="" >{data?.payload?.tech_lang_keys['3']} 5</strong></p>
                    </div>
              ...
              {(  formData.tech_how == "6" || formData.tech_how == "7"  || formData.tech_how == "8" || formData.tech_how == "9" || formData.tech_how == "10" ) && (
                  <>
                <div className="col-span-12 md:col-span-6  six">
                    <div className="grid grid-cols-12 mt-3  gap-4">
                    <div className="col-span-12 ">
                        <p className="my-2 p-2 tagsUnit radius-5"><strong className="" >{data?.payload?.tech_lang_keys['3']} 6</strong></p>
                    </div>
               ...
               {(  formData.tech_how == "7"  || formData.tech_how == "8" || formData.tech_how == "9" || formData.tech_how == "10" ) && (
                  <>
                <div className="col-span-12 md:col-span-6  seven">
                    <div className="grid grid-cols-12 mt-3  gap-4">
                    <div className="col-span-12 ">
                        <p className="my-2 p-2 tagsUnit radius-5"><strong className="" > {data?.payload?.tech_lang_keys['3']} 7</strong></p>
                    </div>
               ...
               {(  formData.tech_how == "8" || formData.tech_how == "9" || formData.tech_how == "10" ) && (
                  <>
                <div className="col-span-12 md:col-span-6  eight">
                    <div className="grid grid-cols-12 mt-3  gap-4">
                    <div className="col-span-12 ">
                        <p className="my-2 p-2 tagsUnit radius-5"><strong className="" >{data?.payload?.tech_lang_keys['3']} 8</strong></p>
                    </div>
               ...
               {( formData.tech_how == "9" || formData.tech_how == "10" ) && (
                ...
                <div className="col-span-12 md:col-span-6  nine">
                    <div className="grid grid-cols-12 mt-3  gap-4">
                    <div className="col-span-12 ">
                        <p className="my-2 p-2 tagsUnit radius-5"><strong className="" >{data?.payload?.tech_lang_keys['3']} 9</strong></p>
                    </div>
                                    ...
                                    <div className="absolute z-10 bg-white border border-gray-300 rounded-md w-auto mt-1 right-0">
                                      {[
                                        ...
                                        <p
                                          key={index}
                                          className="p-2 hover:bg-gray-100 cursor-pointer"
                                          onClick={() => setUnitHandler35(unit.value)}
                                        >
                                          {unit.label}
                                        </p>
                                      ))}
                                    ...
                                    <div className="absolute z-10 bg-white border border-gray-300 rounded-md w-auto mt-1 right-0">
                                      {[
                                        ...
                                        <p
                                          key={index}
                                          className="p-2 hover:bg-gray-100 cursor-pointer"
                                          onClick={() => setUnitHandler36(unit.value)}
                                        >
                                          {unit.label}
                                        </p>
                                      ))}
                ...
                <div className="col-span-12 md:col-span-6  ten">
                    <div className="grid grid-cols-12 mt-3  gap-4">
                    <div className="col-span-12 ">
                        <p className="my-2 p-2 tagsUnit radius-5"><strong className="" >{data?.payload?.tech_lang_keys['3']} 10</strong></p>
                    </div>
                                    ...
                                    <div className="absolute z-10 bg-white border border-gray-300 rounded-md w-auto mt-1 right-0">
                                      {[
                                        ...
                                        <p
                                          key={index}
                                          className="p-2 hover:bg-gray-100 cursor-pointer"
                                          onClick={() => setUnitHandler39(unit.value)}
                                        >
                                          {unit.label}
                                        </p>
                                      ))}
                                    ...
                                    <div className="absolute z-10 bg-white border border-gray-300 rounded-md w-auto mt-1 right-0">
                                      {[
                                        ...
                                        <p
                                          key={index}
                                          className="p-2 hover:bg-gray-100 cursor-pointer"
                                          onClick={() => setUnitHandler40(unit.value)}
                                        >
                                          {unit.label}
                                        </p>
                                      ))}
                        ...
                        <div className="w-full text-center text-[20px]">
                          ...
                          <p className="my-3">
                            <strong className="bg-[#2845F5] px-3 py-2 md:text-[32px] text-[20px] rounded-lg text-white">
                              (
                              {Number(result?.tech_ansx).toFixed(3)} {result?.tech_unit}
                              {((formData.dem === 2 || formData.dem === 3) && result?.tech_ansy !== undefined) && (
                                <>
                                  , {Number(result.tech_ansy).toFixed(3)} {result.tech_unit}
                                </>
                              )}
                              {(formData.dem === 3 && result?.tech_ansz !== undefined) && (
                                <>
                                  , {Number(result.tech_ansz).toFixed(3)} {result.tech_unit}
                                </>
                              )}
                              )
                            </strong>

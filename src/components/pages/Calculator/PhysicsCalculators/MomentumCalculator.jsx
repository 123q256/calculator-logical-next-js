                      ...
                      <div class="grid grid-cols-12 mt-3  gap-4">
                        {formData.tech_type == "velocity" && (
                          <>
                            <div id="linear" class="col-span-12">
                                <div class="grid grid-cols-12 gap-2">
                                    <strong class="col-span-12">{ data?.payload?.tech_lang_keys[3] }:</strong>
                                    <div class="col-span-12 mb-3 mt-3 flex items-center">
                                    ...
                                    {(formData.tech_to_cal === 'mom' || formData.tech_to_cal === 'velo') && (
                                      <>
                                      <div class="col-span-6 mass">
                                     ...
                                     {(formData.tech_to_cal === 'mom' || formData.tech_to_cal === 'mass') && (
                                      <>
                                     ...
                                     {(formData.tech_to_cal === 'mass' || formData.tech_to_cal === 'velo') && (
                                      <>
                                    <div class="col-span-6  kin">
                         ...
                         {formData.tech_type == "rotational" && (
                          <>
                          <div id="rotational" class="col-span-12 ">
                               <div class="grid grid-cols-12 gap-2">
                                  <strong class="col-span-12">{ data?.payload?.tech_lang_keys[3] }:</strong>
                                  <div class="col-span-12  mb-3 mt-3 flex items-center">
                                      ...
                                      <label className="pe-2" htmlFor="force">
                                        ...
                                        />
                                        <span>{ data?.payload?.tech_lang_keys['7'] } (F)</span>
                                      </label>
                                        ...
                                        />
                                        <span>{ data?.payload?.tech_lang_keys['8'] } (ΔT)</span>
                                      </label>

                                  </div>

                                    {(formData.tech_to_calr === 'force' || formData.tech_to_calr === 'time_c') && (
                                      <>
                                      <div class="col-span-6   moment">
                                      ...
                                      {(formData.tech_to_calr === 'mom_t' || formData.tech_to_calr === 'time_c') && (
                                    <>
                                    <div class="col-span-6 ">
                                      ...
                                      {(formData.tech_to_calr === 'mom_t' || formData.tech_to_calr === 'force') && (
                                    <>
                                      <div class="col-span-6 a_velocity">
                                      ...
                                      <tbody>
                                        <tr>
                                          ...
                                          <td className="py-2 border-b">
                                            <strong>{result?.tech_mom} (N-s) kg m/s</strong>
                                          </td>
                                        </tr>
                                      </tbody>
                                    </table>
                                    ...
                                    <table className="w-full text-[16px]">
                                      <tbody>
                                        <tr>
                                          ...
                                          <td className="py-2 border-b">
                                            <strong>{Number(result?.tech_mom * 0.01666667).toFixed(5)} N-min</strong>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td className="text-blue py-2 border-b">
                                          ...
                                          <td className="py-2 border-b">
                                            <strong>{Number(result?.tech_mom * 0.000277778).toFixed(5)} N-h</strong>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td className="text-blue py-2 border-b">
                                          ...
                                          <td className="py-2 border-b">
                                            <strong>{Number(result?.tech_mom * 0.22482).toFixed(5)} lb-ft/s</strong>
                                          </td>
                                        </tr>
                                      </tbody>
                                    </table>
                                    ...
                                    <table className="w-full text-[16px]">
                                      <tbody>
                                        <tr>
                                          ...
                                          <td className="py-2 border-b">
                                            <strong>{Number(result?.tech_mass * 2.20462).toFixed(5)} lbs</strong>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td className="text-blue py-2 border-b">
                                          ...
                                          <td className="py-2 border-b">
                                            <strong>{Number(result?.tech_mass * 1000).toFixed(5)} g</strong>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td className="text-blue py-2 border-b">
                                          ...
                                          <td className="py-2 border-b">
                                            <strong>{Number(result?.tech_mass * 1000000).toFixed(5)} mg</strong>
                                          </td>
                                        </tr>
                                      </tbody>
                                    </table>
                             ...
                             {result?.tech_velo && (
                              <>
                               <div className="w-full md:w-[60%] lg:w-[60%] overflow-auto mt-2">
                                    ...
                                    <tbody>
                                      <tr>
                                        <td className="text-blue py-2 border-b">{data?.payload?.tech_lang_keys['6']}(v)</td>
                                        <td className="py-2 border-b">
                                ...
                                <div className="w-full md:w-[60%] lg:w-[60%] overflow-auto mt-2">
                                    ...
                                    <tbody>
                                      <tr>
                                        <td className="text-blue py-2 border-b">{data?.payload?.tech_lang_keys['6']}(v)</td>
                                        <td className="py-2 border-b">
                                          <strong>{Number(result?.tech_velo / 1609).toFixed(5)} miles/s</strong>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td className="text-blue py-2 border-b">{data?.payload?.tech_lang_keys['6']}(v)</td>
                                        <td className="py-2 border-b">
                                          <strong>{Number(result?.tech_velo / 1000).toFixed(5)} km/s</strong>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td className="text-blue py-2 border-b">{data?.payload?.tech_lang_keys['6']}(v)</td>
                                        <td className="py-2 border-b">
                                          <strong>{Number(result?.tech_velo * 3.281).toFixed(5)} ft/s</strong>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td className="text-blue py-2 border-b">{data?.payload?.tech_lang_keys['6']}(v)</td>
                                        <td className="py-2 border-b">
                                          <strong>{Number(result?.tech_velo * 39.37).toFixed(5)} in/s</strong>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td className="text-blue py-2 border-b">{data?.payload?.tech_lang_keys['6']}(v)</td>
                                        <td className="py-2 border-b">
                                          <strong>{Number(result?.tech_velo * 1.094).toFixed(5)} yd/s</strong>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td className="text-blue py-2 border-b">{data?.payload?.tech_lang_keys['6']}(v)</td>
                                        <td className="py-2 border-b">
                                          <strong>{Number(result?.tech_velo * 3.6).toFixed(5)} km/h</strong>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td className="text-blue py-2 border-b">{data?.payload?.tech_lang_keys['6']}(v)</td>
                                        <td className="py-2 border-b">
                                          <strong>{Number(result?.tech_velo * 2.237).toFixed(5)} m/h</strong>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                            ...
                            {result?.tech_momt && (
                              <>
                                 <div className="w-full md:w-[60%] lg:w-[60%] overflow-auto mt-2">
                                    ...
                                    <tbody>
                                      <tr>
                                        <td className="text-blue py-2 border-b">{data?.payload?.tech_lang_keys['4']}(p)</td>
                                        <td className="py-2 border-b">
                                          <strong>{result?.tech_momt} (N-s) kg m/s</strong>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                                ...
                                <div className="w-full md:w-[60%] lg:w-[60%] overflow-auto mt-2">
                                    ...
                                    <tbody>
                                      <tr>
                                        <td className="text-blue py-2 border-b">{data?.payload?.tech_lang_keys['4']}(p)</td>
                                        <td className="py-2 border-b">
                                          <strong>{Number(result?.tech_momt * 0.01666667).toFixed(5)} N-min</strong>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td className="text-blue py-2 border-b">{data?.payload?.tech_lang_keys['4']}(p)</td>
                                        <td className="py-2 border-b">
                                          <strong>{Number(result?.tech_momt * 0.000277778).toFixed(5)} N-h</strong>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td className="text-blue py-2 border-b">{data?.payload?.tech_lang_keys['4']}(p)</td>
                                        <td className="py-2 border-b">
                                          <strong>{Number(result?.tech_momt * 0.22482).toFixed(5)} lb-ft/s</strong>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                                ...
                                <>
                                  <div className="w-full md:w-[60%] lg:w-[60%] overflow-auto mt-2">
                                    <table className="w-full text-[16px]">
                                      <tbody>
                                        <tr>
                                          <td className="text-blue py-2 border-b">{data?.payload?.tech_lang_keys['7']}(F)</td>
                                          <td className="py-2 border-b">
                                    ...
                                    <table className="w-full text-[16px]">
                                      <tbody>
                                        <tr>
                                          <td className="text-blue py-2 border-b">{data?.payload?.tech_lang_keys['7']}(F)</td>
                                          <td className="py-2 border-b">
                                            <strong>{(result?.tech_forcet / 1e3).toFixed(6)} kN</strong>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td className="text-blue py-2 border-b">{data?.payload?.tech_lang_keys['7']}(F)</td>
                                          <td className="py-2 border-b">
                                            <strong>{(result?.tech_forcet / 1e6).toFixed(6)} MN</strong>
                                          </td>
                                        </tr>
                                      </tbody>
                                    </table>
                              ...
                              {result?.tech_time && (
                                ...
                                <div className="w-full md:w-[60%] lg:w-[60%] overflow-auto mt-2">
                                    <table className="w-full text-[16px]">
                                      <tbody>
                                        <tr>
                                          <td className="text-blue py-2 border-b">{data?.payload?.tech_lang_keys['8']}(ΔT)</td>
                                          <td className="py-2 border-b">
                                    ...
                                    <table className="w-full text-[16px]">
                                      <tbody>
                                        <tr>
                                          <td className="text-blue py-2 border-b">{data?.payload?.tech_lang_keys['8']}(ΔT)</td>
                                          <td className="py-2 border-b">
                                            <strong>{Number(result?.tech_time * 60).toFixed(6)} min</strong>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td className="text-blue py-2 border-b">{data?.payload?.tech_lang_keys['8']}(ΔT)</td>
                                          <td className="py-2 border-b">
                                            <strong>{Number(result?.tech_time * 3600).toFixed(6)} h</strong>
                                          </td>
                                        </tr>
                                      </tbody>
                                    </table>

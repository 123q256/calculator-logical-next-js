            ...
            <div className="grid grid-cols-12  gap-4">
                {formData.tech_type == "linear" && (
                  ...
                  <div className="col-span-12">
                        <div className="grid grid-cols-12  gap-4">
                          <strong className="col-span-12 mt-2 px-2">To Calculate:</strong>
                            ...
                            <table className="w-full text-[16px]">
                              ...
                              <tr>
                                ...
                                <td className="py-2 border-b">
                                  <strong>{result.tech_a_velocity} rad/s</strong>
                                </td>
                              </tr>
                              <tr>
                                <td className="text-blue py-2 border-b">
                                ...
                                <td className="py-2 border-b">
                                  <strong>
                                    {formData?.tech_r_kin} {formData?.tech_unit_k_r}
                                  </strong>
                                </td>
                              </tr>
                              <tr>
                                ...
                                <td className="py-2 border-b">
                                  <strong>
                                    {formData?.tech_moment} {formData?.tech_unit_i}
                                  </strong>
                                </td>
                              </tr>
                              </tbody>
                          ...
                          <div className="w-full md:w-[80%] lg:w-[60%] overflow-auto mt-2">
                              <table className="w-full text-[16px]">
                                ...
                                <tr>
                                  ...
                                  <td className="py-2 border-b">
                                    <strong>{formData?.tech_a_velocity} rad/s</strong>
                                  </td>
                                </tr>
                                </tbody>
                              </table>
                                  ...
                                  <div className="w-full md:w-[80%] lg:w-[60%] overflow-auto mt-2">
                                    <table className="w-full text-[16px]">
                                      ...
                                      <tr>
                                        ...
                                        <td className="py-2 border-b">
                                          <strong>{result.tech_velocity} m/s</strong>
                                        </td>
                                      </tr>
                                      </tbody>
                                    </table>
                                  ...
                                  <div className="w-full md:w-[80%] lg:w-[60%] overflow-auto mt-2">
                                    <table className="w-full text-[16px]">
                                      ...
                                      <tr>
                                        ...
                                        <td className="py-2 border-b">
                                          <strong>{(result.tech_velocity / 1609).toFixed(4)} miles/s</strong>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td className="text-blue py-2 border-b">
                                        ...
                                        <td className="py-2 border-b">
                                          <strong>{(result.tech_velocity / 1000).toFixed(4)} km/s</strong>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td className="text-blue py-2 border-b">
                                        ...
                                        <td className="py-2 border-b">
                                          <strong>{(result.tech_velocity * 3.28084).toFixed(4)} ft/s</strong>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td className="text-blue py-2 border-b">
                                        ...
                                        <td className="py-2 border-b">
                                          <strong>{(result.tech_velocity * 2.23694).toFixed(4)} miles/h</strong>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td className="text-blue py-2 border-b">
                                        ...
                                        <td className="py-2 border-b">
                                          <strong>{(result.tech_velocity * 3.6).toFixed(4)} km/h</strong>
                                        </td>
                                      </tr>
                                      </tbody>
                                    </table>
                            ...
                            <div className="w-full md:w-[80%] lg:w-[60%] overflow-auto mt-2">
                              <table className="w-full text-[16px]">
                                ...
                                <tr>
                                  ...
                                  <td className="py-2 border-b">
                                    <strong>{(result.tech_mass * 1e6).toFixed(4)} mg</strong>
                                  </td>
                                </tr>
                                <tr>
                                  <td className="text-blue py-2 border-b">
                                  ...
                                  <td className="py-2 border-b">
                                    <strong>{(result.tech_mass * 1e3).toFixed(4)} g</strong>
                                  </td>
                                </tr>
                                <tr>
                                  <td className="text-blue py-2 border-b">
                                  ...
                                  <td className="py-2 border-b">
                                    <strong>{(result.tech_mass * 2.205).toFixed(4)} lbs</strong>
                                  </td>
                                </tr>
                                </tbody>
                              </table>
                            ...
                            <div className="w-full md:w-[80%] lg:w-[60%] overflow-auto mt-2">
                              <table className="w-full text-[16px]">
                                ...
                                <tr>
                                  ...
                                  <td className="py-2 border-b">
                                    <strong>{(formData?.tech_kin / 1000).toFixed(6)} kJ</strong>
                                  </td>
                                </tr>
                                <tr>
                                  <td className="text-blue py-2 border-b">
                                  ...
                                  <td className="py-2 border-b">
                                    <strong>{(formData?.tech_kin / 1000000).toFixed(6)} MJ</strong>
                                  </td>
                                </tr>
                                <tr>
                                  <td className="text-blue py-2 border-b">
                                  ...
                                  <td className="py-2 border-b">
                                    <strong>{(formData?.tech_kin / 3600).toFixed(6)} Wh</strong>
                                  </td>
                                </tr>
                                <tr>
                                  <td className="text-blue py-2 border-b">
                                  ...
                                  <td className="py-2 border-b">
                                    <strong>{(formData?.tech_kin / 3.6e6).toFixed(6)} kWh</strong>
                                  </td>
                                </tr>
                                </tbody>
                              </table>

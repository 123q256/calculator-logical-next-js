                                    ...
                                    <>
                                       ...
                                       {(result?.tech_type == 'single_phase') && (
                                          <>
                                            <div className="w-full mt-2 overflow-auto">
                                              <table className="w-full text-[16px]">
                                                ...
                                                <tr>
                                                  ...
                                                  <td className="py-2 border-b">
                                                    {Number(result?.tech_single_phase).toFixed(2)} mm<sup>2</sup>
                                                  </td>
                                                </tr>
                                                </tbody>
                                              </table>

                                              <p className="w-full mt-3">{data?.payload?.tech_lang_keys['16']}</p>
                                              ...
                                              <table className="w-full text-[16px]">
                                                ...
                                                <tr>
                                                  ...
                                                  <td className="py-2 border-b">
                                                    {(Number(result?.tech_single_phase) * 0.000001).toFixed(6)} m²
                                                  </td>
                                                </tr>
                                                <tr>
                                                  <td className="py-2 border-b" width="70%">
                                                  ...
                                                  <td className="py-2 border-b">
                                                    {(Number(result?.tech_single_phase) * 0.00155).toFixed(5)} in²
                                                  </td>
                                                </tr>
                                                <tr>
                                                  <td className="py-2 border-b" width="70%">
                                                  ...
                                                  <td className="py-2 border-b">
                                                    {(Number(result?.tech_single_phase) * 1973.6).toFixed(4)} cmil
                                                  </td>
                                                </tr>
                                                <tr>
                                                  <td className="py-2 border-b" width="70%">
                                                  ...
                                                  <td className="py-2 border-b">
                                                    {(Number(result?.tech_single_phase) * 1.9736).toFixed(2)} kcmil
                                                  </td>
                                                </tr>
                                                </tbody>
                                              </table>
                                            ...
                                            <p className="mt-2">
                                              <InlineMath math={`A(m^2)=\\dfrac{I(A) \\times \\rho(\\Omega·m) \\times L(m)}{V_V}`} />
                                            </p>

                                            <p className="mt-2">Where:</p>
                                            <p className="mt-2">A = {data?.payload?.tech_lang_keys[22]}</p>
                                            <p className="mt-2">ρ = {data?.payload?.tech_lang_keys[23]} (Ω·m)</p>
                                            <p className="mt-2">L = {data?.payload?.tech_lang_keys[24]}</p>
                                            <p className="mt-2">I = {data?.payload?.tech_lang_keys[25]}</p>
                                            <p className="mt-2">v = {data?.payload?.tech_lang_keys[26]}</p>
                                            <p className="mt-2">V = Source voltage</p>
                                            <p className="mt-2">{data?.payload?.tech_lang_keys['27']}</p>
                                            <p className="mt-2">
                                              {data?.payload?.tech_lang_keys[28]} (ρ) = {result?.tech_c_units} (
                                              {result?.tech_metalunit}) Ω⋅m
                                            </p>
                                            <p className="mt-2">
                                            ...
                                            <p className="mt-2">Source voltage (V) = {result?.tech_s_voltage} V</p>
                                            <p className="mt-2">
                                              {data?.payload?.tech_lang_keys[31]} (v) = {result?.tech_voltage_drop} %
                                            </p>
                                            <p className="mt-2">{data?.payload?.tech_lang_keys[32]}</p>
                                            ...
                                            <p className="mt-2">
                                              <InlineMath
                                                math={`= \\dfrac{${result?.tech_current} \\times ${Number(result?.tech_metalunit).toFixed(2)} \\times 10^{-8} \\times (2 \\times ${result?.tech_wire_length})}{${(
                                                  result?.tech_voltage_drop / 100
                                                ).toFixed(4)} \\times ${result?.tech_s_voltage}}`}
                                              />
                                            </p>
                                            ...
                                            <p className="mt-2">
                                              <InlineMath math={`= ${result?.tech_am} \\times 1000000`} />
                                            </p>

                                            <p className="mt-2">
                                              <InlineMath math={`= ${Number(result?.tech_single_phase).toFixed(2)} mm^2`} />
                                            </p>

                                            <p className="mt-2">
                                              {data?.payload?.tech_lang_keys[33]} <strong>{result?.tech_s_data[1]} AWG</strong>{' '}
                                              {data?.payload?.tech_lang_keys[34]}{' '}
                                              <strong>{Number(result?.tech_single_phase).toFixed(2)} mm²</strong>{' '}
                                       ...
                                       { result?.tech_type == 'three_phase' && (
                                              <>
                                                  ...
                                                  <table className="w-full text-[16px]">
                                                    <tbody>
                                                      <tr>
                                                        ...
                                                        <td className="py-2 border-b">{result?.tech_t_data[1]} AWG</td>
                                                      </tr>
                                                      <tr>
                                                        <td className="py-2 border-b">
                                                          <strong>{data?.payload?.tech_lang_keys[15]}</strong>
                                                        ...
                                                        <td className="py-2 border-b">
                                                          {Number(result?.tech_three_phase).toFixed(2)} mm<sup>2</sup>
                                                        </td>
                                                      </tr>
                                                    </tbody>
                                                  </table>
                                                  ...
                                                  <table className="w-full text-[16px]">
                                                    <tbody>
                                                      <tr>
                                                        ...
                                                        <td className="py-2 border-b">
                                                          {(result?.tech_three_phase * 0.000001).toFixed(6)} m²
                                                        </td>
                                                      </tr>
                                                      <tr>
                                                        <td className="py-2 border-b">
                                                        ...
                                                        <td className="py-2 border-b">
                                                          {(result?.tech_three_phase * 0.00155).toFixed(5)} in²
                                                        </td>
                                                      </tr>
                                                      <tr>
                                                        <td className="py-2 border-b">
                                                        ...
                                                        <td className="py-2 border-b">
                                                          {(result?.tech_three_phase * 1973.6).toFixed(0)} cmil
                                                        </td>
                                                      </tr>
                                                      <tr>
                                                        <td className="py-2 border-b">
                                                        ...
                                                        <td className="py-2 border-b">
                                                          {(result?.tech_three_phase * 1.9736).toFixed(2)} kcmil
                                                        </td>
                                                      </tr>
                                                    </tbody>
                                                  </table>
                                                ...
                                                <BlockMath math={`A(m^2) = \\dfrac{ \\sqrt{3} \\times \\rho(\\Omega \\cdot m) \\times L(m) \\times I(A) }{ V_V }`} />
                                                ...
                                                <BlockMath
                                                  math={`= \\dfrac{ \\sqrt{3} \\times ${result?.tech_metalunit} \\times 10^{-8} \\times 2 \\times ${result?.tech_wire_length} \\times ${result?.tech_current} }{ (${(result?.tech_voltage_drop / 100).toFixed(4)}) \\times ${result?.tech_s_voltage} }`}
                                                />
                                                ...
                                                <BlockMath
                                                  math={`= ${Number(result?.tech_three_phase).toFixed(2)} mm^2`}
                                                />

                                                <p className="mt-2">
                                                  {data?.payload?.tech_lang_keys['33']} <strong>{result?.tech_t_data[1]} AWG</strong>{' '}
                                                  {data?.payload?.tech_lang_keys['34']} <strong>{Number(result?.tech_three_phase).toFixed(2)} mm²</strong>{' '}
                                                  {data?.payload?.tech_lang_keys['35']}
                                                </p>
                                              </>
                                        )};
                                        {result?.submit == 'wire_diameter' && (
                                            <div className="w-full mt-2">
                                              <p className="w-full mt-3">{data?.payload?.tech_lang_keys['12']}</p>

                                              <table className="w-full text-[16px]">
                                                <tbody>
                                                  <tr>
                                                    <td className="py-2 border-b" width="70%">
                                                      <strong>{data?.payload?.tech_lang_keys[44]}</strong>
                                                    </td>
                                                    <td className="py-2 border-b">
                                                      {Number(result?.tech_inches).toFixed(4)} in
                                                    </td>
                                                  </tr>
                                                  <tr>
                                                    <td className="py-2 border-b">
                                                      <strong>{data?.payload?.tech_lang_keys[45]}</strong>
                                                    </td>
                                                    <td className="py-2 border-b">
                                              ...
                                              <p className="w-full mt-3">{data?.payload?.tech_lang_keys['15']}</p>
                                              ...
                                              <table className="w-full text-[16px]">
                                                <tbody>
                                                  <tr>
                                                    ...
                                                    <td className="py-2 border-b">
                                                      {Number(result?.tech_kcmil).toFixed(4)} kcmil
                                                    </td>
                                                  </tr>
                                                  <tr>
                                                    <td className="py-2 border-b">
                                                    ...
                                                    <td className="py-2 border-b">
                                                      {Number(result?.tech_sqinches).toFixed(4)} in<sup>2</sup>
                                                    </td>
                                                  </tr>
                                                  <tr>
                                                    <td className="py-2 border-b">
                                                      <strong>{data?.payload?.tech_lang_keys[47]}</strong>
                                                    </td>
                                                    <td className="py-2 border-b">
                                                      {Number(result?.tech_mm2).toFixed(4)} mm<sup>2</sup>
                                                    </td>
                                                  </tr>
                                                </tbody>
                                              </table>
                                        ...
                                        {result?.submit == 'wire_gauge' && (
                                          <div className="w-full mt-2">
                                            <p className="w-full mt-3">{data?.payload?.tech_lang_keys['13']}</p>
                                            ...
                                            <table className="w-full text-[16px]">
                                              <tbody>
                                                <tr>
                                                  ...
                                                  <td className="py-2 border-b">{result?.tech_d_data[1]} AWG</td>
                                                </tr>
                                                <tr>
                                                  <td className="py-2 border-b">
                                                    <strong>Diameter inches</strong>
                                                  </td>
                                                  <td className="py-2 border-b">{result?.tech_d_data[0]} in</td>
                                                </tr>
                                                <tr>
                                                  <td className="py-2 border-b">
                                                    <strong>Diameter millimeters</strong>
                                                  </td>
                                                  <td className="py-2 border-b">{result?.tech_d_data[2]?.mm} mm</td>
                                                </tr>
                                              </tbody>
                                            </table>
                                            ...
                                            <table className="w-full text-[16px]">
                                              <tbody>
                                                <tr>
                                                  ...
                                                  <td className="py-2 border-b">{result?.tech_d_data[2]?.kcmil} kcmil</td>
                                                </tr>
                                                <tr>
                                                  <td className="py-2 border-b">
                                                    <strong>{data?.payload?.tech_lang_keys[46]}</strong>
                                                  </td>
                                                  <td className="py-2 border-b">
                                                    {Number(result?.tech_square_in).toFixed(2)} in<sup>2</sup>
                                                  </td>
                                                </tr>
                                                <tr>
                                                <td className="py-2 border-b">
                                                ...
                                                <td className="py-2 border-b">{result?.tech_d_data[2]?.['mm²']} mm<sup>2</sup></td>
                                              </tr>
                                            </tbody>
                                          </table>
                                        </div>

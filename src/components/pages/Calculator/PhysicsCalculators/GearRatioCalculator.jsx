            ...
            <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
                <div className="grid grid-cols-12 mt-3  gap-4">
                      <div className="col-span-12 mx-auto md:mb-2">
                          <div className="row">
                              <strong className="col-12 mt-2 px-2 text-center">{ data?.payload?.tech_lang_keys[1] }:</strong>
                      ...
                      <div className="rounded-lg  flex items-center justify-center">
                        <div className="w-full mt-3">
                            <div className="w-full">
                                <p className="col-12 mt-2 font-s-21"><strong className="text-blue">{ data?.payload?.tech_lang_keys[19] }</strong></p>
                                  {result?.tech_type == "first" && (
                                    <>
                                    <div className="w-full md:w-[60%] lg:w-[60%] overflow-auto">
                                        <table className="w-full text-[16px]">
                                            <tr>
                                                <td className="text-blue py-2 border-b">{ data?.payload?.tech_lang_keys[20] }</td>
                                                <td className="py-2 border-b"><strong>{ Number(result?.tech_gear_ratio).toFixed(2) } :1</strong></td>
                                            </tr>
                                            <tr>
                                                <td className="text-blue py-2 border-b">{ data?.payload?.tech_lang_keys[21] }</td>
                                                <td className="py-2 border-b"><strong>{ Number(result?.tech_mechanical).toFixed(2) }</strong></td>
                                            </tr>
                                            <tr>
                                                <td className="text-blue py-2 border-b">{ data?.payload?.tech_lang_keys[22] }</td>
                                                <td className="py-2 border-b"><strong>{ Number(result?.tech_output_rot).toFixed(2) } (rpm)</strong></td>
                                            </tr>
                                            <tr>
                                                <td className="text-blue py-2 border-b">{ data?.payload?.tech_lang_keys[23] }</td>
                                                <td className="py-2 border-b"><strong>{ Number(result?.tech_output_tor).toFixed(2) } (Nm)</strong></td>
                                            </tr>
                                        </table>
                                    </div>
                                    ...
                                    <>
                                      <div className="w-full md:w-[60%] lg:w-[60%]mt-2 overflow-auto">
                                          <table className="w-full text-[16px]">
                                            <tbody>
                                              <tr>
                                                  <td className="text-blue py-2 border-b">{ data?.payload?.tech_lang_keys[24] }</td>
                                                  <td className="py-2 border-b"><strong>{ Number(result?.tech_height).toFixed(2) } (in)</strong></td>
                                              </tr>
                                              <tr>
                                                  <td className="text-blue py-2 border-b">{ data?.payload?.tech_lang_keys[25] }</td>
                                                  <td className="py-2 border-b"><strong>{ Number(result?.tech_width).toFixed(2) } (in)</strong></td>
                                              </tr>
                                              </tbody>
                                          </table>
                                      </div>
                                          ...
                                          <table className="w-full text-[16px]" >
                                            <tbody>
                                              <tr className="bg-[#2845F5] text-white">
                                                  <td className="p-2  text-center"><strong className="text-white">{ data?.payload?.tech_lang_keys[26] }</strong></td>
                                                  <td className="p-2  text-center"><strong className="text-white">{ data?.payload?.tech_lang_keys[27] }</strong></td>
                                                  <td className="p-2  text-center"><strong className="text-white">MPH</strong></td>
                                              </tr>
                                              <tr className="bg-white">
                                                  <td className="p-2 border text-center">1st { data?.payload?.tech_lang_keys[28] }</td>
                                                  <td className="p-2 border text-center">{ result?.tech_transratio1_value }</td>
                                                  <td className="p-2 border text-center">{ result?.tech_mph1_value }</td>
                                              </tr>
                                              <tr className="bg-white">
                                                  <td className="p-2 border text-center">2nd { data?.payload?.tech_lang_keys[28] }</td>
                                                  <td className="p-2 border text-center">{ result?.tech_transratio2_value }</td>
                                                  <td className="p-2 border text-center">{ result?.tech_mph2_value }</td>
                                              </tr>
                                              <tr className="bg-white">
                                                  <td className="p-2 border text-center">3rd { data?.payload?.tech_lang_keys[28] }</td>
                                                  <td className="p-2 border text-center">{ result?.tech_transratio3_value }</td>
                                                  <td className="p-2 border text-center">{ result?.tech_mph3_value }</td>
                                              </tr>
                                              <tr className="bg-white">
                                                  <td className="p-2 border text-center">4th { data?.payload?.tech_lang_keys[28] }</td>
                                                  <td className="p-2 border text-center">{ result?.tech_transratio4_value }</td>
                                                  <td className="p-2 border text-center">{ result?.tech_mph4_value }</td>
                                              </tr>
                                              <tr className="bg-white">
                                                  <td className="p-2 border text-center">5th { data?.payload?.tech_lang_keys[28] }</td>
                                                  <td className="p-2 border text-center">{ result?.tech_transratio5_value }</td>
                                                  <td className="p-2 border text-center">{ result?.tech_mph5_value }</td>
                                              </tr>
                                              <tr className="bg-white">
                                                  <td className="p-2 border text-center">6th { data?.payload?.tech_lang_keys[28] }</td>
                                                  <td className="p-2 border text-center">{ result?.tech_transratio6_value }</td>
                                                  <td className="p-2 border text-center">{ result?.tech_mph6_value }</td>
                                              </tr>
                                              </tbody>
                                          </table>
                                      </div>

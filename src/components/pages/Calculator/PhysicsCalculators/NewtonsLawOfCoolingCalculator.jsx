                                      ...
                                      <table className="w-full lg:text-[18px] md:text-[18px] text-[16px]">
                                        <tbody>
                                          <tr>
                                              ...
                                              <td className="py-2 border-b"><strong className="text-blue">{ Number(result?.tech_temperature).toFixed(2) } °C</strong></td>
                                          </tr>
                                          <tr>
                                              <td className="py-2 border-b">{ data?.payload?.tech_lang_keys['8'] }</td>
                                              <td className="py-2 border-b"><strong className="text-blue">{ Number(result?.tech_k).toFixed(5) } sec⁻¹</strong></td>
                                          </tr>
                                          </tbody>
                                      </table>
                                  </div>
                              </div>
                              <p className="col-12 mt-3 lg:text-[18px] md:text-[18px] text-[16px] text-blue">{ data?.payload?.tech_lang_keys[9] }</p>
                              <div className="w-full md:w-[80%] lg:w-[60%]  overflow-auto mt-2">
                                  <table className="w-100 lg:text-[18px] md:text-[18px] text-[16px]" >
                                      <thead>
                                          <tr className="bg-[#2845F5] text-white">
                                              <td className="p-2 border text-center"><strong className="text-blue">°F</strong></td>
                                              <td className="p-2 border text-center"><strong className="text-blue">K</strong></td>
                                          </tr>
                                      </thead>
                                      <tbody>
                                          <tr className="bg-sky">
                                              <td className="text-center p-2 border">{ (result?.tech_temperature * 9 / 5) + 32 }</td>
                                              <td className="text-center p-2 border">{ result?.tech_temperature + 273.15 }</td>
                                          </tr>
                                      </tbody>
                                  </table>
                              </div>

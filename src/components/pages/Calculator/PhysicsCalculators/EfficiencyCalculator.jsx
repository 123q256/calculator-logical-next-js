          ...
          <div class="lg:w-[60%] md:w-[80%] w-full mx-auto ">
            <div class="grid grid-cols-12   gap-2 md:gap-4 lg:gap-4">
              ...
              {(formData.tech_solve == "1" || formData.tech_solve == "3") && (
                <>
                  <div class="lg:col-span-6 md:col-span-6 col-span-12" id="en_in">
              ...
              {(formData.tech_solve == "1" || formData.tech_solve == "2") && (
                <>
                  <div class="lg:col-span-6 md:col-span-6 col-span-12" id="en_ou">
              ...
              {(formData.tech_solve == "2" || formData.tech_solve == "3") && (
                <>
                  <div class="lg:col-span-6 md:col-span-6 col-span-12" id="en_ef">

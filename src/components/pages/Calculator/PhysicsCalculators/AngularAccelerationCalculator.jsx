            ...
            <div className="grid grid-cols-12 mt-3  gap-4">
                <div className="col-span-12 w-set">
                    ...
                    <div className="mt-2">
                      ...
                      >
                        <option value="0">{data?.payload?.tech_lang_keys["1"]}</option>
                ...
                <div className="grid grid-cols-12 mt-3  gap-4">
                  {formData.tech_find == "0" && (
                    ...
                    <div className="col-span-12" id="g-hide">
                        <p className="col med-set"><label><strong>{data?.payload?.tech_lang_keys['4']}: </strong></label></p>
                        <p className="med-set1">
                             <label className="pe-2" htmlFor="angular_acceleration">
                              <input
                                ...
                                onChange={handleChange}
                                checked={formData.tech_select1 === 'angular_acceleration'}
                              />
                             ...
                             <label className="pe-2" htmlFor="tangential_acceleration">
                              <input
                                ...
                                className="mr-2 border"
                                onChange={handleChange}
                                checked={formData.tech_select1 === 'tangential_acceleration'}
                              />
                    ...
                    <>
                      <div className="col-span-12 " id="g-hide1">
                          ...
                          <label className="font_size16"><strong>{ data?.payload?.tech_lang_keys['4']}: </strong></label>
                          </p>
                          <label className="pe-2" htmlFor="angular_acceleration_two">
                                <input
                                  ...
                                  className="mr-2 border"
                                  onChange={handleChange}
                                  checked={formData.tech_select2 === 'angular_acceleration_two'}
                                />
                                <span>{ data?.payload?.tech_lang_keys['5'] }</span>
                              </label>
                      ...
                      <div className="col-span-12 " id="g-hide2">
                        <div className="col-span-12  root">
                          ...
                          <p className="med-set3">
                            <label className="pe-2" htmlFor="angular_acceleration_three">
                                <input
                                  type="radio"
                                  name="tech_select3"
                                  ...
                                  className="mr-2 border"
                                  onChange={handleChange}
                                  checked={formData.tech_select3 === 'angular_acceleration_three'}
                                />
                                <span>{ data?.payload?.tech_lang_keys['5'] }</span>
                              </label>
                ...
                <div className="grid grid-cols-12 mt-3  gap-4">
                   ...
                   {((formData.tech_find == "0" && formData.tech_select1 == "angular_acceleration" ) || (formData.tech_find == "0" && formData.tech_select1 == "radius" )) && (
                    <>
                    <div className="col-span-12 md:col-span-6 lg:col-span-6" id="tangential_acceleration">
                   ...
                   {((formData.tech_find == "0" && formData.tech_select1 == "angular_acceleration" ) || (formData.tech_find == "0" && formData.tech_select1 == "tangential_acceleration" )) && (
                    <>
                    <div className="col-span-12 md:col-span-6 lg:col-span-6" id="radius">
                   ...
                   {((formData.tech_find == "0" && formData.tech_select1 == "radius" )  || (formData.tech_find == "0" && formData.tech_select1 == "tangential_acceleration" ) || (formData.tech_find == "2" && formData.tech_select2 == "mass" ) || (formData.tech_find == "2" && formData.tech_select2 == "total_torque_two" )  || (formData.tech_find == "1" && formData.tech_select3 == "time" )  || (formData.tech_find == "1" && formData.tech_select3 == "inv" ) || (formData.tech_find == "1" && formData.tech_select3 == "fnv" )) && (
                    <>
                    <div className="col-span-12 md:col-span-6 lg:col-span-6 " id="angular_acceleration">
                        ...
                        {data?.payload?.tech_lang_keys["5"]} (α)
                          ...
                          <input
                            ...
                            onChange={handleChange}
                          />
                          <span className="input_unit">rad/s<sup>2</sup></span>
                          </div>
                    </div>
                   ...
                   {/* 3th */}
                      ...
                      {((formData.tech_find == "2" && formData.tech_select2 == "angular_acceleration_two" )  || (formData.tech_find == "2" && formData.tech_select2 == "mass" )) && (
                    <>
                    <div className="col-span-12 md:col-span-6 lg:col-span-6 " id="total_torque">
                      ...
                      {((formData.tech_find == "2" && formData.tech_select2 == "angular_acceleration_two" )  || (formData.tech_find == "2" && formData.tech_select2 == "total_torque_two" )) && (
                    <>
                    <div className="col-span-12 md:col-span-6 lg:col-span-6 " id="moment">
                        ...
                        {data?.payload?.tech_lang_keys["8"]} (I)
                          ...
                          <input
                            ...
                            onChange={handleChange}
                          />
                          <span className="input_unit">kg-m<sup>2</sup>/rad<sup>2</sup></span>
                          </div>
                   ...
                   {((formData.tech_find == "1" && formData.tech_select3 == "angular_acceleration_three" )  || (formData.tech_find == "1" && formData.tech_select3 == "time" )  || (formData.tech_find == "1" && formData.tech_select3 == "fnv" )) && (
                    <>
                    <div className="col-span-12 md:col-span-6 lg:col-span-6 " id="inv">
                      ...
                      { data?.payload?.tech_lang_keys["11"]} (R)
                       ...
                       {((formData.tech_find == "1" && formData.tech_select3 == "angular_acceleration_three" )  || (formData.tech_find == "1" && formData.tech_select3 == "time" )  || (formData.tech_find == "1" && formData.tech_select3 == "inv" )) && (
                    <>
                    <div className="col-span-12 md:col-span-6 lg:col-span-6 " id="fnv">
                    ...
                    {((formData.tech_find == "1" && formData.tech_select3 == "angular_acceleration_three" )  || (formData.tech_find == "1" && formData.tech_select3 == "fnv" )  || (formData.tech_find == "1" && formData.tech_select3 == "inv" )) && (
                    <>
                    <div className="col-span-12 md:col-span-6 lg:col-span-6 " id="time">
                        ...
                        <div className="w-full mt-3">
                            <div className="w-full lg:text-[18px] md:text-[18px] text-[16px] overflow-auto">
                             {result?.tech_method == "1" && (
                                <>
                                  <p className="mt-2">
                                    <strong>{data?.payload?.tech_lang_keys['5']} (<InlineMath math="\alpha" />)</strong>
                                  </p>

                                  <p className="mt-2">
                                    <strong>{Number(result?.tech_ans).toFixed(2)} <span>(rad/s<sup>2</sup>)</span></strong>
                                  </p>
                                  ...
                                  <p className="mt-2 dk">
                                    <InlineMath math={`\\alpha = ${result?.tech_ans}`} />
                                  </p>
                                </>
                              )}
                               {result?.tech_method == "2" && (
                                <>
                                  <p className="mt-2">
                                    <strong>{data?.payload?.tech_lang_keys['6']} (<InlineMath math="R" />)</strong>
                                  </p>

                                  <p className="mt-2">
                                    <strong>{Number(result?.tech_ans).toFixed(2)}<span> (m)</span></strong>
                                  </p>
                                  ...
                                  <div className="mt-2 overflow-auto">
                                    <table className="w-full lg:text-[18px] md:text-[18px] text-[16px]">
                                      <tbody>
                                        <tr>
                                          <td className="color_blue">{data?.payload?.tech_lang_keys['6']} (R)</td>
                                          <td><strong>{result?.tech_ans * 1000} (mm)</strong></td>
                                        </tr>
                                        <tr>
                                          <td className="color_blue">{data?.payload?.tech_lang_keys['6']} (R)</td>
                                          <td><strong>{result?.tech_ans * 100} (cm)</strong></td>
                                        </tr>
                                        <tr>
                                          <td className="color_blue">{data?.payload?.tech_lang_keys['6']} (R)</td>
                                          <td><strong>{result?.tech_ans * 0.001} (km)</strong></td>
                                        </tr>
                                        <tr>
                                          <td className="color_blue">{data?.payload?.tech_lang_keys['6']} (R)</td>
                                          <td><strong>{result?.tech_ans * 39.37} (in)</strong></td>
                                        </tr>
                                        <tr>
                                          <td className="color_blue">{data?.payload?.tech_lang_keys['6']} (R)</td>
                                          <td><strong>{result?.tech_ans * 3.281} (ft)</strong></td>
                                        </tr>
                                        <tr>
                                          <td className="color_blue">{data?.payload?.tech_lang_keys['6']} (R)</td>
                                          <td><strong>{result?.tech_ans * 1.0936} (yd)</strong></td>
                                        </tr>
                                        <tr>
                                          <td className="color_blue">{data?.payload?.tech_lang_keys['6']} (R)</td>
                                          <td><strong>{result?.tech_ans * 0.0006214} (mi)</strong></td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </div>
                              ...
                              {result?.tech_method == "3" && (
                                <>
                                  <p className="mt-2">
                                    <strong>{data?.payload?.tech_lang_keys['7']} (<InlineMath math="a" />)</strong>
                                  </p>

                                  <p className="mt-2">
                                    <strong>{Number(result?.tech_ans).toFixed(2)} <span>(m/s<sup>2</sup>)</span></strong>
                                  </p>
                                  ...
                                  <div className="mt-2 overflow-auto">
                                    <table className="w-full lg:text-[18px] md:text-[18px] text-[16px]">
                                      <tbody>
                                        <tr>
                                          <td className="color_blue">{data?.payload?.tech_lang_keys['7']} (a)</td>
                                          <td><strong>{result?.tech_ans * 0.10197} (g)</strong></td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </div>
                              ...
                              <>
                                  ...
                                  <p className="mt-2">
                                    <strong>
                                      <InlineMath math={`\\omega_1 = ${result?.tech_first_value}, \\omega_2 = ${result?.tech_second_value}, \\ t = ${result?.tech_third_value}, \\ \\text{and} \\ \\alpha`} />
                                    </strong>
                                  </p>
                                  ...
                                  <p className="mt-2">
                                    <BlockMath math={`\\alpha = \\dfrac{${result?.tech_second_value} - ${result?.tech_first_value}}{${result?.tech_third_value}}`} />
                                  </p>
                              ...
                              <>
                                <p className="mt-2">
                                  <strong>{data?.payload?.tech_lang_keys['10']} (<InlineMath math="t" />)</strong>
                                </p>

                                <p className="mt-2">
                                  <strong>{Number(result?.tech_ans).toFixed(2)} <span>(sec)</span></strong>
                                </p>
                                ...
                                <div className="mt-2 overflow-auto">
                                  <table className="w-full lg:text-[18px] md:text-[18px] text-[16px]">
                                    <tbody>
                                      <tr>
                                        <td className="text-blue-600">{data?.payload?.tech_lang_keys['10']} (t)</td>
                                        <td><strong>{(result?.tech_ans * 0.016667).toFixed(6)} minutes (min)</strong></td>
                                      </tr>
                                      <tr>
                                        <td className="text-blue-600">{data?.payload?.tech_lang_keys['10']} (t)</td>
                                        <td><strong>{(result?.tech_ans * 0.0002778).toFixed(6)} hours (hrs)</strong></td>
                                      </tr>
                                      <tr>
                                        <td className="text-blue-600">{data?.payload?.tech_lang_keys['10']} (t)</td>
                                        <td><strong>{(result?.tech_ans * 0.000011574).toFixed(6)} days</strong></td>
                                      </tr>
                                      <tr>
                                        <td className="text-blue-600">{data?.payload?.tech_lang_keys['10']} (t)</td>
                                        <td><strong>{(result?.tech_ans * 0.0000016534).toFixed(6)} weeks</strong></td>
                                      </tr>
                                      <tr>
                                        <td className="text-blue-600">{data?.payload?.tech_lang_keys['10']} (t)</td>
                                        <td><strong>{(result?.tech_ans * 0.00000038026).toFixed(8)} months</strong></td>
                                      </tr>
                                      <tr>
                                        <td className="text-blue-600">{data?.payload?.tech_lang_keys['10']} (t)</td>
                                        <td><strong>{(result?.tech_ans * 0.00000003169).toFixed(8)} years</strong></td>
                                      </tr>
                                    </tbody>
                                  </table>
                                </div>
                                ...
                                <p className="mt-2">
                                  <strong>
                                    <InlineMath math={`\\omega_1 = ${result?.tech_first_value}, \\omega_2 = ${result?.tech_second_value}, \\ a = ${result?.tech_third_value}, \\ \\text{and} \\ \\text{solve for} \\ t`} />
                                  </strong>
                                </p>
                                ...
                                <p className="mt-2">
                                  <BlockMath math={`t = \\dfrac{${result?.tech_second_value} - ${result?.tech_first_value}}{${result?.tech_third_value}}`} />
                                </p>
                              ...
                              {result?.tech_method == "6" && (
                                <>
                                  <p className="mt-2">
                                    <strong>{data?.payload?.tech_lang_keys['11']} (<InlineMath math="\omega_1" />)</strong>
                                  </p>

                                  <p className="mt-2">
                                    <strong>
                                      {Number(result?.tech_ans).toFixed(2)} <span>(rad/s)</span>
                                    </strong>
                                  </p>
                                  ...
                                  <div className="mt-2">
                                    <table className="w-full text-[18px]">
                                      <tbody>
                                        <tr>
                                          <td className="text-blue-600">{data?.payload?.tech_lang_keys['11']} (<InlineMath math="\omega_1" />)</td>
                                          <td><strong>{Number(result?.tech_ans * 9.55).toFixed(2)} Rotations per minute (rpm)</strong></td>
                                        </tr>
                                        <tr>
                                          <td className="text-blue-600">{data?.payload?.tech_lang_keys['11']} (<InlineMath math="\omega_1" />)</td>
                                          <td><strong>{Number(result?.tech_ans * 0.15915).toFixed(2)} Hertz (Hz)</strong></td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </div>
                                  ...
                                  <p className="mt-2 dk">
                                    <InlineMath math={`\\omega_1 = ${result?.tech_ans}`} />
                                  </p>
                                </>
                              )}
                             {result?.tech_method == "7" && (
                              <>
                                <p className="mt-2">
                                  <strong>{data?.payload?.tech_lang_keys['12']} (<InlineMath math="\omega_2" />)</strong>
                                </p>
                                ...
                                <div className="mt-2 overflow-auto">
                                  <table className="w-full lg:text-[18px] md:text-[18px] text-[16px]">
                                    <tbody>
                                      <tr>
                                        <td className="text-blue-600">{data?.payload?.tech_lang_keys['12']} (<InlineMath math="\omega_2" />)</td>
                                        <td><strong>{Number(result?.tech_ans * 9.55).toFixed(2)} Rotations per minute (rpm)</strong></td>
                                      </tr>
                                      <tr>
                                        <td className="text-blue-600">{data?.payload?.tech_lang_keys['12']} (<InlineMath math="\omega_2" />)</td>
                                ...
                                <p className="mt-2 dk">
                                  <InlineMath math={`\\omega_2 = ${result?.tech_ans}`} />
                                </p>
                              </>
                              )}
                              {result?.tech_method == "8" && (
                                <>
                                  ...
                                  <p className="mt-2">
                                    <strong>
                                      {Number(result?.tech_ans).toFixed(2)} <span>(rad/s<sup>2</sup>)</span>
                                    </strong>
                                  </p>
                              ...
                              <>
                                <p className="mt-2">
                                  <strong>
                                    {data?.payload?.tech_lang_keys['8']} (<InlineMath math="I" />)
                                  </strong>
                                </p>
                                ...
                                <p className="mt-2">
                                  <strong>
                                    ...
                                    <span> (kg·m<sup>2</sup>/rad<sup>2</sup>)</span>
                                  </strong>
                                </p>
                            ...
                            <>
                              <p className="mt-2">
                                <strong>
                                  {data?.payload?.tech_lang_keys['9']} (<InlineMath math="\tau" />)
                                </strong>
                              </p>

                              <p className="mt-2">
                                <strong>
                                  {Number(result?.tech_ans).toFixed(2)}<span> rad/sec</span>
                                </strong>
                              </p>
                              ...
                              <p className="mt-2 dk">
                                <InlineMath math={`\\tau = ${result?.tech_ans}`} />
                              </p>
                            </>
                              )}
                            </div>

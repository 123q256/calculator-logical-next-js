                      ...
                      <div className="grid grid-cols-12  gap-4">
                          ...
                          {formData.tech_operations =="1" && (
                              ...
                              <div className="col-span-12 shape2">
                                  ...
                                  <div className="mt-2">
                                    <select
                                      ...
                                      onChange={handleChange}
                                    >
                                      <option value="1">{data?.payload?.tech_lang_keys["11"]}</option>
                                      <option value="2">{data?.payload?.tech_lang_keys["6"]} </option>
                                      <option value="3">{data?.payload?.tech_lang_keys["7"]} </option>
                                      <option value="4">{data?.payload?.tech_lang_keys["12"]} </option>
                                      <option value="5">{data?.payload?.tech_lang_keys["13"]} </option>
                                      <option value="6">{data?.payload?.tech_lang_keys["14"]} </option>
                                    </select>
                                  </div>
                            ...
                            <div className="col-span-12 f1">
                             ...
                             {((formData.tech_operations =="1" &&  formData.tech_shape_1 =="3") || (formData.tech_operations =="1" &&  formData.tech_shape_1 =="4") || (formData.tech_operations =="1" &&  formData.tech_shape_1 =="5") || (formData.tech_operations =="2" &&  formData.tech_shape_2 =="3") || (formData.tech_operations =="2" &&  formData.tech_shape_2 =="4") || (formData.tech_operations =="2" &&  formData.tech_shape_2 =="5")) && (
                            <>
                            <div className="col-span-12 f6">
                               {((formData.tech_operations =="1" &&  formData.tech_shape_1 =="4") || (formData.tech_operations =="1" &&  formData.tech_shape_1 =="5")  || (formData.tech_operations =="2" &&  formData.tech_shape_2 =="4")  || (formData.tech_operations =="2" &&  formData.tech_shape_2 =="5"))?(
                                <>
                                
                                <label htmlFor="tech_six" className="label" > { data?.payload?.tech_lang_keys["28"]} </label>
                                </>
                               ):(

                                 <label htmlFor="tech_six" className="label" > { data?.payload?.tech_lang_keys["16"]} </label>
                             ...
                             {((formData.tech_operations =="1" &&  formData.tech_shape_1 =="6") || (formData.tech_operations =="2" &&  formData.tech_shape_2 =="6") ) && (
                            <>
                            <div className="col-span-12 f7">
                                 {((formData.tech_operations =="1" &&  formData.tech_shape_1 =="6")  || (formData.tech_operations =="2" &&  formData.tech_shape_2 =="6") )?(
                                <>
                                
                                <label htmlFor="tech_seven" className="label" > { data?.payload?.tech_lang_keys["17"]} </label>
                                </>
                               ):(

                                 <label htmlFor="tech_seven" className="label" > { data?.payload?.tech_lang_keys["16"]} </label>
                             ...
                             {((formData.tech_operations =="1" &&  formData.tech_shape_1 =="1") || (formData.tech_operations =="1" &&  formData.tech_shape_1 =="2")  || (formData.tech_operations =="2" &&  formData.tech_shape_2 =="1") || (formData.tech_operations =="2" &&  formData.tech_shape_2 =="2")) && (
                            <>
                  ...
                  <div className="col-span-12 md:col-span-6 con">
                      <div className="grid grid-cols-12  gap-4">
                          <div className="col-span-12 md:col-span-12 text-center">
                              {formData.tech_operations =="1" && (
                                ...
                                { formData.tech_shape_1 =="1" && (
                                  <>
                              <img  src="/images/d1_img1.png" alt="beam image" width="100%" height="100%" className="set_img"/>   
                                  </>
                                )}
                                 { formData.tech_shape_1 =="2" && (
                                  <>
                                 <img  src="/images/d1_img2.png" alt="beam image" width="100%" height="100%" className="set_img"/>   
                                  </>
                                )}
                                 { formData.tech_shape_1 =="3" && (
                                  <>
                                  <img  src="/images/d1_img3.png" alt="beam image" width="100%" height="100%" className="set_img"/>   
                                  </>
                                )}
                                 { formData.tech_shape_1 =="4" && (
                                  <>
                                <img  src="/images/d1_img4.png" alt="beam image" width="100%" height="100%" className="set_img"/>   
                                  </>
                                )}
                                 { formData.tech_shape_1 =="5" && (
                                  <>
                                     <img  src="/images/d1_img5.png" alt="beam image" width="100%" height="100%" className="set_img"/>   
                                  </>
                                )}
                                 { formData.tech_shape_1 =="6" && (
                                  <>
                                  <img  src="/images/d1_img6.png" alt="beam image" width="100%" height="100%" className="set_img"/>   
                                  </>
                                )}
                              ...
                              {formData.tech_operations =="2" && (
                                <>
                                  ...
                                  <>
                                <img  src="/images/d2_img1.png" alt="beam image" width="100%" height="100%" className="set_img"/>   
                                    </>
                                  )}
                                  { formData.tech_shape_2 =="2" && (
                                    <>
                                  <img  src="/images/d2_img2.png" alt="beam image" width="100%" height="100%" className="set_img"/>   
                                    </>
                                  )}
                                  { formData.tech_shape_2 =="3" && (
                                    <>
                                    <img  src="/images/d2_img3.png" alt="beam image" width="100%" height="100%" className="set_img"/>   
                                    </>
                                  )}
                                  { formData.tech_shape_2 =="4" && (
                                    <>
                                  <img  src="/images/d2_img4.png" alt="beam image" width="100%" height="100%" className="set_img"/>   
                                    </>
                                  )}
                                  { formData.tech_shape_2 =="5" && (
                                    <>
                                      <img  src="/images/d2_img5.png" alt="beam image" width="100%" height="100%" className="set_img"/>   
                                    </>
                                  )}
                                  { formData.tech_shape_2 =="6" && (
                                    <>
                                    <img  src="/images/d2_img6.png" alt="beam image" width="100%" height="100%" className="set_img"/>   
                                    </>
                                  )}
                          ...
                          <div className="col-span-12 md:col-span-12 f4">
                           ...
                           {((formData.tech_operations =="1" &&  formData.tech_shape_1 =="2") || (formData.tech_operations =="2" &&  formData.tech_shape_2 =="2") ) && (
                            <>
                         ...
                         {((formData.tech_operations =="1" &&  formData.tech_shape_1 =="4") || (formData.tech_operations =="1" &&  formData.tech_shape_1 =="6")) && (
                            <>
                            ...
                            <label htmlFor="tech_shape1_extra" className="label">
                              ...
                              <div className="mt-2">
                                <select
                                  ...
                                  onChange={handleChange}
                                >
                                  <option value="1">{data?.payload?.tech_lang_keys["23"]}</option>
                                  <option value="2">{data?.payload?.tech_lang_keys["24"]} </option>
                                </select>
                              </div>
                          </div>
                            </>)}
                                      ...
                                      <table className="w-full lg:text-[18px] md:text-[18px] text-[16px]">
                                        ...
                                        <tr>
                                          ...
                                          {result?.tech_distance_b && (
                                            <>
                                              <tr>
                                                  <td className="py-2 border-b">{ data?.payload?.tech_lang_keys[27] }</td>
                                                  <td className="py-2 border-b"><strong className="text-blue">{ Number(result?.tech_distance_b).toFixed(4) } (m)</strong></td>
                                              </tr>
                                            </>
                                          )}  
                                             {result?.tech_x && (
                                            <>
                                              <tr>
                                                  ...
                                                  <td className="py-2 border-b"><strong className="text-blue">{ Number(result?.tech_x).toFixed(4) } (m)</strong></td>
                                              </tr>
                                            </>
                                          )}  
                                       </tbody>

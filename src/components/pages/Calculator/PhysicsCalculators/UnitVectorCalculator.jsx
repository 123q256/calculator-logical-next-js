          ...
          <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
            <div className="grid grid-cols-1  lg:grid-cols-2 md:grid-cols-2 mt-3  gap-4">
              ...
              {formData.tech_method == "find" &&
                formData.tech_dimen == "3d" && (
                  <>
                    <div className="lg:col-span-6 md:col-span-6 col-span-12 " id="fz">
              ...
              {((formData.tech_method == "normalize" &&
                ...
                (formData.tech_method == "normalize" &&
                  formData.tech_dimen == "3d")) && (
                <>
                  <div className="lg:col-span-6 md:col-span-6 col-span-12" id="x">
              ...
              {((formData.tech_method == "normalize" &&
                ...
                (formData.tech_method == "normalize" &&
                  formData.tech_dimen == "3d")) && (
                <>
                  <div className="lg:col-span-6 md:col-span-6 col-span-12 " id="y">
              ...
              {formData.tech_method == "normalize" &&
                formData.tech_dimen == "3d" && (
                  <>
                    <div className="lg:col-span-6 md:col-span-6 col-span-12" id="z">
                ...
                <div>
                  ...
                  <div className="rounded-lg flex items-center justify-center">
                    <div className="w-full mt-3 overflow-auto">
                      <div className="w-full text-[20px] bg-gray-100 p-2 md:p-4">

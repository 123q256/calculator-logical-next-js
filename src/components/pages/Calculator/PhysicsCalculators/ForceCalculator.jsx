        ...
        <div className="grid grid-cols-12 mt-3  gap-4">
            {formData.tech_unit_type == "m1" && (
              ...
              <div className="col-span-12">
                  <div className="grid grid-cols-12 inp_wrap gap-4 mt-4" id="inp_wrap">
                      <div className="col-span-12 md:col-span-6 lg:col-span-6">
                          ...
                          <div className="mt-2">
                            ...
                            >
                              <option value="f">{data?.payload?.tech_lang_keys["2"]} (F)</option>
                              <option value="m">{data?.payload?.tech_lang_keys["3"]} (m)</option>
                              <option value="a">{data?.payload?.tech_lang_keys["4"]} (a)</option>
                            </select>
                          </div>
                      
                      </div>
                      {(formData.tech_cal == "m" || formData.tech_cal == "a") && (
                        <>
                        <div className="col-span-12 md:col-span-6 lg:col-span-6 " id="f">
                       ...
                       {(formData.tech_cal == "f" || formData.tech_cal == "a") && (
                        <>
                        <div className="col-span-12 md:col-span-6 lg:col-span-6" id="m">
                       ...
                       {(formData.tech_cal == "f" || formData.tech_cal == "m") && (
                        <>
                        <div className="col-span-12 md:col-span-6 lg:col-span-6" id="a">
             ...
             {formData.tech_unit_type == "m2" && (
              <>
              <div className="col-span-12">
                  <div className="grid grid-cols-12  inp_wrap gap-4" id="inp_wraps">
                      <div className="col-span-12">
                          ...
                          <div className="mt-2">
                            <select
                              ...
                              onChange={handleChange}
                            >
                              <option value="yes">{data?.payload?.tech_lang_keys["8"]}</option>
                              <option value="no">{data?.payload?.tech_lang_keys["9"]}</option>
                            </select>
                          </div>
                            ...
                            <div className="mt-2 overflow-auto">
                              ...
                              {formData?.tech_cal === 'f' && (
                                <>
                                  ...
                                  <BlockMath math={`F = ${result?.tech_m} \\, kg \\times ${result?.tech_a} \\, m/s^2`} />
                                  <BlockMath math={`F = ${(result?.tech_m * result?.tech_a).toExponential(7)} \\, N`} />
                                </>
                              )}
                              {formData?.tech_cal === 'm' && (
                                <>
                                  <BlockMath math={`m = \\frac{F}{a}`} />
                                  <BlockMath math={`m = \\frac{${result?.tech_f} \\, N}{${result?.tech_a} \\, m/s^2}`} />
                                  <BlockMath math={`m = ${(result?.tech_f / result?.tech_a).toFixed(10)} \\, kg`} />
                                </>
                              )}
                              {formData?.tech_cal === 'a' && (
                                <>
                                  <BlockMath math={`a = \\frac{F}{m}`} />
                                  <BlockMath math={`a = \\frac{${result?.tech_f} \\, N}{${result?.tech_m} \\, kg}`} />
                                  <BlockMath math={`a = ${(result?.tech_f / result?.tech_m).toFixed(3)} \\, m/s^2`} />
                                </>
                              )}
                            </div>
                          </>
                            ...
                            <div className="w-full md:w-[80%] lg:w-[60%] overflow-auto mt-2">
                              <table className="w-full text-[16px]">
                                <tbody>
                                  <tr>
                                    <td className="py-2 border-b" width="40%">
                                      <strong>{data?.payload?.tech_lang_keys[14]} (n)</strong>
                                    </td>
                                    <td className="py-2 border-b">{result?.tech_nf} N</td>
                                  </tr>
                                </tbody>
                              </table>
                            </div>
                            ...
                            <div className="mt-2 overflow-auto">
                              ...
                              {formData?.tech_question === 'yes' ? (
                                <>
                                  ...
                                  <BlockMath math={`n = ${formData?.tech_a_f} + ${formData?.tech_g_f}`} />

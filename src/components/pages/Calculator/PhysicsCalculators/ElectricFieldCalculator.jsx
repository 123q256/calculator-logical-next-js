          ...
          <div className="w-full mx-auto p-4 lg:p-8 md:p-8 bg-white rounded-lg shadow-md space-y-6 mb-3">
           ...
           <div class="grid grid-cols-12  gap-4">
               ...
               <div class="col-span-12 md:col-span-6 lg:col-span-6">
                 ...
                 {((formData.tech_selection == "1" && formData.tech_selection3 == "1") || (formData.tech_selection == "1" && formData.tech_selection3 == "2") || (formData.tech_selection == "2")) && (
                  <>
               <div class="col-span-6 charge" id="charge">
                      {(formData.tech_selection == "2") ? (
                        <>
                        <label htmlFor="tech_charge" className="label" >{ data?.payload?.tech_lang_keys["7"]} 1</label>
                        </>
                      ):(
                        <>
                        <label htmlFor="tech_charge" className="label" >{ data?.payload?.tech_lang_keys["7"]} </label>
                        </>
                      )}
                ...
                {((formData.tech_selection == "1" && formData.tech_selection3 == "1") || (formData.tech_selection == "1" && formData.tech_selection3 == "3") || (formData.tech_selection == "2")) && (
                  <>
                  
               <div class="col-span-6 distance" id="distance">
                 {(formData.tech_selection == "2") ? (
                        <>
                         <label htmlFor="tech_distance" className="label" >{ data?.payload?.tech_lang_keys["6"]} 1</label>
                        </>
                      ):(
                        <>
                        <label htmlFor="tech_distance" className="label" >{ data?.payload?.tech_lang_keys["6"]} </label>
                        </>
                      )}
                  ...
                  {((formData.tech_selection == "1" && formData.tech_selection3 == "2") || (formData.tech_selection == "1" && formData.tech_selection3 == "3")) && (
                  <>
                ...
                {formData.tech_selection == "2" && (
                  ...
                  <div className="col-span-12">
                          ...
                          <div className="col-span-6">
                            ...
                            <div className="relative w-full">
                              <input
                                ...
                                placeholder="00"
                                onChange={(e) => handleChange(e, index, "tech_charge1")}
                              />
                              <label
                                className="absolute cursor-pointer text-sm underline right-6 top-3"
                              ...
                              {dropdownVisible[index] && (
                                <div className="absolute z-10 bg-white border border-gray-300 rounded-md w-auto mt-1 right-0">
                                  {["PC", "NC", "μC", "mC", "C", "e"].map((unit, i) => (
                                    <p
                                      key={i}
                                      className="p-2 hover:bg-gray-100 cursor-pointer"
                                      onClick={() => setUnitHandler(index, "tech_charge_unit", unit)}
                                    >
                                      {unit}
                                    </p>
                                  ))}
                          ...
                          <div className="col-span-6">
                              ...
                              {formData.tech_charge1.length > 1 && (
                                <div className="col-span-12 flex justify-end mt-2">
                                  <img src="/images/delete_btn.png" alt="delete" className="h-4 w-4"  onClick={() => removeRow(index)}/>
                                </div>
                              )}
                                </div>
                            ...
                            <div className="relative w-full">
                              <input
                                ...
                                placeholder="00"
                                onChange={(e) => handleChange(e, index, "tech_distance1")}
                              />
                              <label
                                className="absolute cursor-pointer text-sm underline right-6 top-3"
                              ...
                              {dropdownVisible1[index] && (
                                <div className="absolute z-10 bg-white border border-gray-300 rounded-md w-auto mt-1 right-0">
                                  {["nm", "μm", "mm", "cm", "m", "km", "in", "ft", "yd", "mi"].map(
                                    (unit, i) => (
                                      <p
                                        key={i}
                                        className="p-2 hover:bg-gray-100 cursor-pointer"
                                        onClick={() =>
                                          setUnitHandler1(index, "tech_distance_unit", unit)
                                        }
                                      >
                                        {unit}
                                      </p>
                      ...
                      <div className="col-12 d-flex px-2 mt-5">
                        <button
                          type="button"
                          className="bg-[#99EA48] border rounded px-4 py-2 me-2"
                          onClick={addRow}
                        >
                          <strong className="text-blue">+ {data?.payload?.tech_lang_keys[9]}</strong>
                        </button>
                      </div>
                    </div>
                  </>
                              ...
                              <div class="w-full ">
                                 ...
                                 {result?.tech_answer && (
                                  <div className="text-center overflow-auto">
                                    ...
                                    <p className="text-[21px] bg-sky-100 px-3 py-3 my-3">
                                      <strong className="text-blue">{result?.tech_answer} (N/C)</strong>
                                    </p>
                                  </div>
                                )}
                                ...
                                {result?.tech_answer1 && (
                                  <div className="text-center overflow-auto">
                                    ...
                                    <p className="text-[21px] bg-sky-100 px-3 py-3 my-3">
                                      <strong className="text-blue">{result?.tech_answer1} (m)</strong>
                                    </p>
                                  </div>
                                )}
                                ...
                                {result?.tech_answer2 && (
                                  <div className="text-center overflow-auto">
                                    ...
                                    <p className="text-[21px] bg-sky-100 px-3 py-3 my-3">
                                      <strong className="text-blue">{result?.tech_answer2} (c)</strong>
                                    </p>
                                  </div>
                                )}
                                ...
                                {result?.tech_answer3 && (
                                  <div className="text-center overflow-auto">
                                    ...
                                    <p className="text-[21px] bg-sky-100 px-3 py-3 my-3">
                                      <strong className="text-blue">{result?.tech_answer3} (N/C)</strong>
                                    </p>
                                  </div>
                                )}

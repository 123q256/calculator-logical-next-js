...
const ChangeInMomentumCalculator = () => {
  ...
  const setUnitHandler3 = (unit) => {
    setFormData((prev) => ({ ...prev, tech_chnage_velocity: unit }));
            ...
            <div className="grid grid-cols-12 mt-3  gap-4">
              ...
              <div className="col-span-12  px-2 mt-0 mt-lg-2">
                {formData.tech_operation == "1" && (
                  <>
                    <p className="col s12 font_s28 black-text txt" id="math_s">
                ...
                {formData.tech_operation == "3" && (
                  <>
                    <p className="col s12 font_s28 black-text txt " id="math_t">
                      <b className="col s12 center">
              ...
              {formData.tech_operation == "1" && (
                <>
                  <div className="col-span-6 i_velocity">
              ...
              {formData.tech_operation == "1" && (
                <>
                  <div className="col-span-6 f_velocity">
              ...
              {formData.tech_operation == "2" && (
                <>
                  <div className="col-span-6 chnage_velocity ">
                ...
                <div>
                  ...
                  <div className="rounded-lg  flex items-center justify-center">
                    <div className="w-full mt-3">
                      {formData?.tech_operation == "1" ? (
                        <>
                          <div className="w-full md:w-[90%] lg:w-[90%] overflow-auto mt-2">
                            <table className="w-full lg:text-[18px] md:text-[18px] text-[16px]">
                              ...
                              <tr>
                                ...
                                <td className="py-2 border-b">
                                  {" "}
                                  {Number(result?.tech_final_momentum).toFixed(
                                    2
                                  )}{" "}
                                  Ns
                                </td>

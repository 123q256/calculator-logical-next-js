    ...
    >
      <form className="row" onSubmit={handleSubmit}>
        <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg  space-y-6 mb-3">
          ...
          <div class="lg:w-[70%] md:w-[98%] w-full mx-auto ">
            <div class="grid grid-cols-12 mt-3  gap-4">
                      ...
                      <div class="lg:col-span-4 md:col-span-4 col-span-6">
                        <div class=" relative">
                          <input
                            ...
                            onChange={handleChange}
                          />
                          <span class="input_unit">j</span>
                        </div>
                      </div>
                      {formData.tech_dem == "3" && (
                        <>
                          <div class="lg:col-span-4 md:col-span-4 col-span-6 third_one">
                            <div class=" relative">
                              <input
                                type="number"
                                step="any"
              ...
              {formData.tech_vector_representation == "point" && (
                <>
                  <div class="lg:col-span-8 md:col-span-8 col-span-12 a_one">
                    <div class="grid grid-cols-12 gap-4">
                      <p class="col-span-12">
                        <strong class="label">
                          {data?.payload?.tech_lang_keys[2]} (a)
                  ...
                  {formData.tech_dem == "3" && (
                    <>
                      <div class="md:col-span-4 col-span-12  a_two">
                        <p class="col-12 mx-2 mt-2">&nbsp;</p>
                        <div class="w-full py-2">
                          <label for="tech_3a" class="label">
                            &nbsp;
                          </label>
                          <div class=" relative">
                            <input
                  ...
                  <div class="lg:col-span-8 md:col-span-8 col-span-12 a_three">
                    <div class="grid grid-cols-12 gap-4">
                      <div class="lg:col-span-6 md:col-span-6 col-span-12  ">
                        <label for="tech_1b" class="label">
                  ...
                  {formData.tech_dem == "3" && (
                    <>
                      <div class="md:col-span-4 col-span-12 px-2 a_four">
                        <div class="w-full ">
                          <label for="tech_3b" class="label">
                            &nbsp;
                          </label>
                          <div class=" relative">
                            <input
                ...
                <>
                  <div class="col-span-12 b_coor">
                    <div class="grid grid-cols-12 gap-4">
                      ...
                      {formData.tech_dem == "3" && (
                        <>
                          <div class="lg:col-span-4 md:col-span-4 col-span-6  tw">
                            <div class=" relative">
                              <input
                                type="number"
                                step="any"
              ...
              {formData.tech_vector_b == "point" && (
                <>
                  <div class="lg:col-span-8 md:col-span-8 col-span-12 b_one">
                    <div class="grid grid-cols-12 gap-4">
                      <p class="col-span-12">
                        <strong class="label">
                          {data?.payload?.tech_lang_keys[8]} (b)
                      ...
                      <div class="lg:col-span-6 md:col-span-6 col-span-12  ">
                        <label for="tech_2aa" class="label">
                          &nbsp;
                        </label>
                        <div class=" relative">
                          <input
                  ...
                  {formData.tech_dem == "3" && (
                    <>
                      <div class="md:col-span-4 col-span-12 px-2 b_two">
                        <p class="lg:col-span-6 md:col-span-6 col-span-12 ">&nbsp;</p>
                        <div class="w-full mt-3 ">
                          <label for="tech_3aa" class="label">
                            &nbsp;
                          </label>
                          <div class=" relative">
                            <input
                  ...
                  <div class="lg:col-span-8 md:col-span-8 col-span-12 b_three">
                    <div class="grid grid-cols-12 gap-4">
                      <div class="lg:col-span-6 md:col-span-6 col-span-12  ">
                        <label for="tech_1bb" class="label">
                      ...
                      <div class="lg:col-span-6 md:col-span-6 col-span-12  ">
                        <label for="tech_2bb" class="label">
                          &nbsp;
                        </label>
                        <div class=" relative">
                          <input
                  ...
                  {formData.tech_dem == "3" && (
                    <>
                      <div class="md:col-span-4 col-span-12 px-2 b_four">
                        <div class="w-full ">
                          <label for="tech_3bb" class="label">
                            &nbsp;
                          </label>
                          <div class=" relative">
                            <input

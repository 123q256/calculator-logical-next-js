...
// currency code
 ...
 const [isOpen, setIsOpen] = useState(false);
  ...
  useEffect(() => {
    ...
    setDensVal(val);
  }, [densLokUnt, densLokCat, densCatMtl, densCatMtlNo, densCatGas, densCatLqd, densCatAstr]);
    ...
    >
        <form className="row" onSubmit={handleSubmit}>
          ...
          <div className="col-12  mx-auto mt-2  w-full"> 
            <div className="col-lg-2 font-s-14 hidden d-lg-block">{data?.payload?.tech_lang_keys['3']}:</div>
             <input
                  type="hidden"
                  name="tech_to_cals"
                  id="calculator_time"
                ...
                <div className="flex flex-wrap items-center bg-blue-100 border border-blue-500 text-center rounded-lg px-1">
                  ...
                  <div className="grid grid-cols-12   mt-3  gap-4">
                      ...
                      <div className="col-span-12">
                          <div className="grid grid-cols-12 gap-4">
                            {formData.tech_to_cals == "density" && (
                              <>
                              <div className="col-span-12 md:col-span-6 lg:col-span-6" id="dens_unt">
                                  ...
                                  <div className="mt-2">
                                    ...
                                    >
                                        {[
                                        "kg/m³", "kg/dm³", "kg/L", "g/mL", "t/m³", "g/cm³",
                                        "oz/cu_in", "lb/cu_in", "lb/cu_ft", "lb/cu_yd",
                                        "lb/us_gal", "g/l", "g/dl", "mg/l"
                                      ].map((unit, index) => (
                              ...
                              <>
                              <div className="col-span-12 md:col-span-6 lg:col-span-6" id="volu_unt">
                              ...
                              <>
                              <div className="col-span-12 md:col-span-6 lg:col-span-6" id="mass_unt">
                    ...
                    <div className="col-span-12">
                        <div className="grid grid-cols-12 gap-4">
                            {(formData.tech_to_cals == "volume" || formData.tech_to_cals == "mass") && (
                              <>
                              <div className="col-span-12 md:col-span-6 lg:col-span-6" id="dens_blk_dns">
                              ...
                              {(formData.tech_to_cals == "density"  || formData.tech_to_cals == "mass") && (
                              <>
                              <div className="col-span-12 md:col-span-6 lg:col-span-6" id="dens_blk_vol">
                          ...
                          {(formData.tech_to_cals == "density" || formData.tech_to_cals == "volume") && (
                              <>
                              <div className="col-span-12 md:col-span-6 lg:col-span-6" id="dens_blk_mas">
                                <label htmlFor="tech_vol" className="label">
                                    {data?.payload?.tech_lang_keys["6"]}:
                                      </label>
                                  <div className="grid grid-cols-12 gap-4">
             ...
             {/* Clickable header with arrow */}
              ...
              >
                <strong className="text-[16px]">{data?.payload?.tech_lang_keys["14"]}</strong>
                <img
              ...
              >
                <div className="grid grid-cols-12 gap-4 border pb-2 p-3">
              {/* Unit Selector */}
              <div className="col-span-12" id="dens_lok_unt">
                <p className="label">{data?.payload?.tech_lang_keys["7"]}</p>
                <select
                  className="input dens_lok_answer"
                  aria-label="select"
                  name="tech_dens_lok_unt"
                  id="tech_dens_lok_unt"
                value={densLokUnt} onChange={(e) => setDensLokUnt(e.target.value)}
                >
              ...
              <div className="col-span-4" id="dens_lok_cat">
                <p className="label">{data?.payload?.tech_lang_keys["15"]}</p>
                <select
                  className="input dens_lok_answer mt-3"
                  aria-label="select"
                  name="tech_slcat"
                  id="tech_slcat"
                    value={densLokCat }  onChange={(e) => setDensLokCat(e.target.value)}
                >
                  <option value="metals">{data?.payload?.tech_lang_keys["17"]}</option>
                  <option value="non-metals">{data?.payload?.tech_lang_keys["18"]}</option>
                  <option value="gases">{data?.payload?.tech_lang_keys["19"]}</option>
                  <option value="liquids">{data?.payload?.tech_lang_keys["20"]}</option>
                  <option value="astronomy">{data?.payload?.tech_lang_keys["21"]}</option>
                </select>
              </div>
                ...
                {densLokCat  === "metals" && (
                  <div className="col-span-8" id="dens_cat_mtl">
                    <div className="col m8 s8 unit_h paddings_rl20_10">
                      <p className="label">{data?.payload?.tech_lang_keys["16"]}</p>
                      <select
                        className="input dens_lok_answer"
                        aria-label="select"
                        name="tech_slmtl"
                        id="tech_slmtl"
                       value={densCatMtl} onChange={(e) => setDensCatMtl(e.target.value)}
                      >
                        <option value="aluminum">{data?.payload?.tech_lang_keys["22"]}</option>
                        <option value="beryllium">{data?.payload?.tech_lang_keys["23"]}</option>
                        <option value="brass">{data?.payload?.tech_lang_keys["24"]}</option>
                        <option value="copper">{data?.payload?.tech_lang_keys["25"]}</option>
                        <option value="gold">{data?.payload?.tech_lang_keys["26"]}</option>
                        <option value="iron">{data?.payload?.tech_lang_keys["27"]}</option>
                        <option value="lead">{data?.payload?.tech_lang_keys["28"]}</option>
                        <option value="magnesium">{data?.payload?.tech_lang_keys["29"]}</option>
                        <option value="mercury">{data?.payload?.tech_lang_keys["30"]}</option>
                        <option value="nickel">{data?.payload?.tech_lang_keys["31"]}</option>
                        <option value="platium">{data?.payload?.tech_lang_keys["32"]}</option>
                        <option value="plutonium">{data?.payload?.tech_lang_keys["33"]}</option>
                        <option value="potassium">{data?.payload?.tech_lang_keys["34"]}</option>
                        <option value="silver">{data?.payload?.tech_lang_keys["35"]}</option>
                        <option value="sodium">{data?.payload?.tech_lang_keys["36"]}</option>
                        <option value="tin">{data?.payload?.tech_lang_keys["37"]}</option>
                        <option value="titanium">{data?.payload?.tech_lang_keys["38"]}</option>
                        <option value="uranium">{data?.payload?.tech_lang_keys["39"]}</option>
                        <option value="zinc">{data?.payload?.tech_lang_keys["40"]}</option>
                      </select>
                    </div>
                  </div>
                )}
                ...
                {densLokCat  === "non-metals" && (
                  <div className="col-span-8 ps-2" id="dens_cat_mtl_no">
                    <div className="col m8 s8 unit_h paddings_rl20_10">
                      <p className="text-blue font-s-14 pb-2">{data?.payload?.tech_lang_keys["16"]}</p>
                      <select
                        name="tech_slmtl_no"
                        className="input dens_lok_answer"
                     value={densCatMtlNo} onChange={(e) => setDensCatMtlNo(e.target.value)}
                      >
                        <option value="concrete">{data?.payload?.tech_lang_keys["41"]}</option>
                        <option value="cork">{data?.payload?.tech_lang_keys["42"]}</option>
                        <option value="diamond">{data?.payload?.tech_lang_keys["43"]}</option>
                        <option value="ice">{data?.payload?.tech_lang_keys["44"]}</option>
                        <option value="nylon">{data?.payload?.tech_lang_keys["45"]}</option>
                        <option value="oak">{data?.payload?.tech_lang_keys["46"]}</option>
                        <option value="pine">{data?.payload?.tech_lang_keys["47"]}</option>
                        <option value="plastics">{data?.payload?.tech_lang_keys["48"]}</option>
                        <option value="styrofoam">{data?.payload?.tech_lang_keys["49"]}</option>
                        <option value="wood">{data?.payload?.tech_lang_keys["50"]}</option>
                      </select>
                    </div>
                  </div>
                )}
                  ...
                  <div className="col-span-8 ps-2" id="dens_cat_gas">
                    <div className="col m8 s8 unit_h paddings_rl20_10">
                      ...
                      <select
                        name="tech_slgas"
                        className="input dens_lok_answer"
                       value={densCatGas} onChange={(e) => setDensCatGas(e.target.value)}
                      >
                        <option value="air0">{data?.payload?.tech_lang_keys["51"]}</option>
                        <option value="air20">{data?.payload?.tech_lang_keys["52"]}</option>
                        <option value="carbon_dioxide0">{data?.payload?.tech_lang_keys["53"]}</option>
                        <option value="carbon_dioxide20">{data?.payload?.tech_lang_keys["54"]}</option>
                        <option value="carbon_monoxide0">{data?.payload?.tech_lang_keys["55"]}</option>
                        <option value="carbon_monoxide20">{data?.payload?.tech_lang_keys["56"]}</option>
                        <option value="hydrogen">{data?.payload?.tech_lang_keys["57"]}</option>
                        <option value="helium">{data?.payload?.tech_lang_keys["58"]}</option>
                        <option value="methane0">{data?.payload?.tech_lang_keys["59"]}</option>
                        <option value="methane20">{data?.payload?.tech_lang_keys["60"]}</option>
                        <option value="nitrogen0">{data?.payload?.tech_lang_keys["61"]}</option>
                        <option value="nitrogen20">{data?.payload?.tech_lang_keys["62"]}</option>
                        <option value="oxygen0">{data?.payload?.tech_lang_keys["63"]}</option>
                        <option value="oxygen20">{data?.payload?.tech_lang_keys["64"]}</option>
                        <option value="propane20">{data?.payload?.tech_lang_keys["65"]}</option>
                        <option value="water_vapor">{data?.payload?.tech_lang_keys["66"]}</option>
                      </select>
                    </div>
                  </div>
                )}
                  ...
                  <div className="col-span-8 ps-2" id="dens_cat_lqd">
                    <div className="col m8 s8 unit_h paddings_rl20_10">
                      ...
                      <select
                        name="tech_sllqd"
                        className="input dens_lok_answer"
                       value={densCatLqd} onChange={(e) => setDensCatLqd(e.target.value)}
                      >
                        <option value="cooking_oil">{data?.payload?.tech_lang_keys["67"]}</option>
                        <option value="liquid_hydrogen">{data?.payload?.tech_lang_keys["68"]}</option>
                        <option value="liquid_oxygen">{data?.payload?.tech_lang_keys["69"]}</option>
                        <option value="water_fresh">{data?.payload?.tech_lang_keys["70"]}</option>
                        <option value="water_salt">{data?.payload?.tech_lang_keys["71"]}</option>
                      </select>
                    </div>
                  </div>
                )}
                  ...
                  <div className="col-span-8 ps-2" id="dens_cat_astr">
                    <div className="col m8 s8 unit_h paddings_rl20_10">
                      ...
                      <select
                        name="tech_slastr"
                        className="input dens_lok_answer"
                      value={densCatAstr} onChange={(e) => setDensCatAstr(e.target.value)}
                      >
                        <option value="earth">{data?.payload?.tech_lang_keys["72"]}</option>
                        <option value="earth_core">{data?.payload?.tech_lang_keys["73"]}</option>
                        <option value="sun_core_min">{data?.payload?.tech_lang_keys["74"]}</option>
                        <option value="sun_core_max">{data?.payload?.tech_lang_keys["75"]}</option>
                        <option value="super_black_hole">{data?.payload?.tech_lang_keys["76"]}</option>
                        <option value="dwarf_star">{data?.payload?.tech_lang_keys["77"]}</option>
                        <option value="atomic_nuclei">{data?.payload?.tech_lang_keys["78"]}</option>
                        <option value="neutron_star">{data?.payload?.tech_lang_keys["79"]}</option>
                        <option value="stellar_black_hole">{data?.payload?.tech_lang_keys["80"]}</option>
                      </select>
                    </div>
                  </div>
                )}
              {/* Result Display */}
              <p className="col-span-12 ps-2 text-center text-blue">{data?.payload?.tech_lang_keys["res"]}</p>
              <div className="col-span-12 ps-2 text-center mt-3 bg-sky p-2 bordered rounded-lg" id="dens_lok_ans">
                <p className="text-[18px] pt-2">
                  <strong>{data?.payload?.tech_lang_keys["4"]}</strong>
                </p>
                <p className="text-[32px] px-3 py-2 d-inline-block my-2">
                  <strong className="text-blue dens_lok_ansr">  {densVal !== null ? `${densVal} ${densLokUnt}` : "Select options to see density"}</strong>
                </p>
              </div>
            </div>
              </div>
                          ...
                          <div className="col s12 s12 dnsty_wrap">
                            <div className="text-center">
                              ...
                              <p className="md:text-[25px] text-[18px] bg-[#2845F5] text-white rounded-lg px-3 py-2 inline-block my-3 wrap_dnst">
                                <strong className="text-blue">{result?.tech_ansval}</strong>
                              </p>
                            </div>
                                  ...
                                  <table className="w-100 disp_tbl">
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td className="border-b py-2">{result?.ansval3}</td>
                                      </tr>
                                    </tbody>
                                  </table>
                                </div>
                                  ...
                                  <table className="w-100 disp_tbl">
                                    <tbody>
                                      <tr>
                                        ...
                                        <td className="border-b py-2">{result?.tech_mass}</td>
                                      </tr>
                                      <tr>
                                        <td className="border-b py-2 font-semibold">
                                          {data?.payload?.tech_lang_keys["11"]}:
                                        </td>
                                        <td className="border-b py-2">{result?.tech_lngt}</td>
                                      </tr>
                                      <tr>
                                        <td className="border-b py-2 font-semibold">
                                          {data?.payload?.tech_lang_keys["12"]}:
                                        </td>
                                        <td className="border-b py-2">{result?.tech_wdth}</td>
                                      </tr>
                                      <tr>
                                        <td className="border-b py-2 font-semibold">
                                          {data?.payload?.tech_lang_keys["13"]}:
                                        </td>
                                        <td className="border-b py-2">{result?.tech_hgth}</td>
                                      </tr>
                                      <tr>
                                        <td className="border-b py-2 font-semibold">
                                          {data?.payload?.tech_lang_keys["5"]}:
                                        </td>
                                        <td className="border-b py-2">{result?.tech_vlme}</td>
                                      </tr>
                                      <tr>
                                        <td className="border-b py-2 font-semibold">
                                          {data?.payload?.tech_lang_keys["81"]}:

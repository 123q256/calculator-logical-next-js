          ...
          <div class="lg:w-[60%] md:w-[80%] w-full mx-auto ">
            <div class="grid grid-cols-12 mt-3  gap-4">
              ...
              {(formData.tech_selection == "1" ||
                ...
                <>
                  <div class="col-span-12 md:col-span-6 const">
                    ...
                    <div class=" relative">
                      <input
                        ...
                        onChange={handleChange}
                      />
                      <span class="input_unit">N/m</span>
                    </div>
                  </div>
                </>
              )}
              {(formData.tech_selection == "1" ||
                ...
                <>
                  <div class="col-span-12 md:col-span-6 dis">
              ...
              {(formData.tech_selection == "2" ||
                formData.tech_selection == "3") && (
                <>
                  <div class="col-span-12 md:col-span-6  force">

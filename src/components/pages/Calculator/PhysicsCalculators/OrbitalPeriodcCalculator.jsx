                        ...
                        <div className="w-full md:w-[80%] lg:w-[60%]  overflow-auto">
                          <table className="w-full lg:text-[18px] md:text-[18px] text-[16px]">
                            ...
                            <tr>
                              ...
                              <td className="p-2 border-b">
                                <strong className="text-blue">
                                  {Number(result?.tech_answer * 60).toFixed(2)}
                                </strong>
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td className="p-2 border-b">
                                <strong className="text-blue">
                                  {Number(result?.tech_answer / 24).toFixed(2)}
                                </strong>
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td className="p-2 border-b">
                                <strong className="text-blue">
                                  {Number(result?.tech_answer / 168).toFixed(2)}
                                </strong>
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td className="p-2 border-b">
                                <strong className="text-blue">
                                  {Number(result?.tech_answer / 730).toFixed(2)}
                                </strong>
                              </td>
                            </tr>
                            <tr>
                        ...
                        <div className="w-full md:w-[80%] lg:w-[60%]  overflow-auto">
                          <table className="w-full lg:text-[18px] md:text-[18px] text-[16px]">
                            ...
                            <tr>
                              ...
                              <td className="p-2 border-b">
                                <strong className="text-blue">
                                  {Number(result?.tech_sub_answer * 60).toFixed(
                                    2
                                  )}
                                </strong>
                              </td>
                            ...
                            <tr>
                              ...
                              <td className="p-2 border-b">
                                <strong className="text-blue">
                                  {Number(result?.tech_sub_answer / 24).toFixed(
                                    2
                                  )}
                                </strong>
                              </td>

...
// result
 ...
 const getLabel = () => {
    if (result?.tech_work || result?.tech_work1 || result?.tech_work2) return data?.payload?.tech_lang_keys['6'];
  ...
  const getValue = () => {
    if (result?.tech_work || result?.tech_work1 || result?.tech_work2) return `${result?.tech_w} J`;
          ...
          <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg shadow-md space-y-6 mb-3">
            {formError && (
              ...
              <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
                          ...
                          <div className="space-y-2 method1">
                              ...
                              <div className="mt-2">
                                <select
                                  ...
                                  onChange={handleChange}
                                >
                                  <option value="fnd">{data?.payload?.tech_lang_keys["2"]} & {data?.payload?.tech_lang_keys["3"]}</option>
                                  <option value="velocity">{data?.payload?.tech_lang_keys["4"]}</option>
                                </select>
                              </div>
                          </div>
                        </>
                  ...
                  {(formData.tech_method1 == "fnd" && formData.tech_method == "work" ) && (
                    <>
                  ...
                  {formData.tech_method == "power" && (
                    ...
                    {(formData.tech_method1 == "velocity" && formData.tech_method == "work"  && formData.tech_method == "work" ) && (
                    <>
                  ...
                  <div className="grid grid-cols-2  lg:grid-cols-2 md:grid-cols-2  gap-4">
                      ...
                      {(formData.tech_find != "force" && formData.tech_method1 == "fnd"  && formData.tech_method == "work" ) && (
                        <>
                       ...
                       {(formData.tech_find != "dsplcmnt" && formData.tech_method1 == "fnd"  && formData.tech_method == "work" ) && (
                        <>
                      <div className="space-y-2" id="ds">
                        ...
                        {((formData.tech_find2 == "work2" || formData.tech_find2 == "v0" || formData.tech_find2 == "v1" ) && (formData.tech_method1 == "velocity" ) && ( formData.tech_method == "work")) && (
                        <>
                      <div className="space-y-2 " id="ms">
                        ...
                        {((formData.tech_find2 == "work2" || formData.tech_find2 == "v1" || formData.tech_find2 == "mass" ) && (formData.tech_method1 == "velocity" ) && ( formData.tech_method == "work")) && (
                        <>
                        ...
                        {((formData.tech_find2 == "work2" || formData.tech_find2 == "v0" || formData.tech_find2 == "mass" ) && (formData.tech_method1 == "velocity" ) && ( formData.tech_method == "work")) && (
                        <>
                          ...
                          <>
                            {(
                              (
                                ...
                                (formData.tech_find1 !== "work1" && formData.tech_method === "power") 
                              ) && (
                                <>
                                <div className="space-y-2" id="ws">
                       ...
                       {(
                        (formData.tech_find1 == "work1" || formData.tech_find1 == "time") &&
                        formData.tech_method == "power"
                      ) && (
                        <>
                        ...
                        {((formData.tech_find1 == "work1" ||  formData.tech_find1 == "power")   && formData.tech_method == "power" ) && (
                        <>
                  ...
                  <div>
                    ...
                    <div className="w-full radius-10 mt-3">
                        ...
                        <div className="w-full text-[14px] md:text-[18px]">
                          ...
                          {result?.tech_work && (
                            <>
                              <p className="mt-2"><strong>{data?.payload?.tech_lang_keys['13']}</strong></p>
                              <p className="mt-2">W = F * D</p>
                              <p className="mt-2"><strong>{data?.payload?.tech_lang_keys['14']}</strong></p>
                              <p className="mt-2">F = {result?.tech_f}, D = {result?.tech_d}, W = ?</p>
                              <p className="mt-2"><strong>{data?.payload?.tech_lang_keys['15']}</strong></p>
                              <p className="mt-2">W = F * D</p>
                              <p className="mt-2">W = {result?.tech_f} * {result?.tech_d}</p>
                              <p className="mt-2">W = <strong>{result?.tech_w}</strong></p>
                            </>
                          )}
                          ...
                          {result?.tech_force && (
                            <>
                              ...
                              <p className="mt-2"><strong>{data?.payload?.tech_lang_keys['14']}</strong></p>
                              <p className="mt-2">W = {result?.tech_w}, D = {result?.tech_d}, F = ?</p>
                              <p className="mt-2"><strong>{data?.payload?.tech_lang_keys['15']}</strong></p>
                              <p className="mt-2">F = W / D</p>
                              <p className="mt-2">F = {result?.tech_w} / {result?.tech_d}</p>
                              <p className="mt-2">F = <strong>{result?.tech_f}</strong></p>
                            </>
                          )}
                          ...
                          {result?.tech_dsplcmnt && (
                            <>
                              ...
                              <p className="mt-2"><strong>{data?.payload?.tech_lang_keys['14']}</strong></p>
                              <p className="mt-2">W = {result?.tech_w}, F = {result?.tech_f}, D = ?</p>
                              <p className="mt-2"><strong>{data?.payload?.tech_lang_keys['15']}</strong></p>
                              <p className="mt-2">D = W / F</p>
                              <p className="mt-2">D = {result?.tech_w} / {result?.tech_f}</p>
                              <p className="mt-2">D = <strong>{result?.tech_d}</strong></p>
                            </>
                          )}
                          ...
                          {result?.tech_work1 && (
                            <>
                              ...
                              <p className="mt-2"><strong>{data?.payload?.tech_lang_keys['14']}</strong></p>
                              <p className="mt-2">m = {result?.tech_f}, v₀ = {result?.tech_v0}, v₁ = {result?.tech_v1}, W = ?</p>
                              <p className="mt-2"><strong>{data?.payload?.tech_lang_keys['15']}</strong></p>
                              <p className="mt-2">W = (m/2) * (v₁² - v₀²)</p>
                              <p className="mt-2">W = ({result?.tech_m} / 2) * (({result?.tech_v1})² - ({result?.tech_v0})²)</p>
                              <p className="mt-2">W = ({result?.tech_s1}) * ({result?.tech_s2} - {result?.tech_s3})</p>
                              <p className="mt-2">W = ({result?.tech_s1}) * ({result?.tech_s4})</p>
                              <p className="mt-2">W = <strong>{result?.tech_w}</strong></p>
                            </>
                          )}
                          ...
                          {result?.tech_i_v && (
                            <>
                              ...
                              <p className="mt-2"><strong>{data?.payload?.tech_lang_keys['14']}</strong></p>
                              <p className="mt-2">w = {result?.tech_w}, m = {result?.tech_m}, v₁ = {result?.tech_v1}, v₀ = ?</p>
                              <p className="mt-2"><strong>{data?.payload?.tech_lang_keys['15']}</strong></p>
                              <p className="mt-2">v₀ = √({result?.tech_v1}² - ((2/{result?.tech_m}) * {result?.tech_w}))</p>
                              <p className="mt-2">v₀ = √({result?.tech_s1} - {result?.tech_s2} * {result?.tech_w})</p>
                              <p className="mt-2">v₀ = √({result?.tech_s4})</p>
                              <p className="mt-2">v₀ = <strong>{result?.tech_v0}</strong></p>
                            </>
                          )}
                          ...
                          {result?.tech_f_v && (
                            <>
                              ...
                              <p className="mt-2">v₁ = √(v₀² + (2/m * w))</p>
                              <p className="mt-2"><strong>{data?.payload?.tech_lang_keys['14']}</strong></p>
                              <p className="mt-2">w = {result?.tech_w}, m = {result?.tech_m}, v₀ = {result?.tech_v0}, v₁ = ?</p>
                              <p className="mt-2"><strong>{data?.payload?.tech_lang_keys['15']}</strong></p>
                              <p className="mt-2">v₁ = √({result?.tech_v0}² + ((2/{result?.tech_m}) * {result?.tech_w}))</p>
                              <p className="mt-2">v₁ = √({result?.tech_s1} + {result?.tech_s2} * {result?.tech_w})</p>
                              <p className="mt-2">v₁ = √({result?.tech_s4})</p>
                              <p className="mt-2">v₁ = <strong>{result?.tech_v1}</strong></p>
                            </>
                          )}
                          ...
                          {result?.tech_mass && (
                            <>
                              ...
                              <p className="mt-2"><strong>{data?.payload?.tech_lang_keys['14']}</strong></p>
                              <p className="mt-2">w = {result?.tech_w}, v₀ = {result?.tech_v0}, v₁ = {result?.tech_v1}, m = ?</p>
                              <p className="mt-2"><strong>{data?.payload?.tech_lang_keys['15']}</strong></p>
                              <p className="mt-2">m = (2 * {result?.tech_w}) / (({result?.tech_v1})² - ({result?.tech_v0})²)</p>
                              <p className="mt-2">m = {result?.tech_s1} / ({result?.tech_s2} - {result?.tech_s3})</p>
                              <p className="mt-2">m = {result?.tech_s1} / {result?.tech_s4}</p>
                              <p className="mt-2">m = <strong>{result?.tech_m}</strong></p>
                            </>
                          )}
                          ...
                          {result?.tech_power && (
                            <>
                              ...
                              <p className="mt-2"><strong>{data?.payload?.tech_lang_keys['14']}</strong></p>
                              <p className="mt-2">W = {result?.tech_w}, T = {result?.tech_t}, P = ?</p>
                              <p className="mt-2"><strong>{data?.payload?.tech_lang_keys['15']}</strong></p>
                              <p className="mt-2">P = {result?.tech_w} / {result?.tech_t}</p>
                              <p className="mt-2">P = <strong>{result?.tech_p}</strong></p>
                            </>
                          )}
                          ...
                          {result?.tech_work2 && (
                            <>
                              ...
                              <p className="mt-2"><strong>{data?.payload?.tech_lang_keys['14']}</strong></p>
                              <p className="mt-2">P = {result?.tech_p}, T = {result?.tech_t}, W = ?</p>
                              <p className="mt-2"><strong>{data?.payload?.tech_lang_keys['15']}</strong></p>
                              <p className="mt-2">W = {result?.tech_p} * {result?.tech_t}</p>
                              <p className="mt-2">W = <strong>{result?.tech_w}</strong></p>
                            </>
                          )}
                          ...
                          {result?.tech_time && (
                            <>
                              ...
                              <p className="mt-2"><strong>{data?.payload?.tech_lang_keys['14']}</strong></p>
                              <p className="mt-2">W = {result?.tech_w}, P = {result?.tech_p}, T = ?</p>
                              <p className="mt-2"><strong>{data?.payload?.tech_lang_keys['15']}</strong></p>
                              <p className="mt-2">T = {result?.tech_w} / {result?.tech_p}</p>
                              <p className="mt-2">T = <strong>{result?.tech_t}</strong></p>
                            </>
                          )}
                        </div>
                            </div>

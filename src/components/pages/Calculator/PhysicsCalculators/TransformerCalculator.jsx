        ...
        <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mb-3">
          ...
          <div className="lg:w-[70%] md:w-[90%] w-full mx-auto ">
            <div className="grid grid-cols-12  mt-3  gap-4">
              ...
              {formData.tech_calculation_unit == "1" && (
                <>
             {(formData.tech_calculation_unit == "5" || formData.tech_calculation_unit == "6" || formData.tech_calculation_unit == "7" || formData.tech_calculation_unit == "8" || formData.tech_calculation_unit == "9") && (
              <>
              
            <div class="col-span-12 md:col-span-6 lg:col-span-6  primary_current ">
                 <label htmlFor="tech_primary_current" className="label">
                      {data?.payload?.tech_lang_keys["33"]}:
                        </label>
                        <div class=" relative">
                        ...
                        <table className="w-full lg:text-[18px] md:text-[18px] text-[16px]">
                          ...
                          {result?.tech_rms && (
                            <tr>
                              <td className="py-2 border-b" width="70%">
                                <strong>
                                  R.M.S {data?.payload?.tech_lang_keys[48]} EMF
                                </strong>
                              </td>
                              <td className="py-2 border-b">
                                {result?.tech_rms}

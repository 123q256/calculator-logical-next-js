          ...
          <div class="lg:w-[60%] md:w-[90%] w-full mx-auto ">
            <div class="grid grid-cols-12 mt-3  gap-4">
              ...
              {(formData.tech_find == "wavelength" ||
                ...
                <>
                  <div class="lg:col-span-6 md:col-span-6 col-span-12 " id="velocitys">
              ...
              {(formData.tech_find == "wavelength" ||
                ...
                <>
                  <div class="lg:col-span-6 md:col-span-6 col-span-12" id="frequencys">
              ...
              {(formData.tech_find == "frequency" ||
                formData.tech_find == "velocity") && (
                <>
                  <div class="lg:col-span-6 md:col-span-6 col-span-12 " id="wavelengths">
                    ...
                    <div class="w-full overflow-auto">
                      <div class="w-full md:w-[60%] lg:w-[60%] mt-2">
                        <table class="w-full lg:text-[18px] md:text-[18px] text-[16px]">
                          <tr>
                            <td class="py-2 border-b" width="40%">

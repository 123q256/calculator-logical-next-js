          ...
          <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
            <div className="grid grid-cols-12 mt-3  gap-4">
              ...
              {formData.tech_choose == "2" && (
                <>
                  <div className="lg:col-span-6 md:col-span-6 col-span-12 " id="calculation2">
              ...
              {formData.tech_choose == "1" && (
                <>
                  <div className="lg:col-span-6 md:col-span-6 col-span-12 " id="calculation1">
              ...
              {((formData.tech_choose === "1" &&
                ...
                <>
                  <div className="lg:col-span-6 md:col-span-6 col-span-12 charge_three">
              ...
              {((formData.tech_choose === "2" &&
                ...
                <>
                  <div className="lg:col-span-6 md:col-span-6 col-span-12  charge_one">
              ...
              {((formData.tech_choose === "2" &&
                ...
                <>
                  <div className="lg:col-span-6 md:col-span-6 col-span-12   charge_two">
              ...
              {((formData.tech_choose === "1" &&
                ...
                (formData.tech_choose === "2" &&
                  formData.tech_selection1 === "3")) && (
                <>
                  <div className="lg:col-span-6 md:col-span-6 col-span-12  distance">
              ...
              <div className="lg:col-span-6 md:col-span-6 col-span-12 constant">
                          ...
                          <div className="w-full md:w-[80%] lg:w-[80%] overflow-auto mt-2">
                            <table className="w-full lg:text-[18px] md:text-[18px] text-[16px]">
                              ...
                              <tr>
                                ...
                                <td className="py-2 border-b">
                                  {result?.tech_force * 0.001} (Kilo Newton) kN
                                </td>
                              </tr>
                              <tr>
                                <td className="py-2 border-b" width="30%">
                                ...
                                <td className="py-2 border-b">
                                  {result?.tech_force * 1000} (Milli Newton) mN
                                </td>
                              </tr>
                              <tr>
                                <td className="py-2 border-b" width="30%">
                                ...
                                <td className="py-2 border-b">
                                  {result?.tech_force * 0.224809} (pounds-force)
                                  lbf
                                </td>
                              </tr>
                              <tr>
                                ...
                                <td className="py-2 border-b">
                                  {result?.tech_force * 0.000001} (Mega Newton)
                                  MN
                                </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                ...
                                <td className="py-2 border-b">
                                  {result?.tech_force * 7.23301} (poundals) pdl
                                </td>
                              </tr>
                              </tbody>
                            </table>
                          ...
                          <div className="w-full md:w-[80%] lg:w-[80%] overflow-auto mt-2">
                            <table className="w-full lg:text-[18px] md:text-[18px] text-[16px]">
                              ...
                              <tr>
                                ...
                                <td className="py-2 border-b">
                                  {result?.tech_charging * 1000} (millicoulombs)
                                  mC
                                </td>
                              </tr>
                              <tr>
                                ...
                                <td className="py-2 border-b">
                                  {result?.tech_charging * 0.000277778} (ampere
                                  hours) Ah{" "}
                                </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                ...
                                <td className="py-2 border-b">
                                  {result?.tech_charging * 6241509074460762608}{" "}
                                  (Elementary charge) e
                                </td>
                              </tr>
                              </tbody>
                          ...
                          <div className="w-full md:w-[80%] lg:w-[80%] overflow-auto mt-2">
                            <table className="w-full lg:text-[18px] md:text-[18px] text-[16px]">
                              ...
                              <tr>
                                ...
                                <td className="py-2 border-b">
                                  {result?.tech_distancing * 1000} (millimeters)
                                  mm
                                </td>
                              </tr>
                              <tr>
                                ...
                                <td className="py-2 border-b">
                                  {result?.tech_distancing * 100} (centimeters)
                                  cm{" "}
                                </td>
                              </tr>
                              <tr>
                                ...
                                <td className="py-2 border-b">
                                  {result?.tech_distancing * 0.001} (kilometers)
                                  km
                                </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                ...
                                <td className="py-2 border-b">
                                  {result?.tech_distancing * 3.28084} (feet) ft
                                </td>
                              </tr>
                              <tr>
                                <td className="py-2 border-b" width="40%">
                                ...
                                <div className="w-full md:w-[60%] lg:w-[60%] overflow-auto mt-2">
                                  <table className="w-full lg:text-[18px] md:text-[18px] text-[16px]">
                                    ...
                                    <tr>
                                      ...
                                      <td className="py-2 border-b">
                                        {result?.tech_charge_one * 0.000277778}{" "}

...
if (result?.tech_D < 0 && result?.tech_E < 0) {
  generalForm = `x^2 + y^2 ${signD} ${xD}x ${signE} ${yE}y ${signF === '+' ? '+' : '-'} ${zF} = 0`;
} else if (result?.tech_D >= 0 && result?.tech_E < 0) {
  generalForm = `x^2 + y^2 + ${xD}x ${signE} ${yE}y ${signF === '+' ? '+' : '-'} ${zF} = 0`;
} else if (result?.tech_D < 0 && result?.tech_E >= 0) {
  generalForm = `x^2 + y^2 ${signD} ${xD}x + ${yE}y ${signF === '+' ? '+' : '-'} ${zF} = 0`;
} else {
  generalForm = `x^2 + y^2 + ${xD}x + ${yE}y ${signF === '+' ? '+' : '-'} ${zF} = 0`;
}
                ...
                {(formData.tech_from == "1" || formData.tech_from == "2" || formData.tech_from == "3") && (
                 ...
                 {(formData.tech_from == "4" || formData.tech_from == "5") && (
                  ...
                  <div className="col-span-12  circlePoints">
                      <div className="grid grid-cols-12    gap-2 md:gap-4 lg:gap-4">
                          <p className="col-span-12 text-center my-3 text-[18px]"><strong>{data?.payload?.tech_lang_keys['5']} (x,y)</strong></p>
                 ...
                 {(formData.tech_from == "5") && (
                  ...
                  <div className="col-span-12  centerPoints">
                      <div className="grid grid-cols-12    gap-2 md:gap-4 lg:gap-4">
                          <p className="col-span-12 text-center my-3 text-[18px]"><strong>{data?.payload?.tech_lang_keys['7']} (h,k)</strong></p>
                              ...
                              <div className="w-full">
                                ...
                                <div className="w-full md:w-[80%] lg:w-[80%] overflow-auto mt-2">
                                  ...
                                  <div className="col-12">
                                    ...
                                    <table className="w-full text-[16px]">
                                              <tr>
                                                  <td className="py-2 border-b" width="45%">{ data?.payload?.tech_lang_keys['6'] }</td>
                                                  <td className="py-2 border-b"><strong>{result?.tech_radius}</strong></td>
                                              </tr>
                                              <tr>
                                                  <td className="py-2 border-b" width="45%">{ data?.payload?.tech_lang_keys['10'] }</td>
                                                  <td className="py-2 border-b"><strong>{result?.tech_diameter}</strong></td>
                                              </tr>
                                              <tr>
                                                  <td className="py-2 border-b" width="45%">{ data?.payload?.tech_lang_keys['11'] }</td>
                                                  <td className="py-2 border-b"><strong>[{result?.tech_d1} , {result?.tech_d2}]</strong></td>
                                              </tr>
                                              <tr>
                                                  <td className="py-2 border-b" width="45%">{ data?.payload?.tech_lang_keys['12'] }</td>
                                                  <td className="py-2 border-b"><strong>{result?.tech_eccentricity}</strong></td>
                                              </tr>
                                              <tr>
                                                  <td className="py-2 border-b" rowspan="2" width="45%">{ data?.payload?.tech_lang_keys['13'] }</td>
                                  ...
                                  <div className="w-full md:w-[80%] lg:w-[80%] overflow-auto mt-2">
                                    <table className="w-full text-[16px]">
                                          <tr>
                                              <td className="py-2 border-b" width="45%"><strong>{ data?.payload?.tech_lang_keys['14'] }</strong></td>
                                              <td className="py-2 border-b">{result?.tech_area}</td>
                                          </tr>
                                          <tr>
                                              <td className="py-2 border-b" width="45%"><strong>{ data?.payload?.tech_lang_keys['15'] }</strong></td>
                                              <td className="py-2 border-b">{result?.tech_circumference}</td>
                                          </tr>
                                          <tr>
                                              <td className="py-2 border-b" width="45%"><strong>{ data?.payload?.tech_lang_keys['16'] }</strong></td>
                                              <td className="py-2 border-b">[{result?.tech_r1} , {result?.tech_r2}]</td>
                                          </tr>
                                          <tr>
                                              <td className="py-2 border-b" width="45%"><strong>{ data?.payload?.tech_lang_keys['17'] }</strong></td>
                                              <td className="py-2 border-b">{result?.tech_eccentricity}</td>
                                          </tr>
                                          <tr>
                                              <td className="py-2 border-b" rowspan="2" width="45%"><strong>{ data?.payload?.tech_lang_keys['18'] }</strong></td>

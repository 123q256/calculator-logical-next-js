                            ...
                            <tbody>
                              <tr>
                                <td className="py-2 border-b" width="50%">
                                  <strong>{data?.payload?.tech_lang_keys['sum']}</strong>
                                </td>
                                <td className="py-2 border-b">
                                  {result?.tech_sum !== undefined ? result.tech_sum : '00'}
                                </td>
                              </tr>
                              <tr>
                                <td className="py-2 border-b" width="50%">
                                  <strong>{data?.payload?.tech_lang_keys['how']}</strong>
                                </td>
                                <td className="py-2 border-b">
                                  {result?.tech_total_nbr !== undefined ? result.tech_total_nbr : '00'}
                                </td>
                              </tr>
                              <tr>
                                <td className="py-2 border-b" width="50%">
                                  <strong>{data?.payload?.tech_lang_keys['nbrs']}</strong>
                                </td>
                                <td className="py-2 border-b">
                                  {result?.tech_numbers !== undefined ? result.tech_numbers : '00'}
                                </td>
                              </tr>
                              <tr>
                                <td className="py-2 border-b" width="50%">
                                  <strong>{data?.payload?.tech_lang_keys['max']}</strong>
                                </td>
                                <td className="py-2 border-b">
                                  {result?.tech_max !== undefined ? result.tech_max : '00'}
                                </td>
                              </tr>
                              <tr>
                                <td className="py-2 border-b" width="50%">
                                  <strong>{data?.payload?.tech_lang_keys['min']}</strong>
                                </td>
                                <td className="py-2 border-b">
                                  {result?.tech_min !== undefined ? result.tech_min : '00'}
                                </td>
                              </tr>
                            </tbody>
                          </table>

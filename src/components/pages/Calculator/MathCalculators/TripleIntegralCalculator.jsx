...
useEffect(() => {
  if (containerRef2.current) {
    const scripts = containerRef2.current.querySelectorAll('script[type^="math/tex"]');
...
useEffect(() => {
  if (containerRef3.current) {
    const scripts = containerRef3.current.querySelectorAll('script[type^="math/tex"]');
    ...
    >
        <form className="row" onSubmit={handleSubmit}>
          ...
          <div className=" w-full mx-auto overflow-auto">
            ...
            <div className="flex items-center justify-center" id="inputsField">
                ...
                <p className="text-blue bracket_symbol">(</p>
                  <div className="md:w-[40%] w-[100%]">
                     <div className="col-span-12 md:col-span-4 lg:col-span-4 flex justify-between">
                      <label for="tech_EnterEq" className="label mt-4">  Function:</label>
                        <button type="button" className="  flex border rounded-lg p-1  items-center text-[8px]" id="exampleLoadBtn"  onClick={exampleLoadHandler}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="8" height="8" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-arrow-up-right size-5 me-1" ><path d="M7 7h10v10"></path><path d="M7 17 17 7"></path></svg>
                            Load Example
                        </button>
                      </div>
                      ...
                      {showKeyboard && (
                        ...
                        <button
                          type="button"
                          className="bg-blue-700 text-white rounded-sm h-7 px-2 uppercase shadow-md hover:bg-blue-600"
                          onClick={clearInput}
                        >
                          CLS
                        </button>
                        {["+","-","/","*","^","sqrt(","(",")"].map((keyVal, idx) => (
                          <button
                            key={idx}
                            type="button"
                            className="keyBtn bg-blue-700 text-white rounded-sm h-7 px-2 uppercase shadow-md hover:bg-blue-600"
                          ...
                          <div className="w-full">
                            <div className="w-full text-[16px] overflow-auto">
                              ...
                              <p
                                ...
                                dangerouslySetInnerHTML={renderMath(`= ${result?.tech_final} + \\mathrm{constant}`)}
                              />
                              ...
                              {result?.tech_def === "def" && (
                                <>
                                  ...
                                  <p
                                    className="mt-3 font-s-18"
                                    dangerouslySetInnerHTML={renderMath(`= ${result?.tech_finaln}`)}
                                  />
                                </>
                              )}

                              <p className="mt-3 font-bold">{data?.payload?.tech_lang_keys["7"]}</p>
                              <p
                                className="mt-3"
                                dangerouslySetInnerHTML={renderMath(result?.tech_enter || "")}
                              />

                              <p className="mt-3 font-bold">{data?.payload?.tech_lang_keys["10"]}</p>
                              <p className="mt-3">{data?.payload?.tech_lang_keys["11"]}:</p>

                              <p
                                className="mt-3 mb-3"
                                dangerouslySetInnerHTML={renderMath(result?.tech_en1 || "")}
                              />
                                ...
                                {result?.tech_step1 && (
                                  <div
                                    ...
                                    dangerouslySetInnerHTML={{ __html: result?.tech_step1 }}
                                  />
                                )}
                              </div>
                              ...
                              <p
                                className="mt-3 mb-3"
                                dangerouslySetInnerHTML={renderMath(result?.tech_en2 || "")}
                              />
                              ...
                              <div className="w-full res_step mt-3 overflow-auto">
                                {result?.tech_step2 && (
                                  <div
                                    ref={containerRef2}
                                    className="katex-rendered-content"
                                    dangerouslySetInnerHTML={{ __html: result?.tech_step2 }}
                                  />
                                )}
                              </div>
                              ...
                              <p
                                className="mt-3 mb-3"
                                dangerouslySetInnerHTML={renderMath(result?.tech_en3 || "")}
                              />
                              ...
                              <div className="w-full res_step mt-3 overflow-auto">
                                {result?.tech_step3 && (
                                  <div
                                    ref={containerRef3}
                                    className="katex-rendered-content"
                                    dangerouslySetInnerHTML={{ __html: result?.tech_step3 }}
                                  />
                                )}
                              </div>

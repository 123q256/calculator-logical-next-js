                          ...
                          <div className="w-full mt-3">
                            <div className="w-full">
                              ...
                              <div className="w-full">
                                ...
                                <p className="mt-3">
                                  {data?.payload?.tech_lang_keys['1']} = {formData?.tech_start}
                                </p>
                                <p className="my-3">
                                  {data?.payload?.tech_lang_keys['2']} = {formData?.tech_final}
                                </p>
                                ...
                                <p>
                                  <span className="fraction">
                                    ...
                                    <span className="den">|{formData?.tech_start}|</span>
                                  </span>{" "}
                                  × 100
                                </p>
                                ...
                                {result?.tech_ans < 0 && (
                                  <p className="mt-3">
                                    ...
                                    <span>{Math.abs(Number(result?.tech_ans)).toFixed(5)} %</span>
                                  </p>
                                )}

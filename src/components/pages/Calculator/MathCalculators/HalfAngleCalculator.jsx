              ...
              <div className="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                <div className="col-span-12">
                    ...
                    <div className="mt-2">
                      ...
                      >
                        <option value="angle">{data?.payload?.tech_lang_keys["2"]} (x)</option>
              ...
              {formData.tech_cal != "angle" && (
                ...
                <div className="col-span-12 " id="functionInput">
                      {formData.tech_cal == "sinx" && (
                        <>
                        <label htmlFor="tech_func" className="label"> sin(x)</label>
                        </>
                      )}
                       {formData.tech_cal == "cosx" && (
                        <>
                        <label htmlFor="tech_func" className="label"> cos(x)</label>
                        </>
                      )}
                       {formData.tech_cal == "tanx" && (
                        <>
                        <label htmlFor="tech_func" className="label"> tan(x)</label>
                        </>
                      )}
                       {formData.tech_cal == "sinx_2" && (
                        <>
                        <label htmlFor="tech_func" className="label"> sin(x/2) </label>
                        </>
                      )}
                       {formData.tech_cal == "cosx_2" && (
                        <>
                        <label htmlFor="tech_func" className="label"> cos(x/2)</label>
                        </>
                      )}
                 ...
                 <div className="rounded-lg  flex items-center justify-center">
                    <div className="w-full mt-3">
                        ...
                        <div className="w-full">
                                            ...
                                            <table className="w-full text-[16px]">
                                              <tbody>
                                                <tr>
                                                  ...
                                                  <td className="py-2 border-b">{result?.tech_sinx2}</td>
                                                </tr>
                                                <tr>
                                                  <td className="py-2 border-b" width="60%">
                                                    <strong>cos(x/2)</strong>
                                                  </td>
                                                  <td className="py-2 border-b">{result?.tech_cosx2}</td>
                                                </tr>
                                                <tr>
                                                  <td className="py-2 border-b" width="60%">
                                                    <strong>tan(x/2)</strong>
                                                  </td>
                                                  <td className="py-2 border-b">{result?.tech_tanx2}</td>
                                                </tr>
                                              </tbody>
                                            </table>
                                          </div>
                          ...
                          <BlockMath math={`\\sin\\left(\\frac{x}{2}\\right) = \\pm \\sqrt{\\frac{1 - \\cos(x)}{2}}`} />
                          <BlockMath math={`\\cos\\left(\\frac{x}{2}\\right) = \\pm \\sqrt{\\frac{1 + \\cos(x)}{2}}`} />
                          <BlockMath math={`\\tan\\left(\\frac{x}{2}\\right) = \\pm \\sqrt{\\frac{1 - \\cos(x)}{1 + \\cos(x)}}`} />
                          ...
                          <BlockMath math={`\\sin\\left(\\frac{x}{2}\\right) = \\pm \\sqrt{\\frac{1 - \\cos(x)}{2}}`} />
                          <BlockMath math={`\\sin\\left(\\frac{x}{2}\\right) = \\pm \\sqrt{\\frac{1 - (${result?.tech_cosx})}{2}}`} />
                          <BlockMath math={`\\sin\\left(\\frac{x}{2}\\right) = \\pm \\sqrt{\\frac{${result?.tech_s1}}{2}}`} />
                          <BlockMath math={`\\sin\\left(\\frac{x}{2}\\right) = \\pm \\sqrt{${result?.tech_s2}}`} />
                          <BlockMath math={`\\sin\\left(\\frac{x}{2}\\right) = \\pm ${result?.tech_sinx2}`} />

                          <p className="mt-3">Find cos(x/2)</p>
                          <BlockMath math={`\\cos\\left(\\frac{x}{2}\\right) = \\pm \\sqrt{\\frac{1 + \\cos(x)}{2}}`} />
                          <BlockMath math={`\\cos\\left(\\frac{x}{2}\\right) = \\pm \\sqrt{\\frac{1 + (${result?.tech_cosx})}{2}}`} />
                          <BlockMath math={`\\cos\\left(\\frac{x}{2}\\right) = \\pm \\sqrt{\\frac{${result?.tech_c1}}{2}}`} />
                          <BlockMath math={`\\cos\\left(\\frac{x}{2}\\right) = \\pm \\sqrt{${result?.tech_c2}}`} />
                          <BlockMath math={`\\cos\\left(\\frac{x}{2}\\right) = \\pm ${result?.tech_cosx2}`} />

                          <p className="mt-3">Find tan(x/2)</p>
                          <BlockMath math={`\\tan\\left(\\frac{x}{2}\\right) = \\pm \\sqrt{\\frac{1 - \\cos(x)}{1 + \\cos(x)}}`} />
                          <BlockMath math={`\\tan\\left(\\frac{x}{2}\\right) = \\pm \\sqrt{\\frac{1 - (${result?.tech_cosx})}{1 + (${result?.tech_cosx})}}`} />
                          <BlockMath math={`\\tan\\left(\\frac{x}{2}\\right) = \\pm \\sqrt{\\frac{${result?.tech_s1}}{${result?.tech_c1}}}`} />
                          <BlockMath math={`\\tan\\left(\\frac{x}{2}\\right) = \\pm \\sqrt{${result?.tech_t1}}`} />
                          <BlockMath math={`\\tan\\left(\\frac{x}{2}\\right) = \\pm ${result?.tech_tanx2}`} />
                          </div>
                                  ...
                                  <div className="w-full md:w-[80%] lg:w-[60%] overflow-auto mt-2">
                                          ...
                                          <tbody>
                                            <tr>
                                              ...
                                              <td className="py-2 border-b">{result?.tech_sinx}</td>
                                            </tr>
                                            <tr>
                                              <td className="py-2 border-b" width="60%">
                                                <strong>cos(x)</strong>
                                              </td>
                                              <td className="py-2 border-b">{result?.tech_cosx}</td>
                                            </tr>
                                            <tr>
                                              <td className="py-2 border-b" width="60%">
                                                <strong>tan(x)</strong>
                                              </td>
                                              <td className="py-2 border-b">{result?.tech_tanx}</td>
                                            </tr>
                                          </tbody>
                                        </table>
                                      </div>
                                     ...
                                     <div className="w-full md:w-[80%] lg:w-[60%] overflow-auto mt-2">
                                          ...
                                          <tbody>
                                            <tr>
                                              ...
                                              <td className="py-2 border-b">{sinx_val}</td>
                                            </tr>
                                            <tr>
                                              <td className="py-2 border-b" width="60%">
                                                <strong>cos(x)</strong>
                                              </td>
                                              <td className="py-2 border-b">{cosx_val}</td>
                                            </tr>
                                            <tr>
                                              <td className="py-2 border-b" width="60%">
                                                <strong>tan(x)</strong>
                                              </td>
                                              <td className="py-2 border-b">{tanx_val}</td>
                                            </tr>
                                          </tbody>
                                        </table>
                                      </div>
                          ...
                          <div className="w-full text-[16px] mt-3 overflow-auto">
                            ...
                            <p className="mt-3">
                              Put angle value ({formData?.tech_angle}) into sin(x), cos(x) & tan(x)
                            </p>
                            <p className="mt-3">
                                ...
                                <div className="w-full md:w-[80%] lg:w-[60%] overflow-auto mt-2">
                                    ...
                                    <tbody>
                                      <tr>
                                        ...
                                        <td className="py-2 border-b">{result?.tech_angle_deg} degrees</td>
                                      </tr>
                                      <tr>
                                        <td className="py-2 border-b" width="60%">
                                          <strong>Angle</strong>
                                        </td>
                                        <td className="py-2 border-b">{result?.tech_angle_rad} radians</td>
                                      </tr>
                                      <tr>
                                        <td className="py-2 border-b" width="60%">
                                          <strong>Angle</strong>
                                        </td>
                                        <td className="py-2 border-b">{result?.tech_angle_pirad} π radians</td>
                                      </tr>
                                    </tbody>
                                  </table>
                                </div>

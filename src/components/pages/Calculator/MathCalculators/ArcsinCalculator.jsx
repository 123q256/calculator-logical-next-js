                            ...
                            <div className="w-full">
                                ...
                                <p className="mt-3 text-[18px]"><strong>{ data?.payload?.tech_lang_keys['5'] }</strong></p>
                                  <div className="w-full md:w-[60%] lg:w-[60%] overflow-auto mt-3">
                                    <table className="w-full text-[16px]">
                                        <tr>
                                            <td className="py-2 border-b" width="40%">arcsin ({formData?.tech_arcsin})</td>
                                  ...
                                  <div className="w-full text-[16px] mt-3 overflow-auto">
                                      ...
                                      <p className="mt-2">
                                        arcsin {formData?.tech_arcsin} = sin<sup className="font-s-14">-1</sup> {formData?.tech_arcsin} = {result?.tech_deg}° {result?.tech_min}' {result?.tech_sec}"
                                      </p>

                                      <p className="mt-2">= {result?.tech_angle} + k * 360° (k = -1,0,1,...)</p>

                                      <p className="mt-2">
                                        = {degAnswers.join("°, ")}°, ...
                                      </p>

                                      <p className="mt-2">= {result?.tech_rad} rad + k * 2π (k = -1,0,1,...)</p>

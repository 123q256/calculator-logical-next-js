          ...
          <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mb-3">
           ...
           <div class="lg:w-[60%] md:w-[60%] w-full mx-auto ">
            <div class="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                <div class="col-span-12 " id="bit">
                    ...
                    <div className="mt-2">
                      ...
                      >
                        ...
                        <option value="3">{data?.payload?.tech_lang_keys["4"]} & {data?.payload?.tech_lang_keys["5"]} </option>
                      </select>
                    </div>
                </div>
                ...
                <div class="col-span-12 md:col-span-6 lg:col-span-6 grading_system mt-2  ">
                    ...
                    <div className="mt-2">
                      ...
                      >
                        ...
                        <option value="2">{data?.payload?.tech_lang_keys["7"]} </option>
                        <option value="3">USA ({data?.payload?.tech_lang_keys["11"]}) </option>
                        <option value="4">USA ({data?.payload?.tech_lang_keys["12"]}) </option>
                        <option value="5">Canada </option>
                        <option value="6">GCSE </option>
                        <option value="7">Australian ({data?.payload?.tech_lang_keys["13"]}) </option>
                        <option value="8">Australian {data?.payload?.tech_lang_keys["14"]} </option>
                ...
                {/* final class grade */}
              {((formData.tech_selection == "1") || (formData.tech_selection == "1" && formData.tech_grading_system == "1") || (formData.tech_selection == "1" && formData.tech_grading_system == "2"))  && (
                <>
                ...
                <div class="col-span-12 usa">
                  <div class="grid grid-cols-12    gap-2 md:gap-4 lg:gap-4 ">
                    ...
                    {/* final class grade */}
                     {((formData.tech_selection == "2")  || (formData.tech_selection == "1" && formData.tech_grading_system == "3")) && (
                      <>
                    ...
                    {(formData.tech_selection == "1" && formData.tech_grading_system == "3") && (
                      <>
                      <div class="col-span-12 md:col-span-6 lg:col-span-6">
                ...
                <div class="col-span-12 advanced_usa">
                  <div class="grid grid-cols-12    gap-2 md:gap-4 lg:gap-4 ">
                    ...
                    {((formData.tech_selection == "1" && formData.tech_grading_system == "4")) && (
                      <>
                      <div class="col-span-12 md:col-span-6 lg:col-span-6">
                ...
                <div class="col-span-12 australian_schools">
                  <div class="grid grid-cols-12    gap-2 md:gap-4 lg:gap-4 ">
                   {( (formData.tech_selection == "1" && formData.tech_grading_system == "7")) && (
                      <>
                    <div class="col-span-12 md:col-span-6 lg:col-span-6">
                ...
                <div class="col-span-12 australian_university">
                  <div class="grid grid-cols-12    gap-2 md:gap-4 lg:gap-4 ">
                      {( (formData.tech_selection == "1" && formData.tech_grading_system == "8")) && (
                      <>
                      <div class="col-span-12 md:col-span-6 lg:col-span-6">
                ...
                <div class="col-span-12 india">
                  <div class="grid grid-cols-12    gap-2 md:gap-4 lg:gap-4 ">
                      {( (formData.tech_selection == "1" && formData.tech_grading_system == "9")) && (
                      <>
                        <div class="col-span-12 md:col-span-6 lg:col-span-6">
                ...
                <div class="col-span-12 canada">
                  <div class="grid grid-cols-12 gap-2 md:gap-4 lg:gap-4 ">
                      {( (formData.tech_selection == "1" && formData.tech_grading_system == "5")) && (
                      <>
                      <div class="col-span-12 md:col-span-6 lg:col-span-6">
                ...
                <div class="col-span-12 gcse">
                  <div class="grid grid-cols-12  gap-2 md:gap-4 lg:gap-4 ">
                      {( (formData.tech_selection == "1" && formData.tech_grading_system == "6")) && (
                      <>
                        <div class="col-span-12 md:col-span-6 lg:col-span-6">
                ...
                {/* final class grade */}
                 {((formData.tech_selection == "1" )||  (formData.tech_selection == "1" && formData.tech_grading_system == "1") || (formData.tech_selection == "1" && formData.tech_grading_system == "2") || (formData.tech_selection == "1" && formData.tech_grading_system == "3") || (formData.tech_selection == "1" && formData.tech_grading_system == "4") || (formData.tech_selection == "1" && formData.tech_grading_system == "5") || (formData.tech_selection == "1" && formData.tech_grading_system == "6")  || (formData.tech_selection == "1" && formData.tech_grading_system == "7")  || (formData.tech_selection == "2" && formData.tech_grading_system == "8")  || (formData.tech_selection == "1" && formData.tech_grading_system == "9"))  && (
                <>
                ...
                <div class="col-span-12 mt-2" id="btn2">
                  <button type="button" title="Add More Fields" class="tagsUnit border p-2 cursor-pointer bg-[#99EA48] rounded-lg" ><b><span class="font-s-18">+</span>{data?.payload?.tech_lang_keys[26]}</b></button>
                </div>
                  {/* loop 2 */}
                ...
                {/* <div class="col-span-12 mt-2" id="btn4">
                  <button type="button" title="Add Exam" class="tagsUnit border p-2 cursor-pointer bg-[#99EA48] rounded-lg" ><b><span class="font-s-18">+</span>{data?.payload?.tech_lang_keys[27]}</b></button>
                </div> 
                <div class="col-span-12 mt-2" id="btn5">
                  <button type="button" title="Add Exam" class="tagsUnit border p-2 cursor-pointer bg-[#99EA48] rounded-lg" ><b><span class="font-s-18">+</span>{data?.payload?.tech_lang_keys[28]}2</b></button>
                </div>  */}
              </div>
            </div>
                      ...
                      <div className="w-full mt-3">
                        <div className="w-full text-[18px] text-center">
                          {result?.tech_subtraction && result?.tech_read && (
                            <>
                              <p><strong>{result?.tech_read}</strong></p>
                              <p>
                          ...
                          {result?.tech_final_result && (
                            <>
                              ...
                              <p className="text-blue text-[20px] my-2">
                                <strong>{Number(result?.tech_final_result).toFixed(2)}</strong>
                              </p>
                            </>
                          )}
                          ...
                          {result?.tech_fg && (
                            <>
                              ...
                              <p className="text-blue text-[20px] my-2">
                                <strong>
                                  {Number(result?.tech_fg).toFixed(2)} ({result?.tech_assign}{' '}
                          ...
                          {result?.tech_Grades && (
                            <p className="text-blue text-[20px] my-2">
                              {data?.payload?.tech_lang_keys[30]} {result?.tech_Grades}{' '}

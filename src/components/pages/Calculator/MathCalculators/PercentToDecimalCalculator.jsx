                        ...
                        <div className="w-full mt-3">
                            <div className="w-full">
                                ...
                                <div className="w-full text-[16px] overflow-auto">
                                    ...
                                    <p className="mt-2">{data?.payload?.tech_lang_keys[5]} <strong>100</strong> </p>
                                    <p className="mt-2">{formData?.tech_per} % = {formData?.tech_per} / 100</p>
                                    <p className="mt-2"> = {result?.tech_ans} {data?.payload?.tech_lang_keys[6]}</p>
                                </div>
                            </div>
                        </div>
                    </div>

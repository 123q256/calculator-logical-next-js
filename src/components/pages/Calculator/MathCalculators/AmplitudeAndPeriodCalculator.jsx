...
function changeFunction(sinOrCos, A, B, C, D) {
  ...
  const finalValue = useMemo(() => {
    ...
    if (result.operation === '1') {
      firstSection = C > 0
        ? sinBx * cosC - cosBx * sinC
        : sinBx * cosC + cosBx * sinC;
    } else {
      firstSection = C > 0
        ? cosBx * cosC - sinBx * sinC
        : cosBx * cosC + sinBx * sinC;
    }
                ...
                <div className="col-span-6">
                    ...
                    x₀
                      ...
                      <input
                        ...
                        onChange={handleChange}
                      />
                      <span className="input_unit">{data?.payload?.tech_lang_keys["2"]}</span>
                      </div>
                </div>
                              ...
                              <table className="w-full text-[16px]">
                                ...
                                {formData?.tech_x_not && (
                                  <tr>
                                    ...
                                    <td className="py-2 border-b">{finalValue?.toFixed(6)}</td>
                                  </tr>
                                )}
                                <tr>
                                  <td className="py-2 border-b" width="40%">

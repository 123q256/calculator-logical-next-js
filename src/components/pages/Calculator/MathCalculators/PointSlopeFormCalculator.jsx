  ...
  useEffect(() => {
    ...
    const handleMouseDown = (e) => {
      ...
      chart.data.datasets[0].data.forEach((point, index) => {
        ...
        if (Math.sqrt(dx * dx + dy * dy) < 1) { // Tolerance
                                  ...
                                  {(formData?.tech_point_unit=='1') ? (
                                    ...
                                    <div className="w-full md:w-[60%] lg:w-[60%] mt-2 overflow-auto">
                                        <table className="w-full font-s-18">
                                            <tr>
                                                <td className="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys['ans']}</strong></td>
                                                <td className="py-2 border-b">{result?.tech_s}</td>
                                            </tr>
                                            <tr>
                                                <td className="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys['4']}</strong></td>
                                                <td className="py-2 border-b">{result?.tech_s3}</td>
                                            </tr>
                                        </table>
                                    </div>
                                    <div className="w-full text-[18px] md:text-[20px] mt-3">
                                        ...
                                        <p className="mt-3">y - y<sub className="text-[14px]">1</sub> = m(x - x<sub className="text-[14px]">1</sub>)</p>
                                        ...
                                        <p className="mt-3">{data?.payload?.tech_lang_keys['graph']}:</p>
                                    </div>
                                      <div className="w-full h-[400px]">
                                        <Scatter ref={chartRef} data={datachart} options={options} />
                                      </div>
                                    </>
                                  ):(
                                    <>
                                    ...
                                    <div className="w-full text-[18px] md:text-[20px] mt-3">
                                        ...
                                        <p className="mt-3">{data?.payload?.tech_lang_keys['m']} = (y<sub className="text-[14px]">2</sub> - y<sub className="text-[14px]">1</sub>)/(x<sub className="text-[14px]">2</sub> - x<sub className="text-[14px]">1</sub>)</p>
                                        <p className="mt-3">{data?.payload?.tech_lang_keys['8']}:</p>
                                        <p className="mt-3">{data?.payload?.tech_lang_keys['m']} = {formData?.tech_sec_y2} - {formData?.tech_sec_y1} / ({formData?.tech_sec_x2} - {formData?.tech_sec_x1})</p>
                                        <p className="mt-3">{data?.payload?.tech_lang_keys['m']} = {result?.tech_slope}</p>

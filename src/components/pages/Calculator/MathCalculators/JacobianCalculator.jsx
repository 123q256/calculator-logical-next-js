                ...
                <div className="col-span-12">
                    <div className="grid grid-cols-12  gap-2 md:gap-4 lg:gap-4 mt-4">
                        ...
                        <div className="col-span-1 text-[18px] my-auto text-center">
                            <p className="py-2"><strong>=</strong></p>
                        </div>
                          ...
                          <div className="w-full text-[16px] overflow-auto">
                            {isTwoVars ? (
                              <>
                                ...
                                <p className="mt-3">
                                  <InlineMath math={`J(${v1}, ${v2})(${result?.tech_var}, ${result?.tech_var1}) = ${result?.tech_jacob}`} />
                                </p>
                              </>
                            ) : (
                              <>
                            ...
                            <p className="mt-3">
                              <InlineMath math={`J(${v1}, ${v2})(${result?.tech_var}, ${result?.tech_var1}) = ${result?.tech_dtrmnt}`} />
                            </p>

                            <p className="mt-3">{data?.payload?.tech_lang_keys['10']},</p>

                            <p className="mt-3">
                              {data?.payload?.tech_lang_keys['4']} {data?.payload?.tech_lang_keys['11']} <InlineMath math={result?.tech_jacob} />
                            </p>

                            <p className="mt-3">
                              {data?.payload?.tech_lang_keys['5']} {data?.payload?.tech_lang_keys['11']} <InlineMath math={result?.tech_dtrmnt} />
                            </p>
                          </div>
                        </div>
                      </div>

...
const is_numeric = (n) => !isNaN(parseFloat(n)) && isFinite(n);
 ...
 const formatFraction = (num, den) => `\\frac{${Math.abs(num)}}{${Math.abs(den)}}`;
            ...
            <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
                  ...
                  <label htmlFor="tech_from" className="label">
                    ...
                    <div className="mt-2">
                      ...
                      >
                        ...
                        <option value="3">{data?.payload?.tech_lang_keys["12"]} </option>
                        <option value="7">{data?.payload?.tech_lang_keys["13"]} </option>
                      </select>
                    </div>
              </div>
              ...
              <div className="col-span-12  standardEquation">
                  <div className="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                      <p className="col-span-12 text-center text-[14px]">
                          ...
                          <>
                           <strong id="changeText">  {data?.payload?.tech_lang_keys['3']}: f(x) = a(x - h)² + k</strong>
                          </>
                        ):(
                          <>
                           <strong id="changeText"> Standard Form: y = ax² + bx + c</strong>
                          </>
                        )}
                      ...
                      <div className="col-span-4">
                        {formData?.tech_from == "2" ? (
                          <>
                          <label htmlFor="tech_b" className="label">  h</label>
                          </>
                        ):(
                          <>
                      ...
                      <div className="col-span-4">
                        {formData?.tech_from == "2" ? (
                          <>
                          <label htmlFor="tech_c" className="label">  k</label>
                          </>
                        ):(
                          <>
              ...
              <div className="col-span-12  vertexPoints">
                  <div className="grid grid-cols-12 gap-2 md:gap-4 lg:gap-4">
                      <p className="col-span-12 text-center my-3 text-[14px]"><strong>{data?.payload?.tech_lang_keys['5']} P(h,k)</strong></p>
                      ...
                      <p className="col-span-12 text-center my-3 text-[14px]"><strong>Point P₁(x₁,y₁)</strong></p>
                      <div className="col-span-6">
                ...
                <div className="col-span-12 threePoints">
                    <div className="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                        <p className="col-span-12 text-center my-3 text-[14px]"><strong>P₁(x₁,y₁)</strong></p>
                        <div className="col-span-6">
                    ...
                    <label htmlFor="tech_axis" className="label">
                      ...
                      <div className="mt-2">
                        <select
                          ...
                          onChange={handleChange}
                        >
                          <option value="x">{data?.payload?.tech_lang_keys["15"]} </option>
                          <option value="y">{data?.payload?.tech_lang_keys["16"]} </option>
                        </select>
                      </div>
                </div>
                </>
                        ...
                        <div className="w-full mt-3">
                            <div className="w-full">
                                        ...
                                        <tbody>
                                          <tr>
                                            ...
                                            <td className="py-2 border-b">
                                              <BlockMath math={`y = ${result?.tech_a}x^2 ${(result?.tech_b >= 0 ? '+' : '')}${result?.tech_b}x ${(result?.tech_c >= 0 ? '+' : '')}${result?.tech_c}`} />
                                            </td>
                                          </tr>
                                          <tr>
                                            <td className="py-2 border-b" width="50%">
                                            ...
                                            <td className="py-2 border-b">
                                              <BlockMath
                                                math={`y = ${(result?.tech_a !== '1' ? result?.tech_a : '')}(x ${(result?.tech_hf_ > 0 ? '-' : '+')} ${is_numeric(result?.tech_hf)
                                                  ? Math.abs(result?.tech_hf)
                                                  : `\\frac{${Math.abs(result?.tech_h1)}}{${Math.abs(result?.tech_h2)}}`
                                                })^2 ${(result?.tech_kf_ > 0 ? '+' : '-')} ${
                                                  is_numeric(result?.tech_kf)
                                                    ? Math.abs(result?.tech_kf)
                                                    : `\\frac{${Math.abs(result?.tech_k1)}}{${Math.abs(result?.tech_k2)}}`
                                                }`}
                                              />
                                            </td>
                                          </tr>
                                      ...
                                      <table className="w-full text-[16px]">
                                        <tbody>
                                          <tr>
                                            ...
                                            <td className="py-2 border-b">
                                              <BlockMath
                                                math={`(${is_numeric(result?.tech_kf)
                                                  ? result?.tech_kf
                                          ...
                                          <tr>
                                            ...
                                            <td className="py-2 border-b">
                                              <BlockMath
                                                math={`(${is_numeric(result?.tech_fuf)
                                                  ? result?.tech_fuf
                                          ...
                                          <tr>
                                            ...
                                            <td className="py-2 border-b">
                                              <BlockMath
                                                math={`x = ${is_numeric(result?.tech_dirf)
                                                  ? result?.tech_dirf
                                          ...
                                          <tr>
                                            ...
                                            <td className="py-2 border-b">
                                              <BlockMath
                                                math={`x = ${is_numeric(result?.tech_fuf)
                                                  ? result?.tech_fuf
                                                  : `\\frac{${result?.tech_fu1}}{${result?.tech_fu2}}`}`}
                                              />
                                            </td>
                                          ...
                                          <tr>
                                            ...
                                            <td className="py-2 border-b">
                                              <BlockMath
                                                math={`y = ${is_numeric(result?.tech_hf)
                                                  ? result?.tech_hf
                                                  : `\\frac{${result?.tech_h1}}{${result?.tech_h2}}`}`}
                                              />
                                            </td>
                                          ...
                                          <tr>
                                            ...
                                            <td className="py-2 border-b">
                                              <BlockMath math={`(${result?.tech_y_inter}, 0)`} />
                                            </td>
                                          </tr>
                                        </tbody>
                                      </table>
                                        ...
                                        <table className="w-full text-[18px]">
                                          <tbody>
                                            <tr>
                                              ...
                                              <td className="py-2 border-b">
                                                <BlockMath
                                                  math={`y = ${result?.tech_a}x^2 ${(result?.tech_b >= 0 ? '+' : '')}${result?.tech_b}x ${(result?.tech_c >= 0 ? '+' : '')}${result?.tech_c}`}
                                                />
                                              </td>
                                            </tr>
                                            <tr>
                                              ...
                                              <td className="py-2 border-b">
                                                <BlockMath
                                                  math={`y = ${result?.tech_a !== '1' ? result?.tech_a : ''}(x ${result?.tech_hf_ > 0 ? '-' : '+'} ${
                                                    is_numeric(result?.tech_hf)
                                                      ? Math.abs(result?.tech_hf)
                                                      : formatFraction(result?.tech_h1, result?.tech_h2)
                                                  })^2 ${result?.tech_kf_ > 0 ? '+' : '-'} ${
                                                    is_numeric(result?.tech_kf)
                                                      ? Math.abs(result?.tech_kf)
                                                      : formatFraction(result?.tech_k1, result?.tech_k2)
                                                  }`}
                                                />
                                              </td>
                                            </tr>
                                    ...
                                    <table className="w-full text-[16px]">
                                      <tbody>
                                            ...
                                            <BlockMath
                                              math={`(${
                                                ...
                                                is_numeric(result?.tech_fuf)
                                                  ? result?.tech_fuf
                                                  : formatFraction(result?.tech_fu1, result?.tech_fu2)
                                              })`}
                                            />
                                          </td>
                                        </tr>
                                            ...
                                            <BlockMath
                                              math={`y = ${
                                                is_numeric(result?.tech_dirf)
                                                  ? result?.tech_dirf
                                                  : formatFraction(result?.tech_dir1, result?.tech_dir2)
                                              }`}
                                            />
                                          </td>
                                        </tr>
                                        ...
                                        <tr>
                                          ...
                                          <td className="py-2 border-b">
                                            <BlockMath math={`(0 , ${result?.tech_y_inter})`} />
                                          </td>
                                        </tr>
                                      </tbody>
                                    </table>
                                ...
                                {(result?.tech_from==3 || result?.tech_from==7) && (
                                  ...
                                  {result?.tech_from == 3 && result?.tech_axis == "x" && (
                                    <>
                                      <p className="mt-2">
                                        {data?.payload?.tech_lang_keys["17"]}: <BlockMath math={`P=(${h},${k}), Q=(${val(result?.tech_hf, result?.tech_h1, result?.tech_h2)}, ${val(result?.tech_fuf, result?.tech_fu1, result?.tech_fu2)})`} />
                                      </p>
                                      <p className="mt-2">{data?.payload?.tech_lang_keys["18"]} <BlockMath math={`y = a(x-h)^2 + k`} /></p>
                                      <p className="mt-2">{data?.payload?.tech_lang_keys["19"]} <BlockMath math={`y = a(x-${h})^2 + ${k}`} /></p>
                                      <p className="mt-2">{data?.payload?.tech_lang_keys["20"]} <BlockMath math={`${y11} = a(${x11}-${h})^2 + ${k}`} /></p>
                                      <p className="mt-2">{data?.payload?.tech_lang_keys["21"]} <BlockMath math={`a = ${result?.tech_a}`} /></p>
                                    </>
                                  )}

                                  {result?.tech_from == 3 && result?.tech_axis == "y" && (
                                    <>
                                      <p className="mt-2">
                                        {data?.payload?.tech_lang_keys["17"]}: <BlockMath math={`P=(${h},${k}), Q=(${val(result?.tech_fuf, result?.tech_fu1, result?.tech_fu2)}, ${val(result?.tech_hf, result?.tech_h1, result?.tech_h2)})`} />
                                      </p>
                                      <p className="mt-2">{data?.payload?.tech_lang_keys["18"]} <BlockMath math={`x = a(y-k)^2 + h`} /></p>
                                      <p className="mt-2">{data?.payload?.tech_lang_keys["19"]} <BlockMath math={`x = a(y-${h})^2 + ${k}`} /></p>
                                      <p className="mt-2">{data?.payload?.tech_lang_keys["20"]} <BlockMath math={`${y11} = a(${x11}-${h})^2 + ${k}`} /></p>
                                      <p className="mt-2">{data?.payload?.tech_lang_keys["21"]} <BlockMath math={`a = ${result?.tech_a}`} /></p>
                                    </>
                                  )}

                                  {result?.tech_from == 7 && result?.tech_axis == "x" && (
                                    <>
                                      <p className="mt-2">{data?.payload?.tech_lang_keys["17"]}: <BlockMath math={`P_1=(${x1},${y1}), P_2=(${x2},${y2}), P_3=(${x3},${y3})`} /></p>
                                      <p className="mt-2">{data?.payload?.tech_lang_keys["22"]} <BlockMath math={`y = ax^2 + bx + c`} /></p>
                                      {[x1, x2, x3].map((x, i) => (
                                        <p className="mt-2" key={i}>
                                          {data?.payload?.tech_lang_keys["23"]} <BlockMath math={`${formData[`tech_y${i + 1}`]} = ${Math.pow(x, 2)}a + ${x}b + c`} />
                                        </p>
                                      ))}
                                  ...
                                  \\end{cases}`} />
                                      ...
                                      <p className="mt-2">{data?.payload?.tech_lang_keys["25"]} <BlockMath math={`a = ${result?.tech_a}, b = ${result?.tech_b}, c = ${result?.tech_c}`} /></p>
                                    </>
                                  )}

                                  {result?.tech_from == 7 && result?.tech_axis == "y" && (
                                    <>
                                      <p className="mt-2">{data?.payload?.tech_lang_keys["17"]}: <BlockMath math={`P_1=(${x1},${y1}), P_2=(${x2},${y2}), P_3=(${x3},${y3})`} /></p>
                                      <p className="mt-2">{data?.payload?.tech_lang_keys["22"]} <BlockMath math={`x = ay^2 + by + c`} /></p>
                                      {[y1, y2, y3].map((y, i) => (
                                        <p className="mt-2" key={i}>
                                          {data?.payload?.tech_lang_keys["23"]} <BlockMath math={`${formData[`tech_x${i + 1}`]} = ${Math.pow(y, 2)}a + ${y}b + c`} />
                                        </p>
                                      ))}
                                      <p className="mt-2">{data?.payload?.tech_lang_keys["24"]}
                                        <BlockMath math={`\begin{cases}${a1}a + ${y1}b + c = ${x1} \\ ${a2}a + ${y2}b + c = ${x2} \\ ${a3}a + ${y3}b + c = ${x3}\end{cases}`} />
                                      </p>
                                      <p className="mt-2">{data?.payload?.tech_lang_keys["25"]} <BlockMath math={`a = ${result?.tech_a}, b = ${result?.tech_b}, c = ${result?.tech_c}`} /></p>
                                    </>
                                  )}
                                ...
                                {(formData?.tech_axis!=='y') && (
                                  <>
                                  <div id="box1" className="w-full md:w-[80%] lg:w-[80%] mt-4 mx-auto" >

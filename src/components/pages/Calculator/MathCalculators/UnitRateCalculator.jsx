            ...
            {formError && (
             ...
             <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
                  ...
                  <div className="col-span-12 flex items-center">
                      <div className="px-2">
                          <p className="font-s-14 text-blue text-center py-2"><strong>({data?.payload?.tech_lang_keys[1]})</strong></p>
                            <input
                                type="text"
                                step="any"
                                name="tech_a"
                      ...
                      <div className="px-2">
                          <p className="font-s-14 text-blue text-center py-2"><strong>({data?.payload?.tech_lang_keys[2]})</strong></p>
                            <input
                              type="text"
                              step="any"
                              name="tech_c"
                        ...
                        <div className="w-full mt-3">
                          <div className="w-full">
                            ...
                            <div className="w-full text-[16px] overflow-auto">
                              ...
                              <p className="mt-3">
                                {result?.tech_ans} {formData?.tech_c} per {formData?.tech_d}
                              </p>

                              <p className="mt-3">{data?.payload?.tech_lang_keys[5]}:</p>
                              <p className="mt-3">{data?.payload?.tech_lang_keys[3]} = a/b</p>
                              <p className="mt-3">
                                {data?.payload?.tech_lang_keys[3]} = {formData?.tech_a}/{formData?.tech_b} ={' '}
                              ...
                              <p className="mt-3">{data?.payload?.tech_lang_keys[3]} = a/b  u1/u2</p>
                              <p className="mt-3">
                                {data?.payload?.tech_lang_keys[3]} = {formData?.tech_a}/{formData?.tech_b} ={' '}
                              ...
                              <p className="mt-3">
                                {data?.payload?.tech_lang_keys[3]} = {result?.tech_ans} {formData?.tech_c} / {formData?.tech_d}
                              </p>

                              <p className="mt-3">{data?.payload?.tech_lang_keys[7]}:</p>
                              <p className="mt-3">{data?.payload?.tech_lang_keys[8]} = a:b</p>
                              <p className="mt-3">
                                {data?.payload?.tech_lang_keys[8]} = {formData?.tech_a}:{formData?.tech_b} ={' '}

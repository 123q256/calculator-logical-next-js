                        ...
                        <div className="w-full">
                          ...
                          <div className="w-full md:w-[80%] lg:w-[60%] overflow-auto mt-2">
                            <table className="w-full text-[16px]">
                              <tbody>
                                <tr>
                                  <td className="py-2 border-b w-[60%]"><strong>Time in Hours</strong></td>
                                  <td className="py-2 border-b">{result?.tech_hours}</td>
                                </tr>
                                <tr>
                                  <td className="py-2 border-b w-[60%]"><strong>Time in Minutes</strong></td>
                                  <td className="py-2 border-b">{result?.tech_mins}</td>
                                </tr>
                                <tr>
                                  <td className="py-2 border-b w-[60%]"><strong>Time in Seconds</strong></td>
                                  <td className="py-2 border-b">{result?.tech_secs}</td>
                                </tr>
                              </tbody>
                            </table>
                          </div>
                          ...
                          <div className="w-full text-[16px] mt-2 overflow-auto">
                            ...
                            <p className="mt-2">
                              {data?.payload?.tech_lang_keys[6]}: {`${result?.tech_hour}:${result?.tech_min}:${result?.tech_sec}`} (
                            ...
                            <p className="mt-2">
                              = {result?.tech_hour}hr + {Number(result?.tech_min / 60).toFixed(3)}hr + {Number(result?.tech_sec / 3600).toFixed(3)}hr
                            </p>
                            ...
                            <p className="mt-2">
                              ({result?.tech_hour}hr × 60min) + {result?.tech_min}min + ({result?.tech_sec}sec × 
                              <span className="quadratic_fraction">
                            ...
                            <p className="mt-2">
                              = {result?.tech_hour * 60}min + {result?.tech_min}min + {Number(result?.tech_sec / 60).toFixed(3)}min
                            </p>
                            <p className="mt-2">= {result?.tech_mins}min</p>

                            <p className="mt-2">{data?.payload?.tech_lang_keys[9]}</p>
                            <p className="mt-2">
                              ({result?.tech_hour}hr × 3600sec) + ({result?.tech_min}min × 60sec) + {result?.tech_sec}sec
                            </p>
                            <p className="mt-2">
                              = {result?.tech_hour * 3600}sec + {result?.tech_min * 60}sec + {result?.tech_sec}sec
                            </p>

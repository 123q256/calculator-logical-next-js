                ...
                <div className="grid grid-cols-12 mt-3 gap-2 md:gap-4 lg:gap-4">
                    ...
                    <div className="col-span-12">
                        {formData.tech_convert == "1" ? (
                          <>
                          <label htmlFor="tech_select_unit" className="label">  Select Type of Fraction:</label>
                          </>
                        ):(
                          <>
                          <label htmlFor="tech_select_unit" className="label"> {data?.payload?.tech_lang_keys["4"]}:</label>
                          </>
                        )}
                    ...
                    <div className="col-span-12 flex tems-center px-2">
                        <div>
                            {formData.tech_select_unit == "2" ? (
                              <>
                              <label htmlFor="tech_first_number" className="label">   Part:</label>
                              </>
                            ):(
                              <>
                              <label htmlFor="tech_first_number" className="label">  A :</label>
                              </>
                            )}
                        ...
                        <div>
                           ...
                           {formData.tech_select_unit == "2" ? (
                              <>
                              <label htmlFor="tech_second_number" className="label">   Whole:</label>
                              </>
                            ):(
                              <>
                              <label htmlFor="tech_second_number" className="label">  B :</label>
                              </>
                            )}
                                <div className=" relative">
                                <input
                              ...
                              <div className="w-full text-[16px] overflow-auto">
                                {result.tech_method == "1" && (
                                  ...
                                  />
                                    ...
                                    />
                                    <p className="mt-3">
                                      <BlockMath math={`\\text{ ${data?.payload?.tech_lang_keys['9']} }:`} />
                                    </p>
                                    <p className="mt-3">
                                      <BlockMath math={`\\text{ ${data?.payload?.tech_lang_keys['10']} }`} />
                                    </p>
                                    <BlockMath
                                      math={`${data?.payload?.tech_lang_keys['16']} = ${result.tech_first_number} + ${result.tech_second_number} = ${result.tech_addition}`}
                                    />
                                    <BlockMath math={`\\text{ ${data?.payload?.tech_lang_keys['11']} }:`} />
                                    <BlockMath math={`\\text{ ${data?.payload?.tech_lang_keys['12']} }`} />
                                 <BlockMath
                                ...
                                />
                                    ...
                                    <BlockMath math={`\\text{ ${data?.payload?.tech_lang_keys['15']} }:`} />
                                    {result.tech_upr1 == result.tech_first_number && result.tech_upr2 == result.tech_second_number ? (
                                      <BlockMath math={`\\text{ ${data?.payload?.tech_lang_keys['13']} }`} />
                                    ) : (
                                      <>
                                        <BlockMath math={`\\text{ ${data?.payload?.tech_lang_keys['14']} }`} />
                                        <BlockMath
                                ...
                                {result.tech_method == "2" && (
                                  <>
                                    ...
                                    <p className="mt-3 font-bold">{data?.payload?.tech_lang_keys['8']}:</p>
                                    <BlockMath math={`\\text{ ${data?.payload?.tech_lang_keys['9']} }:`} />
                                    <BlockMath math={`\\text{ ${data?.payload?.tech_lang_keys['22']} }`} />
                                    <BlockMath
                                      math={`${result.tech_first_number}:${result.tech_second_number} = \\frac{${result.tech_first_number}}{${result.tech_second_number}}`}
                                    />
                                    <BlockMath math={`\\text{ ${data?.payload?.tech_lang_keys['11']} }`} />
                                    {result.tech_upr2 == result.tech_first_number && result.tech_btm2 == result.tech_second_number ? (
                                      <BlockMath math={`\\text{ ${data?.payload?.tech_lang_keys['18']} }`} />
                                    ) : (
                                      <>
                                        <BlockMath math={`\\text{ ${data?.payload?.tech_lang_keys['23']} }`} />
                                        <BlockMath
                                ...
                                {result.tech_method == "3" && (
                                  <>
                                    <p className="mt-3 text-[21px]">
                                      <BlockMath math={`${result.tech_upr1}:${result.tech_upr2}`} />
                                    </p>
                                    <p className="mt-3 font-bold">{data?.payload?.tech_lang_keys['8']}:</p>
                                    <BlockMath math={`\\text{ ${data?.payload?.tech_lang_keys['9']} }`} />
                                    {result.tech_upr1 == result.tech_first_number && result.tech_upr2 == result.tech_second_number ? (
                                      ...
                                      <>
                                        <BlockMath math={`\\text{ ${data?.payload?.tech_lang_keys['19']} }`} />
                                        <BlockMath
                                    ...
                                    <BlockMath math={`\\text{ ${data?.payload?.tech_lang_keys['11']} }:`} />
                                    <BlockMath math={`\\text{ ${data?.payload?.tech_lang_keys['20']} }`} />
                                    <BlockMath
                                ...
                                {result.tech_method == "4" && (
                                  <p className="my-3 text-center">
                                    <strong className="bg-white px-3 py-2 text-[32px] rounded-lg text-blue">
                                      <BlockMath math={`\\color{#1670a7}${result.tech_upr1}:\\color{#1670a7}${result.tech_btm1}`} />
                                    </strong>
                                  </p>
                                )}
                              </div>

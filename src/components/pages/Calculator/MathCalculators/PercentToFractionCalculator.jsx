                  ...
                  <div className="w-full">
                        ...
                        <tbody>
                          <tr>
                            <td className="py-2 border-b" width="55%">
                              <strong>
                                {data?.payload?.tech_lang_keys['ans']} {formData?.tech_percent}% =
                              </strong>
                            </td>
                            <td className="py-2 border-b">
                              <InlineMath math={`\\dfrac{${result?.tech_uper}}{${result?.tech_btm}}`} />
                            </td>
                          </tr>
                        </tbody>
                      </table>
                    ...
                    <div className="w-full overflow-auto">
                      ...
                      <p className="mt-2">
                        ...
                        <InlineMath math={`\\dfrac{${formData?.tech_percent}}{100}`} /> = {formData?.tech_percent / 100}
                      </p>

                      <p className="mt-2">
                        {data?.payload?.tech_lang_keys['step']} # 2 ={' '}
                        <InlineMath math={`\\dfrac{${result?.tech_upr}}{${result?.tech_div}}`} />
                      </p>
                      ...
                      {result?.tech_uper > result?.tech_btm && result?.tech_btm !== '1' && (
                        <p className="mt-2">
                          {data?.payload?.tech_lang_keys['or']} = {Math.floor(result?.tech_uper / result?.tech_btm)}{' '}
                          <InlineMath
                            math={`\\dfrac{${result?.tech_uper % result?.tech_btm}}{${result?.tech_btm}}`}
                          />
                        </p>
                      )}
                    </div>

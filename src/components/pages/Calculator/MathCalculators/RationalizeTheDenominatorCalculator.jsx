            ...
            <div class="lg:w-[60%] md:w-[60%] w-full mx-auto ">
                <div class="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                    <div class="col-span-12 flex items-center justify-evenly">
                        <p class="font-s-14 text-blue"><strong>{ data?.payload?.tech_lang_keys[1] }:</strong></p>
                        <p id="fInput">
                          ...
                          <div class="grid grid-cols-12    gap-2 md:gap-4 lg:gap-4">
                              <div class="col-span-12 px-2">
                                ...
                                {formData.tech_operations == "4" && (
                                  <p className="col-span-12 text-[25px] mt-0 mt-lg-2 text-center">
                                    <InlineMath math={`\\frac{a\\sqrt{b} + c\\sqrt{d}}{x\\sqrt{y} + k\\sqrt{u}} = ?`} />
                                  </p>
                                )}
                              </div>


                              <p class="col-span-12"><strong>{ data?.payload?.tech_lang_keys[7] }</strong></p>
                              ...
                              <p class="col-span-12"><strong>{ data?.payload?.tech_lang_keys[8] }</strong></p>
                                ...
                                {formData?.tech_type == "first" ? (
                                  <>
                                    ...
                                    <div className="w-full all_result">
                                      <p className="mt-3">{/* you can place extra output here */}</p>
                                    </div>
                                    <p className="mt-3">
                                      = &nbsp;&nbsp;&nbsp;&nbsp;
                                      <span className="main_jawab"></span>

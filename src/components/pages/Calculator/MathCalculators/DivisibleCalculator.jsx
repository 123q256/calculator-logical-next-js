                        ...
                        <div className="w-full mt-3">
                          <div className="w-full text-[16px] overflow-auto">
                            <p className="mt-2 text-[20px] mb-2">
                              <strong>
                                {result?.tech_number} <span className="black-text">{data?.payload?.tech_lang_keys[4]}{' '}
                                  {result?.tech_modulus === 0
                                    ? data?.payload?.tech_lang_keys[5]
                                    : data?.payload?.tech_lang_keys[6]}{' '}
                                  {data?.payload?.tech_lang_keys[7]}
                                </span> {result?.tech_divisible}
                              </strong>
                            </p>
                            ...
                            {summaryText && (
                              <>
                                <strong>Divisibility Rule For {divisibleNumber}:</strong>
                          ...
                          <thead>
                            <tr className="bg-[#2845F5] text-white">
                              <th className="py-2 px-4 border border-gray-400">Number</th>
                              <th className="py-2 px-4 border border-gray-400">Divisor?</th>
                            </tr>
                          </thead>
                          <tbody>
                            {[...Array(12)].map((_, i) => {
                              const divisor = i + 2;
                              const divisible = formData?.tech_no % divisor === 0;
                              return (
                                <tr key={divisor} className="hover:bg-gray-50">
                                  <td className="py-2 px-4 border border-gray-400 text-center ">{divisor}</td>

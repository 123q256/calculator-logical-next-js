        ...
        <form className="row" onSubmit={handleSubmit}>
          <div className="w-full mx-auto p-4 lg:p-8 md:p-8 bg-white rounded-lg shadow-md space-y-6 mb-3">
            ...
            <div class="lg:w-[60%] md:w-[60%] w-full mx-auto ">
                ...
                <div class="col-span-12 md:col-span-7">
                    ...
                    <div class="col-span-12">
                        {( formData.tech_given == "1" || formData.tech_given == "2"  || formData.tech_given == "3"  || formData.tech_given == "4" ) && (
                          <>
                          <div class="col-12 mt-0 mt-lg-2  lsInput">
                          ...
                          <>
                          <div class="col-12 mt-0 mt-lg-2 ssInput">
                          ...
                          <>
                          <div class="col-12 mt-0 mt-lg-2  areaInput">
                          ...
                          <>
                            <div class="col-12 mt-0 mt-lg-2  perimeterInput">
                          ...
                          <>
                          <div class="col-12 mt-0 mt-lg-2 angleInput">
                          ...
                          <>
                          <div class="col-12 mt-0 mt-lg-2  circumInput">
                ...
                <div class="col-span-12 md:col-span-5 flex items-center text-center">
                                    ...
                                    <table class="w-full font-s-18">
                                        {(result?.tech_lsv != "") && (
                                          <>
                                            ...
                                            <tr>
                                                <td class="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys[1]}</strong></td>
                                                <td class="py-2 border-b">{Number(result?.tech_lsv).toFixed(3)} cm</td>
                                            </tr>
                                          </>
                                        )}
                                            {(result?.tech_ssv != "") && (
                                          <>
                                            ...
                                            <tr>
                                                <td class="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys[2]}</strong></td>
                                                <td class="py-2 border-b">{Number(result?.tech_ssv).toFixed(3)} cm</td>
                                            </tr>
                                          </>
                                        )}
                                        {(result?.tech_area != "") && (
                                          <>
                                            ...
                                            <tr>
                                                <td class="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys[3]}</strong></td>
                                                <td class="py-2 border-b">{Number(result?.tech_area).toFixed(3)} cm²</td>
                                            </tr>
                                          </>
                                        )}
                                        {(result?.tech_perimeter != "") && (
                                          <>
                                            ...
                                            <tr>
                                                ...
                                                <td class="py-2 border-b">{Number(result?.tech_perimeter).toFixed(3)} cm</td>
                                            </tr>
                                          </>
                                        )}
                                        {(result?.tech_radius != "") && (
                                          <>
                                            <tr>
                                                <td class="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys[6]}</strong></td>
                                                <td class="py-2 border-b">{Number(result?.tech_radius).toFixed(3)} cm</td>
                                            </tr>
                                        ...
                                        {(result?.tech_angle_α != "") && (
                                          <>
                                            <tr>
                                                <td class="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys[8]}</strong></td>
                                                <td class="py-2 border-b">{Number(result?.tech_angle_α).toFixed(3)} rad</td>
                                            </tr>
                                        ...
                                        {(result?.tech_diagonal != "") && (
                                          <>
                                            <tr>
                                                <td class="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys[7]}</strong></td>
                                                <td class="py-2 border-b">{Number(result?.tech_diagonal).toFixed(3)} rad</td>
                                            </tr>

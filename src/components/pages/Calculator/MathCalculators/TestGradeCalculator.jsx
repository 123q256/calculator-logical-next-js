    ...
    >
        ...
        <div className="lg:w-[60%] md:w-[90%] w-full mx-auto ">
          <div className="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
            ...
            <p className="col-span-12 text-center mt-3 mb-1"><strong>{ data?.payload?.tech_lang_keys['5'] }</strong></p>
                            ...
                            <div className="w-full">
                                ...
                                <table className="w-full text-[16px]">
                                  <tbody>
                                    <tr>
                                      ...
                                      <td className="py-2 border-b">{result?.tech_per} %</td>
                                    </tr>
                                    <tr>
                                      <td className="py-2 border-b">
                                        <strong>{data?.payload?.tech_lang_keys['8']}</strong>
                                      </td>
                                      <td className="py-2 border-b">{result?.tech_letter_ans}</td>
                                    </tr>
                                    <tr>
                                      <td className="py-2 border-b">
                                        <strong>{data?.payload?.tech_lang_keys['9']}</strong>
                                      </td>
                                      <td className="py-2 border-b">{result?.tech_correct}</td>
                                    </tr>
                                    <tr>
                                      <td className="py-2 border-b">
                              ...
                              <div className="w-full mt-3 text-center overflow-auto">
                                <table className="w-full text-[16px]">
                                  ...
                                  <tbody>
                                    {(result?.tech_q_array || []).slice(0, -1).map((q, i) => (
                                      <tr key={i}>
                                        <td className="py-2 border-b">{q}</td>
                                        <td className="py-2 border-b">{result?.tech_i_array[i]}</td>
                                        <td className="py-2 border-b">{result?.tech_g_array[i]}</td>
                                        <td className="py-2 border-b">{result?.tech_l_array[i]}</td>
                                      </tr>
                                    ))}
                                  </tbody>
                                </table>

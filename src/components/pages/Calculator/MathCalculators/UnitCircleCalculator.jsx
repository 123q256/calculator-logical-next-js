              ...
              <div class="lg:w-[40%] md:w-[40%] w-full mx-auto ">
                  <div class="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                    ...
                    <div class="col-span-12 flex justify-center text-center">
                        <img   src="/images/unit-circle.webp" height="250px" width="250px" alt="MAD Formula"  loading="lazy" decoding="async"/>
                    </div>
               </div>
            </div>
                                  ...
                                  <tbody>
                                    <tr>
                                      <td className="py-2 border-b" style={{ width: '60%' }}>
                                        <strong>
                                          {`sin(${formData?.tech_angle}${angleUnitDisplay()})`}
                                        </strong>
                                      </td>
                                    ...
                                    <tr>
                                      <td className="py-2 border-b" style={{ width: '60%' }}>
                                        <strong>
                                          {`cos(${formData?.tech_angle}${angleUnitDisplay()})`}
                                        </strong>
                                      </td>
                                    ...
                                    <tr>
                                      <td className="py-2 border-b" style={{ width: '60%' }}>
                                        <strong>
                                          {`tan(${formData?.tech_angle}${angleUnitDisplay()})`}
                                        </strong>
                                      </td>

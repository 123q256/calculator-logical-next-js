                ...
                <div class="col-span-6">
                    <div class="col-12 mt-0 mt-lg-2">
                      ...
                      <div className="mt-2">
                        ...
                        >
                        <option value="aa">{data?.payload?.tech_lang_keys['2']} A</option>
                          <option value="ab">{data?.payload?.tech_lang_keys['2']} B</option>
                          <option value="ac">{data?.payload?.tech_lang_keys['2']} C</option>
                          <option value="sa">{data?.payload?.tech_lang_keys['3']} a</option>
                          <option value="sb">{data?.payload?.tech_lang_keys['3']} b</option>
                          <option value="sc">{data?.payload?.tech_lang_keys['3']} c</option>
                        </select>
                      </div>
                    </div>
                    <div class="col-12 mt-0 mt-lg-2" id="a">
                    ...
                    <div class="col-12 mt-0 mt-lg-2 " id="b">
                    ...
                    <div class="col-12 mt-0 mt-lg-2 " id="c">
                  ...
                  <div className="">
                    <div className="col-12 text-[20px] text-center flex items-center justify-center">
                      {formData.tech_cal === "aa" && (
                        <BlockMath math={`A = \\cos^{-1} \\left( \\dfrac{b^2 + c^2 - a^2}{2bc} \\right)`} />
                      )}

                      {formData.tech_cal === "ab" && (
                        <BlockMath math={`B = \\cos^{-1} \\left( \\dfrac{a^2 + c^2 - b^2}{2ac} \\right)`} />
                      )}

                      {formData.tech_cal === "ac" && (
                        <BlockMath math={`C = \\cos^{-1} \\left( \\dfrac{a^2 + b^2 - c^2}{2ab} \\right)`} />
                      )}
                      ...
                      <div class="">
                          <img  src="/images/law_of_cosines.webp" width="75%" height="100%" alt="Law of Cosines" loading="lazy" decoding="async"/>
                      </div>
                      ...
                      <div class="rounded-lg  flex items-center justify-center">
                        <div class="w-full mt-3">
                                ...
                                <tbody>
                                  <tr>
                                    <td className="py-2 border-b" width="60%">
                                      <strong>
                                        {formData?.tech_cal === 'aa' && `${data?.payload?.tech_lang_keys['2']} A`}
                                        {formData?.tech_cal === 'ab' && `${data?.payload?.tech_lang_keys['2']} B`}
                                        {formData?.tech_cal === 'ac' && `${data?.payload?.tech_lang_keys['2']} C`}
                                        {formData?.tech_cal === 'sa' && `${data?.payload?.tech_lang_keys['3']} a`}
                                        {formData?.tech_cal === 'sb' && `${data?.payload?.tech_lang_keys['3']} b`}
                                        {formData?.tech_cal === 'sc' && `${data?.payload?.tech_lang_keys['3']} c`}
                                      </strong>
                                    </td>
                                    <td className="py-2 border-b">
                                      {formData?.tech_cal === 'aa' && `${Number(result?.tech_angle_a).toFixed(5)}°`}
                                      {formData?.tech_cal === 'ab' && `${Number(result?.tech_angle_b).toFixed(5)}°`}
                                      {formData?.tech_cal === 'ac' && `${Number(result?.tech_angle_c).toFixed(5)}°`}
                                      {formData?.tech_cal === 'sa' && `${Number(result?.tech_side_a).toFixed(5)} cm`}
                                      {formData?.tech_cal === 'sb' && `${Number(result?.tech_side_b).toFixed(5)} cm`}
                                      {formData?.tech_cal === 'sc' && `${Number(result?.tech_side_c).toFixed(5)} cm`}
                                    </td>
                                  </tr>
                                </tbody>
                              </table>
                            ...
                            <div class="col-span-12  text-[16px]">
                                <p class="mt-2"><strong>{data?.payload?.tech_lang_keys['4']}:</strong></p>
                              <div className="col-12 font-s-20 text-center flex flex-col items-center">
                                {formData?.tech_cal === 'aa' && (
                                  <>
                                    <p className="mt-2">{data?.payload?.tech_lang_keys['5']} {data?.payload?.tech_lang_keys['2']} A</p>
                                    <BlockMath math={`A = \\cos^{-1} \\left( \\dfrac{b^2 + c^2 - a^2}{2bc} \\right)`} />
                                    <BlockMath math={`A = \\cos^{-1} \\left( \\dfrac{${result?.tech_side_b}^2 + ${result?.tech_side_c}^2 - ${result?.tech_side_a}^2}{2 \\times ${result?.tech_side_b} \\times ${result?.tech_side_c}} \\right)`} />
                                ...
                                {formData?.tech_cal === 'ab' && (
                                  <>
                                    <p className="mt-2">{data?.payload?.tech_lang_keys['5']} {data?.payload?.tech_lang_keys['2']} B</p>
                                    <BlockMath math={`B = \\cos^{-1} \\left( \\dfrac{a^2 + c^2 - b^2}{2ac} \\right)`} />
                                    <BlockMath math={`B = \\cos^{-1} \\left( \\dfrac{${result?.tech_side_a}^2 + ${result?.tech_side_c}^2 - ${result?.tech_side_b}^2}{2 \\times ${result?.tech_side_a} \\times ${result?.tech_side_c}} \\right)`} />
                                ...
                                {formData?.tech_cal === 'ac' && (
                                  <>
                                    <p className="mt-2">{data?.payload?.tech_lang_keys['5']} {data?.payload?.tech_lang_keys['2']} C</p>
                                    <BlockMath math={`C = \\cos^{-1} \\left( \\dfrac{a^2 + b^2 - c^2}{2ab} \\right)`} />
                                    <BlockMath math={`C = \\cos^{-1} \\left( \\dfrac{${result?.tech_side_a}^2 + ${result?.tech_side_b}^2 - ${result?.tech_side_c}^2}{2 \\times ${result?.tech_side_a} \\times ${result?.tech_side_b}} \\right)`} />
                                ...
                                {formData?.tech_cal === 'sa' && (
                                  <>
                                    <p className="mt-2">{data?.payload?.tech_lang_keys['5']} {data?.payload?.tech_lang_keys['3']} a</p>
                                    <BlockMath math={`a = \\sqrt{b^2 + c^2 - 2bc \\cos A}`}/>
                                    <BlockMath math={`a = \\sqrt{${result?.tech_side_b}^2 + ${result?.tech_side_c}^2 - 2 \\times ${result?.tech_side_b} \\times ${result?.tech_side_c} \\cos(${result?.tech_angle_a}^\\circ)}`} />
                                ...
                                {formData?.tech_cal === 'sb' && (
                                  <>
                                    <p className="mt-2">{data?.payload?.tech_lang_keys['5']} {data?.payload?.tech_lang_keys['3']} b</p>
                                    <BlockMath math={`b = \\sqrt{a^2 + c^2 - 2ac \\cos B}`} />
                                    <BlockMath math={`b = \\sqrt{${result?.tech_side_a}^2 + ${result?.tech_side_c}^2 - 2 \\times ${result?.tech_side_a} \\times ${result?.tech_side_c} \\cos(${result?.tech_angle_b}^\\circ)}`} />
                              ...
                              <div className="mt-2">
                                ...
                                <BlockMath math={`a = ${result?.tech_side_a}\\ \\text{cm}`} />
                                <BlockMath math={`b = ${result?.tech_side_b}\\ \\text{cm}`} />
                                <BlockMath math={`c = ${result?.tech_side_c}\\ \\text{cm}`} />
                                ...
                                <BlockMath math={`P = ${result?.tech_P}\\ \\text{cm}`} />
                                <BlockMath math={`s = ${result?.tech_s}\\ \\text{cm}`} />
                                <BlockMath math={`K = ${result?.tech_K}\\ \\text{cm}^2`} />
                                <BlockMath math={`r = ${result?.tech_r}\\ \\text{cm}`} />
                                <BlockMath math={`R = ${result?.tech_R}\\ \\text{cm}`} />

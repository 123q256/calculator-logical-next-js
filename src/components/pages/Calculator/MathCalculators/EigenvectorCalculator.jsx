                       ...
                       <div className="rounded-lg flex items-center justify-center">
                          <div className="w-full mt-3 text-[16px] overflow-auto">
                            ...
                            {formData?.tech_matrix === '2' ? (
                              ...
                              <BlockMath math={`\left(${res1}, ${res2}, ${res3}\right)`} />
                            )}
                            ...
                            <p className="mt-3 font-bold">{data?.payload?.tech_lang_keys['8']} \lambda {data?.payload?.tech_lang_keys['9']}</p>
                            <BlockMath math={`${d}`} />
                            ...
                            {data?.payload?.tech_lang_keys['12']} ({data?.payload?.tech_lang_keys['6']})
                          </p>

                          {formData?.tech_matrix === '2' ? (
                            <BlockMath
                              math={`(\\lambda_1, \\lambda_2) = \\left(${formatValue(l1)}, ${formatValue(l2)}\\right)`}
                            />
                          ) : (
                            <BlockMath
                              math={`(\\lambda_1, \\lambda_2, \\lambda_3) = \\left(${formatValue(l1)}, ${formatValue(l2)}, ${formatValue(l3)}\\right)`}
                            />
                          )}
                         ...
                         <p className="mt-3 font-bold">
                          ...
                          <BlockMath math={`\\text{a.} \\quad \\lambda = ${latexSafe(eigvals1)}`} />
                          <BlockMath math={`\\quad\\quad ${d} = ${res1}`} />

                          <BlockMath math={`\\text{b.} \\quad \\lambda = ${latexSafe(eigvals2)}`} />
                          <BlockMath math={`\\quad\\quad ${d} = ${res2}`} />

                          {formData?.tech_matrix === '3' && eigvals3 && (
                            <>
                              <BlockMath math={`\\text{c.} \\quad \\lambda = ${latexSafe(eigvals3)}`} />
                              <BlockMath math={`\\quad\\quad ${d} = ${res3}`} />
                            </>
                          )}


                            <p className="mt-3 font-bold">{data?.payload?.tech_lang_keys['6']}</p>
                            {formData?.tech_matrix === '2' ? (
                              <BlockMath math={`(${l1}, ${l2})`} />
                            ) : (
                              <BlockMath math={`(${l1}, ${l2}, ${l3})`} />

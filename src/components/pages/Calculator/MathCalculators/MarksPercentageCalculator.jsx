            ...
            <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
                <div className="grid grid-cols-12 mt-3 gap-2 md:gap-4 lg:gap-4">
                    <div className="col-span-12">
                        <p className="d-inline text-blue pe-4 font-s-14">{data?.payload?.tech_lang_keys['17']}</p>
                      ...
                      <>
                          <div className="col-span-12 " >
                              ...
                              <div className="my-2">
                                ...
                                >
                                    <span className="text-[20px] font-bold">+</span> {data?.payload?.tech_lang_keys["13"]}
                                </button>
                              </div>
                        </div>
                      </>
                            ...
                            <div className="w-full mb-3 overfow-auto">
                              <div className="w-full md:w-[60%] lg:w-[60%]">
                                ...
                                <p className="text-blue text-[18px]">
                                  <strong>{Number(result?.tech_total_scored).toFixed(2)}</strong>
                                </p>
                              </div>
                              <div className="w-full md:w-[60%] lg:w-[60%]">
                                <p className="text-[20px] py-2">
                                ...
                                <p className="text-blue text-[18px]">
                                  <strong>{Number(result?.tech_total_marks).toFixed(2)}</strong>
                                </p>
                              </div>
                            </div>
                          )}
                            ...
                            <div>
                              ...
                              {/* Example formula 2 using formData */}
                               <div className="overflow-auto">
                                <strong>{data?.payload?.tech_lang_keys[4]} = </strong>
                                <span className="fraction flex">
                                  <span className="num">{formData.tech_first}</span>
                                  <span className="den">{formData.tech_second}</span>
                                </span>
                                × 100
                              </div>
                          ...
                          <div className="w-full overflow-auto">
                              ...
                              <tbody>
                                {result?.tech_s_array?.map((value, index) => (
                                  <tr key={index}>
                                    <td className="border-b py-2">{result?.tech_name_array?.[index]}</td>
                                    <td className="border-b py-2">{result?.tech_s_array?.[index]}</td>
                                    <td className="border-b py-2">{result?.tech_a_array?.[index]}</td>
                                  </tr>
                                ))}
                              </tbody>
                            </table>

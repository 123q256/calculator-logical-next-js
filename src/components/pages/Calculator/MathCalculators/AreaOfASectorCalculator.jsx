                                          ...
                                          {(result?.tech_mode==1) ? (
                                            <>
                                              <tr>
                                                  ...
                                                  <td className="py-2 border-b">{Number(result?.tech_area).toFixed(5)} {result?.tech_unit}²</td>
                                              </tr>
                                              <tr>
                                                  <td className="py-2 border-b"><strong>{ data?.payload?.tech_lang_keys['5'] } (L)</strong></td>
                                                  <td className="py-2 border-b">{Number(result?.tech_arc).toFixed(5)} {result?.tech_unit}</td>
                                              </tr>
                                              <tr>
                                                  <td className="py-2 border-b"><strong>{ data?.payload?.tech_lang_keys['6'] } (c)</strong></td>
                                                  <td className="py-2 border-b">{Number(result?.tech_c).toFixed(5)} {result?.tech_unit}</td>
                                              </tr>
                                              <tr>
                                                  <td className="py-2 border-b"><strong>{ data?.payload?.tech_lang_keys['3'] }</strong></td>
                                                  <td className="py-2 border-b">{Number(result?.tech_dia).toFixed(5)} {result?.tech_unit}</td>
                                              </tr>
                                            </>
                                          ): (result?.tech_mode==2) ? (
                                            <>
                                              ...
                                              <tr>
                                                  ...
                                                  <td className="py-2 border-b">{Number(result?.tech_rad).toFixed(5)} {result?.tech_unit}</td>
                                              </tr>
                                            </>
                                          ):(result?.tech_mode==3) ? (
                                            <>
                                              ...
                                              <tr>
                                                  ...
                                                  <td className="py-2 border-b">{Number(result?.tech_angle).toFixed(5)} rad / {Number(rad2deg(result?.tech_angle)).toFixed(5)} deg</td>
                                              </tr>
                                              <tr>
                                                  <td className="py-2 border-b"><strong>{ data?.payload?.tech_lang_keys['5'] } (L)</strong></td>
                                                  <td className="py-2 border-b">{Number(result?.tech_arc).toFixed(5)} {result?.tech_unit}</td>

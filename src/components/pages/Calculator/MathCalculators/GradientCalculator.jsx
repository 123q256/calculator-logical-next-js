            ...
            <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
                ...
                <div className="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                    ...
                    <div className="col-span-12">
                        ...
                        <>
                          <label htmlFor="EnterEq" className="font-s-14 text-blue" id="functionText">   {data?.payload?.tech_lang_keys['2']} f(x, y, z):</label>
                        </>
                        ):(
                          <>
                            <label htmlFor="EnterEq" className="font-s-14 text-blue" id="functionText"> {data?.payload?.tech_lang_keys['2']} f(x, y):</label>
                          </>
                        )}
                          ...
                          <div className="w-full">
                              <div className="w-full  overflow-auto">
                                { formData?.tech_type === 'two' ? (
                                    ...
                                    <div className="w-full mt-3">
                                      <button type="button" className="calculate repeat" style={{ fontSize: 16, padding: 10, cursor: 'pointer' }}>
                                    ...
                                    <div className="w-full mt-3">
                                      <button type="button" className="calculate repeat1" style={{ fontSize: 16, padding: 10, cursor: 'pointer' }}>
                                        {data?.payload?.tech_lang_keys['5']}
                                      </button>
                                    </div>
                                    ...
                                    <div className="w-full mt-3">
                                      <button type="button" className="calculate repeat2" style={{ fontSize: 16, padding: 10, cursor: 'pointer' }}>
                                        {data?.payload?.tech_lang_keys['5']}
                                      </button>
                                    </div>

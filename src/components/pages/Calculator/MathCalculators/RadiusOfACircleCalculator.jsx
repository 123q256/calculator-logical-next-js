               ...
               {(formData.tech_operations == "1" || formData.tech_operations == "3") && (
                  ...
                  <div className="col-span-12" id="f_input">
                        {formData.tech_operations == "3" ?(
                          <>
                          <label htmlFor="tech_first" className="label" > { data?.payload?.tech_lang_keys["4"]}  (d):</label>
                          </>
                        ):(
                          <>
                          <label htmlFor="tech_first" className="label" > { data?.payload?.tech_lang_keys["5"]}  (c):</label>
                          </>
                        )}
                ...
                {formData.tech_operations == "2" && (
                  ...
                  <div className="col-span-12 " id="areaInput">
                          ...
                          <label htmlFor="tech_second" className="label" > { data?.payload?.tech_lang_keys["3"]}  ((A)</label>
                          <div className="relative w-full ">
                            <input
                              type="number"
                              name="tech_second"
                                ...
                                <div className="w-full md:w-[90%] lg:w-[80%] overflow-auto mt-2">
                                    <table className="w-full text-[16px]">
                                        {(result?.tech_radius) && (
                                          <>
                                            <tr>
                                                <td className="py-2 border-b" width="40%"><strong>{ data?.payload?.tech_lang_keys['6'] }</strong></td>
                                                <td className="py-2 border-b">{Number(result?.tech_radius).toFixed(2)} cm</td>
                                            </tr>
                                          </>
                                        )}
                                        {(result?.tech_circum) && (
                                          <>
                                            <tr>
                                                <td className="py-2 border-b" width="40%"><strong>{ data?.payload?.tech_lang_keys['5'] }</strong></td>
                                                <td className="py-2 border-b">{Number(result?.tech_circum).toFixed(2)} cm</td>
                                            </tr>
                                          </>
                                        )}
                                        {(result?.tech_area) && (
                                          <>
                                            <tr>
                                                <td className="py-2 border-b" width="40%"><strong>{ data?.payload?.tech_lang_keys['3'] }</strong></td>
                                                <td className="py-2 border-b">{Number(result?.tech_area).toFixed(2)} cm²</td>
                                            </tr>
                                          </>
                                        )}
                                        {(result?.tech_diameter) && (
                                          <>
                                            ...
                                            <tr>
                                                <td className="py-2 border-b" width="40%"><strong>{ data?.payload?.tech_lang_keys['4'] }</strong></td>
                                                <td className="py-2 border-b">{Number(result?.tech_diameter).toFixed(2)} cm</td>
                                            </tr>
                                          </>
                                        )}
                                    </table>

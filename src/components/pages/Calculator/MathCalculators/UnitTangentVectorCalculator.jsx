...
// result
  ...
  const renderPregReplaced = (expr) =>
    expr?.replace(/\(t/g, `(${result?.t}`);

    const displayVecT = (label) => (
    <p className="mt-3 font-s-20">
      <strong>
        <InlineMath
          math={`\\vec T (${label}) = (${Number(result?.tech_ans).toFixed(5)}, ${Number(
            result?.tech_ans1
          ).toFixed(5)}, ${Number(result?.tech_ans2).toFixed(5)})`}
        />
      </strong>
    </p>
  );
            ...
            {formError && (
             ...
             < div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
                        ...
                        <div className="col-span-12 mt-0 mt-lg-2 text-[14px]">
                            <p><strong> {data?.payload?.tech_lang_keys['1']}</strong></p>
                        </div>
                        <div className="col-span-12 mt-2 flex items-center">
                            <p className="text-[18px]" ><strong>r(t) = (</strong></p>
                            <div className="mx-2">
                                <input
                                type="text"
                                step="any"
                            ...
                            <p className="text-[18px]"><strong>,</strong></p>
                            <div className="mx-2">
                                <input
                                type="text"
                                step="any"
                        ...
                        <div className="col-span-12 mt-3 flex items-center">
                            <p className="text-[18px]"><strong>at t =</strong></p>
                            <div className="mx-2">
                                  <input
                                type="number"
                                step="any"
                    ...
                    <div className="w-full mt-3">
                        <div className="w-full text-[16px] overflow-auto">
                            ...
                            {(result?.check=='method1') ? (
                              ...
                              <>
                                    {result?.t ? (
                                      <p className="mt-3 font-s-20">
                                        <strong>
                                          <InlineMath
                                            math={`\\vec T (${result?.t}) = (${Number(result?.tech_res).toFixed(
                                              5
                                            )}, ${Number(result?.tech_res1).toFixed(5)}, ${Number(
                                              result?.tech_res2
                                            ).toFixed(5)})`}
                                          />
                                        </strong>
                                      ...
                                      <p className="mt-3 font-s-20">
                                        <InlineMath
                                          math={`\\vec T (t) = \\left( ${renderFraction(
                                            result?.tech_deriv
                                          )}, ${renderFraction(result?.tech_deriv1)}, ${renderFraction(
                                            result?.tech_deriv2
                                          )} \\right)`}
                                        />
                                      </p>
                                    ...
                                    <p className="mt-3">{data?.payload?.tech_lang_keys["5"]} r(t)</p>
                                    ...
                                    <div className="w-full my-3">
                                      <button type="button" className="calculate repeat">
                                        {data?.payload?.tech_lang_keys["6"]}
                                      </button>
                                    </div>
                                    <div className="w-full res_step hidden" id="step_cal">
                                      {result?.tech_steps}
                                    </div>
                                    ...
                                    <div className="w-full my-3">
                                      <button type="button" className="calculate repeat1">
                                        {data?.payload?.tech_lang_keys["6"]}
                                      </button>
                                    </div>
                                    <div className="w-full res_step hidden" id="step_cal1">
                                      {result?.tech_steps1}
                                    </div>
                                    ...
                                    <div className="w-full my-3">
                                      <button type="button" className="calculate repeat2">
                                        {data?.payload?.tech_lang_keys["6"]}
                                      </button>
                                    </div>
                                    <div className="w-full res_step hidden" id="step_cal2">
                                      {result?.tech_steps2}
                                    </div>
                                    ...
                                    <p className="mt-3">
                                      <InlineMath math={`||\\vec r'(t)|| = \\sqrt{${result?.tech_eq_solve}}`} />
                                    </p>

                                    <p className="mt-3">{data?.payload?.tech_lang_keys["9"]}</p>
                                    <p className="mt-3">
                                      <InlineMath math={`\\vec T (t) = \\frac{\\vec r(t)}{||\\vec r(t)||}`} />
                                    </p>
                                    <p className="mt-3">
                                      <InlineMath
                                    ...
                                    {result?.t && (
                                      <>
                                        <p className="mt-3">
                                          <InlineMath
                                            math={`\\vec T (${result?.t}) = \\left( \\frac{${renderPregReplaced(
                                              result?.tech_deriv
                                              ...
                                              result?.tech_deriv2
                                            )}}{\\sqrt{${renderPregReplaced(result?.tech_eq_solve)}}} \\right)`}
                                          />
                                        </p>
                                        <p className="mt-3">
                                          <InlineMath
                              ...
                              <>
                                {result?.t ? displayVecT(result.tech_t) : displayVecT("t")}

                                <p className="mt-3">
                                  <strong>{data?.payload?.tech_lang_keys["4"]}:</strong>
                                </p>
                                <p className="mt-3">
                                  <strong>{data?.payload?.tech_lang_keys["5"]} r(t)</strong>
                                </p>

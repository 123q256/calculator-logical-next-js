...
// result
 ...
 const sin = parseFloat(result?.tech_sin);
  ...
  const sinKey = Object.keys(table).find(key => parseFloat(key) === Math.abs(sin));
          ...
          <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mb-3">
            ...
            <div className="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                ...
                <div className="col-span-12 text-center flex justify-center">
                    <img   src="/images/sin_prop.png" height="100%" width="90%" alt="Cosine Formula Image"  loading="lazy" decoding="async"/>
                </div>
            </div>
        </div>

...
const gtVl = (formData, [a, b]) =>
  Number(formData[`tech_dtrmn_${a}`] || 0) * Number(formData[`tech_dtrmn_${b}`] || 0);
                    ...
                    <div class="col-span-12">
                        <table class="w-full dtrmn_mtrx_tbl">
                            <tr>
                              ...
                              {(formData.tech_dtrmn_slct_method == "3" || formData.tech_dtrmn_slct_method == "4"  || formData.tech_dtrmn_slct_method == "5") && (
                              <>
                                <td class="">
                                    <div class="px-1 ">
                                        <input
                                ...
                                {(formData.tech_dtrmn_slct_method == "4" || formData.tech_dtrmn_slct_method == "5") && (
                              <>
                                <td class="">
                                    <div class="px-1 ">
                                        <input
                    ...
                    <div class="col-span-12 ">
                      <div className="col-span-12">
                        <button
                          ...
                          className="px-3 py-2 mt-1 mx-1 addmore cursor-pointer bg-[#99EA48] rounded-lg"
                        >
                      ...
                      <label htmlFor="tech_dtrmn_opts_method" className="label">
                        ...
                        <div className="mt-2">
                          ...
                          >
                            ...
                            <option value="leibniz">{data?.payload?.tech_lang_keys["7"]} </option>
                            <option value="triangle">{data?.payload?.tech_lang_keys["8"]} </option>
                            <option value="sarrus">{data?.payload?.tech_lang_keys["9"]} </option>
                          </select>
                        </div>
                    </div>
                    {(formData.tech_dtrmn_opts_method == "exp_col" || formData.tech_dtrmn_opts_method == "exp_row") && (
                      <>
                      <div class="col-span-12 md:col-span-6 lg:col-span-6 " id="dtrmn_opts_Input">
                        ...
                        <div className="w-full text-[16px]">
                            ...
                            />
                                 ...
                                 {/* <p class="col s12 font_size16">
                                  <p class="color_blue left-align font_size20" >
                                      { $stepKey } : 5
                                  </p>
                                  <p class="dtrmn_cols">
                                      \(
                              ...
                              (pow(-1, 1 + 1) * dspVl($d4) * (pow(-1, 1 + 1) * dspVl($b1) * (gtVl([$c1, $d1]) - gtVl([$c2, $c5])) + pow(-1, 2 + 1) * dspVl($b5) * (gtVl([$b2, $d1]) - gtVl([$b3, $c5])) + pow(-1, 3 + 1) * dspVl($c4) * (gtVl([$b2, $c2]) - gtVl([$b3, $c1]))) + pow(-1, 2 + 1) * dspVl($d5) * (pow(-1, 1 + 1) * dspVl($a2) * (gtVl([$c1, $d1]) - gtVl([$c2, $c5])) + pow(-1, 2 + 1) * dspVl($b5) * (gtVl([$a3, $d1]) - gtVl([$a4, $c5])) + pow(-1, 3 + 1) * dspVl($c4) * (gtVl([$a3, $c2]) - gtVl([$a4, $c1]))) + pow(-1, 3 + 1) * dspVl($e1) * (pow(-1, 1 + 1) * dspVl($a2) * (gtVl([$b2, $d1]) - gtVl([$b3, $c5])) + pow(-1, 2 + 1) * dspVl($b1) * (gtVl([$a3, $d1]) - gtVl([$a4, $c5])) + pow(-1, 3 + 1) * dspVl($c4) * (gtVl([$a3, $b3]) - gtVl([$a4, $b2]))) + pow(-1, 4 + 1) * dspVl($e2) * (pow(-1, 1 + 1) * dspVl($a2) * (gtVl([$b2, $c2]) - gtVl([$b3, $c1])) + pow(-1, 2 + 1) * dspVl($b1) * (gtVl([$a3, $c2]) - gtVl([$a4, $c1])) + pow(-1, 3 + 1) * dspVl($b5) * (gtVl([$a3, $b3]) - gtVl([$a4, $b2])))) }
                                  ...
                                  <p class="col s12 font_size20">
                                  <p class="color_blue left-align font_size20" >Rule of
                                      Sarrus : </p>
                                  \(
                                  M =
                                  \begin{bmatrix}
                                  ...
                                  <p class="col s12 font_size20">
                                  <p class="color_blue left-align font_size20" >Triangle’s
                                      Rule : </p>
                                  \(
                                  M =
                                  \begin{bmatrix}

              ...
              {formData.tech_type == "m1" && (
                ...
                <div className="col-span-12 row">
                    <div className="flex items-center justify-center">
                        ...
                        <p className="px-2"><strong>=</strong></p>
                        <div className="w-full py-2">
                            <input
                                type="text"
                                step="any"
                              ...
                              {isM1 ? (
                                ...
                                <>
                                  <p className="mt-2 font-s-18 math">
                                    {`${eq} = ${n1} \\quad : \\quad ${pretty(result?.tech_res)}, ${pretty(res1)}`}
                                  </p>
                                  <div className="col-12 text-center my-2">
                                    <p>
                                  ...
                                  {check1 == check11 && check2 != check22 ? (
                                    <>
                                      <p className="mt-2 math">
                                        {`${variableName} = ${pretty(result?.tech_res)} \\quad \\text{(${lang?.['5']})}`}
                                      </p>
                                      <p className="mt-2 math">
                                        {`${variableName} = ${pretty(res1)} \\quad \\text{(${lang?.['6']})}`}
                                      </p>
                                    </>
                                  ) : check11 != check11 && check2 == check22 ? (
                                    <>
                                      <p className="mt-2 math">
                                        {`${variableName} = ${pretty(res1)} \\quad \\text{(${lang?.['5']})}`}
                                      </p>
                                      <p className="mt-2 math">
                                        {`${variableName} = ${pretty(result?.tech_res)} \\quad \\text{(${lang?.['6']})}`}
                                      </p>
                                    </>
                                  ) : null}
                                </>

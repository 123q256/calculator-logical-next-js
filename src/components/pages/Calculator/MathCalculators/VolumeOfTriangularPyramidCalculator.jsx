        ...
        <form className="row" onSubmit={handleSubmit}>
          <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mb-3">
            ...
            <div className="md:col-span-6 col-span-12">
                    ...
                    <div className="col-span-12 tri">
                        ...
                        <div className="mt-2">
                          ...
                          >
                            ...
                            <option value="2">{data?.payload?.tech_lang_keys["6"]} (SSS) </option>
                            <option value="3">{data?.payload?.tech_lang_keys["7"]} (SAS) </option>
                            <option value="4">{data?.payload?.tech_lang_keys["8"]} (ASA)</option>
                          </select>
                        </div>
                    </div>
                  </>
                ...
                {(formData.tech_selection == "1" && formData.tech_triangle_type == "1") && (
                  <>
                ...
                {(formData.tech_selection == "1" && formData.tech_triangle_type == "1") && (
                  ...
                  { ((formData.tech_selection == "1" && formData.tech_triangle_type == "2") || (formData.tech_selection == "1" && formData.tech_triangle_type == "3") || (formData.tech_selection == "1" && formData.tech_triangle_type == "4"))  &&  (
                  <>
                  ...
                  { ((formData.tech_selection == "1" && formData.tech_triangle_type == "2") || (formData.tech_selection == "1" && formData.tech_triangle_type == "3"))  &&  (
                  <>
                  ...
                  { (formData.tech_selection == "1" && formData.tech_triangle_type == "2")  &&  (
                  <>
                  <div className="col-span-12 sidec">
                    ...
                    {(formData.tech_selection == "1" && formData.tech_triangle_type == "4") && (
                      <>
                ...
                {((formData.tech_selection == "1" && formData.tech_triangle_type == "3") ||  (formData.tech_selection == "1" && formData.tech_triangle_type == "4")) && (
                  <>
                <div className="col-span-12 angle_gamma">
                 ...
                 {((formData.tech_selection == "2") || (formData.tech_selection == "1" && formData.tech_triangle_type == "1") || (formData.tech_selection == "1" && formData.tech_triangle_type == "2") || (formData.tech_selection == "1" && formData.tech_triangle_type == "3") || (formData.tech_selection == "1" && formData.tech_triangle_type == "4")) &&  (
                  <>
            ...
            <div className="md:col-span-6 col-span-12 flex items-center ps-lg-3 justify-center">md:
              {formData.tech_selection == "1" && (
                <>

                {formData.tech_triangle_type == '1' && (
                  <>
                    <img  src="/images/picture1.png"  alt="Flow Rate Calculator" width="130" height="130" className="change_img"/> 
                  </>
                )}
                {formData.tech_triangle_type == '2' && (
                  <>
                    <img  src="/images/picture2.png"  alt="Flow Rate Calculator" width="130" height="130" className="change_img"/> 
                  </>
                )}
                {formData.tech_triangle_type == '3' && (
                  <>
                    <img  src="/images/picture3.png"  alt="Flow Rate Calculator" width="130" height="130" className="change_img"/> 
                  </>
                )}
                {formData.tech_triangle_type == '4' && (
                  <>
                    <img  src="/images/picture4.png"  alt="Flow Rate Calculator" width="130" height="130" className="change_img"/> 
                  </>
                )}
                </>
              )}
              {formData.tech_selection == "2" && (
                <>
                <img  src="/images/picture5.png"  alt="Flow Rate Calculator" width="130" height="130" className="change_img"/> 
                </>
              )}
                                        ...
                                        {result?.tech_pba && (
                                          <>
                                            <tr>
                                                ...
                                                <td className="border-b py-2">{Number(result?.tech_pba).toFixed(3)}<span className="text-[14px]"> (cm<sup>2</sup>)</span></td>
                                            </tr>
                                          </>
                                        )}
                                        <tr>
                                            <td width="45%" className="border-b py-2"><strong>{data?.payload?.tech_lang_keys['15']} :</strong></td>
                                            <td className="border-b py-2"><strong>{Number(result?.tech_volume).toFixed(3)}<span className="font_size22 text-[14px]"> (cm<sup>3</sup>)</span> </strong></td>
                                        </tr>
                                        <tr>
                                            <td className="pt-2" colspan="2"><strong>{data?.payload?.tech_lang_keys['16']}</strong></td>
                                        </tr>
                                        <tr>
                                        <td className="border-b py-2">{data?.payload?.tech_lang_keys['15']} :</td>
                                        <td className="border-b py-2">{result?.tech_volume*1000} <span className="text-[14px]">cubic millimeters (mm<sup>3</sup>)</span></td>
                                        </tr>
                                        <tr>
                                        <td className="border-b py-2">{data?.payload?.tech_lang_keys['15']} :</td>
                                        <td className="border-b py-2">{result?.tech_volume*0.001} <span className="text-[14px]"> cubic decimeters (dm<sup>3</sup>)</span></td>
                                        </tr>
                                        <tr>
                                        <td className="border-b py-2">{data?.payload?.tech_lang_keys['15']} :</td>
                                        <td className="border-b py-2">{result?.tech_volume*0.000001} <span className="text-[14px]">cubic meters (m<sup>3</sup>)</span></td>
                                        </tr>
                                        <tr>
                                        <td className="border-b py-2">{data?.payload?.tech_lang_keys['15']} :</td>
                                        <td className="border-b py-2">{result?.tech_volume*0.000000000000001} <span className="text-[14px]">cubic kilometers (km<sup>3</sup>)</span></td>
                                        </tr>
                                        <tr>
                                        <td className="border-b py-2">{data?.payload?.tech_lang_keys['15']} :</td>
                                        <td className="border-b py-2">{result?.tech_volume*0.061024} <span className="text-[14px]">cubic inches (in<sup>3</sup>)</span></td>
                                        </tr>
                                        <tr>
                                        <td className="border-b py-2">{data?.payload?.tech_lang_keys['15']} :</td>
                                        <td className="border-b py-2">{result?.tech_volume*0.000035315} <span className="text-[14px]">cubic feet (ft<sup>3</sup>)</span></td>
                                        </tr>
                                        <tr>
                                        <td className="border-b py-2">{data?.payload?.tech_lang_keys['15']} :</td>
                                        <td className="border-b py-2">{result?.tech_volume*0.00000130795} <span className="text-[14px]">cubic  yards (yd<sup>3</sup>)</span></td>
                                        </tr>
                                        <tr>
                                        <td className="border-b py-2">{data?.payload?.tech_lang_keys['15']} :</td>
                                        <td className="border-b py-2">{result?.tech_volume/4168000000000000} <span className="text-[14px]">cubic miles (mi<sup>3</sup>)</span></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>

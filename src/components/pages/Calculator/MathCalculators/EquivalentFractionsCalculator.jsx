                      ...
                      <div className="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                          ...
                          {formData.tech_want_to == "2" && (
                            ...
                            <div className="col-span-6 second ">
                                <table className="w-full">
                                    <p className="mt-3 label text-center">{data?.payload?.tech_lang_keys['7']}:</p>
                                    <tr>
                                        {formData.tech_is_frac == "2" && (
                                        <>
                            ...
                            <div className="col-span-6 second  ">
                                <table className="w-full">
                                    <p className="mt-3 label text-center">{data?.payload?.tech_lang_keys['8']}:</p>
                                    <tr>
                                      {formData.tech_is_frac == "2" && (
                                        <>
                      ...
                      <div className="rounded-lg flex items-center justify-center">
                          <div className="w-full mt-3">
                            <div className="w-full">
                              <p className="text-[16px] my-2 clr">{data?.payload?.tech_lang_keys['9']}</p>

                              <div>
                                {formData?.tech_want_to == 1 ? (
                                  <>
                                    {upper[0] < bottom[0] ? (
                                      <p className="text-[16px]">{data?.payload?.tech_lang_keys['9']}</p>
                                    ) : upper[0] > bottom[0] ? (
                                      <p className="text-[16px] mt-1">{data?.payload?.tech_lang_keys['10']}</p>
                                    ) : (
                                      <p className="text-[16px] mt-1">{data?.payload?.tech_lang_keys['11']}</p>
                                    )}

                                    <p className="text-[16px] mt-1">{data?.payload?.tech_lang_keys['12']}</p>
                                            ...
                                            return (
                                              <tr key={key}>
                                                {[0, 1, 2, 3].map((offset) => {
                                                  ...
                                                  if (idx < upper.length) {
                                                    return (
                                                      <td key={idx} className="border py-2">
                                              ...
                                              <tr key={key}>
                                                {[0, 1].map((offset) => {
                                                  ...
                                                  if (idx < upper.length) {
                                                    return (
                                                      <td key={idx} className="border py-2">
                                                        {`${upper[0]}/${bottom[0]} x ${idx + 1}/${idx + 1} = ${upper[idx]}/${bottom[idx]}`}
                                                      </td>
                                                    );
                                                  }
                                                  return null;
                                  ...
                                  <>
                                    ...
                                    <table className="w-full text-[16px] text-center">
                                      <tbody>
                                        <tr>
                                          <td className="border py-2">{result?.tech_input1}</td>
                                          <td className="border py-2">{result?.tech_sign}</td>
                                          <td className="border py-2">{result?.tech_input2}</td>
                                        </tr>
                                      </tbody>
                                    </table>
                                    </div>

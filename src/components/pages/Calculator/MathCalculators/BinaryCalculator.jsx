          ...
          <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mb-3">
            ...
            <div class="lg:w-[60%] md:w-[90%] w-full mx-auto ">
                    ...
                    <div class="col-span-6 md:col-span-4 lg:col-span-4 ">
                        ...
                        <div className="mt-2">
                          <select
                            ...
                            onChange={handleChange}
                          >
                            <option value="binary">{data?.payload?.tech_lang_keys["2"]} </option>
                            <option value="decimal">{data?.payload?.tech_lang_keys["3"]} </option>
                            <option value="hexadecimal">{data?.payload?.tech_lang_keys["4"]} </option>
                            <option value="octal">{data?.payload?.tech_lang_keys["5"]} </option>
                          </select>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-12  mt-4 gap-4">
                    ...
                    <div class="col-span-6 md:col-span-4 lg:col-span-4 order-1 md:order-2">
                    ...
                    <div class="col-span-6 md:col-span-4 lg:col-span-4 order-2 ">
                 ...
                 <div class="rounded-lg  flex items-center justify-center">
                    <div class="w-full bg-light-blue  rounded-lg mt-3">
                        <div class="flex flex-col">
                            <div class="lg:w-1/2 mt-2 overflow-auto">
                                <table class="w-full text-[16px] md:text-[18px]">
                                    <tr>
                                        <td class="py-2 border-b w-3/5 font-bold">{ data?.payload?.tech_lang_keys["2"] }</td>
                                        <td class="py-2 border-b">{ result?.tech_bn }</td>
                                    </tr>
                                    <tr>
                                        <td class="py-2 border-b w-3/5 font-bold">{ data?.payload?.tech_lang_keys["3"] }</td>
                                        <td class="py-2 border-b">{ result?.tech_dc }</td>
                                    </tr>
                                    <tr>
                                        <td class="py-2 border-b w-3/5 font-bold">{ data?.payload?.tech_lang_keys["4"] }</td>
                                        <td class="py-2 border-b">{ result?.tech_hx }</td>
                                    </tr>
                                    <tr>
                                        <td class="py-2 border-b w-3/5 font-bold">{ data?.payload?.tech_lang_keys["5"] }</td>
                                        <td class="py-2 border-b">{ result?.tech_oc }</td>
                                    </tr>
                                </table>
                            </div>
                        </div>

                      ...
                      <div className="w-full mt-3">
                          <div className="w-full">
                              <div className="w-full text-center  text-[20px]">
                                  ...
                                  <p className="my-3"><strong className="bg-[#2845F5] px-3 py-2 md:text-[32px] text-[18px] rounded-lg text-white">({Number(result?.tech_x).toFixed(2)} , {Number(result?.tech_y).toFixed(2)})</strong></p>
                              </div>
                          </div>
                      </div>
                  </div>

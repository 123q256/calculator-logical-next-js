          ...
          <div class="lg:w-[60%] md:w-[60%] w-full mx-auto ">
            <div class="grid grid-cols-12 mt-3 gap-2 md:gap-4 lg:gap-4">
              <div class="col-span-12">
                  <div class="col-span-12 md:col-span-4 lg:col-span-4 md:flex md:justify-between">
                  <label for="tech_EnterEq" class="label mt-4">{data?.payload?.tech_lang_keys['1']}:</label>
                    <button type="button" class="mt-2 flex border rounded-lg p-1  items-center" id="exampleLoadBtn"  onClick={exampleLoadHandler}>
                      ...
                      <div class="w-full py-2 relative">
                        ...
                        />
                        <img   src="/images/keyboard.png" class="keyboardImg absolute right-2 top-12 transform -translate-y-1/2 w-9 h-9" alt="keyboard" loading="lazy" decoding="async"  onClick={toggleKeyboard}/>
                    </div>
              </div>
              {showKeyboard && (
                    ...
                    <div className="rounded-lg flex items-center justify-center">
                      <div className="w-full mt-3">
                        <div className="w-full text-[16px] overflow-auto">
                          ...
                          <p className="mt-3 font-bold">{data?.payload?.tech_lang_keys['5']}</p>
                          ...
                          <p className="my-3">
                            1st {data?.payload?.tech_lang_keys['4']}: <InlineMath math={`\\frac{\\partial}{\\partial x}\\left(${result?.tech_enter}\\right)`} />
                          ...
                          <p className="my-3">
                            2nd {data?.payload?.tech_lang_keys['4']}: <InlineMath math={`\\frac{\\partial}{\\partial x}\\left(${result?.tech_en1}\\right)`} />
                          ...
                          <p className="my-3">
                            1st {data?.payload?.tech_lang_keys['4']}: <InlineMath math={`\\frac{\\partial}{\\partial y}\\left(${result?.tech_enter}\\right)`} />
                          ...
                          <p className="my-3">
                            2nd {data?.payload?.tech_lang_keys['4']}: <InlineMath math={`\\frac{\\partial}{\\partial y}\\left(${result?.tech_en2}\\right)`} />
                          ...
                          <p className="mt-3">
                            {data?.payload?.tech_lang_keys['7']}: <InlineMath math={result?.tech_root} />
                          </p>
                        </div>
                      </div>
                    </div>

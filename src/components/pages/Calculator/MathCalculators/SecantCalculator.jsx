...
const angle = formData?.tech_angle;
  ...
  const degSymbol = angleUnit === "deg" ? "°" : angleUnit === "pirad" ? " * π" : "";
               ...
               <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
                  <div className="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                      ...
                      <div className="col-span-12 flex justify-center text-center">
                          <img  src="/images/sec_prop.png"  height="100%" width="70%" alt="tangent Graph"  loading="lazy" decoding="async"/>
                      </div>
              </div>
               </div>
                                  ...
                                  {angleUnit === "deg" && matchedVal && (
                                    <tr>
                                      <td className="py-2 border-b" width="60%">
                                        <strong>sec({angle}{degSymbol})</strong>
                                      </td>

            ...
            <div className="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                <div className="col-span-12 text-center">
                    <div className="flex velocitytab border-b-dark border-b relative overflow-auto">
                        ...
                        <p className="cursor-pointer veloTabs v_active px-2"><strong>{  data?.payload?.tech_lang_keys['44'] ??  'Mixed Number' }</strong></p>
                        <p className="cursor-pointer veloTabs px-2"><strong>
                        <a href="/fraction-simplifier-calculator" className="cursor-pointer veloTabs  text-decoration-none ">{ data?.payload?.tech_lang_keys['45'] ?? 'Fraction Simplifier' }</a></strong></p>
                    </div>
                </div>
                      ...
                      <div className="rounded-lg flex items-center justify-center">
                            <div className="w-full mt-3">
                              <div className="w-full text-[20px]">
                                ...
                                {/* Example Label */}
                                <p className="mt-3">{data?.payload?.tech_lang_keys['ex']}:</p>
                                ...
                                <p className="mt-3">
                                  ...
                                  <InlineMath math={`\\frac{${tech_totalN}}{${tech_totalD}}`} />
                                </p>
                                ...
                                <p className="mt-3">
                                  ...
                                  {tech_btm === '1' ? (
                                    ...
                                    <InlineMath math={`\\frac{${tech_upr}}{${tech_btm}}`} />
                                  )}
                                </p>

...
// currency code
  ...
  const inverseLatex = `\\begin{bmatrix} ${arrayToLatexMatrix(result?.tech_invrse)} \\end{bmatrix}`;
  const techValueLatex = `\\begin{bmatrix} ${arrayToLatexVector(result?.tech_value)} \\end{bmatrix}`;
  const result2Latex = `\\begin{bmatrix} ${arrayToLatexMatrix(result?.tech_result2)} \\end{bmatrix}`;
            ...
            <div className="lg:w-[80%] md:w-[90%] w-full mx-auto ">
              <div className="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                ...
                <div className="col-span-12 flex items-center mt-0 mt-lg-2">
                    ...
                    <p className="px-2 text-[14px] text-blue" >x<sub className="text-[12px] text-blue">1</sub> <span className="text-[18px] text-blue">+</span></p>
                    <div>
                        <div className="w-full py-2">
                            <input
                              type="number"
                      ...
                      <>
                      <p className="px-2 text-[14px] text-blue thirdInputs " >x<sub className="text-[12px] text-blue">2</sub> <span className="text-[18px] text-blue">+</span></p>
                      
                      </>
                      )}
                     {formData.tech_number == "1" && (
                      <>
                        <p className="px-2 text-[14px] text-blue thirdInputEqual " >x<sub className="text-[12px] text-blue">2</sub> <span className="text-[18px] text-blue">=</span></p>
                    ...
                    {formData.tech_number == "2" && (
                      <>
                      <p className="px-2 text-[14px] text-blue thirdInputs " >x<sub className="text-[12px] text-blue">3</sub> <span className="text-[18px] text-blue">=</span></p>
                      </>
                    )}
                    <div>
                        <div className="w-full py-2">
                ...
                <div className="col-span-12 flex items-center mt-0 mt-lg-2">
                  ...
                  {formData.tech_number == "2" && (
                    ...
                    <div className="col-span-12 flex items-center mt-0 mt-lg-2 thirdInputs">
                        ...
                        <p className="px-2 text-[14px] text-blue" >x<sub className="text-[12px] text-blue">2</sub> <span className="text-[18px] text-blue">+</span></p>
                        <div>
                            <div className="w-full py-2">
                                <input
                                  type="number"
                        ...
                        <p className="px-2 text-[14px] text-blue" >x<sub className="text-[12px] text-blue">3</sub> <span className="text-[18px] text-blue">=</span></p>
                        <div>
                            <div className="w-full py-2">
                              <input
                                  type="number"
                    ...
                    <ResultActions lang={data?.payload?.tech_lang_keys} />
                     ...
                     <div className="rounded-lg flex items-center justify-center w-full mt-3 text-[16px]">
                        <div className="w-full">
                          ...
                          {/* Title */}
                          <p className="mt-3 text-[18px] font-bold">x = A<sup>-1</sup>b</p>
                          ...
                          <div className="col-lg-4 mt-3 overflow-auto">
                            <table className="w-full text-[16px]">
                              {result?.tech_main_result?.map((row, i) => (
                                <tr key={i}>
                                  ...
                                  <td className="py-2 border-b">{formatNumber(row[0])}</td>
                                </tr>
                              ))}
                            </table>
                          </div>
                            <div className="w-full overflow-auto">
                              ...
                              {/* Upper matrix */}
                              <p className="mt-3 text-[18px] font-bold">{data?.payload?.tech_lang_keys[3]} L</p>
                              <BlockMath math={upperLatex} />

                              {/* Lower matrix */}
                              <p className="mt-3 text-[18px] font-bold">{data?.payload?.tech_lang_keys[4]} L</p>
                              <BlockMath math={lowerLatex} />

                              {/* Inverse matrix */}
                              <p className="mt-3 text-[18px] font-bold">{data?.payload?.tech_lang_keys[5]} L<sup>-1</sup>*</p>
                              <BlockMath math={inverseLatex} />

                              {/* Multiplication -inverse * upper = result */}
                              <p className="mt-3 text-[18px] font-bold">{data?.payload?.tech_lang_keys[6]} T</p>
                              <BlockMath math={multInverseUpperLatex} />

                              {/* Multiplication inverse * vector = result2 */}
                              <p className="mt-3 text-[18px] font-bold">{data?.payload?.tech_lang_keys[6]} C</p>

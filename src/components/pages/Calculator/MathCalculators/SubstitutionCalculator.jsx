                      ...
                      <div className="col-span-12  math_1">
                          <div className="grid grid-cols-12  gap-2 md:gap-4 lg:gap-4">
                              <div className="col-span-4">
                                  <label for="a1_f" className="font-s-14 text-blue">a<sub className="font-s-14 text-blue">1</sub></label>
                              ...
                              <div className="col-span-4">
                                  <label for="b1_f" className="font-s-14 text-blue">b<sub className="font-s-14 text-blue">1</sub></label>
                                  <div className="w-full py-2">
                                    <input
                                          type="number"
                                          step="any"
                              ...
                              <div className="col-span-4">
                                  <label for="k1_f" className="font-s-14 text-blue">k<sub className="font-s-14 text-blue">1</sub></label>
                                  <div className="w-full py-2">
                                      <input
                                          type="number"
                                          step="any"
                              ...
                              <div className="col-span-4">
                                  <label for="a2_f" className="font-s-14 text-blue">a<sub className="font-s-14 text-blue">2</sub></label>
                                  <div className="w-full py-2">
                                      <input
                                          type="number"
                                          step="any"
                              ...
                              <div className="col-span-4">
                                  <label for="b2_f" className="font-s-14 text-blue">b<sub className="font-s-14 text-blue">2</sub></label>
                                  <div className="w-full py-2">
                                    <input
                                          type="number"
                                          step="any"
                              ...
                              <div className="col-span-4">
                                  <label for="k2_f" className="font-s-14 text-blue">k<sub className="font-s-14 text-blue">2</sub></label>
                                  <div className="w-full py-2">
                                      <input
                                          type="number"
                                          step="any"
                      ...
                      <div className="col-span-12  math_2">
                          <div className="grid grid-cols-12  gap-2 md:gap-4 lg:gap-4">
                              <div className="col-span-3">
                                  <label for="a1_s" className="font-s-14 text-blue">a<sub className="font-s-14 text-blue">1</sub></label>
                                  <div className="w-full py-2">
                                    <input
                                          type="number"
                                          step="any"
                              ...
                              <div className="col-span-3">
                                  <label for="b1_s" className="font-s-14 text-blue">b<sub className="font-s-14 text-blue">1</sub></label>
                                  <div className="w-full py-2">
                                      <input
                                          type="number"
                                          step="any"
                              ...
                              <div className="col-span-3">
                                  <label for="c1_s" className="font-s-14 text-blue">c<sub className="font-s-14 text-blue">1</sub></label>
                                  <div className="w-full py-2">
                                    <input
                                          type="number"
                                          step="any"
                              ...
                              <div className="col-span-3">
                                  <label for="k1_s" className="font-s-14 text-blue">k<sub className="font-s-14 text-blue">1</sub></label>
                                  <div className="w-full py-2">
                                      <input
                                          type="number"
                                          step="any"
                              ...
                              <div className="col-span-3">
                                  <label for="a2_s" className="font-s-14 text-blue">a<sub className="font-s-14 text-blue">2</sub></label>
                                  <div className="w-full py-2">
                                    <input
                                          type="number"
                                          step="any"
                              ...
                              <div className="col-span-3">
                                  <label for="b2_s" className="font-s-14 text-blue">b<sub className="font-s-14 text-blue">2</sub></label>
                                  <div className="w-full py-2">
                                      <input
                                          type="number"
                                          step="any"
                              ...
                              <div className="col-span-3">
                                  <label for="c2_s" className="font-s-14 text-blue">c<sub className="font-s-14 text-blue">2</sub></label>
                                  <div className="w-full py-2">
                                      <input
                                          type="number"
                                          step="any"
                              ...
                              <div className="col-span-3">
                                  <label for="k2_s" className="font-s-14 text-blue">k<sub className="font-s-14 text-blue">2</sub></label>
                                  <div className="w-full py-2">
                                      <input
                                          type="number"
                                          step="any"
                              ...
                              <div className="col-span-3">
                                  <label for="a3_s" className="font-s-14 text-blue">a<sub className="font-s-14 text-blue">3</sub></label>
                                  <div className="w-full py-2">
                                    <input
                                          type="number"
                                          step="any"
                              ...
                              <div className="col-span-3">
                                  <label for="b3_s" className="font-s-14 text-blue">b<sub className="font-s-14 text-blue">3</sub></label>
                                  <div className="w-full py-2">
                                      <input
                                          type="number"
                                          step="any"
                              ...
                              <div className="col-span-3">
                                  <label for="c3_s" className="font-s-14 text-blue">c<sub className="font-s-14 text-blue">3</sub></label>
                                  <div className="w-full py-2">
                                      <input
                                          type="number"
                                          step="any"
                              ...
                              <div className="col-span-3">
                                  <label for="k3_s" className="font-s-14 text-blue">k<sub className="font-s-14 text-blue">3</sub></label>
                                  <div className="w-full py-2">
                                      <input
                                          type="number"
                                          step="any"

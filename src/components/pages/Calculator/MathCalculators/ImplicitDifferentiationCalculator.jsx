        ...
        <form className="row" onSubmit={handleSubmit}>
          <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mb-3">
            ...
            <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
                ...
                <p className="col-span-12"><strong>{data?.payload?.tech_lang_keys['1']}: f(x,y) = g(x,y)</strong></p>
                ...
                <p className="col-span-12"><strong>{data?.payload?.tech_lang_keys['3']} (x,y): ({data?.payload?.tech_lang_keys['5']})</strong></p>
                <div className="col-span-6">
                            ...
                            {isNumeric(x) && isNumeric(y) && (
                              <div className="w-full text-center overflow-auto mt-3">
                                <p className="my-3">
                                  <strong className="bg-sky px-3 py-4 text-[32px] rounded-lg text-blue-500 math">
                                    {withX
                                      ? `\\color{#1670a7} {\\frac{dy}{dx}\\Big|_{(x,y)=(${x},${y})} = ${Number(resf).toFixed(3)}}`
                                      : `\\color{#1670a7} {\\frac{dx}{dy}\\Big|_{(x,y)=(${x},${y})} = ${Number(resf).toFixed(3)}}`}
                                  </strong>
                                </p>
                              </div>
                            )}

              ...
              {formData.tech_type == "first" && (
               ...
               {formData.tech_type == "second" && (
                ...
                <div className="col-span-12 row " id="hexConverter">
                    ...
                    <div className="col-12 mt-0 mt-lg-2 flex justify-around ">
                        <p id="hex_to_dec">
                            <label className="pe-2" htmlFor="3">
                            <input
                              type="radio"
                              name="tech_options"
                              value="3"
                        ...
                        <p id="hex_to_dec">
                            <label className="pe-2" htmlFor="4">
                            <input
                              type="radio"
                              name="tech_options"
                              value="4"
                                ...
                                {(result?.tech_type =="first") ? (
                                  <>
                                    <div className="col-lg-6 mt-2 overflow-auto">
                                        <table className="w-full text-[16px]">
                                            <tr>
                                                <td className="py-2 border-b" width="50%"><strong>{data?.payload?.tech_lang_keys[17]}</strong></td>
                                                <td className="py-2 border-b">{result?.tech_hx }</td>
                                            </tr>
                                            <tr>
                                                <td className="py-2 border-b" width="50%">{data?.payload?.tech_lang_keys[3]}</td>
                                                <td className="py-2 border-b">{result?.tech_dc }</td>
                                            </tr>
                                            <tr>
                                                <td className="py-2 border-b" width="50%">{data?.payload?.tech_lang_keys[2]}</td>
                                                <td className="py-2 border-b">{result?.tech_bn }</td>
                                            </tr>
                                            <tr>
                                                <td className="py-2 border-b" width="50%">{data?.payload?.tech_lang_keys[5]}</td>
                                                <td className="py-2 border-b">{result?.tech_oc }</td>
                                            </tr>
                                            <tr>
                                                <td className="py-2 border-b" width="50%">{data?.payload?.tech_lang_keys[17]}</td>
                                                <td className="py-2 border-b">{result?.tech_hx }</td>
                                            </tr>
                                        </table>
                                    </div>
                                    <div className="w-full text-[16px]">
                                        ...
                                        <p className="mt-3">{ result?.tech_first_ans1 } {result?.tech_op } {result?.tech_second_ans1 } {" = "} {result?.tech_hx  }</p>
                                        <p className="mt-3">{data?.payload?.tech_lang_keys[20]}</p>
                                        <p className="mt-3">{ result?.tech_first_ans } {result?.tech_op } {result?.tech_second_ans } {" = "} {result?.tech_dc }</p>
                                    </div>
                                  ...
                                  <>
                                    <div className="w-full text-center my-2">
                                        <p><strong className="bg-[#2845F5]  px-3 py-2 text-[21px] rounded-lg text-white">{result?.tech_answer } {result?.tech_text  }</strong></p>
                                    </div>
                                  </>
                                )}

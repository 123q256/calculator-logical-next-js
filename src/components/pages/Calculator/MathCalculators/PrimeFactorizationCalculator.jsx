                            ...
                            {result?.tech_prime == 1 ? (
                              ...
                              <>
                                {formData?.tech_from == 1 ? (
                                      ...
                                      <table className="w-full text-[16px]">
                                        <tbody>
                                          <tr>
                                            ...
                                            <td className="py-2 border-b">{result?.tech_Factors}</td>
                                          </tr>
                                          <tr>
                                            ...
                                            <td
                                              ...
                                              dangerouslySetInnerHTML={{ __html: getExponents() }}
                                            ></td>
                                          </tr>
                                          <tr>
                                            <td className="py-2 border-b">
                                            ...
                                            <td className="py-2 border-b">{result?.tech_csv}</td>
                                          </tr>
                                          <tr>
                                            <td className="py-2 border-b">
                                              <strong>
                                            ...
                                            <td className="py-2 border-b">{getDivisors()}</td>
                                          </tr>
                                        </tbody>
                                      </table>
                                    </div>
                                  ...
                                  <div className="w-full text-center text-[20px]">
                                    <p>
                                      {lang?.["9"]} {formData?.tech_num} {lang?.["10"]}
                                    </p>
                                    <p className="my-3">
                                  ...
                                  <div className="w-full text-center">
                                    <p>
                                      <strong className="bg-[#2845F5] px-3 py-2 text-[32px] rounded-lg text-white">
                                        {formData?.tech_num}:{" "}
                                        {result?.tech_prime_check == 0 ? lang?.["11"] : ""}{" "}
                                        {lang?.["12"]}
                                      </strong>
                                    </p>
                                  </div>
                                      ...
                                      <tbody>
                                        {result?.tech_prev && (
                                          <tr>
                                            ...
                                            <td className="py-2 border-b">{result?.tech_prev}</td>
                                          </tr>
                                        )}
                                        <tr>
                                          <td className="py-2 border-b w-4/5">
                                          ...
                                          <td className="py-2 border-b">{result?.tech_next}</td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </div>

                            ...
                            <table className="w-full text-[16px]">
                              <tbody>
                                ...
                                <tr>
                                  <td className="py-2 border-b w-[40%]">
                                    <strong>
                                      {ordinalSuffix(result?.tech_nth)} {data?.payload?.tech_lang_keys['5']}
                                    </strong>
                                  </td>
                                  <td className="py-2 border-b">{result?.tech_nth_v}</td>
                                </tr>
                                <tr>
                                  <td className="py-2 border-b w-[40%]">
                                    <strong>{data?.payload?.tech_lang_keys['6']}</strong>
                                  </td>
                                  <td className="py-2 border-b">{result?.tech_total}</td>
                                </tr>
                              </tbody>
                            </table>
                          </div>

        ...
        <form className="row" onSubmit={handleSubmit}>
          <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mb-3">
            ...
            <div className="lg:w-[50%] md:w-[70%] w-full mx-auto ">
                      ...
                      <p className="col-span-12 text-[14px]"><strong>{data?.payload?.tech_lang_keys['1']}. (2,8) {data?.payload?.tech_lang_keys['2']} [2,8] {data?.payload?.tech_lang_keys['2']} [2,8) {data?.payload?.tech_lang_keys['2']} (2,8]</strong></p>
                      ...
                      <div className="col-span-12">
                        ...
                        <div className="mt-2">
                          <select
                            ...
                            onChange={handleChange}
                          >
                            <option value="select">{data?.payload?.tech_lang_keys["5"]} </option>
                            <option value="even">{data?.payload?.tech_lang_keys["6"]} </option>
                            <option value="odd">{data?.payload?.tech_lang_keys["7"]} </option>
                            <option value="prime">{data?.payload?.tech_lang_keys["8"]} </option>
                          </select>
                        </div>
                      </div>
                  </div>
                      ...
                      <div className="rounded-lg flex items-center justify-center">
                            <div className="w-full mt-3">
                                ...
                                <table className="w-full text-[16px]">
                                  <tbody>
                                    <tr>
                                      ...
                                      <td className="py-2 border-b">{set.join(", ")}</td>
                                    </tr>
                                  </tbody>
                                </table>
                              </div>
                              ...
                              <div className="w-full text-[16px] steps overflow-auto">
                                <p className="mt-2 font-bold">{data?.payload?.tech_lang_keys["12"]}</p>

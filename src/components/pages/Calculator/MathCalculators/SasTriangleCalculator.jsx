        ...
        <form className="row" onSubmit={handleSubmit}>
          <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mb-3">
            ...
            <div className="col-span-6 text-center flex justify-center items-center">
                <img   src="/images/sas_image.webp" width="175" height="100%" alt="SAS Triangle" loading="lazy" decoding="async"/>
            </div>
        </div>
    </div>
                              ...
                              <div className="w-full">
                                  <div className="w-full md:w-[90%] lg:w-[70%] overflow-auto mt-2">
                                      <table className="w-full text-[16px]">
                                          <tr>
                                              <td className="py-2 border-b" width="60%"><strong>Side (c)</strong></td>
                                              <td className="py-2 border-b">{result?.tech_c} cm</td>
                                          </tr>
                                          <tr>
                                              <td className="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys[5]} ∠A (α)</strong></td>
                                              <td className="py-2 border-b">{Number(result?.tech_alpha).toFixed(2)}<sup className="text-[14px]">°</sup></td>
                                          </tr>
                                          <tr>
                                              <td className="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys[5]} ∠B (β)</strong></td>
                                              <td className="py-2 border-b">{Number(result?.tech_beta).toFixed(2)}<sup className="text-[14px]">°</sup></td>
                                          </tr>
                                          <tr>
                                              <td className="py-2 border-b" width="60%"><strong>Area</strong></td>
                                              <td className="py-2 border-b">{result?.tech_t} cm²</td>
                                          </tr>
                                          <tr>
                                              <td className="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys[3]}</strong></td>
                                              <td className="py-2 border-b">{result?.tech_p} cm</td>
                                          </tr>
                                      </table>
                                  </div>
                              </div>

               ...
               <div className="grid grid-cols-12 mt-3 gap-2 md:gap-4 lg:gap-4">
                  <div className="col-span-12">
                      <div className="">
                          ...
                          <label for="tech_eq" className="text-[12px] ">{data?.payload?.tech_lang_keys['1']}</label>
                          </div>
                              ...
                              <div className="row">
                                  <div className="w-full text-[16px] overflow-auto">
                                    <p className="mt-3 text-[16px]">
                                      <strong>{data?.payload?.tech_lang_keys['4']} {data?.payload?.tech_lang_keys['5']}</strong>
                                    </p>
                                      {result?.tech_ip_1 ? (
                                        <p className="mt-3">
                                          <InlineMath math={`(${result?.tech_ip1}, ${result?.tech_ip11})`} />
                                        </p>
                                      ) : result?.tech_no ? (
                                        <p className="mt-3">
                                          <InlineMath math={`${data?.payload?.tech_lang_keys['6']}\\space${data?.payload?.tech_lang_keys['4']}\\space${data?.payload?.tech_lang_keys['5']}`} />
                                        </p>
                                      ) : (
                                        <>
                                          <p className="mt-3">
                                            <InlineMath math={`(${result?.tech_ip1}, ${result?.tech_ip2})`} />
                                          </p>
                                          <p className="mt-3">
                                            <InlineMath math={`(${result?.tech_ip11}, ${result?.tech_ip22})`} />
                                          </p>
                                        </>
                                      )}
                                      ...
                                      {result?.tech_no ? (
                                        ...
                                        <>
                                          ...
                                          <p className="mt-3">
                                            <InlineMath math={`(${result?.tech_ip1}, \\infty)`} />
                                          </p>
                                          <p className="mt-3 text-[16px]">
                                            <strong>{data?.payload?.tech_lang_keys['11']}</strong>
                                          </p>
                                          <p className="mt-3">
                                            <InlineMath math={`(-\\infty, ${result?.tech_ip1})`} />
                                          </p>
                                        </>
                                      )}
                                     ...
                                     <p className="mt-3 text-[16px]">
                                        <strong>
                                          <InlineMath math="f'(x)" /> {data?.payload?.tech_lang_keys['7']}
                                        </strong>
                                      </p>
                                      <p className="mt-3">
                                      ...
                                      <div className="w-full mt-3">
                                        <button
                                          type="button"
                                          className="px-6 py-3 font-semibold bg-[#2845F5] text-white text-[14px] rounded-lg focus:outline-none focus:ring-2"
                                          onClick={toggleSteps}
                                        >
                                    ...
                                    <div className="w-full res_step mt-3">
                                      ...
                                      className={`w-full res_step transition-all duration-500 overflow-hidden mt-3 katex-rendered-content ${
                                        showSteps ? "max-h-[999px] opacity-100" : "max-h-0 opacity-0"
                                      }`}
                                          ...
                                          <>
                                            ...
                                            ref={containerRef1}
                                              className={`w-full res_step transition-all duration-500 overflow-hidden mt-3 ${
                                                showSteps1 ? "max-h-[999px] opacity-100" : "max-h-0 opacity-0"
                                              }`}
                                      ...
                                      <div className="w-full mt-3">
                                        ...
                                        {result?.tech_step1 && (
                                          ...
                                          <div
                                            ref={containerRef2}
                                            className={`w-full res_step transition-all duration-500 overflow-hidden mt-3 ${
                                              showSteps2 ? "max-h-[999px] opacity-100" : "max-h-0 opacity-0"
                                            }`}

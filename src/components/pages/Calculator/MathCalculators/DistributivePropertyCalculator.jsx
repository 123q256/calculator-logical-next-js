          ...
          <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mb-3">
            ...
            <div className="lg:w-[50%] md:w-[80%] w-full mx-auto ">
                <div className="grid grid-cols-12   gap-2 md:gap-4 lg:gap-4">
                    <p className="col-span-12 my-2 text-[14px]"><strong>{data?.payload?.tech_lang_keys['2']}: {data?.payload?.tech_lang_keys['3']}</strong></p>
                  ...
                  <p className="col-span-12 my-2 text-[14px]"><strong>Examples:</strong> (2-13+4)/(9), 3*(13-7), (13-3-2)*(12-5), (5*(7-3))*(16*(13-3)+5)</p>
            </div>
        </div>
                        ...
                        <div className="rounded-lg flex items-center justify-center">
                          <div className="w-full mt-3 overflow-auto">
                            ...
                            <div className="w-full text-[16px]">
                              ...
                              <p className="text-danger">
                                {data?.payload?.tech_lang_keys["6"]} : {result?.tech_input}
                              </p>
                              <p className="text-danger">= {Number(result?.tech_ans).toFixed(3)}</p>
                            </div>
                          </div>
                        </div>
                  </div>

                    ...
                    <div className="rounded-lg flex items-center justify-center">
                      <div className="w-full mt-3">
                        <div className="w-full text-[16px] overflow-auto">
                          ...
                          <p className="mt-3">
                            <BlockMath math={`\\pi \\int\\limits_{${formData?.tech_lb}}^{${formData?.tech_ub}} (${result?.tech_enter})\\, dx`} />
                          </p>

                          <p className="mt-3">
                            <BlockMath math={`= \\pi \\times ${result?.tech_ress} \\approx ${Number(result?.tech_ress1).toFixed(3)}`} />
                          </p>
                          ...
                          <p className="mt-3">
                            <BlockMath math={`\\pi \\int (${result?.tech_enter})\\, dx`} />
                          </p>

                          <p className="mt-3">
                            <BlockMath math={`= \\pi \\left(${result?.tech_res}\\right) + \\text{constant}`} />
                          </p>
                          ...
                          <p className="mt-3">
                            <BlockMath math={`\\int (${result?.tech_enter})\\, dx`} />
                          </p>

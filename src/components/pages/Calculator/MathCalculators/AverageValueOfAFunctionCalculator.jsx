                          ...
                          <div className="w-full">
                            <div className="col-12 text-[16px] overflow-auto">
                              <p className="mt-3 text-[18px]">
                                <BlockMath math={`\\int_{${formData?.tech_lb}}^{${formData?.tech_ub}} ${result?.tech_sim} \\, d${result?.tech_with} = ${result?.tech_ans}`} />
                              </p>
                              ...
                              <p className="mt-3">
                                {data?.payload?.tech_lang_keys[6]} <BlockMath math={`${result?.tech_input}`} /> {data?.payload?.tech_lang_keys[7]}{" "}
                                <BlockMath math={`\\left[${formData?.tech_lb},${formData?.tech_ub}\\right]`} />
                              </p>

                              <p className="mt-3">
                                {data?.payload?.tech_lang_keys[8]} <BlockMath math="f(x)" /> {data?.payload?.tech_lang_keys[7]} <BlockMath math="[a,b]" /> is{" "}
                                <BlockMath math={`\\bar{f}= \\frac{1}{b-a} \\int_a^b f \\left( x \\right) d x`} />
                              </p>

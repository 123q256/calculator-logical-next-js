...
const evaluatedExpression = i_n.map((x, idx) => {
  const expr = enter.replace(/x/g, `(${x})`);
  return `(${expr})`;
}).join(' + ');

const evaluatedValues = solve.map((val, idx) => {
              ...
              <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
                  ...
                  <div className="col-span-12 ">
                      <div className="grid grid-cols-12  gap-2 md:gap-4 lg:gap-4">
                         <p className="col-span-12 label"><strong>{data?.payload?.tech_lang_keys['calculate']} {data?.payload?.tech_lang_keys['1']}:</strong></p>
                          <p className="col-span-12 md:col-span-4">
                            <label className="pe-2" htmlFor="simple_sum">
                              <input
                                type="radio"
                                name="tech_cal_meth"
                                value="simple_sum"
                         ...
                         <p className="col-span-12 md:col-span-6">
                            <label htmlFor="sigma_sum">
                              ...
                              />
                              <span>{data?.payload?.tech_lang_keys['3']} (Σ) {data?.payload?.tech_lang_keys['4']}</span>
                            </label>
                          </p>
                      </div>
                  </div>
                ...
                {formData.tech_cal_meth === 'sigma_sum' && (
                  ...
                  <div className="col-span-12  sigmaInput">
                     ...
                     {data?.payload?.tech_lang_keys['7']} (x) ({data?.payload?.tech_lang_keys['9']} ∞, {data?.payload?.tech_lang_keys['10']} oo):
                        </label>
                        <div className=" relative">
                        <input
                          type="number"
                  ...
                  <div className="col-span-12  sigmaInput">
                     ...
                     {data?.payload?.tech_lang_keys['8']} (n) ({data?.payload?.tech_lang_keys['9']} -∞, {data?.payload?.tech_lang_keys['10']} -oo):
                        </label>
                        <div className=" relative">
                        <input
                          type="number"
                    ...
                    <div className="rounded-lg flex items-center justify-center">
                      <div className="w-full mt-3 overflow-auto">
                        ...
                        <div className="w-full text-[16px] overflow-auto">
                          ...
                          {isSimpleSum ? (
                            <>
                              <p className="mt-3">∑({formData?.tech_nums}) = {replacedSum}</p>
                              <p className="mt-3">∑({formData?.tech_nums}) = {result?.tech_sum}</p>
                              <p className="mt-3">
                                {data?.payload?.tech_lang_keys['13']} = {result?.tech_tn}
                              </p>
                            </>
                          ) : cnvrgnt ? (
                            <>
                              ...
                              <p className="mt-3">
                                {data?.payload?.tech_lang_keys['16']} x {data?.payload?.tech_lang_keys['17']} ({enter}):
                              </p>

                      ...
                      <div className="w-full mt-3">
                        <div className="w-full text-[16px] overflow-auto">
                          <p className="mt-3 text-[18px] font-bold">
                            <InlineMath math={`\\left(${result?.tech_one}+${result?.tech_two}+${result?.tech_three}\\right)`} />
                          </p>

                          {result?.tech_ev1 && (
                            <p className="mt-3 text-[18px] font-bold">
                              <InlineMath
                                math={`\\left(${result?.tech_ev1 + result?.tech_ev2 + result?.tech_ev3}\\right)`}
                              />
                            </p>
                          )}
                          ...
                          {result?.tech_ev1 && (
                            <>
                              ...
                              <p className="mt-3">
                                <InlineMath
                                  math={`\\operatorname{div}{\\left(${result?.tech_enx},${result?.tech_eny},${result?.tech_enz}\\right)}|_{(x_0,y_0,z_0) = \\left(${formData?.tech_x},${formData?.tech_y},${formData?.tech_z}\\right)} = \\left(${
                                    result?.tech_ev1 + result?.tech_ev2 + result?.tech_ev3
                                  }\\right)`}
                                />
                              </p>
                            </>

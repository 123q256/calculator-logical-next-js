                ...
                <div className="col-span-12 inputs">
                  <div className="grid grid-cols-12 gap-2 md:gap-4 lg:gap-4">
                    <div className="col-span-12">
                      ...
                      <div className="mt-2">
                        ...
                        >
                          <option value="no">{data?.payload?.tech_lang_keys["no"]}</option>
                          <option value="yes">{data?.payload?.tech_lang_keys["yes"]}</option>
                        </select>
                      </div>
                    </div>
                  </div>
                  ...
                  {formData.tech_percentage.map((_, index) => (
                    <div
                      ...
                      key={index}
                    >
                      <p className="col-span-12 text-[14px] flex  justify-between">
                        <div className="">
                          <strong>
                        ...
                        <div className="flex items-center">
                          <img  src="/images/delete_btn.png" alt="remove img" className="h-4 w-4"  onClick={() => deleteEntry(index)} />
                        </div>
                        )}
                      </p>
                      ...
                      <div
                        className={`${
                          formData.tech_same_sample === "yes" ? "col-span-12" : "col-span-6"
                        } percentage`}
                      >
                        <label htmlFor={`tech_percentage_${index}`} className="label">
                        ...
                        <div className="relative">
                          <input
                            ...
                            onChange={(e) =>
                              handleInputChange(index, "tech_percentage", e.target.value)
                            }
                          />
                        </div>
                      </div>
                      ...
                      {formData.tech_same_sample === "no" && (
                        <div className="col-span-6 sample">
                          <label htmlFor={`tech_sample_${index}`} className="label">
                          ...
                          <div className="relative">
                            <input
                              ...
                              onChange={(e) =>
                                handleInputChange(index, "tech_sample", e.target.value)
                              }
                            />
                          </div>
                        </div>
                ...
                <div className="rounded-lg flex items-center justify-center">
                      <div className="w-full mt-3">
                            ...
                            <tbody>
                              <tr>
                                <td className="py-2 border-b" width="60%">
                                  <strong>{data?.payload?.tech_lang_keys["avg_per"]}</strong>
                                </td>
                                <td className="py-2 border-b">{Math.round(avgResult)}%</td>
                              </tr>
                            </tbody>
                          </table>
                        </div>
                        ...
                        <div className="w-full text-[16px] overflow-auto">
                          <p className="mt-3">
                            <strong>{data?.payload?.tech_lang_keys["solution"]}:</strong>
                          </p>

                          {/* First KaTeX expression */}
                          <BlockMath math={`\\dfrac{${numerator}}{${denominator}}`} />

                          {/* Step1 only when samples are not same */}
                          {techSameSample === "no" && (
                            <BlockMath math={`= \\dfrac{${step1}}{${samples_sum}}`} />
                          )}

                          <BlockMath math={`= \\dfrac{${percents_sum}\\%}{${samples_sum}}`} />

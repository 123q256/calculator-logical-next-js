            ...
            <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
                <div className="grid grid-cols-12 mt-3 gap-2 md:gap-4 lg:gap-4">
                        ...
                        <div className="grid grid-cols-12 mt-3 gap-2 md:gap-4 lg:gap-4">
                            <div className="col-span-12">
                                ...
                                <div className="mt-2">
                                  ...
                                  >
                                    <option value="a">{data?.payload?.tech_lang_keys["2"]} </option>
                                    <option value="b">{data?.payload?.tech_lang_keys["3"]} </option>
                                    <option value="c">{data?.payload?.tech_lang_keys["4"]} </option>
                                    <option value="area">{data?.payload?.tech_lang_keys["5"]} </option>
                                    <option value="perimeter">{data?.payload?.tech_lang_keys["6"]} </option>
                                  </select>
                                </div>
                            </div>
                    ...
                    <div className="col-span-5 mt-3 text-center flex justify-center items-center">
                        <img  src="/images/new_fourty_five.webp" height="100%" width="150px" alt="trianle details image" loading="lazy" decoding="async"/>
                    </div>
              </div>
          </div>
                                ...
                                <div className="w-full md:w-[60%] lg:w-[60%] overflow-auto mt-2">
                                    <table className="w-full text-[16px]">
                                        <tr>
                                            ...
                                            <td className="py-2 border-b">{Number(result?.tech_a_ans).toFixed(2)} cm</td>
                                        </tr>
                                        <tr>
                                            <td className="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys[3]}</strong></td>
                                            <td className="py-2 border-b">{Number(result?.tech_b_ans).toFixed(2)} cm</td>
                                        </tr>
                                        <tr>
                                            <td className="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys[4]}</strong></td>
                                            <td className="py-2 border-b">{Number(result?.tech_c_ans).toFixed(2)} cm</td>
                                        </tr>
                                        <tr>
                                            <td className="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys[8]}</strong></td>
                                            <td className="py-2 border-b">{Number(result?.tech_height).toFixed(2)} cm</td>
                                        </tr>
                                        <tr>
                                            <td className="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys[5]}</strong></td>
                                            <td className="py-2 border-b">{Number(result?.tech_area_ans).toFixed(2)} cm²</td>
                                        </tr>
                                        <tr>

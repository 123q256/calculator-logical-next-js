                          ...
                          <div className="w-full mt-3">
                            <div className="w-full">
                                  ...
                                  <tbody>
                                    <tr>
                                      ...
                                      <td className="py-2 border-b">
                                        {Object.keys(result?.tech_ans || {}).map((key, index, arr) => {
                                          const isLast = index === arr.length - 1;
                                          const sep = formData?.tech_order === "1" ? " < " : " > ";
                              ...
                              <div className="w-full text-[16px]">
                                <p className="mt-2 font-bold">{data?.payload?.tech_lang_keys[7]}</p>
                                ...
                                <div className="w-full md:w-[60%] lg:w-[60%] overflow-auto mt-2">
                                  <table className="w-full text-[16px]">
                                    ...
                                    <tbody>
                                      {Object.entries(result?.tech_solve || {}).map(([key, value], idx) => (
                                        <tr key={`solve-${idx}`}>
                                ...
                                <p className="mt-2">
                                  ...
                                  {formData?.tech_order === "1" ? "Least to Greatest" : "Greatest to Least"}
                                </p>
                                ...
                                <div className="w-full md:w-[60%] lg:w-[60%] overflow-auto mt-2">
                                  <table className="w-full text-[16px]">
                                    ...
                                    <tbody>
                                      {Object.entries(result?.tech_ans || {}).map(([key, value], idx) => (
                                        <tr key={`ans-${idx}`}>
                                          <td className="py-2 border-b">{key}</td>
                                          <td className="py-2 border-b">{value}</td>
                                        </tr>

             ...
             <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
                ...
                <div className="col-span-12 text-left">
                    ...
                    <div className="mt-2">
                      ...
                      >
                        <option value="3">{data?.payload?.tech_lang_keys["tri"]}</option>
                        <option value="4">{data?.payload?.tech_lang_keys["pol"]}</option>
                        <option value="n">{data?.payload?.tech_lang_keys["n"]}</option>
                      </select>
                    </div>
                </div>
                          ...
                          <div className="w-full">
                              <div className="w-full overflow-auto  mt-2">
                                  <table className="w-full text-[16px]">
                                      <tr>
                                          <td className="py-2 border-b" width="60%"><strong>{ data?.payload?.tech_lang_keys['anst'] }</strong></td>
                              ...
                              <div className="w-full text-[18px] overflow-auto">
                                  ...
                                  {(formData?.tech_shap=='3' || formData?.tech_total=='3') ? (
                                    <>
                                    <p className="mt-2">
                                      Point 1 (x<sub className="font-s-14">1</sub>, y<sub className="font-s-14">1</sub>) = ({x1}, {y1})<br />
                                      Point 2 (x<sub className="font-s-14">2</sub>, y<sub className="font-s-14">2</sub>) = ({x2}, {y2})<br />
                                      Point 3 (x<sub className="font-s-14">3</sub>, y<sub className="font-s-14">3</sub>) = ({x3}, {y3})
                                    </p>

                                    <p className="mt-2">Formula of Centroid =</p>

                                    <BlockMath math={`\\left( \\frac{x_1 + x_2 + x_3}{3},\\ \\frac{y_1 + y_2 + y_3}{3} \\right)`} />
                                    ...
                                    <p className="mt-2">Centroid (Result): ({result?.tech_ans})</p>
                                  </>
                                  ):(
                                     <>
                                      {/* Render points */}
                                      {Array.from({ length: n }, (_, i) => (
                                        <p key={i} className="mt-2">
                                          Point {i + 1} (x<sub className="font-s-14">{i + 1}</sub>, y
                                          <sub className="font-s-14">{i + 1}</sub>) = ({xVals[i]}, {yVals[i]})
                                        </p>
                                      ))}
                                      ...
                                      <BlockMath
                                        math={`\\left( \\frac{${buildSumWithSubs("x")}}{${n}},\\ \\frac{${buildSumWithSubs("y")}}{${n}} \\right)`}
                                      />

                                      <p className="mt-2">Substitute values:</p>

                                      <BlockMath
                                        math={`\\left( \\frac{${buildSumOfValues(xVals)}}{${n}},\\ \\frac{${buildSumOfValues(yVals)}}{${n}} \\right)`}
                                      />

                                      <p className="mt-2">Calculate sums:</p>

                                      <BlockMath
                                        math={`\\left( \\frac{${xVals.reduce((a, b) => a + b, 0)} }{${n}},\\ \\frac{${yVals.reduce((a, b) => a + b, 0)}}{${n}} \\right)`}
                                      />
                                  ...
                                  <div className="col-12 text-center mt-3">
                                      {(formData.tech_shap == '3') ? (
                                        <>
                                        <img src="/images/triangle.webp" height="100%" width="200px" alt="trianle details image first" loading="lazy" decoding="async"/>
                                        </>
                                      ): (formData.tech_shap == '4') ? (
                                        <>
                                          <img  src="/images/pol.webp" height="100%" width="200px" alt="trianle details image second" loading="lazy" decoding="async"/>
                                        </>
                                      ):(
                                        <>
                                          <img  src="/images/npoint.webp" height="100%" width="200px" alt="trianle details image third" loading="lazy" decoding="async"/>
                                        </>
                                      )}
                                  </div>
                              </div>

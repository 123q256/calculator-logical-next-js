                                  ...
                                  <table className="w-full font-s-18">
                                    <tbody>
                                      <tr>
                                        ...
                                        <td className="py-2 border-b">{result?.tech_answer1}</td>
                                      </tr>
                                    </tbody>
                                  </table>
                                </div>
                                  ...
                                  <div className="w-full md:w-[60%] lg:w-[60%] my-3 tableAns overflow-auto">
                                      ...
                                      <tbody>
                                        <tr>
                                          ...
                                          {Array(tech_col - upperCount)
                                            .fill(null)
                                            .map((_, i) => (
                                              <td key={"u-empty-" + i} style={{ width: 20, height: 20 }}></td>
                                            ))}
                                          {upper.map((val, i) => (
                                            <td key={"u-" + i} style={{ width: 10, height: 10 }}>
                                              {val}
                                            </td>
                                          ))}
                                        </tr>
                                    ...
                                    {result?.tech_line3 && (
                                      <>
                                        ...
                                        <p className="mt-2">
                                          {data?.payload?.tech_lang_keys[3]} = {result.tech_answer1}
                                        </p>
                                      </>
                                    )}

                                    <p className="mb-3 mt-2 text-center">
                                      {formData?.tech_first} × {formData?.tech_second} = {result.tech_answer1}
                                    </p>
                                  </div>
                                </div>
                              </div>

                       ...
                       <div className="rounded-lg flex items-center justify-center">
                          <div className="w-full mt-3">
                            <div className="w-full overflow-auto text-[18px]">
                              ...
                              <BlockMath math={`(f + g)(${x}) = ${result?.tech_add}`} />
                              <BlockMath math={`(f - g)(${x}) = ${result?.tech_sub}`} />
                              <BlockMath math={`(f \\times g)(${x}) = ${result?.tech_mul}`} />
                              <BlockMath math={`(f \\div g)(${x}) = ${result?.tech_div}`} />
                              ...
                              {point && (
                                <>
                                  ...
                                  <BlockMath math={`(f + g)(${point}) = ${result?.tech_add1}`} />
                                  <BlockMath math={`(f - g)(${point}) = ${result?.tech_sub1}`} />
                                  <BlockMath math={`(f \\times g)(${point}) = ${result?.tech_mul1}`} />
                                  <BlockMath math={`(f \\div g)(${point}) = ${result?.tech_div1}`} />
                                </>
                              )}
                            </div>
                            ...
                            <div className="w-full overflow-auto text-[16px]">
                              ...
                              <BlockMath math={`(f + g)(${x}) = (${result?.tech_fox}) + (${result?.tech_gox}) = ${result?.tech_add}`} />
                              <BlockMath math={`(f - g)(${x}) = (${result?.tech_fox}) - (${result?.tech_gox}) = ${result?.tech_sub}`} />
                              <BlockMath math={`(f \\times g)(${x}) = (${result?.tech_fox}) \\times (${result?.tech_gox}) = ${result?.tech_mul}`} />
                              <BlockMath
                              ...
                              {point && (
                                <>
                                  ...
                                  <BlockMath
                                    math={`(f + g)(${point}) = ${renderPointExpression(result?.tech_add, point)} = ${result?.tech_add1}`}
                                  />
                                  <BlockMath
                                    math={`(f - g)(${point}) = ${renderPointExpression(result?.tech_sub, point)} = ${result?.tech_sub1}`}
                                  />
                                  <BlockMath
                                    math={`(f \\times g)(${point}) = ${renderPointExpression(result?.tech_mul, point)} = ${result?.tech_mul1}`}
                                  />
                                  <BlockMath
                                    math={`(f \\div g)(${point}) = ${renderPointExpression(result?.tech_div, point)} = ${result?.tech_div1}`}
                                  />
                                </>
                              )}
                            </div>

            ...
            <div className="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                <div className="lg:col-span-6 md:col-span-6 col-span-12">
                      ...
                      {data?.payload?.tech_lang_keys["1"]}:
                        ...
                        <div className="mt-2">
                          ...
                          >
                            ...
                            <option value="6">{data?.payload?.tech_lang_keys["8"]} </option>
                            <option value="7">{data?.payload?.tech_lang_keys["9"]} </option>
                          </select>
                        </div>
                    </div>
                    {(formData.tech_find == "0" || formData.tech_find == "4" || formData.tech_find == "5" || formData.tech_find == "6" || formData.tech_find == "7") && (
                      <>
                    <div className="col-span-12" id="angleInput">
                      <label htmlFor="tech_angle" className="label" >
                     {data?.payload?.tech_lang_keys['10']} {data?.payload?.tech_lang_keys['21']} (θ)
                        </label>
                      ...
                      {(formData.tech_find == "0" || formData.tech_find == "1" || formData.tech_find == "2" || formData.tech_find == "3") && (
                      <>
                    ...
                    <div className="col-span-12" id="areaInput">
                         <label htmlFor="tech_area" className="label" >
                          {data?.payload?.tech_lang_keys['13']} {data?.payload?.tech_lang_keys['20']} (A)
                        </label>
                        <div className="relative w-full ">
                          <input
                            type="number"
                    ...
                    <div className="col-span-12 " id="chrd_lenInput">
                          ...
                          {data?.payload?.tech_lang_keys['14']} {data?.payload?.tech_lang_keys['22']} (c)
                        </label>
                        <div className="relative w-full ">
                          <input
                            type="number"
                ...
                <div className="lg:col-span-6 md:col-span-6 col-span-12 flex items-center">
                    <div className="col-12 text-center justify-center flex ">
                        <img  src="/images/arc_length.png" width="75%" height="100%" alt="arc length img" loading="lazy" decoding="async"/>
                    </div>
                </div>
          </div>
      </div>
                                    ...
                                    <table className="w-full text-[16px]">
                                      <tbody>
                                        {(formData?.tech_find === '0') ? (
                                          <>
                                            <tr>
                                                <td className="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys['16']}</strong></td>
                                                <td className="py-2 border-b">{result?.tech_arc_len} m</td>
                                            </tr>
                                            <tr>
                                                <td className="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys['12']}</strong></td>
                                                <td className="py-2 border-b">{result?.tech_diameter} m</td>
                                            </tr>
                                            <tr>
                                                <td className="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys['13']} {data?.payload?.tech_lang_keys['17']}</strong></td>
                                                <td className="py-2 border-b">{result?.tech_area} m²</td>
                                            </tr>
                                            <tr>
                                                <td className="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys['14']} {data?.payload?.tech_lang_keys['18']}</strong></td>
                                                <td className="py-2 border-b">{result?.tech_chrd_len} m</td>
                                            </tr>
                                          ...
                                          <>
                                            ...
                                            <tr>
                                                <td className="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys['10']} {data?.payload?.tech_lang_keys['19']}</strong></td>
                                                <td className="py-2 border-b">{result?.tech_angle} rad / {Number(rad2deg(result?.tech_angle)).toFixed(5)} deg</td>
                                            </tr>
                                            <tr>
                                                <td className="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys['12']}</strong></td>
                                                <td className="py-2 border-b">{result?.tech_diameter} m</td>
                                          ...
                                          <>
                                            ...
                                            <tr>
                                                <td className="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys['19']}</strong></td>
                                                <td className="py-2 border-b">{result?.tech_angle} rad / {Number(rad2deg(result?.tech_angle)).toFixed(5)} deg</td>
                                            </tr>
                                            <tr>
                                                <td className="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys['12']}</strong></td>
                                          ...
                                          <>
                                            ...
                                            <tr>
                                                <td className="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys['17']}</strong></td>
                                                <td className="py-2 border-b">{result?.tech_area} m²</td>
                                            </tr>
                                          </>
                                        ): (formData?.tech_find === '4') ? (
                                          <>
                                            ...
                                            <tr>
                                                <td className="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys['11']}</strong></td>
                                                <td className="py-2 border-b">{result?.tech_rad} m</td>
                                            </tr>
                                            <tr>
                                                <td className="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys['12']}</strong></td>
                                                <td className="py-2 border-b">{result?.tech_diameter} m</td>

  ...
  const renderSteps = () => {
    switch (selection) {
      case "1": // Given radius
        return (
          <>
            <BlockMath math={`\\textbf{${data?.payload?.tech_lang_keys['3']}}\\,(d) = 2r`} />
            <BlockMath math={`d = 2 \\times ${r}`} />
            <BlockMath math={`d = ${roundVal(r * 2)}`} />

            <BlockMath math={`\\textbf{${data?.payload?.tech_lang_keys['4']}}\\,(a) = \\pi r`} />
            <BlockMath math={`a = \\pi \\times ${r}`} />
            <BlockMath math={`a = ${roundVal(a)}`} />

            <BlockMath math={`\\textbf{${data?.payload?.tech_lang_keys['6']}}\\,(A) = \\dfrac{\\pi \\times r^2}{2}`} />
            <BlockMath math={`A = \\dfrac{\\pi \\times ${r}^2}{2}`} />
            <BlockMath math={`A = ${roundVal(pi * r * r / 2)}`} />

            <BlockMath math={`\\textbf{${data?.payload?.tech_lang_keys['5']}}\\,(p) = \\pi r + 2r`} />
      ...
      case "2": // Given diameter
        return (
          <>
            <BlockMath math={`\\textbf{${data?.payload?.tech_lang_keys['2']}}\\,(r) = \\dfrac{d}{2}`} />
            <BlockMath math={`r = \\dfrac{${d}}{2}`} />
            <BlockMath math={`r = ${roundVal(r)}`} />

            <BlockMath math={`\\textbf{${data?.payload?.tech_lang_keys['4']}}\\,(a) = r\\pi`} />
      ...
      case "3": // Given arc length
        return (
          <>
            <BlockMath math={`\\textbf{${data?.payload?.tech_lang_keys['2']}}\\,(r) = \\dfrac{c}{\\pi}`} />
      ...
      case "4": // Given perimeter
        return (
          <>
            <BlockMath math={`\\textbf{${data?.payload?.tech_lang_keys['2']}}\\,(r) = \\dfrac{p}{\\pi + 2}`} />
      ...
      case "6": // Given Area
        return (
          <>
            <BlockMath math={`\\textbf{${data?.payload?.tech_lang_keys['2']}}\\,(r) = \\sqrt{\\dfrac{2a}{\\pi}}`} />
                   ...
                   <label htmlFor="tech_selection" className="label">
                    ...
                    <div className="mt-2">
                      ...
                      >
                        ...
                        <option value="2">{data?.payload?.tech_lang_keys["3"]} (d)</option>
                        <option value="3">{data?.payload?.tech_lang_keys["3"]} (a)</option>
                        <option value="4">{data?.payload?.tech_lang_keys["3"]} (p)</option>
                        <option value="6">{data?.payload?.tech_lang_keys["3"]} (A)</option>
                      </select>
                    </div>
                </div>
                <div className="col-span-12">
                  {formData.tech_selection == "2" ? (
                    <>
                    <label htmlFor="tech_radius" className="label">{data?.payload?.tech_lang_keys["3"]} (d):</label>
                    
                    </>
                  ): formData.tech_selection == "3" ? (
                    <>
                    <label htmlFor="tech_radius" className="label">{data?.payload?.tech_lang_keys["4"]} (a):</label>
                    
                    </>
                  ): formData.tech_selection == "4" ? (
                    <>
                    <label htmlFor="tech_radius" className="label">{data?.payload?.tech_lang_keys["5"]} (p):</label>
                    
                    </>
                    ): formData.tech_selection == "6" ? (
                    <>
                    <label htmlFor="tech_radius" className="label">{data?.payload?.tech_lang_keys["6"]} (A):</label>
                    
                    </>
                  ) :(
                    <>
                       <label htmlFor="tech_radius" className="label"> Radius (r):</label>
                    </>
                  )}
                  ...
                  <div>
                    ...
                    <div className="rounded-lg flex  mt-3">
                      <div className="w-full md:w-[60%] text-[16px]">
                        ...
                        <p className="font-bold text-[18px] mb-2">{data?.payload?.tech_lang_keys["14"]}</p>
                        {renderSteps()}
                      </div>
                    </div>

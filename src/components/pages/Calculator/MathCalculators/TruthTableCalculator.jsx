...
function badchar(s) {
  const valid = ",()~v&<>-|#ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuwxyz";
...
function tSeg(f, t, lhs) {
  const tblRows = lhs.slice(1).map((row) => d1(evalTree(t, assign(lhs[0], row))));
  return [d1(t), ...tblRows];
}
            ...
            {table.map((tbl, i) =>
              tbl[rIndex + 1].map((cell, j) => {
                ...
                return (
                  <td
                    key={`${i}-${j}`}
                    className={`border-b py-2 ${isRes ? "font-bold text-blue-600" : ""}`}
                  >
                    {charSet(cell)}
                  </td>
                );
          ...
          <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg shadow-md space-y-6 mb-3">
            {formError && (
             ...
             <div className="lg:w-[40%] md:w-[60%] w-full mx-auto ">
               ...
               <div className="col-span-12">
              <table className="w-full inp_table border radius-5">
                <tbody>
                  <tr>
                    <td colSpan="2" className="border-b py-2 text-center tagsUnit">
                  ...
                  <tr>
                    <td className="border-b p-2">{data?.payload?.tech_lang_keys?.['4']}</td>
                    <td className="border-b p-2">~</td>
                  </tr>
                  <tr>
                    <td className="border-b p-2">{data?.payload?.tech_lang_keys?.['5']}</td>
                    <td className="border-b p-2">&amp;</td>
                  </tr>
                  <tr>
                    <td className="border-b p-2">{data?.payload?.tech_lang_keys?.['6']}</td>
                    <td className="border-b p-2">v</td>
                  </tr>
                  <tr>
                    <td className="border-b p-2">{data?.payload?.tech_lang_keys?.['7']}</td>
                    <td className="border-b p-2">-&gt;</td>
                  </tr>
                  <tr>
                  ...
                  <div className="rounded-lg flex items-center justify-center">
                    <div className="w-full my-[25px]">
                      <div className="row my-2 text-[18px]">
                        ...
                        <div className="text-[16px] overflow-auto">{truthTableHTML}</div>
                      </div>
                    </div>
                  </div>

        ...
        <form className="row" onSubmit={handleSubmit}>
          <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mb-3">
            ...
            <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
                    ...
                    <p className="col-span-12 mx-2 text-center mb-1"><strong>{data?.payload?.tech_lang_keys[1]}</strong></p>
                    ...
                    <p className="col-span-12 mx-2 text-center mb-1 mt-2"><strong>{data?.payload?.tech_lang_keys[2]}</strong></p>
                    <div className="col-span-12 flex items-center justify-center">
                        <div className="md:mx-2 py-2 relative">
                              <div className=" relative">
                              <input
                          ...
                          <div className="w-full mt-3">
                            <div className="w-full">
                                ...
                                <table className="w-full text-[16px]">
                                  <tbody>
                                    {xIsNumeric && (
                                      <tr>
                                        <td className="py-2 border-b w-[80%]">
                                          <strong>{data?.payload?.tech_lang_keys["3"]} x =</strong>
                                        </td>
                                    ...
                                    {yIsNumeric && (
                                      <tr>
                                        <td className="py-2 border-b w-[80%]">
                                          <strong>{data?.payload?.tech_lang_keys["3"]} y =</strong>
                                        </td>
                              ...
                              <div className="w-full text-[20px] md:text-[25px]">
                                ...
                                <p className="mt-2">
                                  <InlineMath math={`x = \\frac{(y_1 \\cdot c_2) - (y_2 \\cdot c_1)}{(x_1 \\cdot y_2) - (x_2 \\cdot y_1)}`} />
                                </p>
                              ...
                              > <Line data={datachart} options={options} /></div>
                            </div>
                          </div>
                        </div>

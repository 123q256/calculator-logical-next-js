...
const MidpointCalculator = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.tech_x1 || !formData.tech_x2  || !formData.tech_y1  || !formData.tech_y2 ) {
    ...
    plugins: {
      dragData: {
        ...
        onDragEnd: (e, datasetIndex, index, value) => {
          console.log(`Point moved in dataset ${datasetIndex} at index ${index}:`, value);
          if (onPointMove) {
                        ...
                        <div className="w-full mt-3">
                          <div className="w-full">
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td className="py-2 border-b">
                                      (x , y) = (
                                      {(result?.tech_x !== undefined && result?.tech_y !== undefined)
                            ...
                            <div className="w-full overflow-auto">
                              ...
                              <p className="mt-2">
                                {data?.payload?.tech_lang_keys['to_find']} X(x₁,x₂) {data?.payload?.tech_lang_keys['use']}:
                              </p>

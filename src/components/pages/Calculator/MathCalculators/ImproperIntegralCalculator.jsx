             ...
             <div className="lg:w-[60%] md:w-[90%] w-full mx-auto ">
                <div className="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                    ...
                    <div className="col-span-6">
                        ...
                        {data?.payload?.tech_lang_keys["2"]} If you want −∞, enter -inf:
                          </label>
                    ...
                    <div className="col-span-6">
                        ...
                        {data?.payload?.tech_lang_keys["3"]} If you want −∞, enter -inf:
                          </label>
                          <div className=" relative">
                          <input
                            type="text"
                    ...
                    <div className="w-full mt-3">
                      <div className="w-full text-[16px] overflow-auto">
                        <p className="mt-3 text-[18px]">
                          <InlineMath math={`${result?.tech_res1} = ${result?.tech_ans}`} />
                        </p>
                        ...
                        {isInf(formData?.tech_lb) ? (
                          <p className="mt-3">
                            <InlineMath
                              math={`\\lim_{x \\to ${limText(formData?.tech_lb)}} \\left(${result?.tech_res}\\right) = ${result?.tech_first}`}
                            />
                          </p>
                        ) : (
                          <p className="mt-3">
                        ...
                        {isInf(formData?.tech_ub) ? (
                          <p className="mt-3">
                            <InlineMath
                              math={`\\lim_{x \\to ${limText(formData?.tech_ub)}} \\left(${result?.tech_res}\\right) = ${result?.tech_sec}`}
                            />
                          </p>
                        ) : (
                          <p className="mt-3">
                        ...
                        <p className="mt-3">
                          <InlineMath
                            math={`${result?.tech_res1} = \\left(${
                              isInf(formData?.tech_lb)
                                ? `\\lim_{x \\to ${limText(formData?.tech_lb)}}\\left(${result?.tech_res}\\right)`
                                : `\\left(${result?.tech_res}\\right)|_{${withVar}=${formData?.tech_lb}}`
                            }\\right) - \\left(${
                              isInf(formData?.tech_ub)
                                ? `\\lim_{x \\to ${limText(formData?.tech_ub)}}\\left(${result?.tech_res}\\right)`

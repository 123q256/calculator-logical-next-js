          ...
          <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg  space-y-6 mb-3">
           ...
           <div class="lg:w-[60%] md:w-[80%] w-full mx-auto ">
              ...
              <p class="col-span-12 text-center my-3 text-[18px]">
                {formData.tech_to == "2" ? (
                  <>
                  <strong id="changeText">{data?.payload?.tech_lang_keys[6]}: y = mx + c</strong>
                  </>
                ):(
                  <>
                  <strong id="changeText">{data?.payload?.tech_lang_keys[4]}: Ax + By + C = 0 </strong>
                  </>
                )}
              </p>
              <div className={formData.tech_to === "1" ? "col-span-4" : "col-span-6"} id="aInput">
                  <label htmlFor="tech_a" className="label">
                    {data?.payload?.tech_lang_keys["5"]} <span id="enter_a">A</span>
                      </label>
                      <div class=" relative">
                      <input
                        type="number"
              ...
              <div className={formData.tech_to === "1" ? "col-span-4" : "col-span-6"} id="bInput">
                 <label htmlFor="tech_b" className="label">
                    {data?.payload?.tech_lang_keys["5"]} <span id="enter_b">B</span>
                      </label>
                      <div class=" relative">
                      <input
                        type="number"
              ...
              {formData.tech_to == "1" && (
                ...
                <div class="col-span-4" id="cInput">
                  <label htmlFor="tech_c" className="label">
                      {data?.payload?.tech_lang_keys["5"]} <span id="enter_b">C</span>
                        </label>
                        <div class=" relative">
                        <input
                          type="number"
                            ...
                            {(formData?.tech_to == "1") ? (
                              ...
                              <div className="col-span-12 text-center text-[16px] overflow-auto">
                                    ...
                                    <div class="flex justify-center">
                                     ...
                                     <p class="my-3 text-[16px]">
                                        That is, the slope-intercept form y = mx + b of your line has the following coefficients:
                                     </p>
                                      <div class="flex justify-center mt-4 overflow-auto">
                                        <strong class="bg-[#2845F5] px-3 py-2 text-[22px] rounded-lg text-white "> m = {Number(result?.tech_m).toFixed(3)} </strong>
                                        <strong class="bg-[#2845F5] px-3 py-2 text-[22px] rounded-lg text-white mx-2">  c = {Number(result.tech_nb).toFixed(3)} </strong>
                                    </div>
                                ...
                                <div className="col-span-12 text-[16px] overflow-auto">
                                  ...
                                  <p className="mt-2">
                                    {data?.payload?.tech_lang_keys[8]} 'x' {data?.payload?.tech_lang_keys[9]}:
                                  </p>
                                  ...
                                  <p className="mt-2">{data?.payload?.tech_lang_keys[10]} y:</p>
                                  ...
                                  <p className="mt-2">
                                    y = ({(-1 * formData?.tech_a)}/{formData?.tech_b})x (
                                    {formData?.tech_c < 0
                                      ? '+ ' + Math.abs(formData?.tech_c)
                                      : '- ' + formData?.tech_c}
                                    /{formData?.tech_b})
                                    ...
                                    <tbody>
                                      <tr>
                                        ...
                                        <td className="py-2 border-b">
                                          <strong>{result?.tech_m !== '' ? result.tech_m : '0.0'}</strong>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td className="py-2 border-b w-[60%]">
                                          Y - {data?.payload?.tech_lang_keys[12]} (c)
                                        </td>
                                        <td className="py-2 border-b">
                                          <strong>
                                            {result?.tech_nb < 0
                                      ...
                                      <tr>
                                        ...
                                        <td className="py-2 border-b">
                                          <strong>
                                            {result?.tech_m
                                              ? ((-1 * result.tech_nb) / result.tech_m).toFixed(2)
                                              : 'NaN'}
                                          </strong>
                                        </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td className="py-2 border-b">
                                          <strong>{(result?.tech_m * 100).toFixed(2)} %</strong>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td className="py-2 border-b w-[60%]">
                              ...
                              <>
                                ...
                                <p className="my-3">
                                  <strong className="text-[20px]">Ax + By + C = 0</strong>
                                </p>

                                <p className="my-3">
                                  <strong className="bg-[#2845F5] px-3 py-2 text-[32px] rounded-[10px] text-white">
                                    {(result?.tech_A !== 1 ? result?.tech_A : '') + 'x '}
                                    {result?.tech_B < 0
                                ...
                                <p class="my-3 text-[16px]">
                                  That is, the standard form Ax + By + C = 0 of your line has the following coefficients:
                              </p>
                              <div class="d-flex justify-content-center mt-4">
                                <strong class="bg-[#2845F5] px-3 py-2 text-[22px] rounded-lg text-white "> A = {result?.tech_A} </strong>
                                
                                <strong class="bg-[#2845F5] px-3 py-2 text-[22px] rounded-lg text-white mx-2">  B = {result.tech_B} </strong>

                                <strong class="bg-[#2845F5] px-3 py-2 text-[22px] rounded-lg text-white ">C =  {result.tech_C}</strong>
                            </div>
                              </div>
                              </>
                            )}

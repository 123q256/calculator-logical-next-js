                            ...
                            {result?.tech_res === 'no' ? (
                              ...
                              <>
                                  ...
                                  <table className="w-full text-[16px]">
                                    <tbody>
                                      <tr>
                                        ...
                                        <td className="py-2 border-b">{result?.tech_res}</td>
                                      </tr>
                                    </tbody>
                                  </table>
                                </div>
                                ...
                                <div className="w-full text-[16px] overflow-auto mt-3 space-y-2">
                                  ...
                                  {/* a * x = 1 mod b */}
                                  <BlockMath math={`${formData?.tech_a} ${formData?.tech_opr === 1 ? '\\cdot' : '+'} x = 1 \\mod ${formData?.tech_b}`} />
                                  ...
                                  {/* a * res = a+res */}
                                  <BlockMath
                                    math={`${formData?.tech_a} ${formData?.tech_opr === 1 ? '\\cdot' : '+'} ${result?.tech_res} = ${formData?.tech_a + result?.tech_res}`}
                                  />

                                  {/* final mod check */}
                                  <BlockMath math={`${formData?.tech_a + result?.tech_res} \\equiv 1 \\mod ${formData?.tech_b}`} />
                                </div>
                              </>
                            )}
                          </div>

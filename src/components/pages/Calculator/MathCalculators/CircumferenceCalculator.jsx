          ...
          <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mb-3">
            {formError && (
             ...
             <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
              <p className="w-full my-3">{ data?.payload?.tech_lang_keys['note_value'] }</p>
                          ...
                          <div className="w-full">
                            <table className="w-full">
                              ...
                              {!formData?.tech_radius && (
                                <tr>
                                  <td className="py-2 border-b w-2/5">
                                    <strong>{data?.payload?.tech_lang_keys['radius']}</strong>
                                  </td>
                              ...
                              {!formData?.tech_diameter && (
                                <tr>
                                  <td className="py-2 border-b">
                                    <strong>{data?.payload?.tech_lang_keys['diameter']}</strong>
                                  </td>
                                  <td className="py-2 border-b text-right">
                                    <strong>2r</strong>
                                  </td>
                                  <td className="py-2 border-b text-right">
                                    {Number(result?.tech_Radius * 2).toFixed(5)} cm
                                  </td>
                                </tr>
                              )}
                              ...
                              {!formData?.tech_circumference && (
                                <tr>
                                  <td className="py-2 border-b">
                                    <strong>{data?.payload?.tech_lang_keys['circumference']}</strong>
                                  </td>
                                  <td className="py-2 border-b text-right">
                                    <strong>2πr</strong>
                                  </td>
                                  <td className="py-2 border-b text-right">
                                    {Number(result?.tech_Radius * 3.14159 * 2).toFixed(5)} cm
                                  </td>
                                </tr>
                              )}
                              ...
                              {!formData?.tech_area && (
                                <tr>
                                  <td className="py-2 border-b">
                                    <strong>{data?.payload?.tech_lang_keys['area']}</strong>
                                  </td>
                                  <td className="py-2 border-b text-right">
                                    <strong>πr²</strong>
                                  </td>
                                  <td className="py-2 border-b text-right">
                                    {Number(Math.pow(result?.tech_Radius, 2) * 3.14159).toFixed(5)} cm
                                  </td>
                                </tr>
                              )}
                              </tbody>

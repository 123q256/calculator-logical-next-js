        ...
        <form className="row" onSubmit={handleSubmit}>
          <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mb-3">
           ...
           <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
                ...
                <p className="col-span-12 text[16px]"><strong>{data?.payload?.tech_lang_keys['start']}</strong></p>
                ...
                <p className="col-span-12 text[16px] "><strong>{data?.payload?.tech_lang_keys['mid']}</strong></p>
                <div className="col-span-6">
                            ...
                            <div className="w-full">
                              <div className="w-full md:w-[60%] lg:w-[60%] mt-2 overflow-auto">
                                <table className="w-full text-[18px]">
                                  <tbody>
                                    <tr>
                                      <td className="py-2 border-b" style={{ width: "60%" }}>
                                        <strong>{data?.payload?.tech_lang_keys['end']}</strong>
                                      </td>
                                    ...
                                    <tr>
                                      <td className="py-2 border-b" style={{ width: "60%" }}>
                                        <strong>{data?.payload?.tech_lang_keys['dis']}</strong>
                                      </td>
                                      <td className="py-2 border-b">{result?.tech_dis}</td>
                                    </tr>
                                  </tbody>
                                </table>
                              </div>
                              <div className="w-full overflow-auto">
                                <p className="mt-2">
                                  <strong>{data?.payload?.tech_lang_keys['exp']}</strong>
                                </p>
                                <p className="mt-2">You entered the following points:</p>
                                <p className="mt-2">
                                  (x_1 , y_1) = ({formData?.tech_x1} , {formData?.tech_y1})
                                </p>
                                <p className="mt-2">
                                ...
                                <p className="mt-2">
                                  (x_2, y_2) = (2 × {formData?.tech_x} - {formData?.tech_x1}, 2 × {formData?.tech_y} - {formData?.tech_y1})
                                </p>
                                ...
                                <p className="mt-2">
                                  d = <InlineMath math=" \sqrt{(x_2 - x_1)^2 + (y_2 - y_1)^2} " />
                                </p>

                                <p className="mt-2">
                                  d = <InlineMath math={` \\sqrt{(${result?.tech_x2} - ${formData?.tech_x1})^2 + (${result?.tech_y2} - ${formData?.tech_y1})^2}`} />
                                </p>
                                ...
                                <p className="mt-2">
                                  d = <InlineMath math={` \\sqrt{${Math.pow(result?.tech_x2 - formData?.tech_x1, 2) + Math.pow(result?.tech_y2 - formData?.tech_y1, 2)}}`} />
                                </p>

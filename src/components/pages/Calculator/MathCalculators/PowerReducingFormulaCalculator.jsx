          ...
          <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mb-3">
           ...
           {formData.tech_know == "2" && (
              ...
              <div className="col-span-12 function ">
                  <div className="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                      <p className="col-span-12 text-center mt-3 mb-1"><strong>{ data?.payload?.tech_lang_keys['4'] }</strong></p>
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td className="py-2 border-b">
                                  <strong>{Number(result.tech_angle).toFixed(5)} (deg)</strong>
                                </td>
                              </tr>
                              <tr>
                                <td className="py-2 border-b" width="60%">
                                ...
                                <td className="py-2 border-b">
                                  <strong>{Number(deg2rad(result.tech_angle)).toFixed(5)} (rad)</strong>
                                </td>
                              </tr>
                            </tbody>
                          </table>
                     ...
                     <div className="w-full md:w-[80%] lg:w-[60%] overflow-auto mt-3">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td className="py-2 border-b">{Number(result?.tech_sin).toFixed(5)}</td>
                            </tr>
                            <tr>
                              <td className="py-2 border-b" width="60%">
                                <strong>cos(x)</strong>
                              </td>
                              <td className="py-2 border-b">{Number(result?.tech_cos).toFixed(5)}</td>
                            </tr>
                            <tr>
                              <td className="py-2 border-b" width="60%">
                                <strong>tan(x)</strong>
                              </td>
                              <td className="py-2 border-b">{Number(result?.tech_tan).toFixed(5)}</td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
                            ...
                            {[2, 3, 4].map((power) => (
                              ['sin', 'cos', 'tan'].map((func) => (
                                <tr key={`${func}${power}`}>
                                  <td className="py-2 border-b" width="60%">
                                    {func}
                                    <sup className="text-[14px]">{power}</sup>(x)
                                  </td>
                                  <td className="py-2 border-b">
                                    <strong>{Number(result?.[`tech_${func}${power}`]).toFixed(5)}</strong>
                                  </td>
                                </tr>
                              ))
                            ))}

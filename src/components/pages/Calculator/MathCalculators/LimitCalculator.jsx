                        ...
                        <div className="flex flex-wrap">
                          <div className="w-full text-base overflow-auto">
                            ...
                            <p className="mt-3 text-lg">
                              <BlockMath math={`\\lim_{ ${formData?.tech_with} \\to ${result?.tech_inf}^{${result?.tech_dir}} } (${result?.tech_enter}) = ${result?.tech_ans}`} />
                            </p>
                            ...
                            {/* Limit again */}
                            <p className="mt-3">
                              <BlockMath math={`\\lim_{ ${formData?.tech_with} \\to ${result?.tech_inf}^{${result?.tech_dir}} } (${result?.tech_enter})`} />
                            </p>
                            ...
                            {result?.tech_upr !== undefined && result?.tech_btm !== undefined && (
                              <p className="mt-3">
                                <BlockMath math={
                                  (result.tech_upr < 0 && result.tech_btm < 0 && result.tech_upr !== 0 && result.tech_btm !== 0)
                                    ? `= \\dfrac{${Math.abs(result.tech_upr)}}{${Math.abs(result.tech_btm)}}`
                                    : (result.tech_btm < 0 && result.tech_upr !== 0 && result.tech_btm !== 0)
                                    ? `= \\dfrac{-${Math.abs(result.tech_upr)}}{${Math.abs(result.tech_btm)}}`
                            ...
                            {/* Final answer */}
                            <p className="mt-3">
                              {data?.payload?.tech_lang_keys[7]} <BlockMath math={`= ${result?.tech_ans}`} />
                            </p>

                            {/* With value */}
                            <p className="mt-3">
                              {data?.payload?.tech_lang_keys[10]} {formData?.tech_with} = {result?.tech_inf}
                            </p>
                            ...
                            <p className="mt-3">
                              ...
                              <br />
                              <span className="text-base">{data?.payload?.tech_lang_keys[11]}</span>
                            </p>

                ...
                <div className="grid grid-cols-12  gap-2 md:gap-3 lg:gap-3">
                    <div className="md:col-span-6 col-span-12">
                          ...
                          <div className="mt-2">
                            ...
                            >
                              <option value="log">{data?.payload?.tech_lang_keys["log"]}</option>
                              <option value="anti">{data?.payload?.tech_lang_keys["anti"]} </option>
                              ...
                              <div className="w-full text-[20px]">
                                ...
                                <p className="my-3 flex justify-center">
                                  <strong className="bg-[#2845F5] px-3 py-2 md:text-[32px] rounded-lg text-white">
                                    {result?.tech_ans != undefined && result?.tech_ans != null 
                                      ? result.tech_ans 
                                      : "0.0"
                                    }
                                  </strong>

...
const [showKeyboard, setShowKeyboard] = useState(false);
  ...
  const handleSubmit = async (e) => {
    ...
    if(formData.form == "def"){
      if (!formData.form  || !formData.EnterEq || !formData.with || !formData.ub || !formData.lb ) {
                ...
                <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
                  <div className="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                      <div className="lg:col-span-9 md:col-span-9 col-span-12">
                          ...
                          <label for="EnterEq" className="label mt-4">{data?.payload?.tech_lang_keys['6']}:</label>
                              ...
                              <div className="w-full  p-3 rounded-lg mt-3">
                                <div className="grid grid-cols-1 gap-4 overflow-auto">
                                  <div className="text-base">
                                    ...
                                    <p className="mt-3 text-lg font-semibold">{data?.payload?.tech_lang_keys['8']}</p>
                                    <p className="mt-3 text-lg">
                                      <InlineMath math={`${result?.tech_ans} + \\text{ constant}`} />
                                    </p>

                                    <p className="mt-3 text-lg font-semibold">{data?.payload?.tech_lang_keys['6']}</p>
                                    ...
                                    {result?.tech_defi ? (
                                      ...
                                      <p className="mt-3">
                                        <InlineMath math={`\\int ${result?.tech_enter}\\, d${formData?.with}`} />
                                      </p>
                                    )}

                                    <p className="mt-3 text-lg font-semibold">Solution:</p>

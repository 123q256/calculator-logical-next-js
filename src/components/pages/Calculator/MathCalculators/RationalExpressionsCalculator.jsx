                        ...
                        <div class="w-full mt-3">
                            <div class="row">
                                {(formData?.tech_to == 1) ? (
                                  ...
                                  <BlockMath math={`= \\dfrac{${result?.tech_up}}{${result?.tech_down}}`} />
                                  <BlockMath math={`= ${result?.tech_ress}`} />
                                </div>
                                  </>
                                ):(formData?.tech_to == 2) ? (
                                  <>
                                        {(formData?.tech_to_cal == 'two') ? (
                                          <>
                                                  ...
                                                  {(result?.tech_lcm && (result?.tech_action === "+" || result?.tech_action === "-")) ? (
                                                    <div className="col-span-12 text-[16px] ">
                                                      <BlockMath math={`= \\dfrac{${result?.tech_top}}{${result?.tech_lcm}}`} />
                                                      <p className="mt-2">
                                                        <strong>{data?.payload?.tech_lang_keys[11]}:</strong>
                                                      </p>
                                                      <BlockMath math={`${result?.tech_up} ${result?.tech_action} ${result?.tech_down}`} />
                                                      <BlockMath math={`= \\dfrac{\\left(${result?.tech_left}\\right) ${result?.tech_action} \\left(${result?.tech_right}\\right)}{${result?.tech_lcm}}`} />
                                                      <BlockMath math={`= \\dfrac{${result?.tech_top}}{${result?.tech_lcm}}`} />
                                                      <BlockMath math={`= \\dfrac{${result?.tech_top}}{${result?.tech_lcm}}`} />
                                                    </div>
                                                  ) : result?.tech_lcm && (result?.tech_action === "*" || result?.tech_action === "÷") ? (
                                                    <div className="col-span-12 text-center my-2">
                                                      <p>
                                                        <strong className="bg-white px-3 py-2 font-s-21 rounded-lg text-blue">
                                                          <BlockMath math={`${result?.tech_up} ${result?.tech_action} ${result?.tech_down} = \\dfrac{${result?.tech_top}}{${result?.tech_lcm}}`} />
                                                        </strong>
                                                      </p>
                                                    </div>
                                                  ) : (
                                                    <div className="col-span-12 text-center my-2  ">
                                                      <p>
                                                        <strong className="bg-white px-3 py-2 font-s-21 rounded-lg text-blue">
                                                          <BlockMath math={`${result?.tech_up} ${result?.tech_action} ${result?.tech_down} = ${result?.tech_ans}`} />
                                                        </strong>
                                                      </p>
                                                    </div>
                                                  )}
                                          ...
                                          <div className="w-full overflow-auto text-[16px]">
                                             {(result?.tech_lcm && isPlusMinus(result?.tech_action) && isPlusMinus(result?.tech_action1)) ? (
                                              <div className="col-span-12 text-[16px]">
                                                <BlockMath math={`= \\dfrac{${result?.tech_top}}{${result?.tech_lcm}}`} />
                                                <p className="mt-2">
                                                  <strong>{data?.payload?.tech_lang_keys[11]}</strong>:
                                                </p>
                                                <BlockMath math={`${result?.tech_up} ${result?.tech_action} ${result?.tech_down} ${result?.tech_action1} ${result?.tech_thr}`} />
                                                <BlockMath
                                            ...
                                            ) : (result?.tech_lcm && isPlusMinus(result?.tech_action) && isMultiplyDivide(result?.tech_action1)) ? (
                                              <div className="col-span-12 text-[16px]">
                                                <BlockMath math={`= \\dfrac{${result?.tech_top}}{${result?.tech_lcm1}}`} />
                                                <p className="mt-2">
                                                  <strong>{data?.payload?.tech_lang_keys[11]}</strong>:
                                                </p>
                                                <BlockMath math={`= ${result?.tech_up} ${result?.tech_action} ${result?.tech_down} ${result?.tech_action1} ${result?.tech_thr}`} />
                                                <BlockMath math={`= ${result?.tech_up} ${result?.tech_action} \\dfrac{${result?.tech_up1}}{${result?.tech_down1}}`} />
                                                <BlockMath
                                                  math={`= \\dfrac{\\left(${result?.tech_left}\\right) ${result?.tech_action} \\left(${result?.tech_right}\\right)}{${result?.tech_lcm1}}`}
                                                />
                                                <BlockMath math={`= \\dfrac{${result?.tech_top}}{${result?.tech_lcm1}}`} />
                                              </div>
                                            ) : (result?.tech_lcm && isMultiplyDivide(result?.tech_action) && isPlusMinus(result?.tech_action1)) ? (
                                              <div className="col-span-12 text-[16px]">
                                                <BlockMath math={`= \\dfrac{${result?.tech_top}}{${result?.tech_lcm}}`} />
                                                <p className="mt-2">
                                                  <strong>{data?.payload?.tech_lang_keys[11]}</strong>:
                                                ...
                                                <BlockMath math={`= ${result?.tech_up} ${result?.tech_action} ${result?.tech_down} ${result?.tech_action1} ${result?.tech_thr}`} />
                                                <BlockMath math={`= \\dfrac{${result?.tech_up1}}{${result?.tech_down1}} ${result?.tech_action1} ${result?.tech_thr}`} />
                                                <BlockMath
                                              ...
                                              <div className="col-span-12 text-center text-[16px]">
                                                <BlockMath math={`= ${result?.tech_up} ${result?.tech_action} ${result?.tech_down} ${result?.tech_action} ${result?.tech_thr}`} />
                                  ...
                                  <>
                                      ...
                                      <p className="my-3 bg-sky-100 overflow-auto">
                                        <strong className=" px-3 py-4 text-[16px] rounded-lg text-blue">
                                          <BlockMath math={`${result?.tech_enter} = ${result?.tech_ans}`} />
                                        </strong>
                                      </p>
                                    </div>
                                  </>

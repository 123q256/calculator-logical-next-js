                ...
                <div className="col-span-12 " id="simpleInput">
                    <div className="col-12 mt-0 mt-lg-2">
                      ...
                      <div className="mt-2">
                        ...
                        >
                          <option value="1">SGPA {data?.payload?.tech_lang_keys["2"]} </option>
                          <option value="2"> {data?.payload?.tech_lang_keys["3"]} CGPA </option>
                        </select>
                      </div>
                    </div>
                    ...
                    {formData.tech_selection == "2" && (
                      <>
                      <div className="col-12 mt-0 mt-lg-2">
                          <label htmlFor="tech_number_of_semesters" className="label">
                      ...
                      <div className="col-12 mt-0 mt-lg-2">
                            ...
                            {data?.payload?.tech_lang_keys["8"]} SGPAs  {data?.payload?.tech_lang_keys["9"]}
                            </label>
                            <div className=" relative">
                            <input
                              type="number"
                ...
                <div id="advancedInput" className="col-span-12">
                  <div id="cd2">
                    {formData.tech_sgpa.map((value, index) => (
                      <div className="col-12 mt-0 mt-lg-2" key={index}>
                        <label htmlFor={`tech_sgpa_${index}`} className="label">
                  ...
                  <div className="col-12 text-end mt-3" id="btn2">
                    <button
                      ...
                      className="px-3 py-2 mx-1 bg-[#2845F5] text-white rounded-lg"
                    >
                      + Add More
                    </button>
                  </div>
                          ...
                          <div className="w-full mt-3">
                              <div className="w-full">
                                  {(result?.tech_percentage) && (
                                    <>
                                      <div className="w-full text-center text-[20px]">
                                          <p>CGPA</p>
                                          <p className="my-3"><strong className="bg-[#2845F5] px-3 py-2 md:text-[25px] text-[18px] rounded-lg text-white">{result?.tech_percentage}</strong></p>
                                      </div>
                                    </>
                                  )}
                                  {(result?.tech_final_gpa) && (
                                    <>
                                      <div className="w-full text-center text-[20px]">
                                          ...
                                          <p className="my-3"><strong className="bg-[#2845F5] px-3 py-2 md:text-[25px] text-[18px] rounded-lg text-white">{result?.tech_final_gpa}%</strong></p>
                                      </div>
                                    </>
                                  )}
                                  {(result?.tech_final_result) && (
                                    <>
                                      <div className="w-full text-center text-[20px]">
                                          <p>{data?.payload?.tech_lang_keys[11]} CGPA {data?.payload?.tech_lang_keys[12]}</p>
                                          <p className="my-3"><strong className="bg-[#2845F5] px-3 py-2 md:text-[25px] text-[18px] rounded-lg text-white">{result?.tech_final_result}</strong></p>
                                      </div>
                                    </>
                                  )}
                              </div>

             ...
             <div className="lg:w-[60%] md:w-[90%] w-full mx-auto ">
                <div className="grid grid-cols-12 mt-3 gap-2 md:gap-4 lg:gap-4">
                  <div className="col-span-12 flex items-center justify-evenly">
                      <p className="label"><strong>{data?.payload?.tech_lang_keys['1']}:</strong></p>
                      <p className="bnry_cal">
                           <label className="pe-2" htmlFor="bnry_cal">
                            <input
                              type="radio"
                              name="tech_cal"
                              value="bnry_cal"
                      ...
                      <p className="dec_cal">
                          <label className="pe-2" htmlFor="dec_cal">
                            <input
                              type="radio"
                              name="tech_cal"
                              value="dec_cal"
                      ...
                      <p className="hex_cal">
                         <label className="pe-2" htmlFor="hex_cal">
                            <input
                              type="radio"
                              name="tech_cal"
                              value="hex_cal"
                  ...
                  {formData.tech_cal === 'bnry_cal' && (
                    <>
                    <p className="col-span-12 text-center my-3 text-[14px] " id="dec_rng">
                        {data?.payload?.tech_lang_keys['2']} {data?.payload?.tech_lang_keys['8']} = <span id="dec_range">-127 to 127</span>
                    </p>
                    </>
                  )}
                   {formData.tech_cal === 'dec_cal' && (
                    <>
                    <p className="col-span-12 text-center my-3 text-[14px]" id="bnry_rng">
                        {data?.payload?.tech_lang_keys['3']} {data?.payload?.tech_lang_keys['8']} = <span id="bnry_range">8 {data?.payload?.tech_lang_keys['13']} ({data?.payload?.tech_lang_keys['14']})</span>
                    </p>
                    </>
                  )}
                   {formData.tech_cal === 'hex_cal' && (
                    <>
                    <p className="col-span-12 text-center my-3 text-[14px] " id="hex_rng">
                        {data?.payload?.tech_lang_keys['4']} {data?.payload?.tech_lang_keys['8']} = <span id="hex_range">0-9 {data?.payload?.tech_lang_keys['15']} A-F (16-{data?.payload?.tech_lang_keys['13']})</span>
                    </p>
                    </>
                  )}
                  ...
                  <div className="col-span-12 " id="hex">
                   ...
                   {(formData.tech_cal === 'bnry_cal' || formData.tech_cal === 'dec_cal') && (
                    <>
                              ...
                              <div className="w-full">
                                <div className="w-full md:w-[90%] lg:w-[60%] overflow-auto mt-2">
                                  <table className="w-full text-[16px]">
                                    <tbody>
                                      <tr>
                                        ...
                                        <td className="py-2 border-b">{result?.tech__1s}</td>
                                      </tr>
                                    </tbody>
                                  </table>
                                  ...
                                  <p className="mt-2 text-[16px]">
                                    <strong>
                                      {data?.payload?.tech_lang_keys["10"]} {result?.tech_bit}-bit{" "}

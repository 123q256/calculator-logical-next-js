        ...
        <form className="row" onSubmit={handleSubmit}>
          ...
          <div className="lg:w-[60%] md:w-[90%] w-full mx-auto ">
              ...
              <div className="col-span-12">
                  ...
                  <label for="tech_EnterEq" className="label mt-4">{data?.payload?.tech_lang_keys['1']} f(x,y): {data?.payload?.tech_lang_keys['1']} e^x  {data?.payload?.tech_lang_keys['1']}  {"e^{x}"}</label>
                          ...
                          <div className="w-full text-[16px] overflow-auto">
                            {formData?.tech_how > 1 ? (
                              (() => {
                                const content = [];
                                let j = "'";
                                for (let i = 1; i < result?.tech_final_res?.length; i += 2) {
                                  const fnIndex = Math.floor(i / 2) + 1;
                                  content.push(
                                    <div key={i}>
                                      <p className="mt-3 text-[18px]">
                                        <strong className="math">{`f${j} (x)`}</strong> {data?.payload?.tech_lang_keys['7']}
                                      </p>
                                      <p className="mt-3 text-[18px] math">{result?.tech_final_res?.[i + 1]}</p>
                                      ...
                                      <div className="w-full mt-3 res_step hidden" step_cal={i + 1}>
                                        <p className="mt-3" dangerouslySetInnerHTML={{ __html: result?.tech_final_res?.[i + 1] }} />
                                      </div>
                                    </div>
                                  );
                                  j += "'";
                              ...
                              <>
                                ...
                                <p className="mt-3 text-[18px] math" >{result?.tech_simple}</p>
                                <p className="mt-3 text-[18px]"><strong>Solution:</strong></p>

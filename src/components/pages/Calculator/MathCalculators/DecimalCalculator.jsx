...
const renderLogSteps = () => {
    ...
    if (decimalPart) {
      ...
      return (
        <>
          <p className="mt-2">
            = log<sub className="font-s-14">{formData.tech_a}</sub>{formData.tech_b}
          </p>
          <p className="mt-2">
            = log<sub className="font-s-14">{formData.tech_a}</sub>({newB}/{divideB})
          </p>
          <p className="mt-2">
            = log<sub className="font-s-14">{formData.tech_a}</sub>({newB}) - log<sub className="font-s-14">{formData.tech_a}</sub>({divideB})
          </p>
      ...
      return (
        <p className="mt-2">
          = log<sub className="font-s-14">{formData.tech_a}</sub>{formData.tech_b} = {result?.tech_ans}
        </p>
      );
    }
  };
             ...
             <div className="lg:w-[50%] md:w-[80%] w-full mx-auto ">
                <div className="grid grid-cols-12 mt-3 gap-2 md:gap-4 lg:gap-4">
                    <p className="col-span-12 text-center my-3 text-[18px]">
                      ...
                      {!["2", "3", "4", "5", "6", "7"].includes(formData?.tech_method) && "a + b = ?"}
                    </strong>
                            ...
                            <table className="w-full text-[16px]">
                              <tbody>
                                <tr>
                                  ...
                                  <td className="py-2 border-b">{Number(result?.tech_ans).toFixed(5)}</td>
                                </tr>
                              </tbody>
                            </table>
                          </div>
                          ...
                          <div className="w-full text-[16px] overflow-auto">
                            ...
                            {formData?.tech_method > 4 && (
                              <>
                                ...
                                <p className="mt-2" dangerouslySetInnerHTML={{ __html: result?.tech_res }}></p>
                              </>
                            )}

                            {formData?.tech_method === "7" && renderLogSteps()}

                            {formData?.tech_method <= 4 && formData?.tech_method !== "7" && (
                              <p className="mt-2" dangerouslySetInnerHTML={{ __html: result?.tech_res }}></p>
                            )}
                            ...
                            {result?.tech_round_ans && (
                              <>
                                <p className="mt-2">
                                  Rounding to {roundingLabels[formData?.tech_rounding]} Place
                                </p>

        ...
        <form className="row" onSubmit={handleSubmit}>
          ...
          <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
                  ...
                  <div className="lg:col-span-9 md:col-span-9 col-span-12">
                      ...
                      <label for="tech_EnterEq" className="label mt-4">{data?.payload?.tech_lang_keys['6']}:</label>
                        ...
                        <div className="w-full mt-3">
                          <div className="w-full">
                            <div className="w-full text-[16px] overflow-auto">
                              ...
                              <p className="mt-3">
                                <BlockMath math={`\\int\\limits_{${formData?.tech_lb}}^{${formData?.tech_ub}} (${result?.tech_enter})\\, d${formData?.tech_with}`} />
                              </p>
                              <p className="mt-3">
                                <InlineMath math={`= ${result?.tech_ress} \\approx ${Number(result?.tech_ress1).toFixed(3)}`} />
                              </p>
                              ...
                              <p className="mt-3">
                                <BlockMath math={`\\int (${result?.tech_enter})\\, d${formData?.tech_with}`} />
                              </p>
                              <p className="mt-3">
                                <BlockMath math={`= \\left(${result?.tech_res}\\right) + \\mathrm{constant}`} />
                              </p>

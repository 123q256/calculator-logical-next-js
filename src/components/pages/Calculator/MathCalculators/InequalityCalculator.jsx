    ...
    >
        <form className="row" onSubmit={handleSubmit}>
          ...
          <div className="lg:w-[60%] md:w-[100%] w-full mx-auto ">
                ...
                <div className={`${formData.tech_select == '1' ? 'md:col-span-5 col-span-12' : 'col-span-12'} mt-0 oneSide`}>
                          ...
                          <div className="w-full overflow-auto">
                            <div className="w-full">
                              {formData?.tech_select === "2" ? (
                                <p className="mt-2 text-[17px] md:text-[16px] text-[#1670a7]">
                            ...
                            <div className="w-full text-[16px]">
                              ...
                              {techSteps.length > 0 && (
                                <>
                                  <p className="mt-3">
                                    <strong>
                                      Steps to solve <InlineMath math={formData?.tech_equ1} />
                                    </strong>
                                  </p>
                                  {techSteps.map((item, index) => {
                                    const parts = item.split(/\\\((.*?)\\\)/g); // Split at \( ... \)
                                    return (
                                      <p key={`step1-${index}`} className="mt-2 flex flex-wrap gap-1">
                                        {parts.map((part, i) =>
                                          i % 2 === 1 ? (
                              ...
                              {techStepsSec.length > 0 && (
                                <>
                                  <p className="mt-3">
                                    <strong>
                                      Steps to solve <InlineMath math={formData?.tech_equ2} />
                                    </strong>
                                  </p>
                                  {techStepsSec.map((item, index) => {
                                    const parts = item.split(/\\\((.*?)\\\)/g);
                                    return (
                                      <p key={`step2-${index}`} className="mt-2 flex flex-wrap gap-1">
                                        {parts.map((part, i) =>
                                          i % 2 === 1 ? (
                                            <InlineMath key={i}>{part}</InlineMath>
                                          ) : (

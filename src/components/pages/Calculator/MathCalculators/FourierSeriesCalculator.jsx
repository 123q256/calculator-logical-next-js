                      ...
                      <div className="w-full mt-3">
                        <div className="w-full text-[16px] overflow-auto">
                          ...
                          <p className="mt-3">
                            ...
                            <InlineMath math={result?.tech_enter} /> on the interval{" "}
                            <InlineMath math={`\\left[${result?.tech_t1}, ${result?.tech_t2}\\right]`} />
                          </p>
                        ...
                        <p className="mt-3">
                          Put <InlineMath math={`A_0, A_n \\text{ and } B_n`} /> values in Fourier Series Formula:
                        </p>

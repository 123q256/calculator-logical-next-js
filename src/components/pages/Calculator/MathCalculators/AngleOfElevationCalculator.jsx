                                          ...
                                          {(formData?.tech_to_cal === '1') ? (
                                            <>
                                              <tr>
                                                  ...
                                                  <td className="py-2 border-b">{Number(result?.tech_ang_deg).toFixed(4)} deg</td>
                                              </tr>
                                              <tr>
                                                  <td className="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys['5']}</strong></td>
                                                  <td className="py-2 border-b">{Number(result?.tech_angle).toFixed(5)} rad</td>
                                              </tr>
                                            </>
                                            ...
                                            <>
                                              <tr>
                                                  ...
                                                  <td className="py-2 border-b">{result?.tech_vertical}</td>
                                              </tr>
                                            </>
                                          ):(
                                            <>
                                              <tr>
                                                  ...
                                                  <td className="py-2 border-b">{result?.tech_hori}</td>
                                              </tr>
                                            </>
                                          ) }
                                          <tr>
                                              <td className="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys['6']}</strong></td>
                                              <td className="py-2 border-b">{Number(result?.tech_grade).toFixed(4)}</td>
                                          </tr>
                                          <tr>
                                              <td className="py-2 border-b" width="60%"><strong>{data?.payload?.tech_lang_keys['7']}</strong></td>
                                              <td className="py-2 border-b">{Number(result?.tech_gradep).toFixed(4)} %</td>
                                          </tr>
                                      </table>
                                  </div>
                              </div>

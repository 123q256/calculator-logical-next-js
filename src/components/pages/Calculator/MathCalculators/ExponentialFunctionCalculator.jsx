...
const ExponentialFunctionCalculator = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.tech_t1 || !formData.tech_y1  || !formData.tech_t2  || !formData.tech_y2 ) {
                      ...
                      <div className="w-full mt-3">
                        <div className="w-full">
                          ...
                          <div className="w-full text-[16px] overflow-auto">
                            ...
                            <p className="mt-3">
                              {data?.payload?.tech_lang_keys[18]}₀{data?.payload?.tech_lang_keys[19]}
                            </p>
                            <BlockMath math={`y_1 = A_0e^{kt_1}`} />
                            <BlockMath math={`y_2 = A_0e^{kt_2}`} />
                            <p className="mt-3">
                              {data?.payload?.tech_lang_keys[20]} Divide y₁ by y₂ to cancel A₀
                            </p>
                        <BlockMath math={`\\frac{y_1}{y_2} = \\frac{A_0 e^{kt_1}}{A_0 e^{kt_2}}`} />
                          <BlockMath math={`\\frac{y_1}{y_2} = \\frac{e^{kt_1}}{e^{kt_2}}`} />
                          <BlockMath math={`\\frac{y_1}{y_2} = e^{k(t_1 - t_2)}`} />
                          <BlockMath math={`\\ln\\left(\\frac{y_1}{y_2}\\right) = k(t_1 - t_2)`} />
                          <BlockMath math={`k = \\frac{1}{t_1 - t_2} \\ln\\left(\\frac{y_1}{y_2}\\right)`} />

                          <p className="mt-3">
                            {data?.payload?.tech_lang_keys[24]} {data?.payload?.tech_lang_keys[25]}
                          </p>
                          ...
                          />
                            ...
                            />
                            <p className="mt-3">
                              {data?.payload?.tech_lang_keys[31]} {data?.payload?.tech_lang_keys[32]}
                            </p>
                            <BlockMath math={`f(t) = A_0e^{kt}`} />
                            <BlockMath math={`f(t) = ${A}e^{${k}t}`} />
                            <p className="mt-3">
                              {data?.payload?.tech_lang_keys[33]} {data?.payload?.tech_lang_keys[34]} {optionalPoint}, so we have:
                            </p>
                            <BlockMath
                            ...
                            <div id="curve_chart" className="col-lg-8 mx-auto my-3 overflow-auto">

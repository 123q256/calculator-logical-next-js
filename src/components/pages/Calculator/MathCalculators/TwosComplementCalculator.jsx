                    ...
                    <div className="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                      <div className="md:col-span-6 col-span-12 ">
                        ...
                        {formData.tech_bits == "other" && (
                          <>
                          <div className="md:col-span-6 col-span-12 " id="no_of_bits">
                          ...
                          <div className="text-center">
                            ...
                            <>
                              <div className="text-center">
                                ...
                                <p className="md:text-[32px] bg-[#2845F5] text-white px-3 py-2 rounded-lg inline-block my-3">
                                  <strong className="text-blue">{result?.tech__2s}</strong>
                                </p>
                              </div>
                              <p>
                                <strong>
                                ...
                                <table className="w-full">
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td className="border-b py-2">{result?.tech__1s}</td>
                                    </tr>
                                    <tr>
                                      <td className="border-b py-2">{data?.payload?.tech_lang_keys["15"]}</td>
                                      <td className="border-b py-2">{result?.tech__2s}</td>
                                    </tr>
                                  </tbody>
                                </table>
                              </div>

                        ...
                        <div className="w-full mt-3">
                          <div className="w-full">
                            <div className="w-full text-[16px] overflow-auto">
                              ...
                              {result?.tech_s2 &&
                                result.tech_s2.split("###").reverse().map((item, idx) => {
                                  const expression = `x = ${item.replace(/frac/g, "dfrac")}`;
                                  return (
                                    <p
                                      key={idx}
                                      className="mt-3 text-[16px] font-bold"
                                      dangerouslySetInnerHTML={renderMath(expression)}
                                    />
                                  );
                                })}
                            </div>
                                ...
                                <tbody>
                                    ...
                                    <td className="py-2 border-b">
                                      <span
                                        dangerouslySetInnerHTML={renderMath(
                                          (result?.tech_sum || "").replace(/frac/g, "dfrac")
                                        )}
                                      />
                                    </td>
                                  </tr>
                                  ...
                                  <tr>
                                    ...
                                    <td className="py-2 border-b">
                                      <span
                                        dangerouslySetInnerHTML={renderMath(
                                          (result?.tech_prod || "").replace(/frac/g, "dfrac")
                                        )}
                                      />
                                    </td>
                                  </tr>

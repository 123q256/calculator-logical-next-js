              ...
              <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
                  ...
                  <p className="col-span-12 text-center my-3 text-[18px]">
                   <strong id="changeText">
                        ...
                        {!['2', '3', '4', '5', '6', '7'].includes(formData?.tech_opr) && 'a + b = ?'}
                      </strong>
                        ...
                        <div className="w-full mt-3">
                          <div className="w-full">
                            <div className="w-full text-center text-[20px]">
                              <p dangerouslySetInnerHTML={{ __html: result?.tech_ansText || '' }}></p>
                              <p className="my-3">
                                <strong className="bg-[#2845F5] text-white px-3 py-2 md:text-[32px] text-[20px] rounded-lg" dangerouslySetInnerHTML={{ __html: result?.tech_ans || '' }}></strong>
                              </p>
                            </div>
                          </div>
                        </div>

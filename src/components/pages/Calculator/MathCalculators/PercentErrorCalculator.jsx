                    ...
                    <div className="w-full mt-3">
                      <div className="w-full">
                            ...
                            <tbody>
                              <tr>
                                <td className="py-2 border-b w-3/5">
                                  <strong>{data?.payload?.tech_lang_keys['percent_err']}</strong>
                                </td>
                                <td className="py-2 border-b">
                                  {result?.errorPercentage !== undefined ? Math.abs(result.errorPercentage) : '0.0'}%
                                </td>
                              </tr>
                              <tr>
                                <td className="py-2 border-b w-3/5">
                                  <strong>{data?.payload?.tech_lang_keys['non_absolute']}</strong>
                                </td>
                                <td className="py-2 border-b">
                                  {result?.errorPercentage !== undefined ? result.errorPercentage : '0.0'}%
                                </td>
                              </tr>
                              <tr>
                                <td className="py-2 border-b w-3/5">
                                  <strong>{data?.payload?.tech_lang_keys['absolute_err']}</strong>
                                </td>
                                <td className="py-2 border-b">
                                  {result?.errorPercentage !== undefined 
                                    ? Math.abs(formData?.originalValue - formData?.actualValue) 
                                    : '0.0'}
                                </td>
                              </tr>
                            </tbody>
                        ...
                        <div className="w-full  text-[18px] md:text-[22px] overflow-auto">
                          <p className="mt-2">
                            <strong>{data?.payload?.tech_lang_keys['cal']}</strong>
                          </p>
                          ...
                          <p className="mt-2">
                            <InlineMath math={`PE = \\frac{${formData?.originalValue} - ${formData?.actualValue}}{${formData?.actualValue}} \\times 100`} />
                          </p>
                          ...
                          <p className="mt-2">
                            <InlineMath math={`PE = ${(((formData?.originalValue - formData?.actualValue) / formData?.actualValue) * 100).toFixed(2)}\\%`} />
                          </p>

                          <p className="mt-2">
                            <InlineMath math={`PE = ${result?.errorPercentage}\\%`} />
                          </p>
                        </div>
                      </div>
                    </div>

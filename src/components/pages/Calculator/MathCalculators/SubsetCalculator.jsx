            ...
            <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
                ...
                <div className="col-span-12 mb-1 flex items-center">
                    <p className="font-s-14 text-blue pe-lg-2 pe-2">
                       ...
                       <p>
                    <label className="pe-2" htmlFor="elements">
                      <input
                        type="radio"
                        name="tech_cal_by"
                        value="elements"
                     ...
                     <p>
                    <label className="pe-2" htmlFor="cardinality">
                      <input
                        type="radio"
                        name="tech_cal_by"
                        value="cardinality"
                          ...
                          <div className="w-full mt-3">
                            <div className="w-full">
                                  ...
                                  <tbody>
                                    <tr>
                                      ...
                                      <td className="py-2 border-b">
                                        <InlineMath math={String(result?.tech_subsets)} />
                                      </td>
                                    </tr>
                                    <tr>
                                      <td className="py-2 border-b" width="60%">
                                      ...
                                      <td className="py-2 border-b">
                                        <InlineMath math={String(result?.tech_pro_subsets)} />
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
                              ...
                              <div className="w-full text-[16px] overflow-auto">
                                ...
                                {ne.length > 0 && (
                                  <p className="mt-2">
                                    <strong>{ne[0]}</strong> {lang['9']} <strong>{lang['10']}</strong> {lang['11']}.
                                  </p>
                                )}
                                ...
                                {ne.slice(1).map((value, index) => (
                                  <p className="mt-2" key={index}>
                                    <strong>{value}</strong> {lang['9']} <strong>{index + 1}</strong> {lang['11']}.
                                  </p>
                                ))}
                              </div>
                              ...
                              {result?.tech_pw && (
                                <div className="w-full text-[16px] overflow-auto">
                                  <p className="mt-2">
                                   ...
                                   {sets.map((set, index) => (
                                      <InlineMath key={index} math={set + (index < sets.length - 1 ? "," : "")} />
                                    ))}

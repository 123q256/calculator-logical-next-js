                    ...
                    <div className="w-full mt-3">
                      <div className="w-full">
                        <div className="w-full text-[18px]">
                          ...
                          <div dangerouslySetInnerHTML={{ __html: result?.tech_specificHtml }} />
                          ...
                          <div className="w-full md:w-[60%] lg:w-[60%] mt-2 px-2 py-1 overflow-auto">
                            <table className="w-full text-[16px]">
                              ...
                              {result?.tech_radius && (
                                <tr>
                                  <td className="py-2 border-b">Radius of Convergence</td>
                                  <td className="py-2 border-b">
                                    <InlineMath>{result.tech_radius}</InlineMath>
                                  </td>
                                </tr>
                              )}
                              {result?.tech_interval && (
                                <tr>
                                  <td className="py-2 border-b">Interval of Convergence</td>
                                  <td className="py-2 border-b">
                                    <InlineMath>{result.tech_interval}</InlineMath>
                                  </td>
                                </tr>
                              )}
                              </tbody>
                          ...
                          <p className="bg-sky bordered rounded-lg px-3 py-2 mt-2 text-[18px] overflow-auto text-center">
                          ...
                          <p className="my-3">{data?.payload?.tech_lang_keys[5]}</p>

                          <p className="my-3 font-s-20">
                            <BlockMath>{`\\sum_{n=1}^\\infty ${result?.tech_enter}`}</BlockMath>
                          </p>

                          <p className="my-3">{data?.payload?.tech_lang_keys[6]}</p>
                          <p className="my-3">
                          ...
                          <p className="my-3 font-s-20">
                            ...
                            <BlockMath>{`L=\\lim_{n \\to \\infty}\\left|\\dfrac{${result?.tech_enter.replace(/n/g, 'n+1')}}{${result?.tech_enter}}\\right|`}</BlockMath>
                          </p>

                          <div className="overflow-auto">
                            <p className="mb-3 mt-4 font-s-20">
                              <BlockMath>{`L=\\lim_{n \\to \\infty}\\left|${result?.tech_equs}\\right|`}</BlockMath>
                            </p>
                          </div>

                          <p className="my-3">{data?.payload?.tech_lang_keys[8]}:</p>
                          <p className="my-3">
                            <InlineMath>{`L=\\left|${result?.tech_ans}\\right|`}</InlineMath>
                          </p>

                          <p className="my-3">{data?.payload?.tech_lang_keys[9]}</p>
                          <p className="my-3">
                            <InlineMath>{`\\left|${result?.tech_ans}\\right| \\le 1`}</InlineMath>
                          </p>
                        </div>

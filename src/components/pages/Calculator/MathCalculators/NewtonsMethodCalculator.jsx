                        ...
                        <div className="w-full mt-3">
                          <div className="w-full">
                            ...
                            <div className="w-full text-[16px] overflow-auto">
                              ...
                              {!result?.tech_check && (
                                <p className="mt-2" dangerouslySetInnerHTML={{ __html: result?.tech_steps }}></p>
                              )}
                             ...
                             <div className="w-full md:w-[80%] lg:w-[60%] overflow-auto mt-2">
                              <table className="w-full text-[16px]">
                                <thead className="bg-gray-100">
                                  <tr>
                                    ...
                                    <th className="py-2 border-b text-center">x</th>
                                    <th className="py-2 border-b text-center">f(x)</th>
                                    <th className="py-2 border-b text-center">f'(x)</th>
                                  </tr>
                                </thead>
                                <tbody>
                                  {ress.slice(0, -1).map((_, i) => (
                                    <tr key={i}>
                                      ...
                                      <td className="py-2 border-b text-center">{sigFig(ress[i], round)}</td>
                                      <td className="py-2 border-b text-center">{Number(fxx[i]).toFixed(round)}</td>
                                      <td className="py-2 border-b text-center">{sigFig(fxx1[i], round)}</td>
                                    </tr>
                                  ))}
                                </tbody>
                              </table>
                              ...
                              {ress.slice(0, -1).map((_, i) => {
                                const x0 = i === 0 ? parseFloat(result?.tech_x0 ?? 0) : sigFig(ress[i - 1], round);
                                ...
                                return (
                                  <div key={`mathstep-${i}`}>
                                    ...
                                    <BlockMath math={`f(x_${i}) = f(${x0}) = ${enter.replace(/x/g, `(${x0})`)} = ${fxVal}`} />
                                    <BlockMath math={`f'(x_${i}) = f'(${x0}) = ${enter1.replace(/x/g, `(${x0})`)} = ${fx1Val}`} />
                                    <BlockMath math={`x_${i + 1} = x_${i} - \\frac{f(x_${i})}{f'(x_${i})}`} />
                                    <BlockMath math={`x_${i + 1} = ${x0} - \\frac{${fxVal}}{${fx1Val}}`} />

            ...
            <div className="col-span-12">
                <label htmlFor="tech_type" className="label">
                    ...
                    <div className="mt-2">
                      ...
                      >
                        <option value="2">{data?.payload?.tech_lang_keys["2"]} (m)</option>
                        <option value="1">{data?.payload?.tech_lang_keys["3"]} </option>
                        <option value="3">{data?.payload?.tech_lang_keys["4"]} (b) & {data?.payload?.tech_lang_keys["5"]} (m)</option>
                        <option value="4">{data?.payload?.tech_lang_keys["6"]} </option>
                      </select>
                    </div>
            </div>
            {(formData.tech_type == "2" || formData.tech_type == "4" || formData.tech_type == "1" || formData.tech_type == "3") && (
              <>
              <div className="col-span-6">
                    {formData.tech_type == "3" ? (
                      <>
                      <label htmlFor="tech_x1" className="label">  Intercept (c):</label>
                      </>
                    ):(
                      <>
                      <label htmlFor="tech_x1" className="label">   X<sub className="text-blue font-s-12">1</sub>:</label>
                      </>
                    )}
             ...
             {(formData.tech_type == "2" || formData.tech_type == "4" || formData.tech_type == "1") && (
              <>
             ...
             {(formData.tech_type == "2" || formData.tech_type == "4" || formData.tech_type == "1" || formData.tech_type == "3") && (
              ...
              <div className="col-span-6">
                  {formData.tech_type == "1" ? (
                      <>
                      <label htmlFor="tech_x2" className="label">   Slope:</label>
                      </>
                    ): formData.tech_type == "3" ?(
                      <>
                      <label htmlFor="tech_x2" className="label">   Slope (m):</label>
                      </>
                    ):(
                      <>
                        <label htmlFor="tech_x2" className="label">  X<sub className="text-blue font-s-12">2</sub>:</label>
                      </>
                    )}
                  ...
                  <div className="rounded-lg  flex items-center justify-center">
                      <div className="w-full mt-3">
                          <div className="w-full overflowauto">
                             {((result?.tech_type=='2') || (result?.tech_type=='1') || (result?.tech_type=='3')) && (
                              <>
                                ...
                                <div className="w-full md:w-[60%] lg:w-[60%] mt-2">
                                  <table className="w-full text-[16px]">
                                    <tbody>
                                      ...
                                      <tr>
                                        <td className="py-2 border-b">
                                          Y - {data?.payload?.tech_lang_keys['4']} (b)
                                        </td>
                                        <td className="py-2 border-b">
                                          {b}
                                        </td>
                             ...
                             {(result?.tech_type=='2') && (
                              ...
                              <p className="mt-3">{data?.payload?.tech_lang_keys['9']} 1:</p>
                              <p className="mt-3">
                                {data?.payload?.tech_lang_keys['10']} P = ({formData?.tech_x1}, {formData?.tech_y1}) and Q = ({formData?.tech_x2}, {formData?.tech_y2})
                              </p>

                              <p className="mt-3">
                                {data?.payload?.tech_lang_keys['11']} P=(x₁, y₁) and Q=(x₂, y₂) {data?.payload?.tech_lang_keys['12']}
                              </p>
                              ...
                              <p className="mt-3">
                                {data?.payload?.tech_lang_keys['13']} x₁ = {formData?.tech_x1}, y₁ = {formData?.tech_y1}, x₂ = {formData?.tech_x2}, y₂ = {formData?.tech_y2}
                              </p>

                              <p className="mt-3">{data?.payload?.tech_lang_keys['9']} 2:</p>
                              ...
                              <p className="mt-3">{data?.payload?.tech_lang_keys['9']} 3:</p>
                              <p className="mt-3">
                                {data?.payload?.tech_lang_keys['15']} b = y₁ − m⋅x₁ (or y₂ − m⋅x₂, {data?.payload?.tech_lang_keys['16']})
                              </p>
                              <p className="mt-3">
                                <InlineMath math={`b = ${formData?.tech_y1} - (${slope}) \\cdot (${formData?.tech_x1}) = ${b}`} />
                              </p>

                              <p className="mt-3">{data?.payload?.tech_lang_keys['9']} 4:</p>
                              <p className="mt-3">{data?.payload?.tech_lang_keys['17']}</p>
                              <p className="mt-3">
                                <InlineMath math={`y = ${slope}x ${bDisplay}`} />
                              </p>

                              <p className="mt-3">{data?.payload?.tech_lang_keys['18']}:</p>
                              <p className="mt-3">
                                <InlineMath math={`y = ${slope}x ${bDisplay}`} />
                              </p>
                              ...
                              <p className="mt-3">
                                <InlineMath math={`${slope}x - y ${bDisplay} = 0`} />
                              </p>

                              <div id="box1" className="col-lg-10 mt-4 mx-auto" style={{ height: '500px' }}>
                              ...
                              <>
                                ...
                                <p className="mt-3">{data?.payload?.tech_lang_keys['9']} 1:</p>
                                <p className="mt-3">
                                  {data?.payload?.tech_lang_keys['21']} m = {m} and the point P = ({x1}, {y1})
                                </p>

                                <p className="mt-3">{data?.payload?.tech_lang_keys['9']} 2:</p>
                                <p className="mt-3">{data?.payload?.tech_lang_keys['15']} b = y₁ − m ⋅ x₁</p>
                                <p className="mt-3">
                                  <InlineMath
                                ...
                                <p className="mt-3">{data?.payload?.tech_lang_keys['9']} 3:</p>
                                <p className="mt-3">{data?.payload?.tech_lang_keys['17']} y = mx + b</p>
                                ...
                                <div id="box2" className="col-lg-10 mt-4 mx-auto" style={{ height: '500px' }}>
                                    <Scatter data={datachart} options={options} />
                                </div>
                              </>
                              )}
                              ...
                              <>
                                ...
                                <p className="mt-3">{data?.payload?.tech_lang_keys['9']} 1:</p>
                                <p className="mt-3">m = {slope}, b = {b}</p>
                                ...
                                <div id="box3" className="col-lg-10 mt-4 mx-auto" style={{ height: '500px' }}>
                                    <Scatter data={datachart} options={options} />
                                </div>
                              </>
                              )}
                              {(result?.tech_type=='4') && (
                                ...
                                <p className="mt-3">{data?.payload?.tech_lang_keys['9']} 2:</p>
                                <p className="mt-3">{data?.payload?.tech_lang_keys['24']}:</p>
                                <p className="mt-3">
                                  <InlineMath
                                ...
                                <p className="mt-3">{data?.payload?.tech_lang_keys['26']}</p>
                                <BlockMath
                                  math={`
                                    \\begin{cases}
                                      x = ${fx}t + (${x1}) \\\\
                                ...
                                <p className="mt-3">{data?.payload?.tech_lang_keys['9']} 1:</p>
                                <p className="mt-3">{data?.payload?.tech_lang_keys['27']}:</p>
                                <BlockMath
                                  math={`
                                    \\begin{cases}
                                      x = lt + x_1 \\\\
                                ...
                                <p className="mt-3">
                                  <InlineMath math={`\\{ l; m; n \\} \\text{ — coordinates of a directing vector } \\ (\\overline{AB})`} />

                                </p>
                                <p className="mt-3">(x₁, y₁, z₁) - coordinates of a point on the line (e.g. point A)</p>
                                ...
                                <p className="mt-3">{data?.payload?.tech_lang_keys['9']} 3:</p>
                                <p className="mt-3">{data?.payload?.tech_lang_keys['28']}:</p>
                                <BlockMath
                                  math={`
                                    \\begin{cases}
                                      x = ${fx}t + (${x1}) \\\\

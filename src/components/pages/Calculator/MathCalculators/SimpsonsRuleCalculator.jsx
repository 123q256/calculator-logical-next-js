                      ...
                      <div className="w-full mt-3">
                        <div className="w-full text-[16px] overflow-auto">
                          ...
                          <p className="mt-3">
                            ...
                            <InlineMath math={`n=${n}`} /> {data?.payload?.tech_lang_keys["8"]}.
                          </p>
                          ...
                          <p className="mt-3">
                            ...
                            <BlockMath math={`a=${result?.tech_lb}, b=${result?.tech_ub}, n=${n}`} />
                          </p>
                          ...
                          <p className="mt-3">
                            ...
                            {data?.payload?.tech_lang_keys["13"]} <InlineMath math={`n=${n}`} />{" "}
                          ...
                          <p className="mt-3">
                            <BlockMath
                              math={`a = ${limitValues.slice(0, -1).join(", ")} = b`}
                            />
                          </p>
                          ...
                          <p className="mt-3">
                            ...
                            <BlockMath math={`\\dfrac{\\Delta ${x}}{3} = ${delta / 3}`} />
                          </p>
                          ...
                          <p className="mt-3">The true solution for the integral is:</p>
                          <p className="mt-3">
                            <BlockMath
                          ...
                          <p className="mt-3">Hence, the error in approximating the integral is:</p>
                          ...
                          <p className="mt-3">
                            <BlockMath
                              math={`\\left| \\varepsilon \\right| = \\left| \\dfrac{${Number(
                                ...
                                2
                              )}}{${Number(result?.tech_intv).toFixed(2)}} \\right| \\approx ${
                                Number(result?.tech_errorans).toFixed(5)
                              } = ${Number(result?.tech_errorans * 100).toFixed(2)}\\%`}
                            />
                          </p>
                        </div>
                      </div>

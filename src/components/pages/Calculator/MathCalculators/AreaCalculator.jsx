                                ...
                                <>
                                  ...
                                  <p className="md:text-[32px] bg-[#2845F5] text-white px-3 py-2 rounded-lg inline-block my-2">
                                    <strong className="text-white">
                                      ...
                                      <span className="text-[20px]"> (cm<sup>2</sup>)</span>
                                    </strong>
                                  </p>
                                </div>
                               ...
                               <div className="text-center">
                                ...
                                <>
                                 <div className="text-center">
                                  ...
                                  <p className="mt-2 text-start"><strong>{data?.payload?.tech_lang_keys['36']} :</strong></p>
                                  <p className="mt-2 text-start">
                                    <BlockMath
                                  ...
                                  <p className="mt-2 text-start"><strong>Input :</strong></p>
                                  <p className="mt-2 text-start">
                                    <BlockMath math={`a = ${result?.tech_area}`} />
                                  </p>

                                  <p className="mt-2 text-start"><strong>{data?.payload?.tech_lang_keys['37']} :</strong></p>
                                  <p className="mt-2 text-start">
                                    <BlockMath

                      ...
                      <div className="w-full mt-3">
                          <div className="w-full">
                              <div className="w-full text-center text-[20px]">
                                  <p>MOD</p>
                                  <p className="my-3"><strong className="bg-[#2845F5] px-3 py-2 text-[16px] md:text-[30px]  rounded-lg text-white">
                                      {result?.tech_agya ? (
                                        <>
                                        {formData?.tech_x} mod {formData?.tech_y} = {result?.tech_mod}
                                        </>
                                      ):(
                                        <>
                                        x mod y = r
                                  ...
                                  <p className="text-center text-[16px] mt-2">{data?.payload?.tech_lang_keys['mod_content']}</p>
                              </div>
                          </div>
                      </div>

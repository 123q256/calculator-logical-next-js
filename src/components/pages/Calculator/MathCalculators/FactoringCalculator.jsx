                      ...
                      <div className="w-full mt-3">
                          <div className="w-full">
                              {(result?.tech_submit==='factoring') ? (
                                <>
                                  {result?.tech_eq_degree == "2" && result?.tech_c != "0" ? (
                                    <>
                                        ...
                                        <table className="w-100 text-[18px]">
                                          <tbody>
                                            <tr>
                                              ...
                                              <td className="py-2 border-b">{displayFactors}</td>
                                            </tr>
                                          </tbody>
                                        </table>
                                      </div>
                                      ...
                                      <div className="w-full text-[16px] overflow-auto">
                                        {!result?.tech_pair1 && !result?.tech_pair2 && (
                                          <p className="mt-3">
                                            This trinomial cannot be factorized into linear binomials with
                                        ...
                                        <p className="mt-3">
                                          {data?.payload?.tech_lang_keys[19]} a = {result?.tech_a}, b ={" "}
                                          {result?.tech_b}, c = {result?.tech_c}
                                        </p>
                                        ...
                                        <p className="mt-3">
                                          {data?.payload?.tech_lang_keys[22]} |ac| = |{result?.tech_a} *{" "}
                                          {result?.tech_c < 0 ? `(${result.tech_c})` : result.tech_c}| ={" "}
                                          {ac}. {data?.payload?.tech_lang_keys[23]} {divisors.length}{" "}
                                          {data?.payload?.tech_lang_keys[24]} {ac}: {divisors.join(", ")}
                                        </p>
                                        ...
                                        <p className="mt-3">
                                          {data?.payload?.tech_lang_keys[28]} * {step2Ans.length} ={" "}
                                          {step2Ans.length * 2} {data?.payload?.tech_lang_keys[29]} b ={" "}
                                          {result?.tech_b}
                                        </p>
                                        ...
                                        {result?.tech_pair1 && result?.tech_pair2 ? (
                                          <>
                                            <p className="mt-3">{data?.payload?.tech_lang_keys[30]}</p>
                                            <p className="mt-3">
                                              {result.tech_c < 0 ? (
                                                result.tech_pair2 < 0 ? (
                                                  `${result.tech_pair1} + ${-result.tech_pair2} = ${
                                            ...
                                            <p className="mt-3">{data?.payload?.tech_lang_keys[31]}</p>
                                            <p className="mt-3">{data?.payload?.tech_lang_keys[32]}</p>
                                            ...
                                            <p className="mt-3">{data?.payload?.tech_lang_keys[33]}</p>
                                            <p className="mt-3">
                                              <BlockMath math={result.tech_eq_enter} />
                                            </p>
                                            <p className="mt-3">{data?.payload?.tech_lang_keys[34]}</p>
                                            <p className="mt-3">
                                              <BlockMath
                                            ...
                                            <p className="mt-3">{data?.payload?.tech_lang_keys[35]}</p>
                                            <p className="mt-3">{data?.payload?.tech_lang_keys[36]}:</p>
                                            <p className="mt-3">
                                          ...
                                          <>
                                            <p className="mt-3">
                                              {data?.payload?.tech_lang_keys[37]} {result?.tech_b}
                                            </p>
                                            <p className="mt-3">{data?.payload?.tech_lang_keys[38]}</p>
                                            <p className="mt-3">{data?.payload?.tech_lang_keys[39]}</p>
                                            <p className="mt-3">{data?.payload?.tech_lang_keys[40]}</p>
                                            <p className="mt-3">
                                              <BlockMath math={`b^2 - 4ac = ${result?.tech_square}`} />
                                            </p>
                                            <p className="mt-3">
                               ...
                               {!isNaN(Number(formData?.tech_num1)) && (
                                  ...
                                  <p className="mt-3 text-[18px] font-bold">
                                    ...
                                    <span className="total_num1">{factors.length}</span>{" "}
                                  ...
                                  {num > 0 && (
                                    <>
                                      ...
                                      <p className="mt-3">{result?.tech_Factors1}</p>
                                      <p className="mt-3">
                                        {data?.payload?.tech_lang_keys["6"]}{" "}
                                        {data?.payload?.tech_lang_keys["4"]} {num}
                                      </p>
                                      <p className="mt-3">{renderPrimeFactors()}</p>
                                    </>
                                  )}
                               ...
                               {!isNaN(Number(formData?.tech_num2)) && (
                                 ...
                                 <div className="w-full text-[16px]">
                                  ...
                                  <p className="mt-3 text-[18px] font-bold">
                                    {data?.payload?.tech_lang_keys["3"]}{" "}
                                    <span className="total_num2">{getFactors(num2).length}</span>{" "}
                                  ...
                                  {num2 > 0 && (
                                    <>
                                      ...
                                      <p className="mt-3">{result?.tech_Factors2}</p>
                                      <p className="mt-3">
                                        {data?.payload?.tech_lang_keys["6"]}{" "}
                                        {data?.payload?.tech_lang_keys["4"]} {num2}
                                      </p>
                                      <p className="mt-3">{renderPrimeFactors(result?.tech_Factors2)}</p>
                                    </>
                                  )}
                                  ...
                                  {!isNaN(num1) && num1 > 0 && num2 > 0 && (
                                    <>
                                      <p className="mt-3 font-bold">
                                        {data?.payload?.tech_lang_keys["3"]}{" "}
                                        <span className="comnFctr">{commonFactors.length}</span>{" "}
                                        {data?.payload?.tech_lang_keys["8"]} {num1}{" "}
                                        {data?.payload?.tech_lang_keys["9"]} {num2}:
                                      </p>
                                    ...
                                    {num1 > 0 && !isNaN(num1) && (
                                      <div className="col-span-12 md:col-span-6">
                                        <p className="mt-3 text-center">
                                          {data?.payload?.tech_lang_keys["10"]} {num1}
                                        </p>
                                        <table
                                          className="w-[30%] mx-auto text-[16px]"
                                          dangerouslySetInnerHTML={{ __html: result?.tech_tree1 }}
                                        />
                                      </div>
                                    )}
                                    {num2 > 0 && !isNaN(num2) && (
                                      <div className="col-span-12 md:col-span-6">
                                        <p className="mt-3 text-center">
                                          {data?.payload?.tech_lang_keys["10"]} {num2}
                                        </p>
                                        <table
                                          className="w-[30%] mx-auto text-[16px]"
                                          dangerouslySetInnerHTML={{ __html: result?.tech_tree2 }}
                                        />
                                      </div>
                                    )}
                                  </div>

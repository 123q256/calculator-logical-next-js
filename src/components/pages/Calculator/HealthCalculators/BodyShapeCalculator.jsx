        ...
        <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mb-3">
          ...
          <div className="lg:w-[70%] md:w-[80%] w-full mx-auto ">
            <div className="w-full">
              <label for="gender" className="pe-3 text-[14px] text-blue">
            ...
            <div className="grid grid-cols-12   gap-2 md:gap-4 lg:gap-4">
              <div className="col-span-12 md:col-span-8">
                <div className="grid grid-cols-12   gap-2 md:gap-4 lg:gap-4">
                  ...
                  {/* <div className="col-span-6">
                                <label for="chest" className="text-[14px] text-blue chest">{ data?.payload?.tech_lang_keys['bust'] }:</label>
                                <div className="relative w-full mt-[7px]">
                                    ...
                                    <label for="bust_units" className="absolute cursor-pointer text-sm underline right-6 top-4" onclick="toggleDropdown('bust_units_dropdown')">{ isset($_POST['bust_units'])?$_POST['bust_units']:'in' } ▾</label>
                  ...
                  {/* <div className="col-span-6">
                                <label for="waist" className="text-[14px] text-blue">{ data?.payload?.tech_lang_keys['Waist'] }:</label>
                                <div className="w-100 py-2 relative">
                                    ...
                                    <label for="waist_units" className="text-blue input_unit text-decoration-underline">{ isset($_POST['waist_units'])?$_POST['waist_units']:'in' } ▾</label>
                  ...
                  {/* <div className="col-span-6">
                                <label for="high" className="text-[14px] text-blue">{ data?.payload?.tech_lang_keys['high'] }:</label>
                                <div className="w-100 py-2 relative">
                                    ...
                                    <label for="high_units" className="text-blue input_unit text-decoration-underline">{ isset($_POST['high_units'])?$_POST['high_units']:'in' } ▾</label>
                  ...
                  {/* <div className="col-span-6">
                                <label for="hip" className="text-[14px] text-blue">{ data?.payload?.tech_lang_keys['Hip'] }:</label>
                                <div className="w-100 py-2 relative">
                                    ...
                                    <label for="hip_units" className="text-blue input_unit text-decoration-underline">{ isset($_POST['hip_units'])?$_POST['hip_units']:'in' } ▾</label>

                    ...
                    <div className="rounded-lg flex items-center justify-center">
                        <div className="w-full mt-3">
                          <div className="w-full">
                                  ...
                                  <table className="w-full text-[16px]">
                                    <thead>
                                      <tr>
                                        ...
                                        <td className="py-2 border-b font-bold">{data?.payload?.tech_lang_keys['2']}</td>
                                        <td className="py-2 border-b font-bold">{data?.payload?.tech_lang_keys['4']}</td>
                                        <td className="py-2 border-b font-bold">{data?.payload?.tech_lang_keys['3']}</td>
                                      </tr>
                                    </thead>
                                    <tbody>
                                      <tr>
                                        <td className="py-2 border-b">USA</td>
                                        <td className="py-2 border-b">{result?.tech_usBust}</td>
                                        <td className="py-2 border-b">{result?.tech_usHips}</td>
                                        <td className="py-2 border-b">{result?.tech_usWaist}</td>
                                      </tr>
                                      <tr>
                                        <td className="py-2 border-b">UK</td>
                                        <td className="py-2 border-b">{result?.tech_ukBust}</td>
                                        <td className="py-2 border-b">{result?.tech_ukHips}</td>
                                        <td className="py-2 border-b">{result?.tech_ukWaist}</td>
                                      </tr>
                                      <tr>
                                        <td className="py-2 border-b">EU</td>
                                        <td className="py-2 border-b">{result?.tech_euBust}</td>
                                        <td className="py-2 border-b">{result?.tech_euHips}</td>
                                        <td className="py-2 border-b">{result?.tech_euWaist}</td>
                                      </tr>
                                      <tr>
                                        <td className="py-2 border-b">{data?.payload?.tech_lang_keys['9']}</td>
                                        <td className="py-2 border-b">{result?.tech_internationalBust}</td>
                                        <td className="py-2 border-b">{result?.tech_internationalHips}</td>
                                        <td className="py-2 border-b">{result?.tech_internationalWaist}</td>
                                      </tr>
                                    </tbody>
                                  </table>
                                </div>
                            ...
                            {result?.tech_usaSize && (
                              <>
                                <p className="my-2 font-bold">{data?.payload?.tech_lang_keys['6']}</p>
                                <div className="grid grid-cols-12 gap-2 md:gap-4 lg:gap-4">
                                  {[
                                    { label: 'USA', value: result?.tech_usaSize, flag: '/images/USA.png' },
                                    { label: 'UK', value: result?.tech_ukSize, flag: '/images/UK.png' },
                                    { label: 'Europe (DE/AT/NL/SE/DK)', value: result?.tech_euroSize, flag: '/images/Europe.png' },
                                    { label: data?.payload?.tech_lang_keys['9'], value: result?.tech_internationalSize, flag: '/images/International.png' }
                                  ].map((item, index) => (
                                    <div key={index} className="col-span-12 md:col-span-6 lg:col-span-6">
                                      <div className="flex flex-wrap items-center justify-between bg-sky border rounded-lg px-3 py-2">
                                        <div className="flex flex-wrap items-center me-2">
                                          <img src={item.flag} width="30px" alt={item.label} />
                                          <span className="pt-1 ms-2">{item.label}</span>
                                        </div>
                                        <div>
                                          <strong className="text-green-500 text-[28px]">{item.value}</strong>
                                        </div>
                                      </div>
                                    </div>
                                  ))}
                            ...
                            <p className="mt-2">
                              <strong>{data?.payload?.tech_lang_keys['10']}:</strong> {data?.payload?.tech_lang_keys['11']}
                            </p>
                          </div>
                        </div>
                      </div>

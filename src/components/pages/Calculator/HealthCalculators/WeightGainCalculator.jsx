                              ...
                              <div className="grid grid-cols-12 gap-2 md:gap-4 lg:gap-4">
                                ...
                                <div className="col-span-12 md:col-span-6 lg:col-span-6">
                                  <div className="flex items-center justify-between bg-sky bordered rounded-lg px-3 py-2">
                                    <div>
                                      <strong className="text-[20px] text-[#2845F5]">{data?.payload?.tech_lang_keys['39']}</strong>
                                    </div>
                                    <div className="border-s-dark ps-2">
                                      <div>
                                        <strong className="text-[#119154] md:text-[20px]">{result?.tech_CaloriesDaily}</strong>
                                      </div>
                                ...
                                <div className="col-span-12 md:col-span-6 lg:col-span-6">
                                  <div className="flex items-center justify-between bg-sky bordered rounded-lg px-3 py-2">
                                    <div>
                                      <strong className="text-[20px] text-[#2845F5]">{data?.payload?.tech_lang_keys['11']}</strong>
                                    </div>
                                    <div className="border-s-dark ps-2">
                                      <div>
                                        <strong className="text-[#119154] md:text-[20px]">{result?.tech_CaloriesLess}</strong>
                                      </div>
                                      <div>{data?.payload?.tech_lang_keys['c/d']}</div>
                                    </div>
                                  </div>
                                ...
                                <div className="col-span-12">
                                  <div className="flex items-center justify-between bg-sky bordered rounded-lg px-3 py-2">
                                    <div className="border-end pe-2 pe-lg-3">
                                      <div className="mb-1">
                                        <strong className="text-[20px] text-[#2845F5]">{data?.payload?.tech_lang_keys['22']}</strong>
                                      </div>
                                      <div>{data?.payload?.tech_lang_keys['56']}</div>
                                    </div>
                                    <div className="ps-2 ps-lg-3">
                                      <div>
                                        <strong className="text-[#119154] md:text-[20px]">{result?.tech_BMR}</strong>
                                      </div>
                                      <div>{data?.payload?.tech_lang_keys['c/d']}</div>
                                    </div>
                                  </div>
                                ...
                                <div className="col-span-12 ">
                                  <div className="flex items-center justify-between bg-sky bordered rounded-lg px-3 py-2">
                                    <div className="border-end pe-2 pe-lg-3">
                                      <div className="mb-1">
                                        <strong className="text-[20px] text-[#2845F5]">TDEE</strong>
                                      </div>
                                      <div>{data?.payload?.tech_lang_keys['57']}</div>
                                    </div>
                                    <div className="ps-2 ps-lg-3">
                                      <div>
                                        <strong className="text-[#119154] md:text-[20px]">{result?.tech_Calories}</strong>
                                      </div>
                                      <div>{data?.payload?.tech_lang_keys['c/d']}</div>
                                    </div>
                                  </div>
                                ...
                                <div className="col-span-12 md:col-span-6 lg:col-span-6">
                                  <div className="flex items-center justify-between bg-sky bordered rounded-lg px-3 py-2">
                                    <div>
                                      <strong className="text-[20px] text-[#2845F5]">{data?.payload?.tech_lang_keys['40']}</strong>
                                    </div>
                                    <div className="border-s-dark ps-2 ps-lg-3">
                                      <div>
                                        <strong className="text-[#119154] md:text-[20px]">{result?.tech_days}</strong>
                                      </div>
                                ...
                                <div className="col-span-12 md:col-span-6 lg:col-span-6">
                                  <div className="flex items-center justify-between bg-sky bordered rounded-lg px-3 py-3" style={{ minHeight: '64px' }}>
                                    <div>
                                      <strong className="text-[20px] text-[#2845F5]">{data?.payload?.tech_lang_keys['Target_Date']}</strong>
                                    </div>
                                    <div className="border-s-dark ps-2">
                                      <div>
                                ...
                                <p className="mt-2"><strong className="text-[20px] text-[#2845F5]">{ data?.payload?.tech_lang_keys[58] }</strong></p>
                                ...
                                <div className="w-full mx-auto" >
                                    <div className="flex  items-center justify-between bg-sky bordered rounded-lg p-3 overflow-auto">
                                        <div className="px-3">
                                            ...
                                            <div>
                                                <strong className="cbval ">{macros.carbs}</strong>
                                        ...
                                        <div className="px-3">
                                            ...
                                            <div>
                                                <strong className="poval ">{macros.protein}</strong>
                                                <span>{ data?.payload?.tech_lang_keys[45] }</span>
                                            </div>
                                        </div>
                                        <div className="border-md-end py-2">&nbsp;</div>
                                        <div className="px-3">
                                            ...
                                            <div>
                                                <strong className="fatval ">{macros.fat}</strong>
                                                <span>{ data?.payload?.tech_lang_keys[45] }</span>
                                            </div>
                                        </div>
                                    </div>

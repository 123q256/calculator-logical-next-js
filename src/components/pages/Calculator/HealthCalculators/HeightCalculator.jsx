...
const toggleDropdown7 = () => {
 ...
 const maxHeightCM = Math.max(girlsHeight, boysHeight, motherHeight, fatherHeight);
  const range = 150;
              ...
              <p className="text-red-500 text-lg font-semibold w-full">
                              ...
                              <div className=" velocitytab relative">
                                  ...
                                  <div className="mt-2">
                                    ...
                                    >
                                      ...
                                      <option value="calculator2">{data?.payload?.tech_lang_keys["3"]} </option>
                                    </select>
                                  </div>
                              </div>
                          </div>
                ...
                <div className="lg:w-[70%] md:w-[100%] w-full mx-auto ">
                    <div className="grid grid-cols-12   gap-2 md:gap-4 lg:gap-4">
                          ...
                          <div className="col-span-6 px-2">
                              ...
                              <div className="mt-2">
                                ...
                                >
                                  ...
                                  <option value="1">{data?.payload?.tech_lang_keys["8"]} </option>
                                </select>
                              </div>
                          </div>
                          ...
                          <div className="md:col-span-6 col-span-12 ft_in_child">
                            <div className="grid grid-cols-12 gap-3">
                              <div className="col-span-6 ft_in_child">
                                <label htmlFor="tech_c_heigh_ft" className="label" >{ data?.payload?.tech_lang_keys["10"]}</label>
                                  <input
                                  type="number"
                                  step="any"
                              ...
                              <div className="col-span-6 ft_in_child">
                              <label htmlFor="tech_c_height_in" className="label" >&nbsp;</label>
                      ...
                      {(formData.tech_calculator_select == "calculator1" || formData.tech_calculator_select == "calculator2") && (
                        <>
                         {/* Mother's Height: */}
                        <input
                          type="hidden"
                        ...
                        <div className="md:col-span-6 col-span-12 ft_in_child">
                          <div className="grid grid-cols-12 gap-3">
                            <div className="col-span-6 ft_in_child">
                              <label htmlFor="tech_m_height_ft" className="label" >{ data?.payload?.tech_lang_keys["4"]}</label>
                                <input
                                type="number"
                                step="any"
                            ...
                            <div className="col-span-6 ft_in_child">
                             <label htmlFor="tech_m_height_in" className="label" >&nbsp;</label>
                            <div className="relative w-full ">
                              <input
                                type="number"
                        ...
                        <div className="md:col-span-6 col-span-12 ft_in_child">
                          <div className="grid grid-cols-12 gap-3">
                            <div className="col-span-6 ft_in_child">
                              <label htmlFor="tech_f_height_ft" className="label" >{ data?.payload?.tech_lang_keys["5"]}</label>
                                <input
                                type="number"
                                step="any"
                            ...
                            <div className="col-span-6 ft_in_child">
                             <label htmlFor="tech_f_height_in" className="label" >&nbsp;</label>
                            <div className="relative w-full ">
                              <input
                                type="number"
                          ...
                          {result?.tech_final_ans ? (
                            ...
                            <div className="w-full mt-5">
                              <div className="flex flex-wrap gap-4">
                                <div className="flex-1 min-w-[280px] bg-sky bordered rounded-lg p-4 flex items-center">
                                  <strong className="me-2"> {data?.payload?.tech_lang_keys["14"]} =</strong>
                                  <strong className="text-orange-600 text-2xl ml-2"> {result?.tech_final_ans_boy}</strong>
                                </div>
                                <div className="flex-1 min-w-[280px] bg-sky bordered rounded-lg p-4 flex items-center">
                                  <strong className="me-2"> {data?.payload?.tech_lang_keys["13"]} =</strong>
                                  <strong className="text-orange-600 text-2xl ml-2"> {result?.tech_final_ans_girl}</strong>
                                </div>
                              </div>
                            </div>
                           ...
                           {result?.tech_final_ans ? (
                            ...
                            <div className="mt-4 relative">
                                  <div className="mt-4 relative">
                                    <strong className="text-lg text-blue">Height comparison chart:</strong>
                                    <div className="overflow-auto mt-3 relative" style={{ minHeight: '200px' }}>
                                      <div className="min-w-[300px]">
                                        ...
                                        {chartData.map((item, index) => (
                                          index > 1 && (
                                            <div
                                              key={index}
                                              className={`flex justify-between py-1 chart-line ${item.isHighlight ? 'bg-yellow-200 font-bold' : ''}`}
                                            >
                                              <span>{item.cm}</span>
                                              <span>{item.ft}' {item.inch}''</span>
                                            </div>
                                          )
                                        ))}
                                          ...
                                          {result?.tech_gender == "0" ? (
                                            <>
                                              <div className="flex flex-col items-center">
                                                <p className="mb-1 font-semibold bg-sky-200 px-5 py-1 rounded">Boy</p>
                                                <img 
                                                src="/images/height/son.svg"
                                                alt="Son" className="w-16" />
                                              </div>
                                              <div className="flex flex-col items-center">
                                                <p className="mb-1 font-semibold bg-sky-200 px-5 py-1 rounded">Father</p>
                                                <img 
                                                  src="/images/height/father.svg"
                                                  alt="Father" className="w-16" />
                                              </div>
                                              <div className="flex flex-col items-center">
                                                <p className="mb-1 font-semibold bg-sky-200 px-5 py-1 rounded">Mother</p>
                                                <img 
                                                src="/images/height/mother.svg"
                                                alt="Mother" className="w-16" />
                                              </div>
                                            </>
                                          ) : (
                                            <>
                                              <div className="flex flex-col items-center">
                                                <p className="mb-1 font-semibold bg-pink-200 px-5 py-1 rounded">Girl</p>
                                                <img 
                                                  src="/images/height/daughter.svg"
                                                alt="Daughter" className="w-16" />
                                              </div>
                                              <div className="flex flex-col items-center">
                                                <p className="mb-1 font-semibold bg-sky-200 px-5 py-1 rounded">Father</p>
                                                <img 
                            ...
                            <div className="w-full mt-4">
                              <strong className="text-blue-600 text-lg">Height Comparison Chart:</strong>
                                  ...
                                  {chartDatas.map((item, index) => (
                                    <div
                                      ...
                                      className={`flex justify-between px-4 py-1 text-sm ${
                                        item.highlight ? "bg-yellow-100 font-bold" : ""
                                      }`}
                                    >
                                  ...
                                  {/* Static Images */}
                                   <div className="absolute bottom-0 left-0 right-0 flex space-x-1 md:space-x-10 justify-center items-end h-32">
                                     <div className="flex flex-col items-center">
                                        ...
                                        <img 
                                          src="/images/height/daughter.svg"
                                        alt="Daughter" className="w-[50px] md:w-20" />
                                      </div>
                                    <div className="flex flex-col items-center">
                                    <p className="mb-1 font-semibold bg-sky-200 px-5 py-1 rounded">Boy</p>
                                    <img 
                                    src="/images/height/son.svg"
                                    alt="Son" className="w-[50px] md:w-20" />
                                  </div>
                                  <div className="flex flex-col items-center">
                                    <p className="mb-1 font-semibold bg-sky-200 px-5 py-1 rounded">Father</p>
                                    <img 
                                      src="/images/height/father.svg"
                                      alt="Father" className="w-[50px] md:w-20" />
                                  </div>
                                  <div className="flex flex-col items-center">
                                    <p className="mb-1 font-semibold bg-sky-200 px-5 py-1 rounded">Mother</p>
                                    <img 
                                    src="/images/height/mother.svg"
                                    alt="Mother" className="w-[50px] md:w-20" />
                                  </div>
                                  </div>
                                </div>
                              </div>

              ...
              <div className="w-full result mx-auto p-4 lg:p-8 md:p-8 result_calculator rounded-lg space-y-6 result">
                <div>
                  ...
                  <div className="rounded-lg  flex items-center ">
                    <div className="w-full md:w-[80%] lg:w-[80%] p-3  mt-3">
                            ...
                            {result?.tech_Robinson ? (
                              <>
                                ...
                                <tr>
                                  ...
                                  {formData?.tech_unit == "kg" ? (
                                    <td className="border-b">
                                      <strong>{result?.tech_Miller} kg</strong>
                                    </td>
                                  ) : (
                                    <td className="border-b">
                                      <strong>
                                ...
                                <tr>
                                  ...
                                  {formData?.tech_unit == "kg" ? (
                                    <td className="border-b">
                                      <strong>{result?.tech_Devine} kg</strong>
                                    </td>
                                  ) : (
                                    <td className="border-b">
                                      <strong>
                                ...
                                <tr>
                                  ...
                                  {formData?.tech_unit == "kg" ? (
                                    <td className="border-b">
                                      <strong>{result?.tech_Lorentz} kg</strong>
                                    </td>
                                  ) : (
                                    <td className="border-b">
                                      <strong>
                                ...
                                <tr>
                                  ...
                                  {formData?.tech_unit == "kg" ? (
                                    <td className="border-b">
                                      <strong>{result?.tech_Lemmens} kg</strong>
                                    </td>
                                  ) : (
                                    <td className="border-b">
                                      <strong>

                        ...
                        <div className="w-full overflow-auto mt-3">
                          ...
                          >
                            ...
                            <tr>
                              ...
                              <td className="border-b py-2">
                                {Math.round(result?.tech_ans * 0.95 * 10) / 10}{" "}
                                {formData?.tech_weight_unit}
                              </td>
                            ...
                            <tr>
                              ...
                              <td className="border-b py-2">
                                {Math.round(result?.tech_ans * 0.85 * 10) / 10}{" "}
                                {formData?.tech_weight_unit}
                              </td>
                            ...
                            <tr>
                              ...
                              <td className="border-b py-2">
                                {Math.round(result?.tech_ans * 0.75 * 10) / 10}{" "}
                                {formData?.tech_weight_unit}
                              </td>
                            ...
                            <tr>
                              ...
                              <td className="border-b py-2">
                                {Math.round(result?.tech_ans * 0.65 * 10) / 10}{" "}
                                {formData?.tech_weight_unit}
                              </td>
                            ...
                            <tr>
                              ...
                              <td className="border-b py-2">
                                {Math.round(result?.tech_ans * 0.55 * 10) / 10}{" "}
                                {formData?.tech_weight_unit}
                              </td>
                        ...
                        <div className="w-full overflow-auto">
                          ...
                          >
                            ...
                            <tr>
                              <td className="border-b py-2">2</td>
                              <td className="border-b py-2">
                                {Math.round(result?.tech_ans * 0.97 * 10) / 10}{" "}
                                {formData?.tech_weight_unit}
                              </td>
                            ...
                            <tr>
                              ...
                              <td className="border-b py-2">
                                {Math.round(result?.tech_ans * 0.94 * 10) / 10}{" "}
                                {formData?.tech_weight_unit}
                              </td>
                            ...
                            <tr>
                              <td className="border-b py-2">4</td>
                              <td className="border-b py-2">
                                {Math.round(result?.tech_ans * 0.92 * 10) / 10}{" "}
                                {formData?.tech_weight_unit}
                              </td>
                            ...
                            <tr>
                              ...
                              <td className="border-b py-2">
                                {Math.round(result?.tech_ans * 0.89 * 10) / 10}{" "}
                                {formData?.tech_weight_unit}
                              </td>
                            ...
                            <tr>
                              <td className="border-b py-2">6</td>
                              <td className="border-b py-2">
                                {Math.round(result?.tech_ans * 0.86 * 10) / 10}{" "}
                                {formData?.tech_weight_unit}
                              </td>
                            ...
                            <tr>
                              ...
                              <td className="border-b py-2">
                                {Math.round(result?.tech_ans * 0.83 * 10) / 10}{" "}
                                {formData?.tech_weight_unit}
                              </td>
                            ...
                            <tr>
                              <td className="border-b py-2">8</td>
                              <td className="border-b py-2">
                                {Math.round(result?.tech_ans * 0.81 * 10) / 10}{" "}
                                {formData?.tech_weight_unit}
                              </td>
                            ...
                            <tr>
                              ...
                              <td className="border-b py-2">
                                {Math.round(result?.tech_ans * 0.78 * 10) / 10}{" "}
                                {formData?.tech_weight_unit}
                              </td>
                            ...
                            <tr>
                              ...
                              <td className="border-b py-2">
                                {Math.round(result?.tech_ans * 0.73 * 10) / 10}{" "}
                                {formData?.tech_weight_unit}
                              </td>
                            ...
                            <tr>
                              <td className="border-b py-2">12</td>
                              <td className="border-b py-2">
                                {Math.round(result?.tech_ans * 0.71 * 10) / 10}{" "}
                                {formData?.tech_weight_unit}
                              </td>
                            ...
                            <tr>
                              ...
                              <td className="border-b py-2">
                                {Math.round(result?.tech_ans * 0.68 * 10) / 10}{" "}
                                {formData?.tech_weight_unit}
                              </td>
                            ...
                            <tr>
                              ...
                              <td className="border-b py-2">
                                {Math.round(result?.tech_ans * 0.67 * 10) / 10}{" "}
                                {formData?.tech_weight_unit}
                              </td>
                            ...
                            <tr>
                              ...
                              <td className="border-b py-2">
                                {Math.round(result?.tech_ans * 0.64 * 10) / 10}{" "}
                                {formData?.tech_weight_unit}
                              </td>
                            ...
                            <tr>
                              ...
                              <td className="border-b py-2">
                                {Math.round(result?.tech_ans * 0.63 * 10) / 10}{" "}
                                {formData?.tech_weight_unit}
                              </td>
                            ...
                            <tr>
                              ...
                              <td className="border-b py-2">
                                {Math.round(result?.tech_ans * 0.61 * 10) / 10}{" "}
                                {formData?.tech_weight_unit}
                              </td>
                            ...
                            <tr>
                              ...
                              <td className="border-b py-2">
                                {Math.round(result?.tech_ans * 0.59 * 10) / 10}{" "}
                                {formData?.tech_weight_unit}
                              </td>
                            ...
                            <tr>
                              ...
                              <td className="border-b py-2">
                                {Math.round(result?.tech_ans * 0.58 * 10) / 10}{" "}
                                {formData?.tech_weight_unit}
                              </td>
                            ...
                            <tr>
                              ...
                              <td className="border-b py-2">
                                {Math.round(result?.tech_ans * 0.57 * 10) / 10}{" "}
                                {formData?.tech_weight_unit}
                              </td>
                            ...
                            <tr>
                              <td className="border-b py-2">24</td>
                              <td className="border-b py-2">
                                {Math.round(result?.tech_ans * 0.56 * 10) / 10}{" "}
                                {formData?.tech_weight_unit}
                              </td>
                            ...
                            <tr>
                              ...
                              <td className="border-b py-2">
                                {Math.round(result?.tech_ans * 0.54 * 10) / 10}{" "}
                                {formData?.tech_weight_unit}
                              </td>
                            ...
                            <tr>
                              ...
                              <td className="border-b py-2">
                                {Math.round(result?.tech_ans * 0.53 * 10) / 10}{" "}
                                {formData?.tech_weight_unit}
                              </td>
                            ...
                            <tr>
                              ...
                              <td className="border-b py-2">
                                {Math.round(result?.tech_ans * 0.52 * 10) / 10}{" "}
                                {formData?.tech_weight_unit}
                              </td>
                            ...
                            <tr>
                              ...
                              <td className="border-b py-2">
                                {Math.round(result?.tech_ans * 0.51 * 10) / 10}{" "}
                                {formData?.tech_weight_unit}
                              </td>

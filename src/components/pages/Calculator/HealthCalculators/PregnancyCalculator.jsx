...
// currency code
  ...
  const formatDate = (dateStr, format = { month: "short", day: "2-digit", year: "numeric" }) => {
    if (!dateStr) return "";
...
const due = new Date(baseDate.getTime() + 38 * 7 * 86400000);        // +38 weeks
  ...
  if (today < ovuDate) {
    rows.push(
      <tr key="ovu-before">
        <td className="text-blue-500 border-b pe-2 p-2">{formatDatex(ovuDate)}</td>
    ...
    rows.push(
      <tr key="ovu-after">
        <td className="text-blue-500 border-b pe-2 p-2">{formatDatex(ovuDate)}</td>
        <td className="color_gray border-b p-2">{data?.payload?.tech_lang_keys['8']}</td>
      </tr>
    );
  }
  ...
  if (today < pregText) {
    ...
    rows.push(
      <tr key="preg-after">
        <td className="text-blue-500 border-b pe-2 p-2">{formatDatex(pregText)}</td>
        <td className="color_gray border-b p-2">{data?.payload?.tech_lang_keys['10']}</td>
      </tr>
    );
  }
  ...
  if (today < heartBeat) {
    rows.push(
      <tr key="heart-before">
        <td className="text-blue border-b pe-2 p-2">{formatDatex(heartBeat)}</td>
    ...
    rows.push(
      <tr key="heart-after">
        <td className="text-blue-500 border-b pe-2 p-2">{formatDatex(heartBeat)}</td>
        <td className="color_gray border-b p-2">{data?.payload?.tech_lang_keys['11']}</td>
      </tr>
    );
  }
  ...
  rows.push(
    <tr key="morning-passed">
      <td className="text-blue-500 border-b pe-2 p-2">{formatDatex(morning)}</td>
      <td className="color_gray border-b p-2">{data?.payload?.tech_lang_keys['12']}</td>
    </tr>
  );
}
...
if (today < midwife) {
  ...
  rows.push(
    <tr key="midwife-passed">
      <td className="text-blue-500 border-b pe-2 p-2">{formatDatex(midwife)}</td>
      <td className="color_gray border-b p-2">{data?.payload?.tech_lang_keys['13']}</td>
    </tr>
  );
}
...
if (today < second) {
  rows.push(
    <tr key="second-upcoming">
      ...
      <td className="border-b p-2">
        <strong>{data?.payload?.tech_lang_keys['2nd']} (13 {data?.payload?.tech_lang_keys['week']})</strong>
      </td>
    </tr>
  );
  ...
  rows.push(
    <tr key="second-passed">
      ...
      <td className="border-b p-2">
        <strong className="color_gray">{data?.payload?.tech_lang_keys['2nd']} (13 {data?.payload?.tech_lang_keys['week']})</strong>
      </td>
    </tr>
  );
}
...
if (today < ears) {
  ...
  rows.push(
    <tr key="ears-after">
      ...
      <td className="color_gray border-b p-2">{data?.payload?.tech_lang_keys['14']}</td>
    </tr>
  );
}
...
if (today < feeling) {
  ...
  rows.push(
    <tr key="feeling-after">
      <td className="text-blue-500 border-b pe-2 p-2">{formatDatex(feeling)}</td>
      <td className="color_gray border-b p-2">{data?.payload?.tech_lang_keys['15']}</td>
    </tr>
  );
}
...
if (today < scan) {
  ...
  rows.push(
    <tr key="scan-after">
      ...
      <td className="color_gray border-b p-2">{data?.payload?.tech_lang_keys['16']}</td>
    </tr>
  );
}
...
if (today < organs) {
  ...
  rows.push(
    <tr key="organs-after">
      <td className="text-blue-500 border-b pe-2 p-2">{formatDatex(organs)}</td>
      <td className="color_gray border-b p-2">{data?.payload?.tech_lang_keys['17']}</td>
    </tr>
  );
}
...
if (today < third) {
  rows.push(
    <tr key="third-before">
      ...
      <td className="border-b p-2">
        <strong>{data?.payload?.tech_lang_keys['3rd']} (28 {data?.payload?.tech_lang_keys['week']})</strong>
      </td>
    </tr>
  );
  ...
  rows.push(
    <tr key="third-after">
      ...
      <td className="border-b p-2">
        <strong className="color_gray">{data?.payload?.tech_lang_keys['3rd']} (28 {data?.payload?.tech_lang_keys['week']})</strong>
      </td>
    </tr>
  );
}
...
if (today < deliver) {
  ...
  rows.push(
    <tr key="deliver-after">
      <td className="text-blue-500 border-b pe-2 p-2">{formatDatex(deliver)}</td>
      <td className="color_gray border-b p-2">{data?.payload?.tech_lang_keys['18']}</td>
    </tr>
  );
}
...
if (today < full) {
  ...
  rows.push(
    <tr key="full-after">
      ...
      <td className="color_gray border-b p-2">{data?.payload?.tech_lang_keys['19']}</td>
    </tr>
  );
}
    ...
    datasets: [
      {
        ...
        data: [1.4,1.3,1.4,1.9,2.4,2.1,2.7,3.1,2.8,2.9,3.8,4.0,4.0,4.6,6.9,5.2,4.5,4.3,4.0,4.1,4.2,4.0,3.1,2.4,2.3,1.7,1.3,1.1,0.7,0,0,0,0].slice(0, labels.length),
    ...
    datasets: [
      {
        ...
        data: [
          10.8,12.1,13.5,15.4,17.9,19.9,22.6,26.6,28.4,31.4,35.2,39.3,43.3,47.9,
          54.4,60.0,64.5,68.8,72.8,76.8,81.0,85.1,88.2,90.7,93.0,94.7,96.0,97.1,97.8,0,0,0,0
                ...
                <div className="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                    <div className="col-span-12 px-2">
                      ...
                      <div className="mt-2">
                        ...
                        >
                          <option value="Last">{data?.payload?.tech_lang_keys["m1"]} </option>
                          <option value="Due">Due Date </option>
                          <option value="Conception">{data?.payload?.tech_lang_keys["m2"]} </option>
                          <option value="IVF">{data?.payload?.tech_lang_keys["m3"]} </option>
                          <option value="Ulrasound">{data?.payload?.tech_lang_keys["m4"]} </option>
                        </select>
                      </div>
                    ...
                    <div className="col-span-12 md:col-span-6 lg:col-span-6">
                      {formData.tech_method == "Last" && (
                        <>
                        <label htmlFor="tech_date" className="label"> {data?.payload?.tech_lang_keys["start_date"]}</label>
                        </>
                      )}
                        {formData.tech_method == "Due" && (
                        <>
                        <label htmlFor="tech_date" className="label"> Due Date:</label>
                        </>
                      )}
                        {formData.tech_method == "Conception" && (
                        <>
                        <label htmlFor="tech_date" className="label"> {data?.payload?.tech_lang_keys["con"]}</label>
                        </>
                      )}
                        {formData.tech_method == "IVF" && (
                        <>
                        <label htmlFor="tech_date" className="label"> {data?.payload?.tech_lang_keys["ivf"]}</label>
                        </>
                      )}
                        {formData.tech_method == "Ulrasound" && (
                        <>
                        <label htmlFor="tech_date" className="label"> {data?.payload?.tech_lang_keys["ultra"]}</label>
                        </>
                      )}
              ...
              <>
                ...
                <div className="rounded-lg  flex items-center justify-center">
                    <div className="w-full p-3 rounded-lg mt-3">
                                      ...
                                      <div className="bg-gradient-to-r from-blue-50 via-sky-100 to-blue-50 bordered border-blue-200 shadow-lg rounded-xl p-4">
                                        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                                          <div className="text-center md:text-left">
                                            <p className="text-lg font-semibold text-blue-600">
                                              {data?.payload?.tech_lang_keys['your_due']} 
                                              <span className="text-blue-800">{formatDate(result?.tech_EstimatedAge)}</span>
                                            </p>
                                          </div>
                                          ...
                                          <div className="flex items-center space-x-4 text-2xl text-gray-700">
                                            <strong>{formatDate(result?.tech_EstimatedAge, { month: "short" })}</strong>
                                            <div className="relative">
                                              <img src="/images/empty_calender.png" alt="Calendar" className="w-[350px] hidden md:block transform transition-transform hover:scale-105" />
                                              <img src="/images/empty_calender.png" alt="Calendar" className="w-[50px] block md:hidden transform transition-transform hover:scale-105" />
                                              <strong className="text-green-500 absolute inset-0 flex items-center justify-center text-xl">
                                                {formatDate(result?.tech_EstimatedAge, { day: "2-digit" })}
                                              </strong>
                                            </div>
                                            <strong>{formatDate(result?.tech_EstimatedAge, { year: "numeric" })}</strong>
                                          </div>
                                        </div>

                                        <p className="text-sm mt-4 text-gray-600">
                                          <strong className="text-red-500">{data?.payload?.tech_lang_keys['cong']}!</strong>
                                        </p>

                                        <p className="text-sm text-gray-700">
                                          <strong>
                                            {data?.payload?.tech_lang_keys['1']} {result?.tech_RemainingWeeks} {data?.payload?.tech_lang_keys['week']}, {result?.tech_RemainingDays} {data?.payload?.tech_lang_keys['days']} {data?.payload?.tech_lang_keys['2']}
                                          </strong>
                                        </p>
                                        ...
                                        {formData?.tech_method === 'Due' && (
                                          <p className="text-sm text-gray-700">
                                            ...
                                            <strong className="text-black">{formatDate(result?.tech_ovu_date)}</strong>
                                          </p>
                                        )}
                                      </div>
                                      ...
                                      <div className="w-full flex justify-center mt-6">
                                        <div className="bg-gradient-to-r from-blue-50 via-sky-100 to-blue-50 bordered border-blue-200 shadow-md rounded-xl px-6 py-5">
                                          <p className="text-lg font-bold text-blue-600">
                                            ...
                                            <span className="text-blue-800">{data?.payload?.tech_lang_keys['week']} {result?.tech_RemainingWeeks} {data?.payload?.tech_lang_keys['6']}</span>
                                          </p>
                                          ...
                                          {(() => {
                                            ...
                                            const weekKey = weekKeyMap[result?.tech_RemainingWeeks];
                                            if (!weekKey || !data?.payload?.tech_lang_keys[weekKey]) return null;

                                            const [title, desc] = data.payload.tech_lang_keys[weekKey].split('@');
                                            return (
                                              <>
                                       ...
                                       <div className="w-full">
                                          ...
                                          <div className="w-full mt-4">
                                            <div className="bg-white flex items-center py-2 rounded-lg shadow">
                                              <div className="w-full bg-gray-100 rounded-lg px-4 py-2 flex flex-col justify-center">
                                                <p className="text-blue-600 font-bold">{data?.payload?.tech_lang_keys["1st"]}</p>
                                                <p className="text-gray-500 text-sm">
                                                  {formatDatexx(firstStart)} to {formatDatexx(firstEnd)}
                                                </p>
                                              </div>
                                            </div>
                                          </div>
                                          ...
                                          <div className="w-full mt-4">
                                            <div className="bg-white flex items-center py-2 rounded-lg shadow">
                                              <div className="w-full bg-gray-100 rounded-lg px-4 py-2 flex flex-col justify-center">
                                                <p className="text-blue-600 font-bold">{data?.payload?.tech_lang_keys["2nd"]}</p>
                                                <p className="text-gray-500 text-sm">
                                                  {formatDatexx(secondStart)} to {formatDatexx(secondEnd)}
                                                </p>
                                              </div>
                                            </div>
                                          </div>
                                          ...
                                          <div className="w-full mt-4">
                                            <div className="bg-white flex items-center py-2 rounded-lg shadow">
                                              <div className="w-full bg-gray-100 rounded-lg px-4 py-2 flex flex-col justify-center">
                                                <p className="text-blue-600 font-bold">{data?.payload?.tech_lang_keys["3rd"]}</p>
                                                <p className="text-gray-500 text-sm">
                                                  {formatDatexx(thirdStart)} to {formatDatexx(thirdEnd)}
                                                </p>
                                              </div>
                                            </div>
                                          </div>
                                          ...
                                          {/* Final Message */}
                                          <p className="mt-6 text-lg font-bold">{data?.payload?.tech_lang_keys["3"]}</p>
                                          <p className="text-gray-700">{data?.payload?.tech_lang_keys["4"]}</p>
                                        </div>
                                ...
                                <div className="col">
                                    <div className="w-full lg:w-[100%] mt-3">
                                        <div className=" bordered rounded-2xl px-3 py-2">
                                            <p className="text-center"> <strong className="text-blue-500">{ data?.payload?.tech_lang_keys['7'] }</strong></p>
                        ...
                        <p className="font-s-18 my-3"><strong className="border-b-blue text-blue pb-1">{ data?.payload?.tech_lang_keys['21'] }</strong></p>
                        <div className="overflow-auto">
                            <div className="row mt-3 flex md:w-full" style={{ width: '750px' }}>
                              <div className="col-2 w-[23%] d-lg-block border-r-2 border-white">
                                ...
                                >
                                  ...
                                  <div className="col-2 w-[13%] col-lg-1 border-r-2 border-white">
                                    ...
                                    {[ 
                                      { key: 'tech_one_t', label: '1', styleBottom: false, defaultClass: 'light-orange orange_color' },
                                      { key: 'tech_two_t', label: '2', styleBottom: false, defaultClass: 'light-orange orange_color' },
                                      { key: 'tech_three_t', label: '3', styleBottom: true, defaultClass: 'light-orange orange_color' },
                                      { key: 'tech_four_t', label: '4', styleBottom: false, defaultClass: 'lighter-blue text-blue' },
                                      { key: 'tech_five_t', label: '5', styleBottom: false, defaultClass: 'lighter-blue text-blue' },
                                      { key: 'tech_six_t', label: '6', styleBottom: true, defaultClass: 'lighter-blue text-blue' },
                                      { key: 'tech_seven_t', label: '7', styleBottom: false, defaultClass: 'light-lime green_color' },
                                      { key: 'tech_eight_t', label: '8', styleBottom: false, defaultClass: 'light-lime green_color' },
                                      { key: 'tech_nine_t', label: '9', styleBottom: false, defaultClass: 'light-lime green_color' }
                                    ].map(({ key, label, styleBottom, defaultClass }) => {
                                      // Determine dynamic class from result or fallback to default
                                      const dynamicClass = (result && result[key]) ? result[key] : defaultClass;

                                      return (
                                        <b
                                          key={key}
                                          className={`col-12 border-white week_height text-center ${dynamicClass}`}
                                          style={styleBottom ? { borderBottom: '2px solid white' } : undefined}
                                        >
                                          {label}
                                        </b>
                                      );
                                  ...
                                  <div className="col-4 w-[32%] border-r-2 border-white">
                                    ...
                                    <div className="row p-2 text-[10px] border-white trim_height light-orange orange_color overflow-auto overflow-md-visible">
                                      <div className="col-lg-6 px-2 overflow-auto">
                                        ...
                                        <p className="font-s-12">
                                          {data?.payload?.tech_lang_keys['28']?.split(',').map((val, idx) => (
                                      ...
                                      <div className="col-lg-6 px-2 overflow-auto">
                                        ...
                                        <p className="font-s-12">
                                          {data?.payload?.tech_lang_keys['31']?.split(',').map((val, idx) => (
                                            <React.Fragment key={idx}>
                                              {val.trim()}
                                              <br />
                                            </React.Fragment>
                                      ...
                                      <div className="col-lg-6 px-2 d-none d-lg-block">
                                        ...
                                        <p className="font-s-12">
                                          {data?.payload?.tech_lang_keys['32']?.split(',').map((val, idx) => (
                                            <React.Fragment key={idx}>
                                              {val.trim()}
                                              <br />
                                            </React.Fragment>
                                    ...
                                    >
                                      <div className="col-12 px-2 overflow-auto">
                                        ...
                                        <p className="font-s-12">
                                          {data?.payload?.tech_lang_keys['34']?.split(',').map((val, idx) => (
                                            <React.Fragment key={idx}>
                                              {val.trim()}
                                              <br />
                                            </React.Fragment>
                                      ...
                                      <div className="col-lg-6 px-2 overflow-auto">
                                        <b>{data?.payload?.tech_lang_keys['29']}:</b>
                                        <p className="font-s-12">
                                          {data?.payload?.tech_lang_keys['35']?.split(',').map((val, idx) => (
                                            <React.Fragment key={idx}>
                                              {val.trim()}
                                              <br />
                                            </React.Fragment>
                                      ...
                                      <div className="col-lg-6 px-2 d-none d-lg-block">
                                        <b>{data?.payload?.tech_lang_keys['30']}</b>
                                        <p className="font-s-12">{data?.payload?.tech_lang_keys['36']}</p>
                                      </div>
                                    </div>
                                    ...
                                    <div className="row p-2 text-[11px] border-white trim_height light-lime green_color overflow-auto overflow-md-visible">
                                      <div className="col-lg-6 px-2 overflow-auto">
                                        ...
                                        <p className="font-s-12">
                                          {data?.payload?.tech_lang_keys['38']?.split(',').map((val, idx) => (
                                            <React.Fragment key={idx}>
                                              {val.trim()}
                                              <br />
                                            </React.Fragment>
                                      ...
                                      <div className="col-lg-6 px-2 overflow-auto">
                                        <b>{data?.payload?.tech_lang_keys['29']}:</b>
                                        <p className="font-s-12">
                                          {data?.payload?.tech_lang_keys['39']?.split(',').map((val, idx) => (
                                            <React.Fragment key={idx}>
                                              {val.trim()}
                                              <br />
                                            </React.Fragment>
                                      ...
                                      <div className="col-lg-6 px-2 d-none d-lg-block">
                                        <b>{data?.payload?.tech_lang_keys['30']}:</b>
                                        <p className="font-s-12">{data?.payload?.tech_lang_keys['40']}</p>
                                      </div>
                                    </div>
                                  </div>
                                  <div className="col-4 w-[32%] border-r-2 border-white">
                                    ...
                                    <div className="col-12 p-2 text-[14px] border-white trim_height light-orange orange_color overflow-auto">
                                      ...
                                      <p className="font-s-12">
                                        {data?.payload?.tech_lang_keys['43']?.split(',').map((val, idx) => (
                                          <React.Fragment key={idx}>
                                            {val.trim()}
                                            <br />
                                          </React.Fragment>
                                      ...
                                      <p className="font-s-12">1/4" --&gt; 209" & 0.8 oz</p>
                                    </div>
                                    ...
                                    >
                                      <b>{data?.payload?.tech_lang_keys['41']}</b>
                                      <p className="font-s-12">
                                        {data?.payload?.tech_lang_keys['44']?.split(',').map((val, idx) => (
                                          <React.Fragment key={idx}>
                                            {val.trim()}
                                            <br />
                                          </React.Fragment>
                                    ...
                                    <div className="col-12 p-2 text-[14px] border-white trim_height light-lime green_color overflow-auto">
                                      ...
                                      <b>{data?.payload?.tech_lang_keys['42']}</b>
                                      <p className="font-s-12">14.4" & 2.9 lbs --&gt; 20.3" & 8.1 lbs</p>
                                    </div>
                                  </div>
                            </div>
                        </div>

                ...
                <div className="grid grid-cols-12  gap-2 md:gap-4 lg:gap-4">
                                ...
                                <div className="flex flex-wrap items-center bg-blue-100 border border-blue-500 text-center rounded-lg px-1">
                                   ...
                                   <div className="lg:w-1/2 w-full px-2 py-1">
                                    <div
                                      className={`bg-white px-3 py-2 cursor-pointer rounded-md transition-colors duration-300 hover_tags hover:text-white pacetab  ${
                                        formData.tech_unit_type === "imperial" ? "tagsUnit" : ""
                                      }`}
                                      id="imperial"
                                      onClick={() => {
                                        setFormData({ ...formData, tech_unit_type: "imperial" });
                                        setResult(null);
                                        setFormError(null);
                                      } }
                                  ...
                                  {/* Time Cal Tab */}
                                   <div className="lg:w-1/2 w-full px-2 py-1">
                                    <div
                                      className={`bg-white px-3 py-2 cursor-pointer rounded-md transition-colors duration-300 hover_tags hover:text-white pacetab ${
                                        formData.tech_unit_type === "metric" ? "tagsUnit" : ""
                                      }`}
                                      id="metric"
                                      onClick={() => {
                                        setFormData({ ...formData, tech_unit_type: "metric" });
                                        setResult(null);
                                        setFormError(null);
                                      } }
                                    >
                    ...
                    <div className="md:col-span-6 col-span-12">
                        ...
                        <div className="mt-2">
                          <select
                            ...
                            onChange={handleChange}
                          >
                            <option value="sedentary">{data?.payload?.tech_lang_keys["No_sport"]} </option>
                            <option value="Lightly_Active">{data?.payload?.tech_lang_keys["Light_activity"]} </option>
                            <option value="Moderately_Active">{data?.payload?.tech_lang_keys["Moderate_activity"]} </option>
                            <option value="Very_Active">{data?.payload?.tech_lang_keys["High_activity"]} </option>
                            <option value="ext">{data?.payload?.tech_lang_keys["Extreme_activity"]} </option>
                          </select>
                        </div>
                    </div>
                    <div className="col-span-12">
                            ...
                            <div className="col-span-12 md:col-span-6 lg:col-span-6">
                              ...
                              <div className="mt-2">
                                <select
                                  ...
                                  onChange={handleChange}
                                >
                                  <option value="0.10">{data?.payload?.tech_lang_keys["49"]} </option>
                                  <option value="0.15">{data?.payload?.tech_lang_keys["50"]} </option>
                                  <option value="0.20">{data?.payload?.tech_lang_keys["51"]} </option>
                                  <option value="custom">{data?.payload?.tech_lang_keys["52"]} </option>
                                </select>
                              </div>
                            </div>
                        </div>
                    ...
                    {formData.tech_surplus == "custom" && (
                      ...
                      <div className="col-span-12 md:col-span-6 lg:col-span-6 surplus ">
                          <div className="col-12 ps-2 mt-2">
                              <p className="font-s-14 pe-2 pe-lg-3 mb-1"><strong>{ data?.payload?.tech_lang_keys['53'] }: </strong></p>
                        ...
                        {formData.tech_stype == "Incal" && (
                          ...
                          <div className="w-full py-2 relative " id="pre_cal">
                              <label htmlFor="tech_per_cal" className="label"> {data?.payload?.tech_lang_keys["i_want"]}: </label>
                                <div className=" relative">
                                  <input
                                    type="number"
                                    step="any"
                     ...
                     <div className="col-span-12 my-2"><strong className="text-[#2845F5]">{ data?.payload?.tech_lang_keys['to_achieve'] }?</strong></div>
                    <div className="col-span-12 md:col-span-6 lg:col-span-6">
                    ...
                    <div className="col-span-12 md:col-span-6 lg:col-span-6 body_percent">
                       <label htmlFor="tech_percent" className="label">
                            {data?.payload?.tech_lang_keys["body_fat"]}  <a title="Body Fat Percentage Calculator" href="/body-fat-percentage-calculator" className="underline" target="_blank" rel="noopener"> { data?.payload?.tech_lang_keys['click'] }</a>:
                              </label>
                              <div className=" relative">
                              <input
                                type="number"
                              ...
                              <div className="grid grid-cols-12 gap-2 md:gap-4 lg:gap-4">
                                ...
                                <div className="col-span-12 md:col-span-6 lg:col-span-6">
                                  <div className="flex items-center justify-between bg-sky bordered rounded-lg px-3 py-2">
                                    <div>
                                      <strong className="md:text-[20px] text-[16px] text-[#2845F5]">{data?.payload?.tech_lang_keys['39']}</strong>
                                    </div>
                                    <div className="border-s-dark ps-2">
                                      <div>
                                        <strong className="text-[#119154] text-[20px]">{result?.tech_CaloriesDaily}</strong>
                                      </div>
                                      <div>{data?.payload?.tech_lang_keys['c/d']}</div>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div className="col-span-12 md:col-span-6 lg:col-span-6">
                                  <div className="flex items-center justify-between bg-sky bordered rounded-lg px-3 py-2">
                                    <div>
                                      <strong className="md:text-[20px] text-[16px] text-[#2845F5]">{data?.payload?.tech_lang_keys['11']}</strong>
                                    </div>
                                    <div className="border-s-dark ps-2">
                                      <div>
                                        <strong className="text-[#119154] text-[20px]">{result?.tech_CaloriesLess}</strong>
                                      </div>
                                      <div>{data?.payload?.tech_lang_keys['c/d']}</div>
                                    </div>
                                  </div>
                                ...
                                <div className="col-span-12">
                                  <div className="flex items-center justify-between bg-sky bordered rounded-lg px-3 py-2">
                                    <div className="border-end pe-2 pe-lg-3">
                                      <div className="mb-1">
                                        <strong className="md:text-[20px] text-[16px] text-[#2845F5]">{data?.payload?.tech_lang_keys['22']}</strong>
                                      </div>
                                      <div>{data?.payload?.tech_lang_keys['56']}</div>
                                    </div>
                                    <div className="ps-2 ps-lg-3">
                                      <div>
                                        <strong className="text-[#119154] text-[20px]">{result?.tech_BMR}</strong>
                                      </div>
                                      <div>{data?.payload?.tech_lang_keys['c/d']}</div>
                                    </div>
                                  </div>
                                ...
                                <div className="col-span-12">
                                  <div className="flex items-center justify-between bg-sky bordered rounded-lg px-3 py-2">
                                    <div className="border-end pe-2 pe-lg-3">
                                      <div className="mb-1">
                                        <strong className="md:text-[20px] text-[16px] text-[#2845F5]">TDEE</strong>
                                      </div>
                                      <div>{data?.payload?.tech_lang_keys['57']}</div>
                                    </div>
                                    <div className="ps-2 ps-lg-3">
                                      <div>
                                        <strong className="text-[#119154] text-[20px]">{result?.tech_Calories}</strong>
                                      </div>
                                      <div>{data?.payload?.tech_lang_keys['c/d']}</div>
                                    </div>
                                  </div>
                                ...
                                <div className="col-span-12 md:col-span-6 lg:col-span-6">
                                  <div className="flex items-center justify-between bg-sky bordered rounded-lg px-3 py-2">
                                    <div>
                                      <strong className="md:text-[20px] text-[16px] text-[#2845F5]">{data?.payload?.tech_lang_keys['40']}</strong>
                                    </div>
                                    <div className="border-s-dark ps-2 ps-lg-3">
                                      <div>
                                        <strong className="text-[#119154] text-[20px]">{result?.tech_days}</strong>
                                      </div>
                                ...
                                {/* Target Date */}
                                <div className="col-span-12 md:col-span-6 lg:col-span-6">
                                  <div className="flex items-center justify-between bg-sky bordered rounded-lg px-3 py-3" style={{ minHeight: '64px' }}>
                                    <div>
                                      <strong className="md:text-[20px] text-[16px] text-[#2845F5]">{data?.payload?.tech_lang_keys['Target_Date']}</strong>
                                    </div>
                                    <div className="border-s-dark ps-2">
                                      <div>
                                        <strong className="text-[#119154] text-[20px]">
                                          {
                                            (() => {
                                              const days = parseInt(result?.tech_days || 0, 10);
                                              const futureDate = new Date();
                                ...
                                <p className="mt-2"><strong className="md:text-[20px] text-[16px] text-[#2845F5]">{ data?.payload?.tech_lang_keys[58] }</strong></p>
                                <p className="">{ data?.payload?.tech_lang_keys[59] }</p>
                                <div className="grid grid-cols-12  gap-2 md:gap-4 lg:gap-4 my-4">
                                    <div className="col-span-12 md:col-span-6 lg:col-span-6"><strong className="text-[#2845F5]">{ data?.payload?.tech_lang_keys[60] }</strong></div>
                                    <div className="col-span-12 md:col-span-6 lg:col-span-6">
                                        <div className="w-full ms-auto">
                                            ...
                                            className="input">
                                                <option value="1" selected>{ data?.payload?.tech_lang_keys[61] }</option>
                                                <option value="2">{ data?.payload?.tech_lang_keys[62] }</option>
                                                <option value="3">{ data?.payload?.tech_lang_keys[63] }</option>
                                                <option value="4">{ data?.payload?.tech_lang_keys[64] }</option>
                                                <option value="5">{ data?.payload?.tech_lang_keys[65] }</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div className="w-full mx-auto" >
                                    <div className="flex  items-center justify-between bg-sky bordered rounded-lg p-3 overflow-auto">
                                        <div className="px-3">
                                            <div className="mb-1"><strong className="text-[#2845F5]">{ data?.payload?.tech_lang_keys[44] }</strong></div>
                                            <div>
                                                <strong className="cbval font-s-25">{macros.carbs}</strong>
                                                <span>{ data?.payload?.tech_lang_keys[45] }</span>
                                            </div>
                                        </div>
                                        <div className="border-md-end py-2">&nbsp;</div>
                                        <div className="px-3">
                                            <div className="mb-1"><strong className="text-[#2845F5]">{ data?.payload?.tech_lang_keys[46] }</strong></div>
                                            <div>
                                                <strong className="poval font-s-25">{macros.protein}</strong>
                                                <span>{ data?.payload?.tech_lang_keys[45] }</span>
                                            </div>
                                        </div>
                                        <div className="border-md-end py-2">&nbsp;</div>
                                        <div className="px-3">
                                            <div className="mb-1"><strong className="text-[#2845F5]">{ data?.payload?.tech_lang_keys[47] }</strong></div>
                                            <div>
                                                <strong className="fatval font-s-25">{macros.fat}</strong>
                                                <span>{ data?.payload?.tech_lang_keys[45] }</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                {(result?.tech_HighRiskCalories == '1') && (
                                  <>
                                    <p className="text-[18px] col s12 padding_10">
                                        <strong className="red-text">{ data?.payload?.tech_lang_keys['3'] }!</strong>
                                        { data?.payload?.tech_lang_keys['4'] } { result?.tech_CaloriesLess } { data?.payload?.tech_lang_keys['c/d'] } , { data?.payload?.tech_lang_keys['5'] }
                                        { result?.tech_CaloriesDaily } { data?.payload?.tech_lang_keys['6'] }!
                                    </p>
                                  </>
                                )}
                            <div className="grid grid-cols-12 gap-2 md:gap-4 lg:gap-4 my-4">
                                <div className="col-span-12 md:col-span-6 lg:col-span-6">
                                  <p className="ps-3">
                                    <strong className="text-[#2845F5] text-[20px]">{data?.payload?.tech_lang_keys['10']}</strong>
                                  </p>
                                ...
                                <div className="col-span-12 md:col-span-6 lg:col-span-6 border-l">
                                  <p className="ps-3">
                                    <strong className="text-[#2845F5] text-[20px]">MACRO</strong>
                                  </p>
                                  <div id="container2">

                ...
                <div className="space-y-2 relative">
                  ...
                  <div className="relative w-full ">
                    <input
                      ...
                      name="tech_weight"
                      step="any"
                      className="border  input border-gray-300 rounded-lg focus:ring-2 w-full "
                  ...
                  <div className="rounded-lg  flex items-center justify-center">
                    <div className="w-full rounded-xl  mt-4 result">
                      <div className="w-full">
                        ...
                        <div className="border rounded-xl px-4 py-3 mt-3">
                        ...
                        <div className="w-full overflow-auto mt-4">
                          <table className="w-full text-sm" cellspacing="0">
                            ...
                            <tr>
                              <td className="border-b border-[#99EA48] border-b-2 px-3 py-2">
                                0-6 mo.
                              </td>
                              <td className="border-b border-[#99EA48] border-b-2 px-3 py-2">

...
useEffect(() => {
  if (result) {
    ...
    const eventsInfo = [
      'Fertile Period', 'Fertile Period', 'Ovulation Date', 'Fertile Period', 'Fertile Period',
      'Fertile Period', 'Fertile Period', 'Ovulation Date', 'Fertile Period', 'Fertile Period',
      'Fertile Period', 'Fertile Period', 'Ovulation Date', 'Fertile Period', 'Fertile Period',
      'Fertile Period', 'Fertile Period', 'Ovulation Date', 'Fertile Period', 'Fertile Period',
      'Fertile Period', 'Fertile Period', 'Ovulation Date', 'Fertile Period', 'Fertile Period',
                                    ...
                                    <div className="col-span-12">
                                        <div className="bg-[#6fab4d12] text-center bordered rounded-lg px-3 py-4">
                                            <div className="w-full mx-auto">
                                                ...
                                                <p className="text-2xl mt-3"><strong className="text-green-500">{ result?.tech_Ovu_date }</strong></p>
                                                <div className="bg-white text-sm rounded-lg p-3 mt-3">
                                                    <strong>{ data?.payload?.tech_lang_keys['last_date'] } <span className="text-gray-500 ml-2">{ formData?.tech_date }</span></strong>
                                                </div>
                                                <div className="bg-white text-sm rounded-lg p-3 mt-3 mb-10">
                                                    <strong>{ data?.payload?.tech_lang_keys['c_l'] } <span className="text-gray-500 ml-2">{ formData?.tech_days } { data?.payload?.tech_lang_keys['days'] }</span></strong>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                  ...
                                  {/* <div className="col-span-12 md:col-span-6 lg:col-span-6">
                                            ...
                                            <div className="grid grid-cols-12 mt-3   gap-2 md:gap-4 lg:gap-4">
                                                <div className="col-span-12 md:col-span-6 lg:col-span-6">
                                                    <div className="bg-white text-sm rounded-lg p-2">
                                                        ...
                                                        alt="Fertile Period" className="w-[30px] h-15 mt-3 object-cover mx-auto" />
                                                        <p className="text-blue-500 mt-2"><strong>{ data?.payload?.tech_lang_keys['fertile'] }</strong></p>
                                                        <p>{ result?.tech_First_day } to { (result?.tech_Last_day) }</p>
                                                    </div>
                                                </div>
                                                <div className="col-span-12 md:col-span-6 lg:col-span-6">
                                                    <div className="bg-white text-sm rounded-lg p-2">
                                                        ...
                                                        alt="Next Period" className="w-[30px]  mx-auto" />
                                                        <p className="text-blue-500"><strong>{ data?.payload?.tech_lang_keys['next_period'] }</strong></p>
                                                ...
                                                <div className="col-span-12 md:col-span-6 lg:col-span-6">
                                                    <div className="bg-white text-sm rounded-lg p-2">
                                                        ...
                                                        alt="Intercourse Window for Pregnancy" className="w-[30px]  mx-auto" />
                                                        <p className="text-blue-500 mt-2"><strong>{ data?.payload?.tech_lang_keys['inter_w'] }</strong></p>
                                                        <p>{ result?.tech_First_day} {result?.tech_Last_day }</p>
                                                    </div>
                                                </div>
                                                <div className="col-span-12 md:col-span-6 lg:col-span-6">
                                                    <div className="bg-white text-sm rounded-lg p-2">
                                                        <img
                                                          src="/images/safe.png"
                                                        alt="Safe Period" className="w-[30px]  mx-auto"/>
                                                        <p className="text-blue-500"><strong>{ data?.payload?.tech_lang_keys['save'] }</strong></p>
                                                ...
                                                <div className="col-span-12 md:col-span-6 lg:col-span-6">
                                                    <div className="bg-white text-sm rounded-lg p-2">
                                                        ...
                                                        alt="Due Date" className="w-[30px]  mx-auto"/>
                                                        <p className="text-blue-500"><strong>{ data?.payload?.tech_lang_keys['due_date'] }</strong></p>
                                                ...
                                                <div className="col-span-12 md:col-span-6 lg:col-span-6">
                                                    <div className="bg-white text-sm rounded-lg p-2">
                                                        <img
                                                          src="/images/test.png"
                                                            alt="Pregnancy Test" className="w-[30px]  mx-auto"/>
                                                        <p className="text-blue-500 mt-4"><strong>{ data?.payload?.tech_lang_keys['p_t'] }</strong></p>
                                    ...
                                    <div className="col-span-12 md:col-span-6 lg:col-span-6">
                                        <div className="bg-[#6fab4d12] border rounded-lg p-2 pt-3">
                                            <p className="text-center"><strong className="text-blue-500">{ data?.payload?.tech_lang_keys['6cycle'] }</strong></p>
                                            <div className="w-full overflow-auto cycle6_table">
                                                <table className="w-full mt-2 border" cellspacing="0">
                                                    <tr>
                                                        <td className="border-b border-gray-400 text-xs"><strong>{ data?.payload?.tech_lang_keys['p_s'] }</strong></td>
                                                        <td className="border-b border-l border-gray-400 text-xs"><strong>{ data?.payload?.tech_lang_keys['o_w'] }</strong></td>
                                                        <td className="border-b border-l border-gray-400 text-xs"><strong>{ data?.payload?.tech_lang_keys['d_d'] }</strong></td>
                                                    </tr>
                                                      <tbody className="space-y-7 border" dangerouslySetInnerHTML={{ __html: result.tech_table }} />
                                                </table>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-span-12 ">
                                      <p className="text-sm text-gray-600 mb-2">
                                        <strong>Note:</strong> In the chart below, <span className="text-green-600 font-semibold">1</span> means data is available, and <span className="text-red-600 font-semibold">0</span> means data is missing or not calculated.
                                      </p>

                                      <div className="bg-white p-4 rounded-lg">
                                        <h3 className="text-blue-500 font-semibold mb-2">Overview Chart</h3>

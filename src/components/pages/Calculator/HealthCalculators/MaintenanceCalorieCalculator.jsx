                  ...
                  <div className="rounded-lg  flex items-center justify-center">
                    <div className="w-fill mt-3">
                      <div className="col-12 text-[14px] md:text-[18px]">
                        ...
                        <div className="grid grid-cols-12 gap-4 border-2 rounded-xl p-4 bg-[#F6FAFC]">
                          {/* Left side values */}
                          <div className="col-span-12 md:col-span-5">
                            <div className="px-3 border-b-2 py-3">
                              <strong className="text-[#2845F5]">
                          ...
                          {/* Divider */}
                          <div className="col-span-1 border-r-2 hidden md:block" />

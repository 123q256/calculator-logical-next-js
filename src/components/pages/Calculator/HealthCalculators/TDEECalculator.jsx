               ...
               <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
                <div className="grid grid-cols-12   gap-2 md:gap-4 lg:gap-4">
                  ...
                  {formData.tech_hightUnit == "ft/in"  &&(
                    <>
                    <div className="md:col-span-6 col-span-12 md:col-span-3 ft_in mr-2 ">
                    ...
                    <div className="md:col-span-6 col-span-12 md:col-span-3 ft_in mr-2 mt-1">
                  ...
                  <div>
                    <ResultActions lang={data?.payload?.tech_lang_keys} />
                           ...
                           <div className="grid grid-cols-12 gap-2">
                            ...
                            <div className="col-span-8 md:col-span-7 lg:col-span-4 ">
                              <select
                                name="formula_types"

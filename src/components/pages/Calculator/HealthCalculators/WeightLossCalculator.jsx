...
// });
 ...
 // Define all possible duration arrays
  const calorieArrays = [
    { key: "pandran", dataKey: "tech_diff_array_pandran", finalKey: "tech_final_array_pandran" },
    { key: "adha", dataKey: "tech_diff_array_adha", finalKey: "tech_final_array_adha" },
    { key: "pona", dataKey: "tech_diff_array_pona", finalKey: "tech_final_array_pona" },
    { key: "hour", dataKey: "tech_diff_array", finalKey: "tech_final_array" },
    { key: "sawa", dataKey: "tech_diff_array_sawa", finalKey: "tech_final_array_sawa" },
    { key: "dher", dataKey: "tech_diff_array_dher", finalKey: "tech_final_array_dher" },
    { key: "pone", dataKey: "tech_diff_array_pone", finalKey: "tech_final_array_pone" },
    { key: "do", dataKey: "tech_diff_array_do", finalKey: "tech_final_array_do" }
  ];
            ...
            {formError && (
              ...
              <div className="lg:w-[90%] md:w-[99%] w-full mx-auto ">
                 <div className="grid grid-cols-12  gap-4">
                      <div className="col-span-12 px-2 pb-2">
                          <span className="pe-3 font-s-14 text-blue">{ data?.payload?.tech_lang_keys['83'] }:</span>
                    ...
                    />
                      ...
                      <div className="md:col-span-6 col-span-12 px-2">
                        <label htmlFor="tech_select_type" className="label hidden md:block">{data?.payload?.tech_lang_keys["89"]}: </label>
                        <label htmlFor="tech_select_type" className="label md:hidden">Please select one </label>
                        <div className="mt-2">
                          <select
                            className="input"
                            aria-label="select"
                            ...
                            onChange={handleChange}
                          >
                            <option value="target_date">{data?.payload?.tech_lang_keys["90"]} </option>
                            <option value="custom_cal">{data?.payload?.tech_lang_keys["92"]} </option>
                            <option value="pace">{data?.payload?.tech_lang_keys["94"]} </option>
                          </select>
                        </div>
                      </div>
                      {formData.tech_select_type == "target_date" && (
                        <>
                        <div className="md:col-span-6 col-span-12 relative" id="by_target_show">
                        ...
                        <>
                        <div className="md:col-span-6 col-span-12 relative" id="by_calories_show">
                        ...
                        <>
                        <div className="md:col-span-6 col-span-12 relative" id="by_pace_show">
                          ...
                          <div className="mt-2">
                            ...
                            >
                              <option value="relaxed">
                                {data?.payload?.tech_lang_keys["76"]} : 0.25 kg (0.5 lb) /{" "}
                                {data?.payload?.tech_lang_keys["96"]}
                              </option>
                              <option value="normal">
                                {data?.payload?.tech_lang_keys["78"]} : 0.5 kg (1.1 lb) /{" "}
                                {data?.payload?.tech_lang_keys["96"]}
                              </option>
                              <option value="strict">
                      ...
                      <div className="md:col-span-8 col-span-12 px-2">
                        ...
                        <div className="mt-2">
                          <select
                            ...
                            onChange={handleChange}
                          >
                            <option value="0.2">{data?.payload?.tech_lang_keys["175"] ?? "No sport/exercise"} </option>
                            <option value="0.375">{data?.payload?.tech_lang_keys["176"] ?? "Light activity (sport 1-3 times per week)"} </option>
                            <option value="0.55">{data?.payload?.tech_lang_keys["177"] ?? "Moderate activity (sport 3-5 times per week)"} </option>
                            <option value="0.725">{data?.payload?.tech_lang_keys["178"] ?? "High activity (everyday exercise)"} </option>
                            <option value="0.9">{data?.payload?.tech_lang_keys["179"] ?? "Extreme activity (professional athlete)"} </option>
                          </select>
                        </div>
                      </div>
                    ...
                    {data?.payload?.tech_lang_keys['190'] && (
                      <div className="col-span-12 px-2 mt-3 font-s-12 hidden md:block">
                        <p>
                          <strong>{data?.payload?.tech_lang_keys['189']}:</strong> {data?.payload?.tech_lang_keys['190']}
                        </p>
                      </div>
                    )}
                    {data?.payload?.tech_lang_keys['191'] && (
                      <div className="col-span-12 px-2 mt-3 font-s-12 md:hidden">
                        <p>
                          <strong>{data?.payload?.tech_lang_keys['189']}:</strong> {data?.payload?.tech_lang_keys['191']}
                        </p>
                      </div>
                    )}
              ...
              <div className="mb-6 mt-10 text-center space-x-2">
                  ...
                  <div className="col-span-12 custom-alert mt-3 " id="alertmsg">
                    <p><strong>Disclaimer</strong>:  This weight loss date calculator provides estimated calories. Results may vary by individual factors. Consult a healthcare professional before making dietary or fitness changes.</p>
                </div>
              </div>
                  ...
                  <div>
                          ...
                          <div className="grid grid-cols-1 gap-4 m-3 p-3">
                            <div className="bg-sky bordered rounded-lg px-4 py-3">
                              ...
                              <p className="text-sm mt-2">
                                ...
                                <strong>
                                  {new Date(Date.now() + result?.tech_days * 86400000).toLocaleDateString("en-GB", {
                                    day: "2-digit",
                                    month: "short",
                                    year: "numeric",
                                  })}
                              ...
                              <p className="text-center text-lg my-2">
                                <strong className="text-orange-500 md:text-[40px] text-[25px]">{result?.tech_CaloriesDaily}</strong>{" "}
                                <strong className="text-blue-600">{data?.payload?.tech_lang_keys[103]}</strong>
                              </p>
                              <p className="text-sm mt-2">
                          ...
                          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-4">
                            <div className="bordered bg-sky rounded-lg p-4 flex flex-col justify-between" >
                              <div>
                                ...
                                <p className="text-sm mt-2 hidden md:block">
                                  ...
                                  <strong>{result?.tech_Calories - result?.tech_CaloriesDaily}</strong>
                            ...
                            <div className="bordered bg-sky rounded-lg p-4 flex flex-col justify-between" >
                              <div>
                                ...
                                <p className="text-sm mt-2">{data?.payload?.tech_lang_keys[140]}</p>
                                <div className="text-center mt-2">
                                  <p className="text-orange-500 text-[32px] font-semibold">
                                    {(result?.tech_Calories - result?.tech_CaloriesDaily)?.toLocaleString()}
                                  </p>
                                  <p className="text-blue-600 text-sm font-medium">
                                    {data?.payload?.tech_lang_keys[103]}
                                  </p>
                        ...
                        <div className="w-full ">
                          <div  className="bg-sky bordered rounded-lg px-3 py-2  overflow-auto mt-3">
                            <table className="w-full" cellSpacing="0">
                              <tbody>
                                <tr>
                                  <td className="border-bottom py-2">Maintain weight</td>
                                  <td className="border-bottom py-2 text-end">
                                    <strong className="font-s-18">{Number(result?.tech_Calories)}</strong>
                                ...
                                <tr>
                                  <td className="border-bottom py-2">
                                    Mild Weight Loss
                                    {result?.tech_submit === "lbs" ? "( 0.5 lb/week )" : "( 0.25 kg/week )"}
                                  </td>
                                  <td className="border-bottom py-2 text-end">
                                    {(() => {
                                      const calorieReduction = result?.tech_submit === "lbs" ? 250 : Math.round((7700 * 0.25) / 7);
                                      return (
                                        <>
                                          <strong className="font-s-18">{Number(result?.tech_Calories - calorieReduction)}</strong>
                                          <span className="font-s-14">Calories/Day</span>
                                        </>
                                      );
                                    })()}
                                ...
                                <tr>
                                  <td className="border-bottom py-2">
                                    Weight Loss
                                    {result?.tech_submit === "lbs" ? "( 1 lb/week )" : "( 0.5 kg/week )"}
                                  </td>
                                  <td className="border-bottom py-2 text-end">
                                    {(() => {
                                      const calorieReduction = result?.tech_submit === "lbs" ? 500 : Math.round((7700 * 0.5) / 7);
                                      return (
                                        <>
                                          <strong className="font-s-18">{Number(result?.tech_Calories - calorieReduction)}</strong>
                                          <span className="font-s-14">Calories/Day</span>
                                ...
                                <tr>
                                  <td className="py-2">
                                    Extreme Weight Loss
                                    {result?.tech_submit === "lbs" ? "( 2 lb/week )" : "( 1 kg/week )"}
                                  </td>
                                  <td className="py-2 text-end">
                                    {(() => {
                                      const calorieReduction = result?.tech_submit === "lbs" ? 1000 : Math.round(7700 / 7);
                                      return (
                                        <>
                                          <strong className="font-s-18">{Number(result?.tech_Calories - calorieReduction)}</strong>
                                          <span className="font-s-14">Calories/Day</span>
                          ...
                          <div className="col-12 mt-3">
                            ...
                            <div className="bg-sky bordered rounded-lg p-3 mt-2">
                              <div className="row align-items-center">
                                ...
                                <div className="col-md-6">
                                  <div className="col-md-9 ms-auto">
                                    ...
                                    >
                                      <option value="1">15 {data?.payload?.tech_lang_keys[148]}</option>
                                      <option value="2">30 {data?.payload?.tech_lang_keys[148]}</option>
                                      <option value="3">45 {data?.payload?.tech_lang_keys[148]}</option>
                                      <option value="4">1 {data?.payload?.tech_lang_keys[149]}</option>
                                      <option value="5">1 {data?.payload?.tech_lang_keys[149]} 15 {data?.payload?.tech_lang_keys[148]}</option>
                                      <option value="6">1 {data?.payload?.tech_lang_keys[149]} 30 {data?.payload?.tech_lang_keys[148]}</option>
                                      <option value="7">1 {data?.payload?.tech_lang_keys[149]} 45 {data?.payload?.tech_lang_keys[148]}</option>
                                      <option value="8">2 {data?.payload?.tech_lang_keys[149]}</option>
                                    </select>
                                  </div>
                                </div>
                              </div>
                              ...
                              {calorieArrays.map(({ key, dataKey, finalKey }) => {
                                ...
                                const visible = selectedValue === getDurationValueByKey(key);

                                return visible ? (
                                  <div key={key} className={`col-12 calories_${key} my-3`}>
                                    {diffArray?.length > 0 ? (
                                      <div className="col-12 overflow-auto" style={{ height: "300px" }}>
                                        <table className="col-12" cellSpacing="0">
                                          <tbody>
                                        {finalArray.map((value, index) => {
                                          const { cal_ans, name_ans } = parseValue(value);

                                          // Step 1: Remove parentheses content first
                                          let cleanName = name_ans?.replace(/\(.*?\)/g, '').trim();

                                          // Step 2: Then split before comma
                                          let firstPart = cleanName?.split(",")[0]?.trim();

                                          // Step 3: Clean special characters except space
                                          const cleanedPhrase = firstPart?.replace(/[^\w\s]/g, '');

                                          // Step 4: Remove spaces for image filename
                                          const imageName = cleanedPhrase?.replace(/\s+/g, '');
                   ...
                   <div className="mt-4 border border-gray-200 rounded-xl shadow-sm overflow-auto bg-white">
                      ...
                      <tbody className="divide-y divide-gray-200">
                        ...
                        <tr className="hover:bg-gray-50">
                          ...
                          <td className="py-3 px-4 text-right">
                            <strong>{result?.tech_BMR}</strong> <sub>{data?.payload?.tech_lang_keys[103]}</sub>
                          </td>
                        </tr>
                        ...
                        <tr className="hover:bg-gray-50">
                          ...
                          <td className="py-3 px-4 text-right">
                            ...
                            <sub>{formData?.tech_unit_type === "lbs" ? "lbs" : "kg"}</sub>
                          </td>
                        </tr>

                        {/* You Are */}
                        <tr className="hover:bg-gray-50">
                          <td className="py-3 px-4 font-medium">{data?.payload?.tech_lang_keys[125]}</td>
                          <td className="py-3 px-4 text-right">
                    ...
                    <p className="mb-4 ps-0 lg:ps-3 text-gray-700 text-sm leading-relaxed">
                      Besides cutting calories, amp up your activity! See a list of estimated weight loss for different activity levels, based on a daily intake of{" "}
                      ...
                      <table className="min-w-full text-left text-sm text-gray-700">
                        ...
                        <tbody className="divide-y divide-blue-100">
                          {[
                            ...
                            ["Light activity (1–3x/week)", result?.tech_activity_second],
                            ["Moderate activity (3–5x/week)", result?.tech_activity_third],
                            ["High activity (daily exercise)", result?.tech_activity_four],
                            ["Extreme activity (athlete)", result?.tech_activity_five],

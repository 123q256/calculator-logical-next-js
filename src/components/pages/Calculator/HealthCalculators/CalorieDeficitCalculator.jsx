  ...
  const rows = (result?.tech_intake_cal_array || []).map((val, index) => {
    ...
    return (
      ...
      >
        ...
        <td className={`text-[14px] ${borderClass} p-2`} width="15%">{in_cal}</td>
                            ...
                            {/* Summary Table (Hide when details shown) */}
                              {!showDetail && (
                                <div className="w-full hide_table px-3">
                                  ...
                                  <div className="w-full overflow-auto bg-sky bordered rounded-lg custom-scroll" style={{ maxHeight: 286 }}>
                                        ...
                                        {(result?.tech_intake_cal_array || []).map((val, idx) => {
                                          ...
                                          return (
                                            ...
                                            >
                                              ...
                                              <td className={`text-[14px] ${borderClass} p-2`}>{yrs}</td>
                                              <td className={`text-[14px] ${borderClass} p-2`}>{date}</td>
                                              <td className={`${borderClass} text-green-500 p-2 flex`} title={data?.payload?.tech_lang_keys[77]}>
                                                <span className="mx-1">{data?.payload?.tech_lang_keys[87]}</span>
                                                <img
                                                  src="/images/blue-arrow.png"
                                                  alt="Arrow"

...
const BodyFatCalculator = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.tech_calculator_type || !formData.tech_method) {
    ...
    try {
      const response = await calculateEbitCalculator({
        tech_calculator_type: formData.tech_calculator_type,
  ...
  const setUnitHandler2 = (unit) => {
    setFormData((prev) => ({ ...prev, tech_hip: unit }));
          ...
          <div className="lg:w-[70%] md:w-[60%] w-full mx-auto ">
            <div className="grid grid-cols-12 mt-3  gap-4">
              <div className="col-span-12 px-2 flex mb-2 items-center">
                <label for="gender" className="pe-lg-3 pe-2 label">
              ...
              {/* <input
                    ...
                    onChange={handleChange}
                  />
                  <div className="col-span-6 px-2 ft_in" >
                  ...
                  <div className="col-span-6 px-2 ps-lg-0 ft_in ">
              ...
              {/* addition code */}
              <div className="col-span-6 h_cm hidden  height-cm">
              ...
              <div className="col-span-6 px-2 abd ">
                <label htmlFor="tech_abd" className="label flex items-center">
              ...
              <div className="col-span-6 px-2 thigh ">
                <label htmlFor="tech_thigh" className="label flex items-center">
              ...
              <div className="col-span-6 px-2 sub ">
                <label htmlFor="tech_sub" className="label flex items-center">
              ...
              <div className="col-span-6 px-2 sup ">
                <label htmlFor="tech_sup" className="label flex items-center">
              ...
              <div className="col-span-6 px-2 mid ">
                <label htmlFor="tech_mid" className="label flex items-center">
              ...
              <div className="col-span-6 px-2 bicep ">
                <label htmlFor="tech_bicep" className="label flex items-center">
              ...
              <div className="col-span-6 px-2 back ">
                <label htmlFor="tech_back" className="label flex items-center">
                      ...
                      <div className="col-12">
                        ...
                        formData?.tech_calculator_type == "simple" ? (
                          <div className="col-lg-12 mx-auto">
                            <div className="grid grid-cols-12 gap-3">
                              <div className="col-span-12 md:col-span-6 ">
                                <div className="bg-sky-100 text-center border radius-10 p-3 ">
                                  <p>
                                    <strong>
                                      {
                            ...
                            <div className="border radius-10 mt-3 statistics">
                              <div className="row text-center ">
                                <p className="text-[14px] py-2 font_w  bg-[#99ea48] br-top ">
                            ...
                            <div className="row hidden">
                              <div className="col-lg-3 p-2">
                                <div className="bg-sky-100 text-center border radius-10 px-3 py-2">
                          ...
                          <div className="col-lg-12 mx-auto">
                            ...
                            <div className="row bg-[#99ea48] radius-10">

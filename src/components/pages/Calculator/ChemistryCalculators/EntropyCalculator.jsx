        ...
        <form className="row" onSubmit={handleSubmit}>
          <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mb-3">
            ...
            <div className="lg:w-[60%] md:w-[80%] w-full mx-auto ">
                <div className="grid grid-cols-1    gap-4">
                    <div className="space-y-2 relative">
                          ...
                          <div className="mt-2">
                            ...
                            >
                              <option value={data?.payload?.tech_lang_keys["11"]}>{data?.payload?.tech_lang_keys["11"]}</option>
                              <option value={data?.payload?.tech_lang_keys["12"]}>{data?.payload?.tech_lang_keys["12"]}</option>
                              <option value={data?.payload?.tech_lang_keys["13"]}>{data?.payload?.tech_lang_keys["13"]}</option>
                            </select>
                          </div>
                      
                    </div>
                </div>
                {formData.tech_point_unit == data?.payload?.tech_lang_keys["11"]  && (
                  <>
               ...
               {formData.tech_point_unit == data?.payload?.tech_lang_keys["12"]  && (
                  <>
               ...
               {formData.tech_point_unit == data?.payload?.tech_lang_keys["13"]  && (
                  <>
                <div className="col-12 " id="three">
                    <div className="grid grid-cols-1 mt-4  lg:grid-cols-2 md:grid-cols-2  gap-4">
                        <div className="space-y-2 relative">
                          ...
                          <div className="mt-2">
                            <select
                              ...
                              onChange={handleChange}
                            >
                              <option value={data?.payload?.tech_lang_keys["23"]}>{data?.payload?.tech_lang_keys["23"]}</option>
                              <option value={data?.payload?.tech_lang_keys["24"]}>{data?.payload?.tech_lang_keys["24"]}</option>
                            </select>
                          </div>
                        </div>
                        <div className="space-y-2 ">
                      ...
                      {formData.tech_base_unit == data?.payload?.tech_lang_keys["23"]  && (
                        <>
                        <div className="space-y-2">
                            ...
                            {dropdownVisible5 && (
                              <div className="absolute z-10 bg-white border border-gray-300 rounded-md w-auto mt-1 right-0">
                                {[
                                  ...
                                  { label: "US fluid ounces (US fl oz)", value: "US fl oz" },
                                  { label: "UK fluid ounces (UK fl oz)", value: "UK fl oz" },
                         ...
                         <div className="space-y-2">
                          ...
                          {formData.tech_base_unit == data?.payload?.tech_lang_keys["24"]  && (
                        <>
                    ...
                    <ResultActions lang={data?.payload?.tech_lang_keys} />
                      ...
                      <div className="rounded-lg  flex items-center justify-center">
                          <div className="w-full mt-3">
                            {(formData?.tech_point_unit === "entropy change for a reaction") ? (
                              <>
                              <div>
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                  <div className="border-r-4 mt-3">
                                    ...
                                    <p>{(entropy * 0.737562149).toExponential(3)}</p>
                                  </div>
                                  <div className="border-r-4 mt-3">
                                  ...
                                  <div className="border-r-4 mt-3">
                                    ...
                                    <p>{(entropy * 6.242 * Math.pow(10, 18)).toExponential(3)}</p>
                                  </div>
                                </div>
                              </div>
                              
                              </>
                            ): (formData?.tech_point_unit === "gibbs free energy ΔG = ΔH - T*ΔS") ? (
                              <>
                              <div>
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                  ...
                                  <div className="border-r-4 mt-3 break-words">
                                    ...
                                    <p>{(gibbs * 6.242 * Math.pow(10, 18)).toExponential(3)}</p>
                                  </div>
                                </div>
                              </div>
                              </>

                            ): (formData?.tech_point_unit === "isothermal entropy change of an ideal gas") ? (
                              <>
                                  {formData?.tech_base_unit === "volume" ? (
                                  <>
                                    <div className="flex flex-col md:flex-row items-center bg-sky bordered rounded-lg px-3 py-2">
                                      <strong className="md:pe-3">{data?.payload?.tech_lang_keys['21']} =</strong>
                                      <strong className="text-[#119154] text-[28px]">
                                        {Number(result?.tech_answer).toExponential(3)} <span className="text-[16px]">j</span>
                                      </strong>
                                    </div>

                                    <p className="mt-3 font-bold">{data?.payload?.tech_lang_keys['15']}</p>

                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                      <UnitBox label="kj" value={result?.tech_answer / 1000} />
                                      <UnitBox label="mj" value={result?.tech_answer / 1e6} />
                                      <UnitBox label="wh" value={result?.tech_answer / 3600} />
                                      <UnitBox label="kwh" value={result?.tech_answer / 3.6e6} />
                                    </div>

                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                      <UnitBox label="ft-lb" value={result?.tech_answer * 0.737562149} />
                                      <UnitBox label="cal" value={result?.tech_answer / 4.184} />
                                      <UnitBox label="kcal" value={result?.tech_answer * 0.000239006} />
                                      <UnitBox label="ev" value={result?.tech_answer * 6.242 * Math.pow(10, 18)} />
                                    </div>
                                  </>
                                ) : (
                                  <>
                                    <div className="flex flex-col md:flex-row items-center bg-sky bordered rounded-lg px-3 py-2">
                                      <strong className="md:pe-3">{data?.payload?.tech_lang_keys['21']} =</strong>
                                      <strong className="text-[#119154] text-[28px]">
                                        {Number(result?.tech_answers).toExponential(3)} <span className="text-[16px]">j</span>
                                      </strong>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                      <UnitBox label="kj" value={result?.tech_answers / 1000} />
                                      <UnitBox label="mj" value={result?.tech_answers / 1e6} />
                                      <UnitBox label="wh" value={result?.tech_answers / 3600} />
                                      <UnitBox label="kwh" value={result?.tech_answers / 3.6e6} />
                                    </div>

                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                      <UnitBox label="ft-lb" value={result?.tech_answers * 0.737562149} />
                                      <UnitBox label="cal" value={result?.tech_answers / 4.184} />
                                      <UnitBox label="kcal" value={result?.tech_answers * 0.000239006} />
                                      <UnitBox label="ev" value={result?.tech_answers * 6.242 * Math.pow(10, 18)} />
                                    </div>
                                  </>
                                )}

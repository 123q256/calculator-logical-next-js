    ...
    >
      <form className="row" onSubmit={handleSubmit}>
        <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mb-3">
          ...
          <div class="lg:w-[80%] md:w-[94%] w-full mx-auto ">
            <div class="grid grid-cols-12  lg:gap-4 md:gap-4 gap-1">
              ...
              <div class="lg:col-span-6 md:col-span-6 col-span-12 lawn_mowed">
                ...
                <div>
                  ...
                  <div class="rounded-lg  flex items-center justify-center">
                    <div class="w-full mt-3 ">
                      <div
                        class="w-full  result canvas_div_pdf lg:text-[18px] md:text-[18px] text-[16px]"
                        id="printThis"
                      >
                        <div class="col m10 s12">
                          <div class="text-center pt-1 pb-2">
                            <p class=" text-[#2845F5] text-[20px] relative inline-block rounded-full  p-3">
                              {data?.payload?.tech_lang_keys["3"]}
                            </p>
                            <p class="text-[28px] bordered rounded-lg text-[#ff6d00] font-bold  bg-sky">
                              {Number(result?.tech_final_result3).toFixed(5)}
                            </p>
                          </div>
                          <p class="w-full py-2 text-[25px] text-[#2845F5]">
                            <strong>
                              {data?.payload?.tech_lang_keys["4"]}:
                            </strong>
                          </p>
                          <p class="w-full py-2 lg:text-[18px] md:text-[18px] text-[16px] ">
                            <strong>
                          ...
                          <p class="w-full py-2 lg:text-[18px] md:text-[18px] text-[16px] text-[#2845F5] ">
                            <strong>
                          ...
                          <p class="w-full py-2 lg:text-[18px] md:text-[18px] text-[16px] orange-text text-accent-4">
                            <strong>
                              = {Number(result?.tech_final_result3).toFixed(5)}
                            </strong>
                          </p>

      ...
      <form className="row" onSubmit={handleSubmit}>
        <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg space-y-6 mb-3">
          ...
          <div class="lg:w-[60%] md:w-[80%] w-full mx-auto ">
            ...
            {formData.tech_calculator_name == "calculator1" && (
              <>
                <div class="grid grid-cols-12 gap-1  md:gap-4 mt-5">
                  ...
                  {(formData.tech_find == "n0" ||
                    ...
                    <>
                      <div class="col-span-12 md:col-span-6 px-2 nt">
                        <label htmlFor="tech_nt" className="label">
                          {data?.payload?.tech_lang_keys["2"]} (N
                          <sub class="text-blue">t</sub>):
                        </label>
                        <div class=" relative">
                          <input
                            type="number"
                  ...
                  {(formData.tech_find == "nt" ||
                    ...
                    formData.tech_find == "t1_2") && (
                    <>
                      <div class="col-span-12 md:col-span-6 px-2 n0">
                        <label htmlFor="tech_n0" className="label">
                          {data?.payload?.tech_lang_keys["3"]} (N
                          <sub class="text-blue">0</sub>):
                        </label>
                        <div class=" relative">
                          <input
                            type="number"
                  ...
                  {(formData.tech_find == "nt" ||
                    ...
                    formData.tech_find == "t1_2") && (
                    <>
                      <div class="col-span-12 md:col-span-6 px-2 t">
                  ...
                  {(formData.tech_find == "nt" ||
                    ...
                    formData.tech_find == "t") && (
                    <>
                      <div class="col-span-12 md:col-span-6 px-2 t1_2 ">
                        <label htmlFor="tech_t1_2" className="label">
                          {data?.payload?.tech_lang_keys["5"]} (t
                          <sub class="text-blue">1/2</sub>):
                        </label>
                        <div class=" relative">
                          <input
                            type="number"
            ...
            {formData.tech_calculator_name == "calculator2" && (
              <>
                <div class="grid grid-cols-12 gap-1  md:gap-4 mt-4 ">
                  <h2 class="text-blue-800 trxt-[18px] px-2 mb-3 col-span-12">

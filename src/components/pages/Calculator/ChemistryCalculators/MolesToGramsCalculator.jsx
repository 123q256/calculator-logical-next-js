        ...
        <div className="w-full mx-auto p-4 lg:p-8 md:p-8 input_form rounded-lg  space-y-6 mb-3">
          ...
          <div class="lg:w-[70%] md:w-[90%] w-full mx-auto ">
            {formData.tech_unit != "3" && (
              <>
                <div class="grid grid-cols-1   gap-4 mt-2 cont">
                ...
                <div class="grid grid-cols-12 gap-1  md:gap-4 mt-2 ">
                  ...
                  <div class="lg:col-span-6 md:col-span-6 col-span-12" id="selection2">
                  ...
                  <div class="lg:col-span-6 md:col-span-6 col-span-12" id="molar_mass">
            ...
            <div class="grid grid-cols-1 mt-4  gap-4 mt-2 ">
              <div class="space-y-2">
                <p>
                  <strong class="text-blue">
            ...
            <div class="grid grid-cols-12 gap-1  md:gap-4 mt-2">
              ...
              {(formData.tech_unit == "1" || formData.tech_unit == "3") && (
                <>
                  <div class="lg:col-span-6 md:col-span-6 col-span-12" id="mass">
              ...
              {(formData.tech_unit == "2" || formData.tech_unit == "3") && (
                <>
                  <div class="lg:col-span-6 md:col-span-6 col-span-12" id="no_moles">

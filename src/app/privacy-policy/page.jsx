...
const PrivacyPolicy = () => {
  const canonicalUrl = `https://calculator-logical.com/privacy-policy`;
  const ogImage = `https://calculator-logical.com/images/ogview/pages/calculator-logical.png`;
  const metaTitle = "Privacy Policy And Cookies";
  ...
  return (
    <div className="mx-auto max-w-7xl sm:px-6 lg:px-8 px-5 mb-[60px]">
      ...
      <ul className="list-disc list-inside">
        <li className=" my-4 text-[16px] leading-[28.71px]">
          <strong>Email: </strong> <span className="pl-1">[Email address]</span>
        </li>
      </ul>
